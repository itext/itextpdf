/* in_action/chapter02/HelloWorldStamper.java */
...
public class HelloWorldStamper {
	...
	public static void main(String[] args) {
		System.out.println("Chapter 2: example HelloWorldStamper");
		System.out
				.println("-> Creates a PDF file, then stamps extra content on it:");
		...
		System.out.println("   HelloWorldStamper.pdf");
		...
		try {
			...
			PdfStamper stamper = new PdfStamper(reader, new FileOutputStream(
					"results/in_action/chapter02/HelloWorldStamper.pdf"));
