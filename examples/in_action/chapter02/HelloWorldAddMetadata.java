...
public class HelloWorldAddMetadata {
	...
	public static void main(String[] args) {
		...
		createPdf("results/in_action/chapter02/HelloWorldNoMetadata.pdf");
		// now we are going to inspect it
		try {
			// we create a PdfReader object
			PdfReader reader = new PdfReader("results/in_action/chapter02/HelloWorldNoMetadata.pdf");
			System.out.println("Tampered? " + reader.isTampered());
			PdfStamper stamper = new PdfStamper(reader, new FileOutputStream(
					"results/in_action/chapter02/HelloWorldStampedMetadata.pdf"));
			System.out.println("Tampered? " + reader.isTampered());
