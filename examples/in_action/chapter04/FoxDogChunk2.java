/* in_action/chapter04/FoxDogChunk2.java */
...
public class FoxDogChunk2 {
	...
	public static void main(String[] args) {
		System.out.println("Chapter 4: example FoxDogChunk2");
		System.out.println("-> Creates a PDF file with the text");
		System.out.println("   'Quick brown fox jumps over the lazy dog';");
		System.out.println("   the text is added using Chunk objects but overlaps.");
		System.out.println("-> jars needed: iText.jar");
		System.out.println("-> resulting PDF: fox_dog_overlapping_chunks.pdf");
		...
		try {
			...
			// that listens to the document
					...
					new FileOutputStream("results/in_action/chapter04/fox_dog_overlapping_chunks.pdf"));
