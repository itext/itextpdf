/* in_action/chapter04/FoxDogGoto1.java */
...
public class FoxDogGoto1 {
	...
	public static void main(String[] args) {
		System.out.println("Chapter 4: example FoxDogGoto1");
		...
		System.out.println("-> resulting PDF: fox_dog_goto1.pdf");
		...
		try {
			...
			// that listens to the document
					...
					new FileOutputStream("results/in_action/chapter04/fox_dog_goto1.pdf"));
			...
			Chunk chunk = new Chunk("Quick brown fox jumps over the lazy dog.",
					font);
			chunk
					.setAnchor("http://en.wikipedia.org/wiki/The_quick_brown_fox_jumps_over_the_lazy_dog");
			document.add(chunk);
