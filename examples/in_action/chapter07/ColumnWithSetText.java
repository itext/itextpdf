/* in_action/chapter07/ColumnWithSetText.java */
...
public class ColumnWithSetText {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// that listens to the document
					...
					new FileOutputStream("results/in_action/chapter07/column_set_text.pdf"));
