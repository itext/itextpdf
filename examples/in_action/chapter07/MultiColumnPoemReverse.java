/* in_action/chapter07/MultiColumnPoemReverse.java */
...
public class MultiColumnPoemReverse {
	...
	public static void main(String[] args) {
		System.out.println("Chapter 7: example MultiColumnPoemReverse");
		System.out.println("-> Creates a PDF file with absurd poems in columns.");
		System.out.println("-> jars needed: iText.jar");		
		System.out.println("-> file generated: poem_reverse.pdf");		
		...
		try {
			...
			PdfWriter.getInstance(
					...
					new FileOutputStream("results/in_action/chapter07/poem_reverse.pdf"));
