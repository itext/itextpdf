...
public class TooltipExample extends PdfPageEventHelper {
	public static void main(String[] args) {
		...
		try {
			...
			PdfWriter writer = PdfWriter.getInstance(
					...
					new FileOutputStream("results/in_action/chapterX/tooltip.pdf"));
			// step 3: we open the document
			document.open();
			writer.setPageEvent(new TooltipExample());
