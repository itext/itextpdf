/* in_action/chapter07/MultiColumnPoem.java */
...
public class MultiColumnPoem {
	...
	public static void main(String[] args) {
		System.out.println("Chapter 7: example MultiColumnPoem");
		System.out.println("-> Creates a PDF file with absurd poems in columns.");
		System.out.println("-> jars needed: iText.jar");
		System.out.println("-> file generated: poem.pdf");
		...
		try {
			...
			// that listens to the document
					...
					new FileOutputStream("results/in_action/chapter07/poem.pdf"));
			...
			for (int i = 0; i < 30; i++) {
				...
				mct.addElement(newParagraph(randomWord(noun),
						Element.ALIGN_CENTER, Font.BOLDITALIC));
				for (int j = 0; j < 4; j++) {
					mct.addElement(newParagraph(poemLine(), Element.ALIGN_LEFT,
							Font.NORMAL));
				}
				mct.addElement(newParagraph(randomWord(adverb),
