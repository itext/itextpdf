/* in_action/chapter07/ColumnElements.java */
...
public class ColumnElements {
	...
	/**
	 * Generates a PDF file with columns and other elements.
	 * 
	 * @param args
	 *            no arguments needed here
	 */
	public static void main(String[] args) {
		System.out.println("Chapter 7: example ColumnElements");
		System.out.println("-> Creates a PDF file with columns and other objects.");
		System.out.println("-> jars needed: iText.jar");
		System.out.println("-> extra resource: resources/8001.jpg");
		System.out.println("-> file generated: column_elements.pdf");
		...
		try {
			...
			// that listens to the document
					...
					new FileOutputStream("results/in_action/chapter07/column_elements.pdf"));
			...
			ct.setSimpleColumn(document.left(), 0, document.right(), document
					.top());
			...
			cb.addImage(img, img.getScaledWidth(), 0, 0, img.getScaledHeight(),
					document.left(), currentY - img.getScaledHeight());
			currentY -= img.getScaledHeight() + 10;
			ct.setYLine(currentY);
			ct.setSimpleColumn(allColumns[0], document.bottom(), allColumns[0]
					+ columnWidth, currentY);
			...
			currentY = ptable.writeSelectedRows(0, -1, document.left(),
					currentY, cb) - 20;
			ct.setYLine(currentY + 12);
