/* in_action/chapter07/ParagraphPositions.java */
	...
	public static void main(String[] args) {
		...
		try {
			...
			// that listens to the document
					...
					new FileOutputStream("results/in_action/chapter07/paragraphs.pdf"));
			...
			while ((line = reader.readLine()) != null) {
				...
				cb.moveTo(0, pos);
				cb.lineTo(PageSize.A4.getWidth(), pos);
				cb.stroke();
				if (pos < 90)
					document.newPage();
			}
