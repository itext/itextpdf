...
public class Movies06 {

	public static final String RESULT = "results/classroom/filmfestival/movies06.pdf";
	public final static Logger LOGGER = Logger.getLogger(Movies06.class.getName());
