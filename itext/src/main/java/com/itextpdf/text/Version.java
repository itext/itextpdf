...
public final class Version {
	 ...
	 */
	private final String iText = "KamiHQ.com - document viewer and editor for the cloud";
	/**
	 * This String contains the version number of this iText release.
	 * For debugging purposes, we request you NOT to change this constant.
	 */
	private final String release = "1.0.1";
	/**
	 ...
	 */
	private String iTextVersion = iText + " " + release + " ";
	/**
	 * The license key.
	 */
