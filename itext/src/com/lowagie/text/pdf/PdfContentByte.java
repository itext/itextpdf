...
// methods to add graphical content 
	...
	final void doImage(PdfName name, double[] matrix, int x, int y) {
		content.append("q ");
		content.append(matrix[Image.AX]).append(" ");
		content.append(matrix[Image.AY]).append(" ");
		content.append(matrix[Image.BX]).append(" ");
		content.append(matrix[Image.BY]).append(" ");
		content.append(x - matrix[Image.CX]).append(" ");
		content.append(y - matrix[Image.CY]).append(" cm ");
    ...
    {
        content.append(f).append(" Tc\n");
    }

    public void setWordSpacing(float f)
    {
        content.append(f).append(" Tw\n");
    }

    public void setHorizontalScaling(float f)
    {
        content.append(f).append(" Tz\n");
    }

    public void setLeading(float f)
    {
        content.append(f).append(" TL\n");
    }

    public void setFontSize(BaseFont bf, float size)
    {
        lastFontUsed = bf;
    ...
    {
        content.append(i).append(" Tr\n");
    }

    public void setTextRise(float f)
    {
        content.append(f).append(" Ts\n");
    }

    private void showText2(String text) throws NullPointerException, UnsupportedEncodingException
    {
        if (lastFontUsed == null)
            throw new NullPointerException("Font size must be set before writing any text");
        byte b[] = lastFontUsed.convertToBytes(text);
        content.append_i('(');
    ...
    public void showText(String text) throws NullPointerException, UnsupportedEncodingException
    {
        showText2(text);
        content.append("Tj\n");
    }
    
    public void newlineShowText(String text) throws NullPointerException, UnsupportedEncodingException
    {
        showText2(text);
        content.append("'\n");
    }
    
    public void newlineShowText(float wordSpacing, float characterSpacing, String text) throws NullPointerException, UnsupportedEncodingException
    {
        content.append(wordSpacing).append(" ").append(characterSpacing);
        showText2(text);
        content.append("\"\n");
    }
    ...
    {
        content.append(a).append_i(' ').append(b).append_i(' ')
            .append(c).append_i(' ').append(d).append_i(' ')
            .append(e).append_i(' ').append(f).append(" Tm\n");
    }
