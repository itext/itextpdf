 ...
 */
        ...
        void addProducer() {
            put(PdfName.PRODUCER, new PdfString("iText by lowagie.com - build 78"));
        }
        ...
        try {
            switch(element.type()) {
                ...
                case Element.PTABLE:
                {
                    ...
                    float dn = ptable.writeRows(xWidth, indentTop() - currentHeight, writer.getDirectContent());
                    text.moveText(0, -(-currentHeight - dn + indentTop()));
