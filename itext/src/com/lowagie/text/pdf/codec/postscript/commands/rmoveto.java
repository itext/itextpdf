...
public class rmoveto implements PACommand, IBinaryExecute,IPSLevel1 {
  public rmoveto() {
    super();
  }
 ...
 public void execute(PAContext context, Number operand1, Number operand2) throws
     PainterException {
   context.pencil.rmoveto(operand1.doubleValue(), operand2.doubleValue());
   if(PAContext.DebugCommandleveltrace)System.out.println("rmoveto("+operand1.doubleValue()+","+operand2.doubleValue()+")");
 }
