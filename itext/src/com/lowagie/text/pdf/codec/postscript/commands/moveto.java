...
public class moveto implements PACommand, IBinaryExecute,IPSLevel1 {
  public moveto() {
    super();
  }
 ...
 public void execute(PAContext context, Number operand1, Number operand2) throws
     PainterException {
   context.pencil.moveto(operand1.doubleValue(), operand2.doubleValue());
   if(PAContext.DebugCommandleveltrace)System.out.println("moveto("+operand1.doubleValue()+","+operand2.doubleValue()+")");
 }
