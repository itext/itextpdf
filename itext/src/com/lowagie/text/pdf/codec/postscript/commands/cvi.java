...
/**
 *
 * <p>Title: cvi (convert to integer)</p>
 *
 * <p>Description: num cvi int
 *                 string cvi int</p>
 *
...
public class cvi
  ...
  public void execute(PAContext context, String operand1) throws
    ...
    context.operands.push(new Integer(operand1));
  }

  public void execute(PAContext context, Number operand1) throws
      PainterException {
    context.operands.push(new Integer(operand1.intValue()));
  }
}
