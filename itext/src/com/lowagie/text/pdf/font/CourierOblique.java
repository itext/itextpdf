/*
 * @(#)CourierOblique.java			0.23 2000/02/02
...
/**
 * This class contains the metrics of the font <VAR>Courier Oblique</VAR>.
 * <P>
 * You can find these metrics in the following file:
 * ftp://ftp.adobe.com/pub/adobe/type/win/all/afmfiles/base17/0.1/coo_____.afm
 *
...
public class CourierOblique extends PdfFontMetrics {

// static membervariables	   

	/** Contains the widths of the Courier Oblique characters. */
...
// constructor
	...
	public CourierOblique(int encoding, int fontsize) {
...
// implementing the abstract methods of the superclass.
	...
	public final PdfName name() {
		return PdfName.COURIER_OBLIQUE;
	}

	/**
	 * Gets the kerning of a certain pair of characters.
	 * <P>
	 * In the case of <CODE>CourierOblique</CODE>, the kerning is always <VAR>0</VAR>.
	 * 
