/*
 * @(#)HelveticaOblique.java		0.23 2000/02/02
...
/**
 * This class contains the metrics of the font <VAR>Helvetica Oblique</VAR>.
 * <P>
 * You can find these metrics in the following file:
 * ftp://ftp.adobe.com/pub/adobe/type/win/all/afmfiles/base17/0.2/hvo_____.afm
 *
...
public class HelveticaOblique extends PdfFontMetrics {

// static membervariables
								  					 
	/** The widths of the Helvetica Oblique characters. */
...
// constructor
	...
	public HelveticaOblique(int encoding, int fontsize) {
...
// implementing the abstract methods of the superclass.
	...
	public final PdfName name() {
		return PdfName.HELVETICA_OBLIQUE;
	}
