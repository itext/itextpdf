/*
 * @(#)CourierBoldOblique.java		0.23 2000/02/02
...
/**
 * This class contains the metrics of the font <VAR>Courier Bold Oblique</VAR>.
 * <P>
 * You can find these metrics in the following file:
 * ftp://ftp.adobe.com/pub/adobe/type/win/all/afmfiles/base17/0.1/cobo____.afm
 *
...
public class CourierBoldOblique extends PdfFontMetrics {

// static membervariables

	/** Contains the widths of the Courier Bold Oblique characters. */
...
// constructor
	...
	public CourierBoldOblique(int encoding, int fontsize) {
...
// implementing the abstract methods of the superclass.
	...
	public final PdfName name() {
		return PdfName.COURIER_BOLDOBLIQUE;
	}

	/**
	 * Gets the kerning of a certain pair of characters.
	 * <P>
	 * In the case of <CODE>CourierBoldOblique</CODE>, the kerning is always <VAR>0</VAR>.
	 * 
