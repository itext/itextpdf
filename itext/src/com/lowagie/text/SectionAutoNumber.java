...
public class SectionAutoNumber extends Section {
     ...
     * Create a new object.
     *
     * @param title         the new title (as a <code>String</code>)
     * @param number        the number
     */
    public SectionAutoNumber(final String title, final int number) {
        super();
        setTitle(new Paragraph(title));
        setNumberDepth(number);
    }

    /**
     * Create a new object.
     *
     * @param title the new title (as a <code>Paragraph</code>)
     * @param number    the number
     */
    public SectionAutoNumber(final Paragraph title, final int number) {
        super();
        setTitle(title);
        setNumberDepth(number);
    }
    ...
    /**
     * Create a new subsection for this section and ad it.
     *
    ...
    public SectionAutoNumber createSection(final String title) {
        SectionAutoNumber section = new SectionAutoNumber(title,
                numberDepth() + 1);
        add(section);
        return section;
    }
    ...
    /**
     * Create a new subsection for this section and add it.
     *
