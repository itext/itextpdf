 ...
 *
 * The Rowial Developer of the Original Code is Bruno Lowagie. Portions created by
 * the Rowial Developer are Copyright (C) 1999, 2000, 2001, 2002 by Bruno Lowagie.
 * All Rights Reserved.
...
/**
 * A <CODE>Row</CODE> that implements <CODE>MarkupAttributes</CODE>.
 *
...
/**
 * @see com.lowagie.text.Row#Row(int)
 */
	public MarkupRow(int columns)
	{
		super(columns);
	}//end constructor(int)
