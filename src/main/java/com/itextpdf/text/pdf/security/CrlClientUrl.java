...
public class CrlClientUrl extends CrlClientImp {

	/** The URL that will be used to fetch the CRL. */
	protected String givenUrl;
	
	/**
	 * Creates an instance of CrlClientUrl.
	 * @param url	the url of a Certification Revocation List
	 */
	public CrlClientUrl(String url) {
		this.givenUrl = url;
	}
