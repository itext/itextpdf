...
class FileChannelRandomAccessSource extends GroupedRandomAccessSource implements RandomAccessSource {
    ...
    private static final int DEFAULT_TOTAL_BUFSIZE = 1 << 26; 
    private static final int DEFAULT_MAX_OPEN_BUFFERS = 16;
    ...
    /**
     * Constructs a new {@link FileChannelRandomAccessSource} based on the specified FileChannel, with a default buffer configuration.
     ...
     * @throws IOException if the channel cannot be opened or mapped
     */
	public FileChannelRandomAccessSource(final FileChannel channel, final int totalBufferSize, final int maxOpenBuffers) throws IOException {
