...
public class RtfRow
{
   ...
   */
    public boolean importRow(Row row, int width, int pageWidth, int cellpadding,
    ...
    int y)
    {
        ...
        int cellLeft = 0;
        int cellWidth = (int) (((((float) pageWidth) / 100) * width) /
        row.columns());
   ...
   */
    public boolean writeRow(OutputStream os) throws DocumentException,
    IOException
    {
