...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_pca;

/**
 * Description:
 * 	,"IBM PC code page 850, used by IBM Personal System/2 (not
 * 	implemented in version 1 of Microsoft Word for OS/2)
 * Group:
 * 	Character Set
 * Type:
 * 	Flag
...
public class RtfCtrlWord_pca extends RtfCtrlWordBase_pca {

	public RtfCtrlWord_pca(RtfParser rtfParser){
		super(rtfParser);
	}
	...
	protected boolean handleControlWord() {
		...
		// TODO Set the document character set here.
