...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_cpg;
...
public class RtfCtrlWord_cpg extends RtfCtrlWordBase_cpg {

	public RtfCtrlWord_cpg(RtfParser rtfParser){
		super(rtfParser);
