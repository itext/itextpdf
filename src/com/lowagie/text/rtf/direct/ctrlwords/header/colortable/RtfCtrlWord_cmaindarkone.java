...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_cmaindarkone;

/**
 * Description:
 * 	,"Specifies that the given color entry references the
 *  Main Dark  theme color. A \ctintN and 
 *  \cshadeN can be specified if this color entry describes 
 *  a tint or a shade of the theme color.
 * 	Note   If specified, the accompanying \redN, \greenN, \blueN 
 * values are provided so that theme-unaware applications can read 
 * what the given color evaluates to while safely ignoring the theme 
 * control words new to Microsoft Office Word 2007.
 * Group:
 * 	Color Table
 * Type:
 * 	Flag
...
public class RtfCtrlWord_cmaindarkone extends RtfCtrlWordBase_cmaindarkone {

	public RtfCtrlWord_cmaindarkone(RtfParser rtfParser){
		super(rtfParser);
