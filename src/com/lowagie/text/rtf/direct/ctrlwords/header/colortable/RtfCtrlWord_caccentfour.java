...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_caccentfour;

/**
 * Description:
 * 	,"Specifies that the given color entry references the Accent 4
...
public class RtfCtrlWord_caccentfour extends RtfCtrlWordBase_caccentfour {

	public RtfCtrlWord_caccentfour(RtfParser rtfParser){
		super(rtfParser);
