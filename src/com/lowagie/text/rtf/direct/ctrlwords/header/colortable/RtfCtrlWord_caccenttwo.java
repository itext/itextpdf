...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_caccenttwo;

/**
 * Description:
 * 	,"  Specifies that the given color entry references the Accent 2
...
public class RtfCtrlWord_caccenttwo extends RtfCtrlWordBase_caccenttwo {

	public RtfCtrlWord_caccenttwo(RtfParser rtfParser){
		super(rtfParser);
	}
	/* (non-Javadoc)
