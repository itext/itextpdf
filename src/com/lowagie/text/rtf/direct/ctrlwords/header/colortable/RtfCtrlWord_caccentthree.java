...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_caccentthree;

/**
 * Description:
 * 	,"Specifies that the given color entry references the Accent 3 theme color. 
 * A \ctintN and \cshadeN can be specified if this color entry describes a tint 
 * or a shade of the theme color.
...
public class RtfCtrlWord_caccentthree extends RtfCtrlWordBase_caccentthree {

	public RtfCtrlWord_caccentthree(RtfParser rtfParser){
		super(rtfParser);
