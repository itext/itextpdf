...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_caccentsix;

/**
 * Description:
 * 	,"Specifies that the given color entry references the Accent 6
...
public class RtfCtrlWord_caccentsix extends RtfCtrlWordBase_caccentsix {

	public RtfCtrlWord_caccentsix(RtfParser rtfParser){
		super(rtfParser);
