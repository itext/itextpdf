...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_fname;
...
public class RtfCtrlWord_fname extends RtfCtrlWordBase_fname {

	public RtfCtrlWord_fname(RtfParser rtfParser){
		super(rtfParser);
