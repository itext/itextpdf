...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_stshfhich;
...
public class RtfCtrlWord_stshfhich extends RtfCtrlWordBase_stshfhich {

	public RtfCtrlWord_stshfhich(RtfParser rtfParser){
		super(rtfParser);
