...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_deflang;

/**
 * Description:
 * 	Defines the default language used in the document used with a \plain control word. See the section on Font/Character Formatting Properties in this Specification for a list of possible values for N.
 * Group:
...
public class RtfCtrlWord_deflang extends RtfCtrlWordBase_deflang {

	public RtfCtrlWord_deflang(RtfParser rtfParser){
		super(rtfParser);
