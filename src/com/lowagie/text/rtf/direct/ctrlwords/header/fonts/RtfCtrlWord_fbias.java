...
public class RtfCtrlWord_fbias extends RtfCtrlWordBase_fbias {

	public RtfCtrlWord_fbias(RtfParser rtfParser){
		super(rtfParser);
	}
	/* (non-Javadoc)
