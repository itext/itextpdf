...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_ctexttwo;

/**
 * Description:
 * 	,"Specifies that the given color entry references the Text 2
...
public class RtfCtrlWord_ctexttwo extends RtfCtrlWordBase_ctexttwo {

	public RtfCtrlWord_ctexttwo(RtfParser rtfParser){
		super(rtfParser);
