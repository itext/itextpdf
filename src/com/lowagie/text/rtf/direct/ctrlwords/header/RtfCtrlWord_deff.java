...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_deff;
...
public class RtfCtrlWord_deff extends RtfCtrlWordBase_deff {

	public RtfCtrlWord_deff(RtfParser rtfParser){
		super(rtfParser);
	}
