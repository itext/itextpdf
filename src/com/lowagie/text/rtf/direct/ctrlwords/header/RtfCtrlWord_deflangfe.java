...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_deflangfe;

/**
 * Description:
 * 	Default language ID for East Asian text in Word.
 * Group:
...
public class RtfCtrlWord_deflangfe extends RtfCtrlWordBase_deflangfe {

	public RtfCtrlWord_deflangfe(RtfParser rtfParser){
		super(rtfParser);
