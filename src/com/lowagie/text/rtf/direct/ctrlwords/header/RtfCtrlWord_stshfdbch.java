...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_stshfdbch;

/**
 * Description:
 * 	Defines what font should be used by default in the style sheet for East Asian characters.
 * Group:
 * 	Default Fonts
 * Type:
 * 	Value
...
public class RtfCtrlWord_stshfdbch extends RtfCtrlWordBase_stshfdbch {

	public RtfCtrlWord_stshfdbch(RtfParser rtfParser){
		super(rtfParser);
