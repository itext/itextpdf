...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_listtable;
...
public class RtfCtrlWord_listtable extends RtfCtrlWordBase_listtable {

	public RtfCtrlWord_listtable(RtfParser rtfParser){
		super(rtfParser);
		this.defaultParserState = RtfParser.PARSER_IN_LIST_TABLE;
	}
