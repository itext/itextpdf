...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_panose;
...
public class RtfCtrlWord_panose extends RtfCtrlWordBase_panose {

	public RtfCtrlWord_panose(RtfParser rtfParser){
		super(rtfParser);
