...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_passwordhash;
...
public class RtfCtrlWord_passwordhash extends RtfCtrlWordBase_passwordhash {

	public RtfCtrlWord_passwordhash(RtfParser rtfParser){
		super(rtfParser);
	}
	/* (non-Javadoc)
