...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_falt;
...
public class RtfCtrlWord_falt extends RtfCtrlWordBase_falt {

	public RtfCtrlWord_falt(RtfParser rtfParser){
		super(rtfParser);
	...
	public boolean handleCloseGroup() {
		...
		if(state.text.length() > 0) {
			handleText(state.text.toString());
		}
		return true;
	}

	/* (non-Javadoc)
	 * @see com.lowagie.text.rtf.direct.ctrlwords.KwdBase#handleText(java.lang.String)
	 */
	public boolean handleText(String value) {
		if(value.indexOf(";") >= 0) {
			value = value.substring(0,value.indexOf(";"));
		}
		this.rtfParser.getDestFontTable().setFontAlternate(value);
		return true;
	}
