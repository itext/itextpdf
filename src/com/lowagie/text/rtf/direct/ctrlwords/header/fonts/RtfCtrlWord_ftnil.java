...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_ftnil;
...
public class RtfCtrlWord_ftnil extends RtfCtrlWordBase_ftnil {

	public RtfCtrlWord_ftnil(RtfParser rtfParser){
		super(rtfParser);
