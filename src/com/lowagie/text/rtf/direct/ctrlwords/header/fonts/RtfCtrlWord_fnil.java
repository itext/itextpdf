...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_fnil;

/**
 * Description:
 * 	Unknown or default fonts (the default) Not applicable
 * Group:
 * 	Font Table
 * Type:
 * 	Flag
...
public class RtfCtrlWord_fnil extends RtfCtrlWordBase_fnil {

	public RtfCtrlWord_fnil(RtfParser rtfParser){
		super(rtfParser);
