...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_caccentone;

/**
 * Description:
 * 	,"  Specifies that the given color entry references the Accent 1 theme color. 
 * A \ctintN and \cshadeN can be specified if this color entry describes a tint or a 
...
public class RtfCtrlWord_caccentone extends RtfCtrlWordBase_caccentone {

	public RtfCtrlWord_caccentone(RtfParser rtfParser){
		super(rtfParser);
