...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_ctint;

/**
 * Description:
 * 	,"Specifies the tint of the given theme when specifying a theme color. If the entry references a theme color, \ctintN specifies its shade. If not, \ctintN is ignored.
 * 	Acceptable values for this control wordâ€™s parameter are integers from 0 to 255 inclusive; where 255 means no tint, and 0 means full tint (resulting in white color).
...
public class RtfCtrlWord_ctint extends RtfCtrlWordBase_ctint {

	public RtfCtrlWord_ctint(RtfParser rtfParser){
		super(rtfParser);
