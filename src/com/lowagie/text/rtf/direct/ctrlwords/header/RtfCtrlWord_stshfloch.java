...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_stshfloch;

/**
 * Description:
 * 	Defines what font should be used by default in the style sheet for ASCII characters.
 * Group:
 * 	Default Fonts
 * Type:
 * 	Value
...
public class RtfCtrlWord_stshfloch extends RtfCtrlWordBase_stshfloch {

	public RtfCtrlWord_stshfloch(RtfParser rtfParser){
		super(rtfParser);
