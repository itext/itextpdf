...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_ansi;
...
public class RtfCtrlWord_ansi extends RtfCtrlWordBase_ansi {

	public RtfCtrlWord_ansi(RtfParser rtfParser){
		super(rtfParser);
