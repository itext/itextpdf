...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_cbackgroundone;

/**
 * Description:
 * 	,"Specifies that the given color entry references the Background 1
...
public class RtfCtrlWord_cbackgroundone extends RtfCtrlWordBase_cbackgroundone {

	public RtfCtrlWord_cbackgroundone(RtfParser rtfParser){
		super(rtfParser);
