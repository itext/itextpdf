...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_fscript;
...
public class RtfCtrlWord_fscript extends RtfCtrlWordBase_fscript {

	public RtfCtrlWord_fscript(RtfParser rtfParser){
		super(rtfParser);
		this.defaultParserState = RtfParser.PARSER_IN_FONT_TABLE_INFO;
	}

	protected boolean handleParserInFontTableInfo() {		
		this.rtfParser.getDestFontTable().setFontFamily("script");
		return true;
	}
