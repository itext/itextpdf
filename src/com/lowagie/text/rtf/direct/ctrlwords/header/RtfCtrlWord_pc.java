...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_pc;
...
public class RtfCtrlWord_pc extends RtfCtrlWordBase_pc {

	public RtfCtrlWord_pc(RtfParser rtfParser){
		super(rtfParser);
	}
