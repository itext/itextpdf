...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_fswiss;

/**
 * Description:
 * 	,"Swiss, proportionally spaced sans serif fonts Arial
 * Group:
 * 	Font Table
 * Type:
 * 	Flag
...
public class RtfCtrlWord_fswiss extends RtfCtrlWordBase_fswiss {

	public RtfCtrlWord_fswiss(RtfParser rtfParser){
		super(rtfParser);
		this.defaultParserState = RtfParser.PARSER_IN_FONT_TABLE_INFO;
	}

	protected boolean handleParserInFontTableInfo() {		
		this.rtfParser.getDestFontTable().setFontFamily("swiss");
		return true;
	}
}
