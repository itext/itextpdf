...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_fprq;
...
public class RtfCtrlWord_fprq extends RtfCtrlWordBase_fprq {

	public RtfCtrlWord_fprq(RtfParser rtfParser){
		super(rtfParser);
