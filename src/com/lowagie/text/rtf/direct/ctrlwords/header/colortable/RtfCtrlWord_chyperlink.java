...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_chyperlink;

/**
 * Description:
 * 	,"Specifies that the given color entry references the Hyperlink 
...
public class RtfCtrlWord_chyperlink extends RtfCtrlWordBase_chyperlink {

	public RtfCtrlWord_chyperlink(RtfParser rtfParser){
		super(rtfParser);
