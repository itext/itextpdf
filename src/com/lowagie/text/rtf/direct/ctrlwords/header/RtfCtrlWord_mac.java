...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_mac;
...
public class RtfCtrlWord_mac extends RtfCtrlWordBase_mac {

	public RtfCtrlWord_mac(RtfParser rtfParser){
		super(rtfParser);
