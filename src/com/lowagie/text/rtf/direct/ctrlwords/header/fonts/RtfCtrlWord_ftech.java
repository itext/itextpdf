...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_ftech;

/**
 * Description:
 * 	,"Technical, symbol, and mathematical fonts Symbol
 * Group:
 * 	
 * Type:
 * 	
...
public class RtfCtrlWord_ftech extends RtfCtrlWordBase_ftech {

	public RtfCtrlWord_ftech(RtfParser rtfParser){
		super(rtfParser);
		this.defaultParserState = RtfParser.PARSER_IN_FONT_TABLE_INFO;
	}

	protected boolean handleParserInFontTableInfo() {		
		this.rtfParser.getDestFontTable().setFontFamily("tech");
		return true;
	}
