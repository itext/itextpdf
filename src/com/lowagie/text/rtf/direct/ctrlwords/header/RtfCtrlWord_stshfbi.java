...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_stshfbi;
...
public class RtfCtrlWord_stshfbi extends RtfCtrlWordBase_stshfbi {

	public RtfCtrlWord_stshfbi(RtfParser rtfParser){
		super(rtfParser);
