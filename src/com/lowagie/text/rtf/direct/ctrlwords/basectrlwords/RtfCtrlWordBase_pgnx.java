...
public class RtfCtrlWordBase_pgnx extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnx(RtfParser rtfParser){
		super(rtfParser, "pgnx", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
