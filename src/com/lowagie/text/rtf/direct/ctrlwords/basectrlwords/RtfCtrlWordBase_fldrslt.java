...
public class RtfCtrlWordBase_fldrslt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fldrslt(RtfParser rtfParser){
		super(rtfParser, "fldrslt", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
