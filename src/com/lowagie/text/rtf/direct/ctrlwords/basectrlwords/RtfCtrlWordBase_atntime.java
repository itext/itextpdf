...
public class RtfCtrlWordBase_atntime extends RtfCtrlWordBase {

	public RtfCtrlWordBase_atntime(RtfParser rtfParser){
		super(rtfParser, "atntime", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
