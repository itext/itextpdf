...
public class RtfCtrlWordBase_dpfillfgpal extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpfillfgpal(RtfParser rtfParser){
		super(rtfParser, "dpfillfgpal", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
