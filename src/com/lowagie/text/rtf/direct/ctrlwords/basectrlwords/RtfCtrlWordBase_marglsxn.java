...
public class RtfCtrlWordBase_marglsxn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_marglsxn(RtfParser rtfParser){
		super(rtfParser, "marglsxn", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
