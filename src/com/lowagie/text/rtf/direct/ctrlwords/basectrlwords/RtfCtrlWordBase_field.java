...
public class RtfCtrlWordBase_field extends RtfCtrlWordBase {

	public RtfCtrlWordBase_field(RtfParser rtfParser){
		super(rtfParser, "field", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
