...
public class RtfCtrlWordBase_tposyil extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tposyil(RtfParser rtfParser){
		super(rtfParser, "tposyil", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
