...
public class RtfCtrlWordBase_noqfpromote extends RtfCtrlWordBase {

	public RtfCtrlWordBase_noqfpromote(RtfParser rtfParser){
		super(rtfParser, "noqfpromote", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
