...
public class RtfCtrlWordBase_stylesheet extends RtfCtrlWordBase {

	public RtfCtrlWordBase_stylesheet(RtfParser rtfParser){
		super(rtfParser, "stylesheet", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
