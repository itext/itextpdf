...
public class RtfCtrlWordBase_footerf extends RtfCtrlWordBase {

	public RtfCtrlWordBase_footerf(RtfParser rtfParser){
		super(rtfParser, "footerf", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
