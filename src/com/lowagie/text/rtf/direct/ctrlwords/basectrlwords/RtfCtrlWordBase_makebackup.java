...
public class RtfCtrlWordBase_makebackup extends RtfCtrlWordBase {

	public RtfCtrlWordBase_makebackup(RtfParser rtfParser){
		super(rtfParser, "makebackup", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
