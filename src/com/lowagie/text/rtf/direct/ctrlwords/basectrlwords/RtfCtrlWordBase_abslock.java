...
public class RtfCtrlWordBase_abslock extends RtfCtrlWordBase {

	public RtfCtrlWordBase_abslock(RtfParser rtfParser){
		super(rtfParser, "abslock", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
