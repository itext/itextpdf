...
public class RtfCtrlWordBase_pndecd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pndecd(RtfParser rtfParser){
		super(rtfParser, "pndecd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
