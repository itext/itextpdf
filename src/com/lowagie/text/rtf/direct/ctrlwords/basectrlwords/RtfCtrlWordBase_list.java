...
public class RtfCtrlWordBase_list extends RtfCtrlWordBase {

	public RtfCtrlWordBase_list(RtfParser rtfParser){
		super(rtfParser, "list", 0, false, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
