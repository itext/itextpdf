...
public class RtfCtrlWordBase_taprtl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_taprtl(RtfParser rtfParser){
		super(rtfParser, "taprtl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
