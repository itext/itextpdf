...
public class RtfCtrlWordBase_tscellpaddb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscellpaddb(RtfParser rtfParser){
		super(rtfParser, "tscellpaddb", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
