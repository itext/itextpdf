...
public class RtfCtrlWordBase_footery extends RtfCtrlWordBase {

	public RtfCtrlWordBase_footery(RtfParser rtfParser){
		super(rtfParser, "footery", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
