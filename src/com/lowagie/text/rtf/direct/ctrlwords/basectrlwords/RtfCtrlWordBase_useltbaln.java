...
public class RtfCtrlWordBase_useltbaln extends RtfCtrlWordBase {

	public RtfCtrlWordBase_useltbaln(RtfParser rtfParser){
		super(rtfParser, "useltbaln", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
