...
public class RtfCtrlWordBase_chbgbdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chbgbdiag(RtfParser rtfParser){
		super(rtfParser, "chbgbdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
