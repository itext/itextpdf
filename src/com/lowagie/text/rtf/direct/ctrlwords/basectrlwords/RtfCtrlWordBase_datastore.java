...
public class RtfCtrlWordBase_datastore extends RtfCtrlWordBase {

	public RtfCtrlWordBase_datastore(RtfParser rtfParser){
		super(rtfParser, "datastore", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
