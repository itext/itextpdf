...
public class RtfCtrlWordBase_b extends RtfCtrlWordBase {

	public RtfCtrlWordBase_b(RtfParser rtfParser){
		super(rtfParser, "b", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
