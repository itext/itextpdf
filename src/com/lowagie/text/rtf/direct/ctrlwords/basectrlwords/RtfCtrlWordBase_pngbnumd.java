...
public class RtfCtrlWordBase_pngbnumd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pngbnumd(RtfParser rtfParser){
		super(rtfParser, "pngbnumd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
