...
public class RtfCtrlWordBase_pncard extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pncard(RtfParser rtfParser){
		super(rtfParser, "pncard", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
