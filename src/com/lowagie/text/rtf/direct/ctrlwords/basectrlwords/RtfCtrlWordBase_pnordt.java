...
public class RtfCtrlWordBase_pnordt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnordt(RtfParser rtfParser){
		super(rtfParser, "pnordt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
