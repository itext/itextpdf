...
public class RtfCtrlWordBase_brdrthtnlg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrthtnlg(RtfParser rtfParser){
		super(rtfParser, "brdrthtnlg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
