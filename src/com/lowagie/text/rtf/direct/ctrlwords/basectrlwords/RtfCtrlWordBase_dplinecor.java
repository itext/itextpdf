...
public class RtfCtrlWordBase_dplinecor extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dplinecor(RtfParser rtfParser){
		super(rtfParser, "dplinecor", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
