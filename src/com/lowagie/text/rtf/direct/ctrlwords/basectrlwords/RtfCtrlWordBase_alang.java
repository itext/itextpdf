...
public class RtfCtrlWordBase_alang extends RtfCtrlWordBase {

	public RtfCtrlWordBase_alang(RtfParser rtfParser){
		super(rtfParser, "alang", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
