...
public class RtfCtrlWordBase_ftnsepc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnsepc(RtfParser rtfParser){
		super(rtfParser, "ftnsepc", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
