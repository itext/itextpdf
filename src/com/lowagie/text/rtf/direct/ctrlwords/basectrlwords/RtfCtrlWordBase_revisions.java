...
public class RtfCtrlWordBase_revisions extends RtfCtrlWordBase {

	public RtfCtrlWordBase_revisions(RtfParser rtfParser){
		super(rtfParser, "revisions", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
