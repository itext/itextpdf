...
public class RtfCtrlWordBase_pnuld extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnuld(RtfParser rtfParser){
		super(rtfParser, "pnuld", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
