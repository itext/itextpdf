...
public class RtfCtrlWordBase_picprop extends RtfCtrlWordBase {

	public RtfCtrlWordBase_picprop(RtfParser rtfParser){
		super(rtfParser, "picprop", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
