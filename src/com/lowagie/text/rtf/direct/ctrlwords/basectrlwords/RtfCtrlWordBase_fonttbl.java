...
public class RtfCtrlWordBase_fonttbl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fonttbl(RtfParser rtfParser){
		super(rtfParser, "fonttbl", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
