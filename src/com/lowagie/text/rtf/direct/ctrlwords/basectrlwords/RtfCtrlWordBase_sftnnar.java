...
public class RtfCtrlWordBase_sftnnar extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnnar(RtfParser rtfParser){
		super(rtfParser, "sftnnar", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
