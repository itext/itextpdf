...
public class RtfCtrlWordBase_tposy extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tposy(RtfParser rtfParser){
		super(rtfParser, "tposy", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
