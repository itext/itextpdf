...
public class RtfCtrlWordBase_saftnndbnumk extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnndbnumk(RtfParser rtfParser){
		super(rtfParser, "saftnndbnumk", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
