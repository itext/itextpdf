...
public class RtfCtrlWordBase_ffprot extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ffprot(RtfParser rtfParser){
		super(rtfParser, "ffprot", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
