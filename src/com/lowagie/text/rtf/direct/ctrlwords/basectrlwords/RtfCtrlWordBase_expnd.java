...
public class RtfCtrlWordBase_expnd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_expnd(RtfParser rtfParser){
		super(rtfParser, "expnd", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
