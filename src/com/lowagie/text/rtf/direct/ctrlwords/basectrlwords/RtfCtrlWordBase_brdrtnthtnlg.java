...
public class RtfCtrlWordBase_brdrtnthtnlg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrtnthtnlg(RtfParser rtfParser){
		super(rtfParser, "brdrtnthtnlg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
