...
public class RtfCtrlWordBase_cachedcolbal extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cachedcolbal(RtfParser rtfParser){
		super(rtfParser, "cachedcolbal", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
