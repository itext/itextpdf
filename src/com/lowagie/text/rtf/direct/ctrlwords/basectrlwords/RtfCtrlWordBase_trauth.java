...
public class RtfCtrlWordBase_trauth extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trauth(RtfParser rtfParser){
		super(rtfParser, "trauth", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
