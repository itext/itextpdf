...
public class RtfCtrlWordBase_nocolbal extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nocolbal(RtfParser rtfParser){
		super(rtfParser, "nocolbal", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
