...
public class RtfCtrlWordBase_aftnndbar extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnndbar(RtfParser rtfParser){
		super(rtfParser, "aftnndbar", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
