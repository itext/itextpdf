...
public class RtfCtrlWordBase_frmtxtbrlv extends RtfCtrlWordBase {

	public RtfCtrlWordBase_frmtxtbrlv(RtfParser rtfParser){
		super(rtfParser, "frmtxtbrlv", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
