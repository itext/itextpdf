...
public class RtfCtrlWordBase_softline extends RtfCtrlWordBase {

	public RtfCtrlWordBase_softline(RtfParser rtfParser){
		super(rtfParser, "softline", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
