...
public class RtfCtrlWordBase_widctlpar extends RtfCtrlWordBase {

	public RtfCtrlWordBase_widctlpar(RtfParser rtfParser){
		super(rtfParser, "widctlpar", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
