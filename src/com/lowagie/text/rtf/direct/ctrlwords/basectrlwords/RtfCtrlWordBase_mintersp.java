...
public class RtfCtrlWordBase_mintersp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mintersp(RtfParser rtfParser){
		super(rtfParser, "mintersp", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
