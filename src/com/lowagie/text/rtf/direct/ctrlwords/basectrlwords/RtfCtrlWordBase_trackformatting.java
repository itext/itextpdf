...
public class RtfCtrlWordBase_trackformatting extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trackformatting(RtfParser rtfParser){
		super(rtfParser, "trackformatting", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
