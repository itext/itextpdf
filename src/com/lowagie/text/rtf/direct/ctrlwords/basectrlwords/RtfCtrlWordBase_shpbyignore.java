...
public class RtfCtrlWordBase_shpbyignore extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shpbyignore(RtfParser rtfParser){
		super(rtfParser, "shpbyignore", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
