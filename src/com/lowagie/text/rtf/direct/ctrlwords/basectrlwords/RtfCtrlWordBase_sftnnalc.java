...
public class RtfCtrlWordBase_sftnnalc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnnalc(RtfParser rtfParser){
		super(rtfParser, "sftnnalc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
