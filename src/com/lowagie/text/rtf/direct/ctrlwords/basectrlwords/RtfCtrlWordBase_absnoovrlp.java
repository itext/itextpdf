...
public class RtfCtrlWordBase_absnoovrlp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_absnoovrlp(RtfParser rtfParser){
		super(rtfParser, "absnoovrlp", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
