...
public class RtfCtrlWordBase_xmlsdttregular extends RtfCtrlWordBase {

	public RtfCtrlWordBase_xmlsdttregular(RtfParser rtfParser){
		super(rtfParser, "xmlsdttregular", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
