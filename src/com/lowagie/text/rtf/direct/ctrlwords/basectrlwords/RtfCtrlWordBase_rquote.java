...
public class RtfCtrlWordBase_rquote extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rquote(RtfParser rtfParser){
		super(rtfParser, "rquote", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
