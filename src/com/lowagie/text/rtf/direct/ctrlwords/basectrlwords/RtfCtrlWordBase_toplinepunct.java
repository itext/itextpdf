...
public class RtfCtrlWordBase_toplinepunct extends RtfCtrlWordBase {

	public RtfCtrlWordBase_toplinepunct(RtfParser rtfParser){
		super(rtfParser, "toplinepunct", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
