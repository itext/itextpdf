...
public class RtfCtrlWordBase_nosectexpand extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nosectexpand(RtfParser rtfParser){
		super(rtfParser, "nosectexpand", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
