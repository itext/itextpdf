...
public class RtfCtrlWordBase_pnstrike extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnstrike(RtfParser rtfParser){
		super(rtfParser, "pnstrike", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
