...
public class RtfCtrlWordBase_spltpgpar extends RtfCtrlWordBase {

	public RtfCtrlWordBase_spltpgpar(RtfParser rtfParser){
		super(rtfParser, "spltpgpar", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
