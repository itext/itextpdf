...
public class RtfCtrlWordBase_mmdestemail extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmdestemail(RtfParser rtfParser){
		super(rtfParser, "mmdestemail", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
