...
public class RtfCtrlWordBase_bin extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bin(RtfParser rtfParser){
		super(rtfParser, "bin", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
