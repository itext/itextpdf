...
public class RtfCtrlWordBase_template extends RtfCtrlWordBase {

	public RtfCtrlWordBase_template(RtfParser rtfParser){
		super(rtfParser, "template", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
