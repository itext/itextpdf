...
public class RtfCtrlWordBase_jis extends RtfCtrlWordBase {

	public RtfCtrlWordBase_jis(RtfParser rtfParser){
		super(rtfParser, "jis", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
