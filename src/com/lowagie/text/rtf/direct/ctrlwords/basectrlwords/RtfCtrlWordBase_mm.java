...
public class RtfCtrlWordBase_mm extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mm(RtfParser rtfParser){
		super(rtfParser, "mm", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
