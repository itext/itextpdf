...
public class RtfCtrlWordBase_dpcooffset extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpcooffset(RtfParser rtfParser){
		super(rtfParser, "dpcooffset", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
