...
public class RtfCtrlWordBase_ud extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ud(RtfParser rtfParser){
		super(rtfParser, "ud", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
