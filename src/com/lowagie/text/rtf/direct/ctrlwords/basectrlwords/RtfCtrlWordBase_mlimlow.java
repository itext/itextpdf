...
public class RtfCtrlWordBase_mlimlow extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mlimlow(RtfParser rtfParser){
		super(rtfParser, "mlimlow", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
