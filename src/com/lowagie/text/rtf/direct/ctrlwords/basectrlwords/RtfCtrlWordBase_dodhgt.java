...
public class RtfCtrlWordBase_dodhgt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dodhgt(RtfParser rtfParser){
		super(rtfParser, "dodhgt", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
