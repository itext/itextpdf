...
public class RtfCtrlWordBase_dpcodcenter extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpcodcenter(RtfParser rtfParser){
		super(rtfParser, "dpcodcenter", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
