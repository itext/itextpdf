...
public class RtfCtrlWordBase_dropcapli extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dropcapli(RtfParser rtfParser){
		super(rtfParser, "dropcapli", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
