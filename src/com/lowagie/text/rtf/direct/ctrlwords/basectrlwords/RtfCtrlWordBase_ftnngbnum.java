...
public class RtfCtrlWordBase_ftnngbnum extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnngbnum(RtfParser rtfParser){
		super(rtfParser, "ftnngbnum", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
