...
public class RtfCtrlWordBase_dpptx extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpptx(RtfParser rtfParser){
		super(rtfParser, "dpptx", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
