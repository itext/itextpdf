...
public class RtfCtrlWordBase_colortbl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_colortbl(RtfParser rtfParser){
		super(rtfParser, "colortbl", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
