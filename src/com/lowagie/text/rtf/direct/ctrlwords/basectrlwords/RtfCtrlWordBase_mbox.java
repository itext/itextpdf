...
public class RtfCtrlWordBase_mbox extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mbox(RtfParser rtfParser){
		super(rtfParser, "mbox", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
