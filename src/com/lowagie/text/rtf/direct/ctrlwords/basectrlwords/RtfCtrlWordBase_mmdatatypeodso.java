...
public class RtfCtrlWordBase_mmdatatypeodso extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmdatatypeodso(RtfParser rtfParser){
		super(rtfParser, "mmdatatypeodso", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
