...
public class RtfCtrlWordBase_nestrow extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nestrow(RtfParser rtfParser){
		super(rtfParser, "nestrow", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
