...
public class RtfCtrlWordBase_pgnlcltr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnlcltr(RtfParser rtfParser){
		super(rtfParser, "pgnlcltr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
