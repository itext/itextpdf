...
public class RtfCtrlWordBase_sbys extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sbys(RtfParser rtfParser){
		super(rtfParser, "sbys", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
