...
public class RtfCtrlWordBase_trpaddt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trpaddt(RtfParser rtfParser){
		super(rtfParser, "trpaddt", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
