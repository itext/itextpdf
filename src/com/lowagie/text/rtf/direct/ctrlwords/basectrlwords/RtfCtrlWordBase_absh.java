...
public class RtfCtrlWordBase_absh extends RtfCtrlWordBase {

	public RtfCtrlWordBase_absh(RtfParser rtfParser){
		super(rtfParser, "absh", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
