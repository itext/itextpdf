...
public class RtfCtrlWordBase_mmath extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmath(RtfParser rtfParser){
		super(rtfParser, "mmath", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
