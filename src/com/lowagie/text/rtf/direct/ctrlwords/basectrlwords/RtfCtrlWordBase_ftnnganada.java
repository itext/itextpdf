...
public class RtfCtrlWordBase_ftnnganada extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnnganada(RtfParser rtfParser){
		super(rtfParser, "ftnnganada", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
