...
public class RtfCtrlWordBase_trbgfdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trbgfdiag(RtfParser rtfParser){
		super(rtfParser, "trbgfdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
