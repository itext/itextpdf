...
public class RtfCtrlWordBase_phmrg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_phmrg(RtfParser rtfParser){
		super(rtfParser, "phmrg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
