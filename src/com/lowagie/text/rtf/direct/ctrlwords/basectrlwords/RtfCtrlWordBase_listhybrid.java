...
/**
 * Description:
 * 	,"Present if the list has 9 levels, each of which is the
 * 	equivalent of a simple list. Only one of \listsimple and
 * 	\listhybrid should be present. Word 2000 and newer versions
 * 	will write lists with the \listhybrid property.
 * Group:
 * 	List Table
 * Type:
 * 	Flag
...
public class RtfCtrlWordBase_listhybrid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_listhybrid(RtfParser rtfParser){
		super(rtfParser, "listhybrid", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
