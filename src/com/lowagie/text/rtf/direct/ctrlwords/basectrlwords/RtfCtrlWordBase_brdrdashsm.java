...
public class RtfCtrlWordBase_brdrdashsm extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrdashsm(RtfParser rtfParser){
		super(rtfParser, "brdrdashsm", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
