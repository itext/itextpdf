...
public class RtfCtrlWordBase_tcn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tcn(RtfParser rtfParser){
		super(rtfParser, "tcn", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
