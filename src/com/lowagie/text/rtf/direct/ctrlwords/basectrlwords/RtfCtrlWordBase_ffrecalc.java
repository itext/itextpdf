...
public class RtfCtrlWordBase_ffrecalc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ffrecalc(RtfParser rtfParser){
		super(rtfParser, "ffrecalc", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
