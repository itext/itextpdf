...
public class RtfCtrlWordBase_mmmaintypeemail extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmmaintypeemail(RtfParser rtfParser){
		super(rtfParser, "mmmaintypeemail", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
