...
public class RtfCtrlWordBase_cell extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cell(RtfParser rtfParser){
		super(rtfParser, "cell", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
