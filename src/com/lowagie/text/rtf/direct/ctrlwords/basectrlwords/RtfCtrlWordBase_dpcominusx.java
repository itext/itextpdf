...
public class RtfCtrlWordBase_dpcominusx extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpcominusx(RtfParser rtfParser){
		super(rtfParser, "dpcominusx", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
