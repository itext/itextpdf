...
public class RtfCtrlWordBase_softlheight extends RtfCtrlWordBase {

	public RtfCtrlWordBase_softlheight(RtfParser rtfParser){
		super(rtfParser, "softlheight", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
