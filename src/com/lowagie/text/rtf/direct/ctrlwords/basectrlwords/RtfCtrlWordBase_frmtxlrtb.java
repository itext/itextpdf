...
public class RtfCtrlWordBase_frmtxlrtb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_frmtxlrtb(RtfParser rtfParser){
		super(rtfParser, "frmtxlrtb", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
