...
public class RtfCtrlWordBase_brdrtnthsg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrtnthsg(RtfParser rtfParser){
		super(rtfParser, "brdrtnthsg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
