...
public class RtfCtrlWordBase_splytwnine extends RtfCtrlWordBase {

	public RtfCtrlWordBase_splytwnine(RtfParser rtfParser){
		super(rtfParser, "splytwnine", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
