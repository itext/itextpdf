...
/**
 * Description:
 * 	An RSID is inserted to denote the session in which
 * 	particular text was inserted. Example:
 * 	{\insrsid8282541
 * 	This is text.}
 * 	For use in lists:
 * 	{\insrsid8282541
 * 	Item  in List  \par{\listtext\pard\plain\f3\insrsid8282541
...
public class RtfCtrlWordBase_insrsid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_insrsid(RtfParser rtfParser){
		super(rtfParser, "insrsid", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
