...
public class RtfCtrlWordBase_objocx extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objocx(RtfParser rtfParser){
		super(rtfParser, "objocx", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
