...
public class RtfCtrlWordBase_margsz extends RtfCtrlWordBase {

	public RtfCtrlWordBase_margsz(RtfParser rtfParser){
		super(rtfParser, "margsz", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
