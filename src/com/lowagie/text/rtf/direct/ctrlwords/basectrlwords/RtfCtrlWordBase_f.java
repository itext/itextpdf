...
public class RtfCtrlWordBase_f extends RtfCtrlWordBase {

	public RtfCtrlWordBase_f(RtfParser rtfParser){
		super(rtfParser, "f", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
