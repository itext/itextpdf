...
public class RtfCtrlWordBase_dprect extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dprect(RtfParser rtfParser){
		super(rtfParser, "dprect", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
