...
public class RtfCtrlWordBase_dpaendw extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpaendw(RtfParser rtfParser){
		super(rtfParser, "dpaendw", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
