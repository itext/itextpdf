...
public class RtfCtrlWordBase_clbgvert extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clbgvert(RtfParser rtfParser){
		super(rtfParser, "clbgvert", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
