...
public class RtfCtrlWordBase_buptim extends RtfCtrlWordBase {

	public RtfCtrlWordBase_buptim(RtfParser rtfParser){
		super(rtfParser, "buptim", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
