...
public class RtfCtrlWordBase_pindtabql extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pindtabql(RtfParser rtfParser){
		super(rtfParser, "pindtabql", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
