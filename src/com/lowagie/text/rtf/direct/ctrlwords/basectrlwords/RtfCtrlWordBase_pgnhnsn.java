...
public class RtfCtrlWordBase_pgnhnsn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnhnsn(RtfParser rtfParser){
		super(rtfParser, "pgnhnsn", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
