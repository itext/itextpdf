...
public class RtfCtrlWordBase_blipuid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_blipuid(RtfParser rtfParser){
		super(rtfParser, "blipuid", 0, false, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
