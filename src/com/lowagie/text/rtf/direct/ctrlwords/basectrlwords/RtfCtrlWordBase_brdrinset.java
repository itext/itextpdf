...
public class RtfCtrlWordBase_brdrinset extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrinset(RtfParser rtfParser){
		super(rtfParser, "brdrinset", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
