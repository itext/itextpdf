...
public class RtfCtrlWordBase_collapsed extends RtfCtrlWordBase {

	public RtfCtrlWordBase_collapsed(RtfParser rtfParser){
		super(rtfParser, "collapsed", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
