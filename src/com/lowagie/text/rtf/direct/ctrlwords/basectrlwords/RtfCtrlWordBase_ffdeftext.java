...
public class RtfCtrlWordBase_ffdeftext extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ffdeftext(RtfParser rtfParser){
		super(rtfParser, "ffdeftext", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
