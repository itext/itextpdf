...
public class RtfCtrlWordBase_fttruetype extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fttruetype(RtfParser rtfParser){
		super(rtfParser, "fttruetype", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
