 ...
 * 	5 Ordinal
 * 	number (1st, 2nd, 3rd)
 * 	6 Cardinal text number (One, Two
 * 	Three)
 ...
 * 	* 	13 46 phonetic katakana characters in iroha order
 * 	(*iroha)
 ...
 * 	21 46
 * 	phonetic double-byte katakana characters (*iroha*dbchar)
 *
 ...
 * 	34 Taiwanese double-byte
 * 	numbering 2
 * 	35 Taiwanese double-byte numbering 3
 * 	36
 * 	Taiwanese double-byte numbering 4
 * 	37 Chinese double-byte
 * 	numbering 1
 * 	38 Chinese double-byte numbering 2
 * 	39
 * 	Chinese double-byte numbering 3
 * 	40 Chinese double-byte
 * 	numbering 4
 * 	41 Korean double-byte numbering 1
 * 	42
 * 	Korean double-byte numbering 2
 * 	43 Korean double-byte
 * 	numbering 3
...
public class RtfCtrlWordBase_levelnfc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_levelnfc(RtfParser rtfParser){
		super(rtfParser, "levelnfc", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
