...
public class RtfCtrlWordBase_widowctrl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_widowctrl(RtfParser rtfParser){
		super(rtfParser, "widowctrl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
