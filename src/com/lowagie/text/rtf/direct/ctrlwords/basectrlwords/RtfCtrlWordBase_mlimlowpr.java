...
public class RtfCtrlWordBase_mlimlowpr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mlimlowpr(RtfParser rtfParser){
		super(rtfParser, "mlimlowpr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
