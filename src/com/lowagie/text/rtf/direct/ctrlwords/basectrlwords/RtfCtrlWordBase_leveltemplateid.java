...
public class RtfCtrlWordBase_leveltemplateid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_leveltemplateid(RtfParser rtfParser){
		super(rtfParser, "leveltemplateid", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
