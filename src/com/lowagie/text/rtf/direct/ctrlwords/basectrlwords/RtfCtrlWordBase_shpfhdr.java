...
public class RtfCtrlWordBase_shpfhdr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shpfhdr(RtfParser rtfParser){
		super(rtfParser, "shpfhdr", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
