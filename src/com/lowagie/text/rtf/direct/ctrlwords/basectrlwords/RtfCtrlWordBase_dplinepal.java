...
public class RtfCtrlWordBase_dplinepal extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dplinepal(RtfParser rtfParser){
		super(rtfParser, "dplinepal", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
