...
public class RtfCtrlWordBase_rawclbgbdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rawclbgbdiag(RtfParser rtfParser){
		super(rtfParser, "rawclbgbdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
