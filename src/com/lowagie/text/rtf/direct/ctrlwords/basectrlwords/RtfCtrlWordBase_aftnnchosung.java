...
public class RtfCtrlWordBase_aftnnchosung extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnnchosung(RtfParser rtfParser){
		super(rtfParser, "aftnnchosung", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
