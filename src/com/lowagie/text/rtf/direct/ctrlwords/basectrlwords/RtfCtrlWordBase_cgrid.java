...
public class RtfCtrlWordBase_cgrid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cgrid(RtfParser rtfParser){
		super(rtfParser, "cgrid", 0, false, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
