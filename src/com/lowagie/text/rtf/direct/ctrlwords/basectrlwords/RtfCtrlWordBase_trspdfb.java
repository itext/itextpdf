...
public class RtfCtrlWordBase_trspdfb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trspdfb(RtfParser rtfParser){
		super(rtfParser, "trspdfb", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
