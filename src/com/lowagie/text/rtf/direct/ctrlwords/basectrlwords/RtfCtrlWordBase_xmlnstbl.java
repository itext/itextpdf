...
public class RtfCtrlWordBase_xmlnstbl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_xmlnstbl(RtfParser rtfParser){
		super(rtfParser, "xmlnstbl", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
