...
public class RtfCtrlWordBase_ulw extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ulw(RtfParser rtfParser){
		super(rtfParser, "ulw", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
