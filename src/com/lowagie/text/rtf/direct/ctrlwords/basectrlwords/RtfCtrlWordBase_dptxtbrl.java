...
public class RtfCtrlWordBase_dptxtbrl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dptxtbrl(RtfParser rtfParser){
		super(rtfParser, "dptxtbrl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
