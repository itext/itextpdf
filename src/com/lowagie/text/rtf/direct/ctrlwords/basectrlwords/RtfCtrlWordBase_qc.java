...
public class RtfCtrlWordBase_qc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_qc(RtfParser rtfParser){
		super(rtfParser, "qc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
