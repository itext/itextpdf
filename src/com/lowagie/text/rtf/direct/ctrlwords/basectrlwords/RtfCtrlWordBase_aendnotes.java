...
public class RtfCtrlWordBase_aendnotes extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aendnotes(RtfParser rtfParser){
		super(rtfParser, "aendnotes", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
