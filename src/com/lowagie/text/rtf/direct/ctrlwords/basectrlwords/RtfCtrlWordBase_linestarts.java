...
public class RtfCtrlWordBase_linestarts extends RtfCtrlWordBase {

	public RtfCtrlWordBase_linestarts(RtfParser rtfParser){
		super(rtfParser, "linestarts", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
