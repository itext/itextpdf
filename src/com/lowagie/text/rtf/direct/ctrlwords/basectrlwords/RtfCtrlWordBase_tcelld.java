...
public class RtfCtrlWordBase_tcelld extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tcelld(RtfParser rtfParser){
		super(rtfParser, "tcelld", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
