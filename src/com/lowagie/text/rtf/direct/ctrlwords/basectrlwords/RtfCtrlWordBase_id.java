...
public class RtfCtrlWordBase_id extends RtfCtrlWordBase {

	public RtfCtrlWordBase_id(RtfParser rtfParser){
		super(rtfParser, "id", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
