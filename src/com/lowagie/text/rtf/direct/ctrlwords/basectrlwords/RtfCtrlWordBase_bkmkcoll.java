...
public class RtfCtrlWordBase_bkmkcoll extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bkmkcoll(RtfParser rtfParser){
		super(rtfParser, "bkmkcoll", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
