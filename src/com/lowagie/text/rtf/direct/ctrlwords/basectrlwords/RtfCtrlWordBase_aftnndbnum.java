...
public class RtfCtrlWordBase_aftnndbnum extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnndbnum(RtfParser rtfParser){
		super(rtfParser, "aftnndbnum", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
