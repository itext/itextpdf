...
public class RtfCtrlWordBase_margt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_margt(RtfParser rtfParser){
		super(rtfParser, "margt", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
