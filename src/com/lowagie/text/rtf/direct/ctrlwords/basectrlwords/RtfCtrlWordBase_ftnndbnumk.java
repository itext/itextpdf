...
public class RtfCtrlWordBase_ftnndbnumk extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnndbnumk(RtfParser rtfParser){
		super(rtfParser, "ftnndbnumk", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
