...
public class RtfCtrlWordBase_trqc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trqc(RtfParser rtfParser){
		super(rtfParser, "trqc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
