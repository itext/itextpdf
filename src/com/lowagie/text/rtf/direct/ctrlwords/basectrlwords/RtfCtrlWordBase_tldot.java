...
public class RtfCtrlWordBase_tldot extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tldot(RtfParser rtfParser){
		super(rtfParser, "tldot", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
