...
public class RtfCtrlWordBase_dplinedot extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dplinedot(RtfParser rtfParser){
		super(rtfParser, "dplinedot", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
