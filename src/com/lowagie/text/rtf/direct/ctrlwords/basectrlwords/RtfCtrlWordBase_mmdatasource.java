...
public class RtfCtrlWordBase_mmdatasource extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmdatasource(RtfParser rtfParser){
		super(rtfParser, "mmdatasource", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
