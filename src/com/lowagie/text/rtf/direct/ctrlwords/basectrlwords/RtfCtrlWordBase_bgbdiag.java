...
public class RtfCtrlWordBase_bgbdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bgbdiag(RtfParser rtfParser){
		super(rtfParser, "bgbdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
