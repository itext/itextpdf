...
public class RtfCtrlWordBase_passwordhash extends RtfCtrlWordBase {

	public RtfCtrlWordBase_passwordhash(RtfParser rtfParser){
		super(rtfParser, "passwordhash", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
