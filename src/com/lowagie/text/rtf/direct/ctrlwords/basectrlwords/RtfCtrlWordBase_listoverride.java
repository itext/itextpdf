...
public class RtfCtrlWordBase_listoverride extends RtfCtrlWordBase {

	public RtfCtrlWordBase_listoverride(RtfParser rtfParser){
		super(rtfParser, "listoverride", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
