...
public class RtfCtrlWordBase_pubauto extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pubauto(RtfParser rtfParser){
		super(rtfParser, "pubauto", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
