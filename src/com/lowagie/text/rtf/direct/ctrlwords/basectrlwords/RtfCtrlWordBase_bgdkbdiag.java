...
public class RtfCtrlWordBase_bgdkbdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bgdkbdiag(RtfParser rtfParser){
		super(rtfParser, "bgdkbdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
