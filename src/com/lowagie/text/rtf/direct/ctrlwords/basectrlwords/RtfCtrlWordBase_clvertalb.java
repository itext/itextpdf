...
public class RtfCtrlWordBase_clvertalb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clvertalb(RtfParser rtfParser){
		super(rtfParser, "clvertalb", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
