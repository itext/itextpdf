...
public class RtfCtrlWordBase_chbgvert extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chbgvert(RtfParser rtfParser){
		super(rtfParser, "chbgvert", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
