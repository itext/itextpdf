...
public class RtfCtrlWordBase_auld extends RtfCtrlWordBase {

	public RtfCtrlWordBase_auld(RtfParser rtfParser){
		super(rtfParser, "auld", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
