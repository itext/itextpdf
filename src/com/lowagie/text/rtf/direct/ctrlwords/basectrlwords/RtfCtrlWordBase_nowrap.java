...
public class RtfCtrlWordBase_nowrap extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nowrap(RtfParser rtfParser){
		super(rtfParser, "nowrap", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
