...
public class RtfCtrlWordBase_dn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dn(RtfParser rtfParser){
		super(rtfParser, "dn", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
