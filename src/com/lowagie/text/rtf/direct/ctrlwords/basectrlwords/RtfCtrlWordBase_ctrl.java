...
/**
 * Description:
 * 	The CTRL modifier key. Used to describe shortcut key codes
 * 	for styles.
 * Group:
 * 	Style Sheet
 * Type:
...
public class RtfCtrlWordBase_ctrl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ctrl(RtfParser rtfParser){
		super(rtfParser, "ctrl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
