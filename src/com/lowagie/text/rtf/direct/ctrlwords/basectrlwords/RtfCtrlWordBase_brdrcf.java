...
public class RtfCtrlWordBase_brdrcf extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrcf(RtfParser rtfParser){
		super(rtfParser, "brdrcf", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
