...
public class RtfCtrlWordBase_mmodsoudldata extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmodsoudldata(RtfParser rtfParser){
		super(rtfParser, "mmodsoudldata", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
