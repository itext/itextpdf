...
public class RtfCtrlWordBase_rempersonalinfo extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rempersonalinfo(RtfParser rtfParser){
		super(rtfParser, "rempersonalinfo", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
