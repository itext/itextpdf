...
public class RtfCtrlWordBase_pgnthaic extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnthaic(RtfParser rtfParser){
		super(rtfParser, "pgnthaic", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
