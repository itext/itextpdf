...
public class RtfCtrlWordBase_pgnhnsp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnhnsp(RtfParser rtfParser){
		super(rtfParser, "pgnhnsp", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
