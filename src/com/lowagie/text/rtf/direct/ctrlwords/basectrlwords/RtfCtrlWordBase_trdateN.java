...
public class RtfCtrlWordBase_trdateN extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trdateN(RtfParser rtfParser){
		super(rtfParser, "trdateN", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
