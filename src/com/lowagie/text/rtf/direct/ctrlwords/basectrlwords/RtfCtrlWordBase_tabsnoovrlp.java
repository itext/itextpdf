...
public class RtfCtrlWordBase_tabsnoovrlp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tabsnoovrlp(RtfParser rtfParser){
		super(rtfParser, "tabsnoovrlp", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
