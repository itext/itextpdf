...
public class RtfCtrlWordBase_tdfrmtxtLeft extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tdfrmtxtLeft(RtfParser rtfParser){
		super(rtfParser, "tdfrmtxtLeft", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
