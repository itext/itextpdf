...
public class RtfCtrlWordBase_ql extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ql(RtfParser rtfParser){
		super(rtfParser, "ql", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
