...
public class RtfCtrlWordBase_pgnstarts extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnstarts(RtfParser rtfParser){
		super(rtfParser, "pgnstarts", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
