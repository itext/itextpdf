...
public class RtfCtrlWordBase_mailmerge extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mailmerge(RtfParser rtfParser){
		super(rtfParser, "mailmerge", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
