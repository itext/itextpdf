...
public class RtfCtrlWordBase_delrsid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_delrsid(RtfParser rtfParser){
		super(rtfParser, "delrsid", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
