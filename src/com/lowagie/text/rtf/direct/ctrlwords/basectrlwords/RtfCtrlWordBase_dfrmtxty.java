...
public class RtfCtrlWordBase_dfrmtxty extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dfrmtxty(RtfParser rtfParser){
		super(rtfParser, "dfrmtxty", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
