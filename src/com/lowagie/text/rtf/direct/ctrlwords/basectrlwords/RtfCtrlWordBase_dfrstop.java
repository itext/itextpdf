...
public class RtfCtrlWordBase_dfrstop extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dfrstop(RtfParser rtfParser){
		super(rtfParser, "dfrstop", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
