...
public class RtfCtrlWordBase_posyb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_posyb(RtfParser rtfParser){
		super(rtfParser, "posyb", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
