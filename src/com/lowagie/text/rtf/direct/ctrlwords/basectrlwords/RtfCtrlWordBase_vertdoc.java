...
public class RtfCtrlWordBase_vertdoc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_vertdoc(RtfParser rtfParser){
		super(rtfParser, "vertdoc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
