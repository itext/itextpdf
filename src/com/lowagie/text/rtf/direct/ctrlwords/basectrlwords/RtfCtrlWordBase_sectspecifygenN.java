...
public class RtfCtrlWordBase_sectspecifygenN extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sectspecifygenN(RtfParser rtfParser){
		super(rtfParser, "sectspecifygenN", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
