...
public class RtfCtrlWordBase_mborderbox extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mborderbox(RtfParser rtfParser){
		super(rtfParser, "mborderbox", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
