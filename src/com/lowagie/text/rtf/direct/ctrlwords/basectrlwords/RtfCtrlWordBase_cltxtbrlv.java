...
public class RtfCtrlWordBase_cltxtbrlv extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cltxtbrlv(RtfParser rtfParser){
		super(rtfParser, "cltxtbrlv", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
