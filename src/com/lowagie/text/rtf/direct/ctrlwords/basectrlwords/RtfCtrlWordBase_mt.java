...
public class RtfCtrlWordBase_mt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mt(RtfParser rtfParser){
		super(rtfParser, "mt", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
