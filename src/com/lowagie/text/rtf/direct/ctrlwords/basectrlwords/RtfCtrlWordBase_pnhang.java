...
public class RtfCtrlWordBase_pnhang extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnhang(RtfParser rtfParser){
		super(rtfParser, "pnhang", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
