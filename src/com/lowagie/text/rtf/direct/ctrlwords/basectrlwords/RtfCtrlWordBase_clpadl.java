...
public class RtfCtrlWordBase_clpadl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clpadl(RtfParser rtfParser){
		super(rtfParser, "clpadl", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
