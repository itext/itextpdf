...
public class RtfCtrlWordBase_clvmrg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clvmrg(RtfParser rtfParser){
		super(rtfParser, "clvmrg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
