...
public class RtfCtrlWordBase_margmirsxn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_margmirsxn(RtfParser rtfParser){
		super(rtfParser, "margmirsxn", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
