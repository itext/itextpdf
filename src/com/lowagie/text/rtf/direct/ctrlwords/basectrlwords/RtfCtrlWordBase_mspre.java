...
public class RtfCtrlWordBase_mspre extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mspre(RtfParser rtfParser){
		super(rtfParser, "mspre", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
