...
public class RtfCtrlWordBase_sftnndbnumk extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnndbnumk(RtfParser rtfParser){
		super(rtfParser, "sftnndbnumk", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
