...
public class RtfCtrlWordBase_mcgp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mcgp(RtfParser rtfParser){
		super(rtfParser, "mcgp", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
