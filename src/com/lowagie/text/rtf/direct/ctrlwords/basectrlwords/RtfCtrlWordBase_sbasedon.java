...
/**
 * Description:
 * 	Defines the number of the style the current style is based
 * 	on (the default is 222?no style).
 * Group:
 * 	Style Sheet
 * Type:
 * 	Value
...
public class RtfCtrlWordBase_sbasedon extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sbasedon(RtfParser rtfParser){
		super(rtfParser, "sbasedon", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
