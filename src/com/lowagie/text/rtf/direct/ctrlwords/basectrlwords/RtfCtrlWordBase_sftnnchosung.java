...
public class RtfCtrlWordBase_sftnnchosung extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnnchosung(RtfParser rtfParser){
		super(rtfParser, "sftnnchosung", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
