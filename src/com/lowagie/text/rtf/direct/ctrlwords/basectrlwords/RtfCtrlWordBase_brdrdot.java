...
public class RtfCtrlWordBase_brdrdot extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrdot(RtfParser rtfParser){
		super(rtfParser, "brdrdot", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
