...
public class RtfCtrlWordBase_sectrsid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sectrsid(RtfParser rtfParser){
		super(rtfParser, "sectrsid", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
