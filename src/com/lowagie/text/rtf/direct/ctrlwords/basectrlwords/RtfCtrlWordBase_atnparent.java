...
public class RtfCtrlWordBase_atnparent extends RtfCtrlWordBase {

	public RtfCtrlWordBase_atnparent(RtfParser rtfParser){
		super(rtfParser, "atnparent", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
