...
public class RtfCtrlWordBase_mpos extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mpos(RtfParser rtfParser){
		super(rtfParser, "mpos", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
