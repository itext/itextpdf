...
public class RtfCtrlWordBase_mmr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmr(RtfParser rtfParser){
		super(rtfParser, "mmr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
