...
public class RtfCtrlWordBase_piccropt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_piccropt(RtfParser rtfParser){
		super(rtfParser, "piccropt", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
