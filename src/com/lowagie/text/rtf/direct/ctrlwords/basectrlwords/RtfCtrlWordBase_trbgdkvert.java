...
public class RtfCtrlWordBase_trbgdkvert extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trbgdkvert(RtfParser rtfParser){
		super(rtfParser, "trbgdkvert", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
