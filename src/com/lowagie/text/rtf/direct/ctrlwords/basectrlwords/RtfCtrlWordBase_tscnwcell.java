...
public class RtfCtrlWordBase_tscnwcell extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscnwcell(RtfParser rtfParser){
		super(rtfParser, "tscnwcell", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
