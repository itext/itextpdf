...
public class RtfCtrlWordBase_themelangcs extends RtfCtrlWordBase {

	public RtfCtrlWordBase_themelangcs(RtfParser rtfParser){
		super(rtfParser, "themelangcs", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
