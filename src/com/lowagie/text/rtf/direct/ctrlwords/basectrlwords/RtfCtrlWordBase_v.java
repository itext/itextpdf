...
public class RtfCtrlWordBase_v extends RtfCtrlWordBase {

	public RtfCtrlWordBase_v(RtfParser rtfParser){
		super(rtfParser, "v", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
