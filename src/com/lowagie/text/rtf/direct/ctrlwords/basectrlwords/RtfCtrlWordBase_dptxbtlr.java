...
public class RtfCtrlWordBase_dptxbtlr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dptxbtlr(RtfParser rtfParser){
		super(rtfParser, "dptxbtlr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
