...
public class RtfCtrlWordBase_pnuldash extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnuldash(RtfParser rtfParser){
		super(rtfParser, "pnuldash", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
