...
public class RtfCtrlWordBase_pnaiueod extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnaiueod(RtfParser rtfParser){
		super(rtfParser, "pnaiueod", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
