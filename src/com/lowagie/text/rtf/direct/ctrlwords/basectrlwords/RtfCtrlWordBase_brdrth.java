...
public class RtfCtrlWordBase_brdrth extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrth(RtfParser rtfParser){
		super(rtfParser, "brdrth", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
