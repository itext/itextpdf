...
public class RtfCtrlWordBase_pgbrdrt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgbrdrt(RtfParser rtfParser){
		super(rtfParser, "pgbrdrt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
