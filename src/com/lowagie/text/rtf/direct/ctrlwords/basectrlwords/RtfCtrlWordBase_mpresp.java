...
public class RtfCtrlWordBase_mpresp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mpresp(RtfParser rtfParser){
		super(rtfParser, "mpresp", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
