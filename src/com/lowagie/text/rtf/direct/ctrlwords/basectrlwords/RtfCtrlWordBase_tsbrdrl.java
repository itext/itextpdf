...
public class RtfCtrlWordBase_tsbrdrl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsbrdrl(RtfParser rtfParser){
		super(rtfParser, "tsbrdrl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
