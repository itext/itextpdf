...
public class RtfCtrlWordBase_ebcend extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ebcend(RtfParser rtfParser){
		super(rtfParser, "ebcend", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
