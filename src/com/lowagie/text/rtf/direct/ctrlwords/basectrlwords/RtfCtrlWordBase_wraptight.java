...
public class RtfCtrlWordBase_wraptight extends RtfCtrlWordBase {

	public RtfCtrlWordBase_wraptight(RtfParser rtfParser){
		super(rtfParser, "wraptight", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
