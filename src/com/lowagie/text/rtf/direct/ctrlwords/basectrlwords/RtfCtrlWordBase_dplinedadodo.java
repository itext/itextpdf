...
public class RtfCtrlWordBase_dplinedadodo extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dplinedadodo(RtfParser rtfParser){
		super(rtfParser, "dplinedadodo", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
