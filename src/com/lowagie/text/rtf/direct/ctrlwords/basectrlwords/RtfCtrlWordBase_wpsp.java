...
public class RtfCtrlWordBase_wpsp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_wpsp(RtfParser rtfParser){
		super(rtfParser, "wpsp", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
