...
public class RtfCtrlWordBase_tab extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tab(RtfParser rtfParser){
		super(rtfParser, "tab", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
