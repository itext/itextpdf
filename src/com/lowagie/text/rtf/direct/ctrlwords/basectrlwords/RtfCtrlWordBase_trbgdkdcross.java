...
public class RtfCtrlWordBase_trbgdkdcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trbgdkdcross(RtfParser rtfParser){
		super(rtfParser, "trbgdkdcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
