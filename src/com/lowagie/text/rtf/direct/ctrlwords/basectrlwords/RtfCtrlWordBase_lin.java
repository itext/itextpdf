...
public class RtfCtrlWordBase_lin extends RtfCtrlWordBase {

	public RtfCtrlWordBase_lin(RtfParser rtfParser){
		super(rtfParser, "lin", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
