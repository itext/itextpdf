...
public class RtfCtrlWordBase_htmautsp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_htmautsp(RtfParser rtfParser){
		super(rtfParser, "htmautsp", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
