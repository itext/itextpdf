...
public class RtfCtrlWordBase_ftnnar extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnnar(RtfParser rtfParser){
		super(rtfParser, "ftnnar", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
