...
public class RtfCtrlWordBase_trbgdkcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trbgdkcross(RtfParser rtfParser){
		super(rtfParser, "trbgdkcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
