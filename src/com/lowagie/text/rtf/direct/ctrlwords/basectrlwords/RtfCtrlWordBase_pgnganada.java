...
public class RtfCtrlWordBase_pgnganada extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnganada(RtfParser rtfParser){
		super(rtfParser, "pgnganada", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
