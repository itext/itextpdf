...
public class RtfCtrlWordBase_wbmplanes extends RtfCtrlWordBase {

	public RtfCtrlWordBase_wbmplanes(RtfParser rtfParser){
		super(rtfParser, "wbmplanes", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
