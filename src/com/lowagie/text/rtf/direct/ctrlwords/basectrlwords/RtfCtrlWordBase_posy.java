...
public class RtfCtrlWordBase_posy extends RtfCtrlWordBase {

	public RtfCtrlWordBase_posy(RtfParser rtfParser){
		super(rtfParser, "posy", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
