...
public class RtfCtrlWordBase_clbgdkcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clbgdkcross(RtfParser rtfParser){
		super(rtfParser, "clbgdkcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
