...
public class RtfCtrlWordBase_objw extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objw(RtfParser rtfParser){
		super(rtfParser, "objw", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
