...
public class RtfCtrlWordBase_vern extends RtfCtrlWordBase {

	public RtfCtrlWordBase_vern(RtfParser rtfParser){
		super(rtfParser, "vern", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
