...
/**
 * Description:
 * 	The style is locked. It cannot be used in the current
 * 	document if protection is on.
 * Group:
 * 	Style Sheet
 * Type:
 * 	Value
...
public class RtfCtrlWordBase_slocked extends RtfCtrlWordBase {

	public RtfCtrlWordBase_slocked(RtfParser rtfParser){
		super(rtfParser, "slocked", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
