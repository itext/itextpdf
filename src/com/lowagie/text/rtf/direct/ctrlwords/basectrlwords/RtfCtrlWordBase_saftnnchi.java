...
public class RtfCtrlWordBase_saftnnchi extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnnchi(RtfParser rtfParser){
		super(rtfParser, "saftnnchi", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
