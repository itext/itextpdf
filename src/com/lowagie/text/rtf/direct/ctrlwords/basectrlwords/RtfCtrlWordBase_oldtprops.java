...
public class RtfCtrlWordBase_oldtprops extends RtfCtrlWordBase {

	public RtfCtrlWordBase_oldtprops(RtfParser rtfParser){
		super(rtfParser, "oldtprops", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
