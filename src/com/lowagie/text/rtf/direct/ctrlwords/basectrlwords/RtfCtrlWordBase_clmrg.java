...
public class RtfCtrlWordBase_clmrg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clmrg(RtfParser rtfParser){
		super(rtfParser, "clmrg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
