...
public class RtfCtrlWordBase_linemod extends RtfCtrlWordBase {

	public RtfCtrlWordBase_linemod(RtfParser rtfParser){
		super(rtfParser, "linemod", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
