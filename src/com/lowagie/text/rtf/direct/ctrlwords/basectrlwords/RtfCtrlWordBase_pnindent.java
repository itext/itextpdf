...
public class RtfCtrlWordBase_pnindent extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnindent(RtfParser rtfParser){
		super(rtfParser, "pnindent", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
