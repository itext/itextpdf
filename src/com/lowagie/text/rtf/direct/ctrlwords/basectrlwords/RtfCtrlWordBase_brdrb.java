...
public class RtfCtrlWordBase_brdrb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrb(RtfParser rtfParser){
		super(rtfParser, "brdrb", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
