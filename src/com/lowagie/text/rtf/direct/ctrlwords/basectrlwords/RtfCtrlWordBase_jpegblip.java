...
public class RtfCtrlWordBase_jpegblip extends RtfCtrlWordBase {

	public RtfCtrlWordBase_jpegblip(RtfParser rtfParser){
		super(rtfParser, "jpegblip", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
