...
public class RtfCtrlWordBase_objtransy extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objtransy(RtfParser rtfParser){
		super(rtfParser, "objtransy", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
