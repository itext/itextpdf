...
public class RtfCtrlWordBase_expshrtn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_expshrtn(RtfParser rtfParser){
		super(rtfParser, "expshrtn", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
