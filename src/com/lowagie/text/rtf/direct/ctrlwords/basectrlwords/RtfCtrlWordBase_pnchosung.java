...
public class RtfCtrlWordBase_pnchosung extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnchosung(RtfParser rtfParser){
		super(rtfParser, "pnchosung", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
