...
public class RtfCtrlWordBase_sftnngbnumd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnngbnumd(RtfParser rtfParser){
		super(rtfParser, "sftnngbnumd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
