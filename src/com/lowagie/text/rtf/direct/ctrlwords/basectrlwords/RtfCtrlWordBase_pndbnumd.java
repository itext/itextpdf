...
public class RtfCtrlWordBase_pndbnumd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pndbnumd(RtfParser rtfParser){
		super(rtfParser, "pndbnumd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
