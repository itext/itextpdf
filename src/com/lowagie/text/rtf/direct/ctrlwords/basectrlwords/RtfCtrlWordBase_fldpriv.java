...
public class RtfCtrlWordBase_fldpriv extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fldpriv(RtfParser rtfParser){
		super(rtfParser, "fldpriv", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
