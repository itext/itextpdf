...
public class RtfCtrlWordBase_meqarrpr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_meqarrpr(RtfParser rtfParser){
		super(rtfParser, "meqarrpr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
