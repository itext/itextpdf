...
public class RtfCtrlWordBase_clbgfdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clbgfdiag(RtfParser rtfParser){
		super(rtfParser, "clbgfdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
