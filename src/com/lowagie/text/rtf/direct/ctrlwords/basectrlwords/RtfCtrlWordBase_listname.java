...
/**
 * Description:
 * 	The argument for \listname is a string that is the name of
 * 	this list. Names allow ListNum fields to specify the list to
 * 	which they belong. This is a destination control word.
 * Group:
 * 	List Table
 * Type:
 * 	Destination
...
public class RtfCtrlWordBase_listname extends RtfCtrlWordBase {

	public RtfCtrlWordBase_listname(RtfParser rtfParser){
		super(rtfParser, "listname", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
