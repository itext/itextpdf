...
public class RtfCtrlWordBase_deftab extends RtfCtrlWordBase {

	public RtfCtrlWordBase_deftab(RtfParser rtfParser){
		super(rtfParser, "deftab", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
