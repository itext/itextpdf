...
public class RtfCtrlWordBase_rtlgutter extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rtlgutter(RtfParser rtfParser){
		super(rtfParser, "rtlgutter", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
