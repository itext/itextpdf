...
public class RtfCtrlWordBase_pntxtb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pntxtb(RtfParser rtfParser){
		super(rtfParser, "pntxtb", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
