...
public class RtfCtrlWordBase_brdrart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrart(RtfParser rtfParser){
		super(rtfParser, "brdrart", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
