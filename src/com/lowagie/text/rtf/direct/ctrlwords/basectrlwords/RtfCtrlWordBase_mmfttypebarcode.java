...
public class RtfCtrlWordBase_mmfttypebarcode extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmfttypebarcode(RtfParser rtfParser){
		super(rtfParser, "mmfttypebarcode", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
