...
public class RtfCtrlWordBase_pgwsxn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgwsxn(RtfParser rtfParser){
		super(rtfParser, "pgwsxn", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
