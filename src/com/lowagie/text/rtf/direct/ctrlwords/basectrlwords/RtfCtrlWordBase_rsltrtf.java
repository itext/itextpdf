...
public class RtfCtrlWordBase_rsltrtf extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rsltrtf(RtfParser rtfParser){
		super(rtfParser, "rsltrtf", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
