...
public class RtfCtrlWordBase_mmdestnewdoc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmdestnewdoc(RtfParser rtfParser){
		super(rtfParser, "mmdestnewdoc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
