...
public class RtfCtrlWordBase_creatim extends RtfCtrlWordBase {

	public RtfCtrlWordBase_creatim(RtfParser rtfParser){
		super(rtfParser, "creatim", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
