...
public class RtfCtrlWordBase_caps extends RtfCtrlWordBase {

	public RtfCtrlWordBase_caps(RtfParser rtfParser){
		super(rtfParser, "caps", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
