...
public class RtfCtrlWordBase_page extends RtfCtrlWordBase {

	public RtfCtrlWordBase_page(RtfParser rtfParser){
		super(rtfParser, "page", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
