...
public class RtfCtrlWordBase_dplinew extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dplinew(RtfParser rtfParser){
		super(rtfParser, "dplinew", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
