...
public class RtfCtrlWordBase_pnlvlbody extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnlvlbody(RtfParser rtfParser){
		super(rtfParser, "pnlvlbody", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
