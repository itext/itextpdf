...
public class RtfCtrlWordBase_piccropl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_piccropl(RtfParser rtfParser){
		super(rtfParser, "piccropl", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
