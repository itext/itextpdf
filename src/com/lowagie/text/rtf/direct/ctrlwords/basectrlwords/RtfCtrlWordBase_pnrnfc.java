...
public class RtfCtrlWordBase_pnrnfc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnrnfc(RtfParser rtfParser){
		super(rtfParser, "pnrnfc", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
