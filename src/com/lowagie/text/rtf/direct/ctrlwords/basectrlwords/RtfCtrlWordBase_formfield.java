...
public class RtfCtrlWordBase_formfield extends RtfCtrlWordBase {

	public RtfCtrlWordBase_formfield(RtfParser rtfParser){
		super(rtfParser, "formfield", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
