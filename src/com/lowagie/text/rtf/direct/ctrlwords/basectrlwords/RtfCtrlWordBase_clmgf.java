...
public class RtfCtrlWordBase_clmgf extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clmgf(RtfParser rtfParser){
		super(rtfParser, "clmgf", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
