...
public class RtfCtrlWordBase_gcw extends RtfCtrlWordBase {

	public RtfCtrlWordBase_gcw(RtfParser rtfParser){
		super(rtfParser, "gcw", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
