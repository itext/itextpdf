...
public class RtfCtrlWordBase_tsclastcol extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsclastcol(RtfParser rtfParser){
		super(rtfParser, "tsclastcol", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
