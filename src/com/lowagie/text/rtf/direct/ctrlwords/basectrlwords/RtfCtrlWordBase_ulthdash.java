...
public class RtfCtrlWordBase_ulthdash extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ulthdash(RtfParser rtfParser){
		super(rtfParser, "ulthdash", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
