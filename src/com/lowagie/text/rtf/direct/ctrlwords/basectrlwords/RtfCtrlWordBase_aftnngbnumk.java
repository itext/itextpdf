...
public class RtfCtrlWordBase_aftnngbnumk extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnngbnumk(RtfParser rtfParser){
		super(rtfParser, "aftnngbnumk", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
