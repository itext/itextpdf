...
public class RtfCtrlWordBase_clbrdrb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clbrdrb(RtfParser rtfParser){
		super(rtfParser, "clbrdrb", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
