...
public class RtfCtrlWordBase_atnid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_atnid(RtfParser rtfParser){
		super(rtfParser, "atnid", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
