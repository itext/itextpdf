...
public class RtfCtrlWordBase_af extends RtfCtrlWordBase {

	public RtfCtrlWordBase_af(RtfParser rtfParser){
		super(rtfParser, "af", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
