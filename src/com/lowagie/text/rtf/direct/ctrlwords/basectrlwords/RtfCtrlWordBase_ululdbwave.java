...
public class RtfCtrlWordBase_ululdbwave extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ululdbwave(RtfParser rtfParser){
		super(rtfParser, "ululdbwave", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
