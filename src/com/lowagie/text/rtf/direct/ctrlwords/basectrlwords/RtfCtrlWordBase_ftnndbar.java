...
public class RtfCtrlWordBase_ftnndbar extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnndbar(RtfParser rtfParser){
		super(rtfParser, "ftnndbar", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
