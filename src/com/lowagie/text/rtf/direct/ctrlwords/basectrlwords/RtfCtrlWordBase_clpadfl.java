...
public class RtfCtrlWordBase_clpadfl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clpadfl(RtfParser rtfParser){
		super(rtfParser, "clpadfl", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
