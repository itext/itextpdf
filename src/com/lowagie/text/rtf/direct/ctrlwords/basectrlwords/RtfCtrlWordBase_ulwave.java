...
public class RtfCtrlWordBase_ulwave extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ulwave(RtfParser rtfParser){
		super(rtfParser, "ulwave", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
