...
public class RtfCtrlWordBase_ipgp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ipgp(RtfParser rtfParser){
		super(rtfParser, "ipgp", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
