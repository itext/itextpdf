...
public class RtfCtrlWordBase_ftnnauc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnnauc(RtfParser rtfParser){
		super(rtfParser, "ftnnauc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
