...
public class RtfCtrlWordBase_aftnngbnuml extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnngbnuml(RtfParser rtfParser){
		super(rtfParser, "aftnngbnuml", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
