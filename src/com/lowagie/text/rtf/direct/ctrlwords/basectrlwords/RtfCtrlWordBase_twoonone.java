...
public class RtfCtrlWordBase_twoonone extends RtfCtrlWordBase {

	public RtfCtrlWordBase_twoonone(RtfParser rtfParser){
		super(rtfParser, "twoonone", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
