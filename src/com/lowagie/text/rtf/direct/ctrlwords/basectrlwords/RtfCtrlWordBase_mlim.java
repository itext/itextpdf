...
public class RtfCtrlWordBase_mlim extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mlim(RtfParser rtfParser){
		super(rtfParser, "mlim", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
