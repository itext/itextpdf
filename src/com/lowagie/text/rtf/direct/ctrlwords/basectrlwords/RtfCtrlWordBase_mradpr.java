...
public class RtfCtrlWordBase_mradpr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mradpr(RtfParser rtfParser){
		super(rtfParser, "mradpr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
