...
public class RtfCtrlWordBase_pnucltr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnucltr(RtfParser rtfParser){
		super(rtfParser, "pnucltr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
