...
public class RtfCtrlWordBase_pncaps extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pncaps(RtfParser rtfParser){
		super(rtfParser, "pncaps", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
