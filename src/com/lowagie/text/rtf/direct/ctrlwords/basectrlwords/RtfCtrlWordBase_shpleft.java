...
public class RtfCtrlWordBase_shpleft extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shpleft(RtfParser rtfParser){
		super(rtfParser, "shpleft", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
