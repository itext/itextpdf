...
public class RtfCtrlWordBase_clbgdkbdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clbgdkbdiag(RtfParser rtfParser){
		super(rtfParser, "clbgdkbdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
