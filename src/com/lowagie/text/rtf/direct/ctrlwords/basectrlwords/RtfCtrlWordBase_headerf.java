...
public class RtfCtrlWordBase_headerf extends RtfCtrlWordBase {

	public RtfCtrlWordBase_headerf(RtfParser rtfParser){
		super(rtfParser, "headerf", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
