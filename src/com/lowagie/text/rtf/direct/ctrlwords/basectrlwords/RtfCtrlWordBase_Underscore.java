...
public class RtfCtrlWordBase_Underscore extends RtfCtrlWordBase {

	public RtfCtrlWordBase_Underscore(RtfParser rtfParser){
		super(rtfParser, "_", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
