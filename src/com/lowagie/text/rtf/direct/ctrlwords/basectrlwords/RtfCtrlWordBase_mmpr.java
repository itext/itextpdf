...
public class RtfCtrlWordBase_mmpr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmpr(RtfParser rtfParser){
		super(rtfParser, "mmpr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
