...
public class RtfCtrlWordBase_facingp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_facingp(RtfParser rtfParser){
		super(rtfParser, "facingp", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
