...
public class RtfCtrlWordBase_lyttblrtgr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_lyttblrtgr(RtfParser rtfParser){
		super(rtfParser, "lyttblrtgr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
