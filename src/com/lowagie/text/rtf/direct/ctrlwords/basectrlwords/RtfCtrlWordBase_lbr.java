...
public class RtfCtrlWordBase_lbr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_lbr(RtfParser rtfParser){
		super(rtfParser, "lbr", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
