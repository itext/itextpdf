...
public class RtfCtrlWordBase_macc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_macc(RtfParser rtfParser){
		super(rtfParser, "macc", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
