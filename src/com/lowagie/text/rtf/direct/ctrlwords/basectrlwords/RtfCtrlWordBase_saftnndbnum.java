...
public class RtfCtrlWordBase_saftnndbnum extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnndbnum(RtfParser rtfParser){
		super(rtfParser, "saftnndbnum", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
