...
public class RtfCtrlWordBase_pncf extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pncf(RtfParser rtfParser){
		super(rtfParser, "pncf", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
