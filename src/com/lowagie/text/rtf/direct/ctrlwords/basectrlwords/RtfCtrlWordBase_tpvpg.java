...
public class RtfCtrlWordBase_tpvpg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tpvpg(RtfParser rtfParser){
		super(rtfParser, "tpvpg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
