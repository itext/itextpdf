...
public class RtfCtrlWordBase_dpcount extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpcount(RtfParser rtfParser){
		super(rtfParser, "dpcount", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
