...
public class RtfCtrlWordBase_annotprot extends RtfCtrlWordBase {

	public RtfCtrlWordBase_annotprot(RtfParser rtfParser){
		super(rtfParser, "annotprot", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
