...
public class RtfCtrlWordBase_bgfdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bgfdiag(RtfParser rtfParser){
		super(rtfParser, "bgfdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
