...
public class RtfCtrlWordBase_pnfs extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnfs(RtfParser rtfParser){
		super(rtfParser, "pnfs", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
