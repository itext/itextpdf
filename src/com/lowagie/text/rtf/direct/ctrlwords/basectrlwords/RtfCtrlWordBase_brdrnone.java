...
public class RtfCtrlWordBase_brdrnone extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrnone(RtfParser rtfParser){
		super(rtfParser, "brdrnone", 0, false, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
