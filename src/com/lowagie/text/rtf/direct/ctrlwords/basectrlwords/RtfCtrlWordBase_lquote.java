...
public class RtfCtrlWordBase_lquote extends RtfCtrlWordBase {

	public RtfCtrlWordBase_lquote(RtfParser rtfParser){
		super(rtfParser, "lquote", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
