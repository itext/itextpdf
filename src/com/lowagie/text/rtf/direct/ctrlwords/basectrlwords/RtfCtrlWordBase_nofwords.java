...
public class RtfCtrlWordBase_nofwords extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nofwords(RtfParser rtfParser){
		super(rtfParser, "nofwords", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
