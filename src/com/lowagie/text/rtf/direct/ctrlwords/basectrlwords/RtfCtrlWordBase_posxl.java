...
public class RtfCtrlWordBase_posxl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_posxl(RtfParser rtfParser){
		super(rtfParser, "posxl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
