...
public class RtfCtrlWordBase_bkmkend extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bkmkend(RtfParser rtfParser){
		super(rtfParser, "bkmkend", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
