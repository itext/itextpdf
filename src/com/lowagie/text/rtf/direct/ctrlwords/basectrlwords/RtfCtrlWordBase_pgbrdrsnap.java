...
public class RtfCtrlWordBase_pgbrdrsnap extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgbrdrsnap(RtfParser rtfParser){
		super(rtfParser, "pgbrdrsnap", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
