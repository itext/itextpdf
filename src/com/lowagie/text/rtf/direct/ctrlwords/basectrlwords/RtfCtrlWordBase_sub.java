...
public class RtfCtrlWordBase_sub extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sub(RtfParser rtfParser){
		super(rtfParser, "sub", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
