...
public class RtfCtrlWordBase_fittext extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fittext(RtfParser rtfParser){
		super(rtfParser, "fittext", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
