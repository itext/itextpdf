...
public class RtfCtrlWordBase_fvalidmac extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fvalidmac(RtfParser rtfParser){
		super(rtfParser, "fvalidmac", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
