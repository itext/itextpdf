...
public class RtfCtrlWordBase_nospaceforul extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nospaceforul(RtfParser rtfParser){
		super(rtfParser, "nospaceforul", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
