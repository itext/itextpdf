...
public class RtfCtrlWordBase_fafixed extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fafixed(RtfParser rtfParser){
		super(rtfParser, "fafixed", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
