...
public class RtfCtrlWordBase_tsbgdkvert extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsbgdkvert(RtfParser rtfParser){
		super(rtfParser, "tsbgdkvert", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
