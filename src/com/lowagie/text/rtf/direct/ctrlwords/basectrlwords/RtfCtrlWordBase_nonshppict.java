...
public class RtfCtrlWordBase_nonshppict extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nonshppict(RtfParser rtfParser){
		super(rtfParser, "nonshppict", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
