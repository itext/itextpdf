...
public class RtfCtrlWordBase_tscbandverteven extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscbandverteven(RtfParser rtfParser){
		super(rtfParser, "tscbandverteven", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
