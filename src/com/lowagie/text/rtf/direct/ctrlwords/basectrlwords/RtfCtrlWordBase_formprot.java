...
public class RtfCtrlWordBase_formprot extends RtfCtrlWordBase {

	public RtfCtrlWordBase_formprot(RtfParser rtfParser){
		super(rtfParser, "formprot", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
