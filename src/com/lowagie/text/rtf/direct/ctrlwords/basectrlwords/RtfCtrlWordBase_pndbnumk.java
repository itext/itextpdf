...
public class RtfCtrlWordBase_pndbnumk extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pndbnumk(RtfParser rtfParser){
		super(rtfParser, "pndbnumk", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
