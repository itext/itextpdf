...
public class RtfCtrlWordBase_fchars extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fchars(RtfParser rtfParser){
		super(rtfParser, "fchars", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
