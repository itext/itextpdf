...
public class RtfCtrlWordBase_htmlrtf extends RtfCtrlWordBase {

	public RtfCtrlWordBase_htmlrtf(RtfParser rtfParser){
		super(rtfParser, "htmlrtf", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
