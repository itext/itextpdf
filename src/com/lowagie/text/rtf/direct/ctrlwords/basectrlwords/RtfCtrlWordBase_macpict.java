...
public class RtfCtrlWordBase_macpict extends RtfCtrlWordBase {

	public RtfCtrlWordBase_macpict(RtfParser rtfParser){
		super(rtfParser, "macpict", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
