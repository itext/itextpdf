...
public class RtfCtrlWordBase_indrlsweleven extends RtfCtrlWordBase {

	public RtfCtrlWordBase_indrlsweleven(RtfParser rtfParser){
		super(rtfParser, "indrlsweleven", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
