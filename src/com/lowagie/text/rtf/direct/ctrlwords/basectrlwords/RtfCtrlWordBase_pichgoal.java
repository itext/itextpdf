...
public class RtfCtrlWordBase_pichgoal extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pichgoal(RtfParser rtfParser){
		super(rtfParser, "pichgoal", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
