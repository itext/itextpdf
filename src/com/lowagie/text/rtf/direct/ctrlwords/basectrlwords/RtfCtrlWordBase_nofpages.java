...
public class RtfCtrlWordBase_nofpages extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nofpages(RtfParser rtfParser){
		super(rtfParser, "nofpages", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
