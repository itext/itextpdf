...
public class RtfCtrlWordBase_tsbgdkhor extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsbgdkhor(RtfParser rtfParser){
		super(rtfParser, "tsbgdkhor", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
