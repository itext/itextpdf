...
public class RtfCtrlWordBase_scaps extends RtfCtrlWordBase {

	public RtfCtrlWordBase_scaps(RtfParser rtfParser){
		super(rtfParser, "scaps", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
