...
public class RtfCtrlWordBase_dpcallout extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpcallout(RtfParser rtfParser){
		super(rtfParser, "dpcallout", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
