...
public class RtfCtrlWordBase_pararsid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pararsid(RtfParser rtfParser){
		super(rtfParser, "pararsid", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
