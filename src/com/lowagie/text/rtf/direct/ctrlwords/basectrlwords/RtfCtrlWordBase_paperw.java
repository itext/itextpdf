...
public class RtfCtrlWordBase_paperw extends RtfCtrlWordBase {

	public RtfCtrlWordBase_paperw(RtfParser rtfParser){
		super(rtfParser, "paperw", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
