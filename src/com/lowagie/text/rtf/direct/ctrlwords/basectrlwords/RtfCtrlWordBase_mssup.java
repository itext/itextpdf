...
public class RtfCtrlWordBase_mssup extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mssup(RtfParser rtfParser){
		super(rtfParser, "mssup", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
