...
public class RtfCtrlWordBase_lnbrkrule extends RtfCtrlWordBase {

	public RtfCtrlWordBase_lnbrkrule(RtfParser rtfParser){
		super(rtfParser, "lnbrkrule", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
