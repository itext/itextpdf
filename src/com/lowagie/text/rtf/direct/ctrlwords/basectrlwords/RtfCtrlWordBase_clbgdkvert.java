...
public class RtfCtrlWordBase_clbgdkvert extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clbgdkvert(RtfParser rtfParser){
		super(rtfParser, "clbgdkvert", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
