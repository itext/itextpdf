...
public class RtfCtrlWordBase_chbgcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chbgcross(RtfParser rtfParser){
		super(rtfParser, "chbgcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
