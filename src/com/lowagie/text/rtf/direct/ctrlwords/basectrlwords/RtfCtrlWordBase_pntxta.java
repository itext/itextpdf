...
public class RtfCtrlWordBase_pntxta extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pntxta(RtfParser rtfParser){
		super(rtfParser, "pntxta", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
