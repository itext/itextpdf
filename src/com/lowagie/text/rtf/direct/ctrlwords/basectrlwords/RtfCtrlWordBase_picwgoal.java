...
public class RtfCtrlWordBase_picwgoal extends RtfCtrlWordBase {

	public RtfCtrlWordBase_picwgoal(RtfParser rtfParser){
		super(rtfParser, "picwgoal", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
