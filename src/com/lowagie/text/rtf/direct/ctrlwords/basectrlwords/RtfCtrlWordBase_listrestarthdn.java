...
/**
 * Description:
 * 	1 if the list restarts at each section; 0 if not. Used for
 * 	Word 7.0 compatibility only.
 * Group:
 * 	List Table
 * Type:
 * 	Value
...
public class RtfCtrlWordBase_listrestarthdn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_listrestarthdn(RtfParser rtfParser){
		super(rtfParser, "listrestarthdn", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
