...
public class RtfCtrlWordBase_ftnsep extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnsep(RtfParser rtfParser){
		super(rtfParser, "ftnsep", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
