...
public class RtfCtrlWordBase_mbasejc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mbasejc(RtfParser rtfParser){
		super(rtfParser, "mbasejc", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
