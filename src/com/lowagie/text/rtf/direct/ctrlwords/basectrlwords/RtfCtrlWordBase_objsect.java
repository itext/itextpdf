...
public class RtfCtrlWordBase_objsect extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objsect(RtfParser rtfParser){
		super(rtfParser, "objsect", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
