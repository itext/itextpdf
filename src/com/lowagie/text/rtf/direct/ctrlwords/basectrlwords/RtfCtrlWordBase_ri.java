...
public class RtfCtrlWordBase_ri extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ri(RtfParser rtfParser){
		super(rtfParser, "ri", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
