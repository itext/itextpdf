...
public class RtfCtrlWordBase_xmlattrname extends RtfCtrlWordBase {

	public RtfCtrlWordBase_xmlattrname(RtfParser rtfParser){
		super(rtfParser, "xmlattrname", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
