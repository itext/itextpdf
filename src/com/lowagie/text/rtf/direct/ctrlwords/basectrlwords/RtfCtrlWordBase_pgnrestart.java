...
public class RtfCtrlWordBase_pgnrestart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnrestart(RtfParser rtfParser){
		super(rtfParser, "pgnrestart", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
