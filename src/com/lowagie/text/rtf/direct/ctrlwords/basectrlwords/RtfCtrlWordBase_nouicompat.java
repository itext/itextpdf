...
public class RtfCtrlWordBase_nouicompat extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nouicompat(RtfParser rtfParser){
		super(rtfParser, "nouicompat", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
