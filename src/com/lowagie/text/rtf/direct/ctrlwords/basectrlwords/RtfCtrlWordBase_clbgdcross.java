...
public class RtfCtrlWordBase_clbgdcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clbgdcross(RtfParser rtfParser){
		super(rtfParser, "clbgdcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
