...
public class RtfCtrlWordBase_tscfirstrow extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscfirstrow(RtfParser rtfParser){
		super(rtfParser, "tscfirstrow", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
