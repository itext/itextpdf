...
/**
 * Description:
 * 	Number of list override levels within this list override
 * 	(should be either 1 or 9).
 * Group:
 * 	List Table
 * Type:
 * 	Value
...
public class RtfCtrlWordBase_listoverrideformat extends RtfCtrlWordBase {

	public RtfCtrlWordBase_listoverrideformat(RtfParser rtfParser){
		super(rtfParser, "listoverrideformat", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
