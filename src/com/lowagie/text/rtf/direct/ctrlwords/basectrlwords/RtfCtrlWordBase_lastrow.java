...
public class RtfCtrlWordBase_lastrow extends RtfCtrlWordBase {

	public RtfCtrlWordBase_lastrow(RtfParser rtfParser){
		super(rtfParser, "lastrow", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
