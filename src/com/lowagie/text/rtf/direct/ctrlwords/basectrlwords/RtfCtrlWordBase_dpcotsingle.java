...
public class RtfCtrlWordBase_dpcotsingle extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpcotsingle(RtfParser rtfParser){
		super(rtfParser, "dpcotsingle", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
