...
public class RtfCtrlWordBase_xmlopen extends RtfCtrlWordBase {

	public RtfCtrlWordBase_xmlopen(RtfParser rtfParser){
		super(rtfParser, "xmlopen", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
