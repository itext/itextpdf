...
public class RtfCtrlWordBase_mmblanklines extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmblanklines(RtfParser rtfParser){
		super(rtfParser, "mmblanklines", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
