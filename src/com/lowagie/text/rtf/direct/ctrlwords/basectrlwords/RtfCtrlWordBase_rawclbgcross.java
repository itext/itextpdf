...
public class RtfCtrlWordBase_rawclbgcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rawclbgcross(RtfParser rtfParser){
		super(rtfParser, "rawclbgcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
