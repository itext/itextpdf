...
public class RtfCtrlWordBase_mhideleft extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mhideleft(RtfParser rtfParser){
		super(rtfParser, "mhideleft", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
