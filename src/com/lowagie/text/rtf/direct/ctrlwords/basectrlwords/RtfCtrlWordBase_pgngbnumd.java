...
public class RtfCtrlWordBase_pgngbnumd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgngbnumd(RtfParser rtfParser){
		super(rtfParser, "pgngbnumd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
