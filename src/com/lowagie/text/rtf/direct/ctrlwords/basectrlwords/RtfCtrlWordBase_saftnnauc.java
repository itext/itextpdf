...
public class RtfCtrlWordBase_saftnnauc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnnauc(RtfParser rtfParser){
		super(rtfParser, "saftnnauc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
