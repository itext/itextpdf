...
public class RtfCtrlWordBase_horzdoc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_horzdoc(RtfParser rtfParser){
		super(rtfParser, "horzdoc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
