...
public class RtfCtrlWordBase_cvmme extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cvmme(RtfParser rtfParser){
		super(rtfParser, "cvmme", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
