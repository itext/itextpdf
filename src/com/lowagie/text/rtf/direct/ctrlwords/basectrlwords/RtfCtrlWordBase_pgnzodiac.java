...
public class RtfCtrlWordBase_pgnzodiac extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnzodiac(RtfParser rtfParser){
		super(rtfParser, "pgnzodiac", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
