...
public class RtfCtrlWordBase_oldpprops extends RtfCtrlWordBase {

	public RtfCtrlWordBase_oldpprops(RtfParser rtfParser){
		super(rtfParser, "oldpprops", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
