...
public class RtfCtrlWordBase_wraparound extends RtfCtrlWordBase {

	public RtfCtrlWordBase_wraparound(RtfParser rtfParser){
		super(rtfParser, "wraparound", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
