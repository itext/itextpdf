...
public class RtfCtrlWordBase_fi extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fi(RtfParser rtfParser){
		super(rtfParser, "fi", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
