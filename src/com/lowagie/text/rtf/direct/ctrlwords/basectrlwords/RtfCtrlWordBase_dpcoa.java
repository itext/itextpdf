...
public class RtfCtrlWordBase_dpcoa extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpcoa(RtfParser rtfParser){
		super(rtfParser, "dpcoa", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
