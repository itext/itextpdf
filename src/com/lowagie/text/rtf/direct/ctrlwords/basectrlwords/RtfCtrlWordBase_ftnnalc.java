...
public class RtfCtrlWordBase_ftnnalc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnnalc(RtfParser rtfParser){
		super(rtfParser, "ftnnalc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
