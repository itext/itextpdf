...
public class RtfCtrlWordBase_dpgroup extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpgroup(RtfParser rtfParser){
		super(rtfParser, "dpgroup", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
