...
public class RtfCtrlWordBase_rdblquote extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rdblquote(RtfParser rtfParser){
		super(rtfParser, "rdblquote", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
