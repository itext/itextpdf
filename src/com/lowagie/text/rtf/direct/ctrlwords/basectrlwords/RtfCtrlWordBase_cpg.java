...
public class RtfCtrlWordBase_cpg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cpg(RtfParser rtfParser){
		super(rtfParser, "cpg", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
