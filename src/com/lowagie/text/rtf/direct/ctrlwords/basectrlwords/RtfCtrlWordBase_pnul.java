...
public class RtfCtrlWordBase_pnul extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnul(RtfParser rtfParser){
		super(rtfParser, "pnul", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
