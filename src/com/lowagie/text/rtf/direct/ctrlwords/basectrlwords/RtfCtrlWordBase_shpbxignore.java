...
public class RtfCtrlWordBase_shpbxignore extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shpbxignore(RtfParser rtfParser){
		super(rtfParser, "shpbxignore", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
