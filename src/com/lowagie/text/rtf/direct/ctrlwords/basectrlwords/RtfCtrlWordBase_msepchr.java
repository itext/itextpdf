...
public class RtfCtrlWordBase_msepchr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_msepchr(RtfParser rtfParser){
		super(rtfParser, "msepchr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
