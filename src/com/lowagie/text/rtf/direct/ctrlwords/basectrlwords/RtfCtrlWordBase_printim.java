...
public class RtfCtrlWordBase_printim extends RtfCtrlWordBase {

	public RtfCtrlWordBase_printim(RtfParser rtfParser){
		super(rtfParser, "printim", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
