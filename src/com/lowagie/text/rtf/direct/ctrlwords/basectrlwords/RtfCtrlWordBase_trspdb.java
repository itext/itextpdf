...
public class RtfCtrlWordBase_trspdb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trspdb(RtfParser rtfParser){
		super(rtfParser, "trspdb", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
