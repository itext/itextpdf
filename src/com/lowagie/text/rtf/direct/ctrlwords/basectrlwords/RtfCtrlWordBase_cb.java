...
public class RtfCtrlWordBase_cb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cb(RtfParser rtfParser){
		super(rtfParser, "cb", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
