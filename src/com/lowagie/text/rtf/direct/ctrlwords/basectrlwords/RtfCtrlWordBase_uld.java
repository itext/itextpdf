...
public class RtfCtrlWordBase_uld extends RtfCtrlWordBase {

	public RtfCtrlWordBase_uld(RtfParser rtfParser){
		super(rtfParser, "uld", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
