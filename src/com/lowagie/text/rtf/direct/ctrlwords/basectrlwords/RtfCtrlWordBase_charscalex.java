...
public class RtfCtrlWordBase_charscalex extends RtfCtrlWordBase {

	public RtfCtrlWordBase_charscalex(RtfParser rtfParser){
		super(rtfParser, "charscalex", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
