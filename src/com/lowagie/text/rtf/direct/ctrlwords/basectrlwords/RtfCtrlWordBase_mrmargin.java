...
public class RtfCtrlWordBase_mrmargin extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mrmargin(RtfParser rtfParser){
		super(rtfParser, "mrmargin", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
