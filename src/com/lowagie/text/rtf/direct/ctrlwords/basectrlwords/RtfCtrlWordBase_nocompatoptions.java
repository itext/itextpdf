...
public class RtfCtrlWordBase_nocompatoptions extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nocompatoptions(RtfParser rtfParser){
		super(rtfParser, "nocompatoptions", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
