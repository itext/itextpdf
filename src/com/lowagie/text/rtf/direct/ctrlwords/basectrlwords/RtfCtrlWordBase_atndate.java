...
public class RtfCtrlWordBase_atndate extends RtfCtrlWordBase {

	public RtfCtrlWordBase_atndate(RtfParser rtfParser){
		super(rtfParser, "atndate", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
