...
public class RtfCtrlWordBase_mvfmf extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mvfmf(RtfParser rtfParser){
		super(rtfParser, "mvfmf", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
