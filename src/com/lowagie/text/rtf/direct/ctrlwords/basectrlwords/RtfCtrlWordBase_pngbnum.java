...
public class RtfCtrlWordBase_pngbnum extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pngbnum(RtfParser rtfParser){
		super(rtfParser, "pngbnum", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
