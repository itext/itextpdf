...
public class RtfCtrlWordBase_saftnndbnumd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnndbnumd(RtfParser rtfParser){
		super(rtfParser, "saftnndbnumd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
