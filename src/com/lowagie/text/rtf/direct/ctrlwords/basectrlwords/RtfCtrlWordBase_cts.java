...
public class RtfCtrlWordBase_cts extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cts(RtfParser rtfParser){
		super(rtfParser, "cts", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
