...
public class RtfCtrlWordBase_sftnndbnumd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnndbnumd(RtfParser rtfParser){
		super(rtfParser, "sftnndbnumd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
