...
public class RtfCtrlWordBase_affixed extends RtfCtrlWordBase {

	public RtfCtrlWordBase_affixed(RtfParser rtfParser){
		super(rtfParser, "affixed", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
