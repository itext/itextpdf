...
public class RtfCtrlWordBase_chbgdkbdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chbgdkbdiag(RtfParser rtfParser){
		super(rtfParser, "chbgdkbdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
