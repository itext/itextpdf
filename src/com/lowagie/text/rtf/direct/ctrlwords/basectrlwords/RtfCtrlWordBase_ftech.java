...
public class RtfCtrlWordBase_ftech extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftech(RtfParser rtfParser){
		super(rtfParser, "ftech", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
