...
public class RtfCtrlWordBase_ulth extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ulth(RtfParser rtfParser){
		super(rtfParser, "ulth", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
