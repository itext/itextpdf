...
public class RtfCtrlWordBase_itap extends RtfCtrlWordBase {

	public RtfCtrlWordBase_itap(RtfParser rtfParser){
		super(rtfParser, "itap", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
