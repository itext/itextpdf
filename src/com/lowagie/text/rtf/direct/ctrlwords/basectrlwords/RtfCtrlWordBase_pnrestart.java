...
public class RtfCtrlWordBase_pnrestart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnrestart(RtfParser rtfParser){
		super(rtfParser, "pnrestart", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
