...
public class RtfCtrlWordBase_li extends RtfCtrlWordBase {

	public RtfCtrlWordBase_li(RtfParser rtfParser){
		super(rtfParser, "li", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
