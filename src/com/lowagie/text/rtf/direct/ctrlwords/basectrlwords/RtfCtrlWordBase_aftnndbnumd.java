...
public class RtfCtrlWordBase_aftnndbnumd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnndbnumd(RtfParser rtfParser){
		super(rtfParser, "aftnndbnumd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
