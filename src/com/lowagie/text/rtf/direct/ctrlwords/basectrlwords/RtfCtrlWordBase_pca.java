...
public class RtfCtrlWordBase_pca extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pca(RtfParser rtfParser){
		super(rtfParser, "pca", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
