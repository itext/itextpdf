...
public class RtfCtrlWordBase_nogrowautofit extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nogrowautofit(RtfParser rtfParser){
		super(rtfParser, "nogrowautofit", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
