...
public class RtfCtrlWordBase_uldash extends RtfCtrlWordBase {

	public RtfCtrlWordBase_uldash(RtfParser rtfParser){
		super(rtfParser, "uldash", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
