...
public class RtfCtrlWordBase_sectunlocked extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sectunlocked(RtfParser rtfParser){
		super(rtfParser, "sectunlocked", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
