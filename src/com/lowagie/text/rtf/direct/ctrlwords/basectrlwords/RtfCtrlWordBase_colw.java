...
public class RtfCtrlWordBase_colw extends RtfCtrlWordBase {

	public RtfCtrlWordBase_colw(RtfParser rtfParser){
		super(rtfParser, "colw", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
