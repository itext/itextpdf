...
public class RtfCtrlWordBase_dparc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dparc(RtfParser rtfParser){
		super(rtfParser, "dparc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
