...
public class RtfCtrlWordBase_objcropb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objcropb(RtfParser rtfParser){
		super(rtfParser, "objcropb", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
