...
public class RtfCtrlWordBase_tposnegy extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tposnegy(RtfParser rtfParser){
		super(rtfParser, "tposnegy", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
