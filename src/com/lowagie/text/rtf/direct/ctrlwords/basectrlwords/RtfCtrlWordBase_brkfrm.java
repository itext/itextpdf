...
public class RtfCtrlWordBase_brkfrm extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brkfrm(RtfParser rtfParser){
		super(rtfParser, "brkfrm", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
