...
public class RtfCtrlWordBase_mmfttypeaddress extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmfttypeaddress(RtfParser rtfParser){
		super(rtfParser, "mmfttypeaddress", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
