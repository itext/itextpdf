...
public class RtfCtrlWordBase_aspalpha extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aspalpha(RtfParser rtfParser){
		super(rtfParser, "aspalpha", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
