...
public class RtfCtrlWordBase_objalias extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objalias(RtfParser rtfParser){
		super(rtfParser, "objalias", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
