...
public class RtfCtrlWordBase_sb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sb(RtfParser rtfParser){
		super(rtfParser, "sb", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
