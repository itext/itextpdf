...
public class RtfCtrlWordBase_softpage extends RtfCtrlWordBase {

	public RtfCtrlWordBase_softpage(RtfParser rtfParser){
		super(rtfParser, "softpage", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
