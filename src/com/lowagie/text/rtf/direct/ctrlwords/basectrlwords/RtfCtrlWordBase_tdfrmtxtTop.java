...
public class RtfCtrlWordBase_tdfrmtxtTop extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tdfrmtxtTop(RtfParser rtfParser){
		super(rtfParser, "tdfrmtxtTop", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
