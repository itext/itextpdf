...
public class RtfCtrlWordBase_fldalt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fldalt(RtfParser rtfParser){
		super(rtfParser, "fldalt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
