...
public class RtfCtrlWordBase_aftnnrlc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnnrlc(RtfParser rtfParser){
		super(rtfParser, "aftnnrlc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
