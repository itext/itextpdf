...
public class RtfCtrlWordBase_ulthd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ulthd(RtfParser rtfParser){
		super(rtfParser, "ulthd", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
