...
public class RtfCtrlWordBase_tsbgdkbdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsbgdkbdiag(RtfParser rtfParser){
		super(rtfParser, "tsbgdkbdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
