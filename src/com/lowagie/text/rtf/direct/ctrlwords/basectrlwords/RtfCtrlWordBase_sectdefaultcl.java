...
public class RtfCtrlWordBase_sectdefaultcl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sectdefaultcl(RtfParser rtfParser){
		super(rtfParser, "sectdefaultcl", 0, false, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
