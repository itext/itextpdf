...
public class RtfCtrlWordBase_dgsnap extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dgsnap(RtfParser rtfParser){
		super(rtfParser, "dgsnap", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
