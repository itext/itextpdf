...
public class RtfCtrlWordBase_qr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_qr(RtfParser rtfParser){
		super(rtfParser, "qr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
