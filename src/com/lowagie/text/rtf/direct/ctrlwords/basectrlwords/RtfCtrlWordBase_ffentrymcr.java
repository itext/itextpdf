...
public class RtfCtrlWordBase_ffentrymcr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ffentrymcr(RtfParser rtfParser){
		super(rtfParser, "ffentrymcr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
