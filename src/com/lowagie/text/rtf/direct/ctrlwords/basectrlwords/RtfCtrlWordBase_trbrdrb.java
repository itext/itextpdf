...
public class RtfCtrlWordBase_trbrdrb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trbrdrb(RtfParser rtfParser){
		super(rtfParser, "trbrdrb", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
