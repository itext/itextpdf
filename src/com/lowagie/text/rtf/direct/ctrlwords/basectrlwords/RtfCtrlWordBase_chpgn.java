...
public class RtfCtrlWordBase_chpgn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chpgn(RtfParser rtfParser){
		super(rtfParser, "chpgn", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
