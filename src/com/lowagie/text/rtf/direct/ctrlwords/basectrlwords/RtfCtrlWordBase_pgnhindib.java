...
public class RtfCtrlWordBase_pgnhindib extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnhindib(RtfParser rtfParser){
		super(rtfParser, "pgnhindib", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
