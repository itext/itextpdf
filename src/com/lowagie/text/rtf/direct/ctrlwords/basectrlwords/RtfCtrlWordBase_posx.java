...
public class RtfCtrlWordBase_posx extends RtfCtrlWordBase {

	public RtfCtrlWordBase_posx(RtfParser rtfParser){
		super(rtfParser, "posx", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
