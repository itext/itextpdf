...
public class RtfCtrlWordBase_shp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shp(RtfParser rtfParser){
		super(rtfParser, "shp", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
