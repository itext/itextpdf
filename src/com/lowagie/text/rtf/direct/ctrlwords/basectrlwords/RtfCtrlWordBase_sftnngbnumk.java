...
public class RtfCtrlWordBase_sftnngbnumk extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnngbnumk(RtfParser rtfParser){
		super(rtfParser, "sftnngbnumk", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
