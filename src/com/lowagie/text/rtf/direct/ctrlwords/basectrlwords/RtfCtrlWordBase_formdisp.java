...
public class RtfCtrlWordBase_formdisp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_formdisp(RtfParser rtfParser){
		super(rtfParser, "formdisp", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
