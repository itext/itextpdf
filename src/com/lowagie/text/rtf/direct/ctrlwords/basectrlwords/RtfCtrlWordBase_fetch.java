...
public class RtfCtrlWordBase_fetch extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fetch(RtfParser rtfParser){
		super(rtfParser, "fetch", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
