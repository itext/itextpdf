...
public class RtfCtrlWordBase_rtf extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rtf(RtfParser rtfParser){
		super(rtfParser, "rtf", 1, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
