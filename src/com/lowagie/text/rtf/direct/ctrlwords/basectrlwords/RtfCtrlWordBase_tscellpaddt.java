...
public class RtfCtrlWordBase_tscellpaddt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscellpaddt(RtfParser rtfParser){
		super(rtfParser, "tscellpaddt", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
