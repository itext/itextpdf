...
public class RtfCtrlWordBase_nolead extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nolead(RtfParser rtfParser){
		super(rtfParser, "nolead", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
