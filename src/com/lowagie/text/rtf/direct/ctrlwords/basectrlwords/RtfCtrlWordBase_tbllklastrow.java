...
public class RtfCtrlWordBase_tbllklastrow extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tbllklastrow(RtfParser rtfParser){
		super(rtfParser, "tbllklastrow", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
