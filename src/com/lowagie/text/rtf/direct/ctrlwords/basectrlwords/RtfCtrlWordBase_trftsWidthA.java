...
public class RtfCtrlWordBase_trftsWidthA extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trftsWidthA(RtfParser rtfParser){
		super(rtfParser, "trftsWidthA", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
