...
public class RtfCtrlWordBase_ftnngbnuml extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnngbnuml(RtfParser rtfParser){
		super(rtfParser, "ftnngbnuml", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
