...
public class RtfCtrlWordBase_dplinecog extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dplinecog(RtfParser rtfParser){
		super(rtfParser, "dplinecog", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
