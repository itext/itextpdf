...
public class RtfCtrlWordBase_trbgdkhor extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trbgdkhor(RtfParser rtfParser){
		super(rtfParser, "trbgdkhor", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
