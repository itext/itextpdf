...
/**
 * Description:
 * 	The base address that is used for the path of all relative
 * 	hyperlinks inserted in the document. This can be a path or
 * 	an Internet address (URL).
 * 	users referenced during
 * 	document protection.
 * Group:
 * 	Information Group
 * Type:
...
public class RtfCtrlWordBase_hlinkbase extends RtfCtrlWordBase {

	public RtfCtrlWordBase_hlinkbase(RtfParser rtfParser){
		super(rtfParser, "hlinkbase", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
