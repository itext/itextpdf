...
public class RtfCtrlWordBase_ftnnzodiacd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnnzodiacd(RtfParser rtfParser){
		super(rtfParser, "ftnnzodiacd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
