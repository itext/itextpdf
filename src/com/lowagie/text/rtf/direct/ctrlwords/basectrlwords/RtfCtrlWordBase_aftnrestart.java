...
public class RtfCtrlWordBase_aftnrestart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnrestart(RtfParser rtfParser){
		super(rtfParser, "aftnrestart", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
