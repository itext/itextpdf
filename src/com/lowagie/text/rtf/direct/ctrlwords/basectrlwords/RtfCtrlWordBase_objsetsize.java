...
public class RtfCtrlWordBase_objsetsize extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objsetsize(RtfParser rtfParser){
		super(rtfParser, "objsetsize", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
