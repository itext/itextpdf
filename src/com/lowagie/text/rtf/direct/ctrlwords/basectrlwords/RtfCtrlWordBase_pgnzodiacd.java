...
public class RtfCtrlWordBase_pgnzodiacd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnzodiacd(RtfParser rtfParser){
		super(rtfParser, "pgnzodiacd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
