...
public class RtfCtrlWordBase_aftnnzodiacd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnnzodiacd(RtfParser rtfParser){
		super(rtfParser, "aftnnzodiacd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
