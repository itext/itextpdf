...
public class RtfCtrlWordBase_tbllklastcol extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tbllklastcol(RtfParser rtfParser){
		super(rtfParser, "tbllklastcol", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
