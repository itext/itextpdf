...
public class RtfCtrlWordBase_tscellwidthfts extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscellwidthfts(RtfParser rtfParser){
		super(rtfParser, "tscellwidthfts", 0, true, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
