...
public class RtfCtrlWordBase_tsbrdrr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsbrdrr(RtfParser rtfParser){
		super(rtfParser, "tsbrdrr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
