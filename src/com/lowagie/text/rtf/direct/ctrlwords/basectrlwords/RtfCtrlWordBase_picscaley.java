...
public class RtfCtrlWordBase_picscaley extends RtfCtrlWordBase {

	public RtfCtrlWordBase_picscaley(RtfParser rtfParser){
		super(rtfParser, "picscaley", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
