...
public class RtfCtrlWordBase_felnbrelev extends RtfCtrlWordBase {

	public RtfCtrlWordBase_felnbrelev(RtfParser rtfParser){
		super(rtfParser, "felnbrelev", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
