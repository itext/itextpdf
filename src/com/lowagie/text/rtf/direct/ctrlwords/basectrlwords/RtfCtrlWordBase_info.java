...
public class RtfCtrlWordBase_info extends RtfCtrlWordBase {

	public RtfCtrlWordBase_info(RtfParser rtfParser){
		super(rtfParser, "info", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
