...
public class RtfCtrlWordBase_listpicture extends RtfCtrlWordBase {

	public RtfCtrlWordBase_listpicture(RtfParser rtfParser){
		super(rtfParser, "listpicture", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
