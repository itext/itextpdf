...
public class RtfCtrlWordBase_mmfttypenull extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmfttypenull(RtfParser rtfParser){
		super(rtfParser, "mmfttypenull", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
