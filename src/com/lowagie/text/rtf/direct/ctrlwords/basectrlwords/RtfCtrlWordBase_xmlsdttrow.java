...
public class RtfCtrlWordBase_xmlsdttrow extends RtfCtrlWordBase {

	public RtfCtrlWordBase_xmlsdttrow(RtfParser rtfParser){
		super(rtfParser, "xmlsdttrow", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
