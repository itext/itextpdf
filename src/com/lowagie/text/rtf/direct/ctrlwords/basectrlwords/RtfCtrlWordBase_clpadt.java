...
public class RtfCtrlWordBase_clpadt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clpadt(RtfParser rtfParser){
		super(rtfParser, "clpadt", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
