...
public class RtfCtrlWordBase_trwWidthB extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trwWidthB(RtfParser rtfParser){
		super(rtfParser, "trwWidthB", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
