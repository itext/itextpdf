...
public class RtfCtrlWordBase_time extends RtfCtrlWordBase {

	public RtfCtrlWordBase_time(RtfParser rtfParser){
		super(rtfParser, "time", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
