...
public class RtfCtrlWordBase_tsbgdkdcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsbgdkdcross(RtfParser rtfParser){
		super(rtfParser, "tsbgdkdcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
