...
public class RtfCtrlWordBase_ssemihidden extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ssemihidden(RtfParser rtfParser){
		super(rtfParser, "ssemihidden", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
