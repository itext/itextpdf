...
public class RtfCtrlWordBase_revised extends RtfCtrlWordBase {

	public RtfCtrlWordBase_revised(RtfParser rtfParser){
		super(rtfParser, "revised", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
