...
public class RtfCtrlWordBase_mpostsp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mpostsp(RtfParser rtfParser){
		super(rtfParser, "mpostsp", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
