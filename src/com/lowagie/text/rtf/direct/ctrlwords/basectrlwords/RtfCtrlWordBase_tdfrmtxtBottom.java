...
public class RtfCtrlWordBase_tdfrmtxtBottom extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tdfrmtxtBottom(RtfParser rtfParser){
		super(rtfParser, "tdfrmtxtBottom", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
