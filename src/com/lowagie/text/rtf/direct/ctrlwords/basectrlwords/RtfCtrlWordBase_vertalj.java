...
public class RtfCtrlWordBase_vertalj extends RtfCtrlWordBase {

	public RtfCtrlWordBase_vertalj(RtfParser rtfParser){
		super(rtfParser, "vertalj", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
