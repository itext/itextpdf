...
public class RtfCtrlWordBase_trleft extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trleft(RtfParser rtfParser){
		super(rtfParser, "trleft", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
