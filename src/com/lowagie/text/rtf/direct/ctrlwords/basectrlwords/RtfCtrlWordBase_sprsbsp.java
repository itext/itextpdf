...
public class RtfCtrlWordBase_sprsbsp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sprsbsp(RtfParser rtfParser){
		super(rtfParser, "sprsbsp", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
