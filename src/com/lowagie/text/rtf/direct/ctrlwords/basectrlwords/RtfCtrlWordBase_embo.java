...
public class RtfCtrlWordBase_embo extends RtfCtrlWordBase {

	public RtfCtrlWordBase_embo(RtfParser rtfParser){
		super(rtfParser, "embo", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
