...
public class RtfCtrlWordBase_bgdkfdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bgdkfdiag(RtfParser rtfParser){
		super(rtfParser, "bgdkfdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
