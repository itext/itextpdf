...
public class RtfCtrlWordBase_dpcoborder extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpcoborder(RtfParser rtfParser){
		super(rtfParser, "dpcoborder", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
