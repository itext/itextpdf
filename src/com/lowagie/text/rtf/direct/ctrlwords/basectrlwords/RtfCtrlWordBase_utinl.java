...
public class RtfCtrlWordBase_utinl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_utinl(RtfParser rtfParser){
		super(rtfParser, "utinl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
