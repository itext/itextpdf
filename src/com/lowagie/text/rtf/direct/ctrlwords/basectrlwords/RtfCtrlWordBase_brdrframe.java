...
public class RtfCtrlWordBase_brdrframe extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrframe(RtfParser rtfParser){
		super(rtfParser, "brdrframe", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
