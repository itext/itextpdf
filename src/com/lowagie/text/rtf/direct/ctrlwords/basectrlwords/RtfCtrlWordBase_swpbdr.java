...
public class RtfCtrlWordBase_swpbdr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_swpbdr(RtfParser rtfParser){
		super(rtfParser, "swpbdr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
