...
public class RtfCtrlWordBase_sect extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sect(RtfParser rtfParser){
		super(rtfParser, "sect", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
