...
public class RtfCtrlWordBase_mlimupp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mlimupp(RtfParser rtfParser){
		super(rtfParser, "mlimupp", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
