...
public class RtfCtrlWordBase_fet extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fet(RtfParser rtfParser){
		super(rtfParser, "fet", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
