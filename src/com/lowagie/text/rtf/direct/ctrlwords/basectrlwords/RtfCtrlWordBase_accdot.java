...
public class RtfCtrlWordBase_accdot extends RtfCtrlWordBase {

	public RtfCtrlWordBase_accdot(RtfParser rtfParser){
		super(rtfParser, "accdot", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
