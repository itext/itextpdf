...
public class RtfCtrlWordBase_ffhelptext extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ffhelptext(RtfParser rtfParser){
		super(rtfParser, "ffhelptext", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
