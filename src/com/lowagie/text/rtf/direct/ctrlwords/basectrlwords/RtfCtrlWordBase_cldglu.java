...
public class RtfCtrlWordBase_cldglu extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cldglu(RtfParser rtfParser){
		super(rtfParser, "cldglu", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
