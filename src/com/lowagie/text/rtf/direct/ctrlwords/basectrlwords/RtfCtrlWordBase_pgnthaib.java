...
public class RtfCtrlWordBase_pgnthaib extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnthaib(RtfParser rtfParser){
		super(rtfParser, "pgnthaib", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
