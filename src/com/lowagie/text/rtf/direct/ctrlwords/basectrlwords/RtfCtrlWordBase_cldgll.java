...
public class RtfCtrlWordBase_cldgll extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cldgll(RtfParser rtfParser){
		super(rtfParser, "cldgll", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
