...
public class RtfCtrlWordBase_brdrdashdotstr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrdashdotstr(RtfParser rtfParser){
		super(rtfParser, "brdrdashdotstr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
