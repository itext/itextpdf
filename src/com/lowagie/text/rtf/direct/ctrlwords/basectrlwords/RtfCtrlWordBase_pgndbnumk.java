...
public class RtfCtrlWordBase_pgndbnumk extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgndbnumk(RtfParser rtfParser){
		super(rtfParser, "pgndbnumk", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
