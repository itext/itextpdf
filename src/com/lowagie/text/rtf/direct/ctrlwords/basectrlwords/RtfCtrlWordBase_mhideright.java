...
public class RtfCtrlWordBase_mhideright extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mhideright(RtfParser rtfParser){
		super(rtfParser, "mhideright", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
