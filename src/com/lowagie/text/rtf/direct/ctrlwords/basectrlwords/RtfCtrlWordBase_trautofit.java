...
public class RtfCtrlWordBase_trautofit extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trautofit(RtfParser rtfParser){
		super(rtfParser, "trautofit", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
