...
public class RtfCtrlWordBase_viewzk extends RtfCtrlWordBase {

	public RtfCtrlWordBase_viewzk(RtfParser rtfParser){
		super(rtfParser, "viewzk", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
