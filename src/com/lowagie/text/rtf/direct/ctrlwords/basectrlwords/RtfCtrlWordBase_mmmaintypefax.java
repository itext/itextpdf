...
public class RtfCtrlWordBase_mmmaintypefax extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmmaintypefax(RtfParser rtfParser){
		super(rtfParser, "mmmaintypefax", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
