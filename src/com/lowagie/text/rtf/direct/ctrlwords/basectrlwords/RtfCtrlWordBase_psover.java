...
public class RtfCtrlWordBase_psover extends RtfCtrlWordBase {

	public RtfCtrlWordBase_psover(RtfParser rtfParser){
		super(rtfParser, "psover", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
