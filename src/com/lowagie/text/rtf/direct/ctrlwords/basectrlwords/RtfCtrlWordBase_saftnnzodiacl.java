...
public class RtfCtrlWordBase_saftnnzodiacl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnnzodiacl(RtfParser rtfParser){
		super(rtfParser, "saftnnzodiacl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
