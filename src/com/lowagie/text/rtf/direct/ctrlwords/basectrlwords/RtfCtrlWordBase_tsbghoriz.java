...
public class RtfCtrlWordBase_tsbghoriz extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsbghoriz(RtfParser rtfParser){
		super(rtfParser, "tsbghoriz", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
