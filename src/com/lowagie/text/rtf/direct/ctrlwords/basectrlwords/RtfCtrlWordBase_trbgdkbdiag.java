...
public class RtfCtrlWordBase_trbgdkbdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trbgdkbdiag(RtfParser rtfParser){
		super(rtfParser, "trbgdkbdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
