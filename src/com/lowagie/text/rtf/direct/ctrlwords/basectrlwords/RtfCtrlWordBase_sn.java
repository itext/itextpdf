...
public class RtfCtrlWordBase_sn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sn(RtfParser rtfParser){
		super(rtfParser, "sn", 0, false, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
