...
public class RtfCtrlWordBase_nonesttables extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nonesttables(RtfParser rtfParser){
		super(rtfParser, "nonesttables", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
