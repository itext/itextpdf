...
public class RtfCtrlWordBase_softcol extends RtfCtrlWordBase {

	public RtfCtrlWordBase_softcol(RtfParser rtfParser){
		super(rtfParser, "softcol", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
