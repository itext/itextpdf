...
public class RtfCtrlWordBase_dpastartl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpastartl(RtfParser rtfParser){
		super(rtfParser, "dpastartl", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
