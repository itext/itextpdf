...
public class RtfCtrlWordBase_bgdkdcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bgdkdcross(RtfParser rtfParser){
		super(rtfParser, "bgdkdcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
