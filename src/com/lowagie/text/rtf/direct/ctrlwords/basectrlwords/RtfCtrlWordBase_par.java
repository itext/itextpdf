...
public class RtfCtrlWordBase_par extends RtfCtrlWordBase {

	public RtfCtrlWordBase_par(RtfParser rtfParser){
		super(rtfParser, "par", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
