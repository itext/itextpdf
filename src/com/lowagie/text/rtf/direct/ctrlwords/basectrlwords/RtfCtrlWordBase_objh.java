...
public class RtfCtrlWordBase_objh extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objh(RtfParser rtfParser){
		super(rtfParser, "objh", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
