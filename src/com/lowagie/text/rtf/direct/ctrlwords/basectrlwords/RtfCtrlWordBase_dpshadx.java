...
public class RtfCtrlWordBase_dpshadx extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpshadx(RtfParser rtfParser){
		super(rtfParser, "dpshadx", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
