...
public class RtfCtrlWordBase_pmmetafile extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pmmetafile(RtfParser rtfParser){
		super(rtfParser, "pmmetafile", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
