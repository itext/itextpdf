...
public class RtfCtrlWordBase_pgbrdrfoot extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgbrdrfoot(RtfParser rtfParser){
		super(rtfParser, "pgbrdrfoot", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
