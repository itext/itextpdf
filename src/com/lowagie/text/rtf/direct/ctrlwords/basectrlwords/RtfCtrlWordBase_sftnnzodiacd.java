...
public class RtfCtrlWordBase_sftnnzodiacd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnnzodiacd(RtfParser rtfParser){
		super(rtfParser, "sftnnzodiacd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
