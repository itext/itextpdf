...
public class RtfCtrlWordBase_dpellipse extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpellipse(RtfParser rtfParser){
		super(rtfParser, "dpellipse", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
