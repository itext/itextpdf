...
public class RtfCtrlWordBase_dpx extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpx(RtfParser rtfParser){
		super(rtfParser, "dpx", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
