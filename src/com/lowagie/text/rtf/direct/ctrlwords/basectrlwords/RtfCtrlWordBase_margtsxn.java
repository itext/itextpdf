...
public class RtfCtrlWordBase_margtsxn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_margtsxn(RtfParser rtfParser){
		super(rtfParser, "margtsxn", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
