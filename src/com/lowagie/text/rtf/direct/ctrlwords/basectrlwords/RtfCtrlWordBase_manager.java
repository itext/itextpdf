...
public class RtfCtrlWordBase_manager extends RtfCtrlWordBase {

	public RtfCtrlWordBase_manager(RtfParser rtfParser){
		super(rtfParser, "manager", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
