...
public class RtfCtrlWordBase_saftnrstcont extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnrstcont(RtfParser rtfParser){
		super(rtfParser, "saftnrstcont", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
