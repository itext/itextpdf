...
public class RtfCtrlWordBase_posyil extends RtfCtrlWordBase {

	public RtfCtrlWordBase_posyil(RtfParser rtfParser){
		super(rtfParser, "posyil", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
