...
public class RtfCtrlWordBase_qmspace extends RtfCtrlWordBase {

	public RtfCtrlWordBase_qmspace(RtfParser rtfParser){
		super(rtfParser, "qmspace", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
