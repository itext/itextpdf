...
public class RtfCtrlWordBase_rtlch extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rtlch(RtfParser rtfParser){
		super(rtfParser, "rtlch", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
