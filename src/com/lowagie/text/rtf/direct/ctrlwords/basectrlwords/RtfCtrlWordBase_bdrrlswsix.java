...
public class RtfCtrlWordBase_bdrrlswsix extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bdrrlswsix(RtfParser rtfParser){
		super(rtfParser, "bdrrlswsix", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
