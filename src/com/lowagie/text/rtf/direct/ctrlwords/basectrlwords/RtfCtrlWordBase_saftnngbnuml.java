...
public class RtfCtrlWordBase_saftnngbnuml extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnngbnuml(RtfParser rtfParser){
		super(rtfParser, "saftnngbnuml", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
