...
public class RtfCtrlWordBase_wrapthrough extends RtfCtrlWordBase {

	public RtfCtrlWordBase_wrapthrough(RtfParser rtfParser){
		super(rtfParser, "wrapthrough", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
