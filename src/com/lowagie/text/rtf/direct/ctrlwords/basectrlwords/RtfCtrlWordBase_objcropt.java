...
public class RtfCtrlWordBase_objcropt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objcropt(RtfParser rtfParser){
		super(rtfParser, "objcropt", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
