...
public class RtfCtrlWordBase_clbrdrr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clbrdrr(RtfParser rtfParser){
		super(rtfParser, "clbrdrr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
