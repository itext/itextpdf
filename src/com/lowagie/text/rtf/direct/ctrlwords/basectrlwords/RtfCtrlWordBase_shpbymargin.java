...
public class RtfCtrlWordBase_shpbymargin extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shpbymargin(RtfParser rtfParser){
		super(rtfParser, "shpbymargin", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
