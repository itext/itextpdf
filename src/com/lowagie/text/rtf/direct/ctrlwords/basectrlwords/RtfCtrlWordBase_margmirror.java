...
public class RtfCtrlWordBase_margmirror extends RtfCtrlWordBase {

	public RtfCtrlWordBase_margmirror(RtfParser rtfParser){
		super(rtfParser, "margmirror", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
