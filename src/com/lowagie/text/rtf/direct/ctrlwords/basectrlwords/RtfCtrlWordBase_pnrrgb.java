...
public class RtfCtrlWordBase_pnrrgb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnrrgb(RtfParser rtfParser){
		super(rtfParser, "pnrrgb", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
