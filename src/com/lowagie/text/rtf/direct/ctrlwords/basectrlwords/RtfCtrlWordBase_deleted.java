...
public class RtfCtrlWordBase_deleted extends RtfCtrlWordBase {

	public RtfCtrlWordBase_deleted(RtfParser rtfParser){
		super(rtfParser, "deleted", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
