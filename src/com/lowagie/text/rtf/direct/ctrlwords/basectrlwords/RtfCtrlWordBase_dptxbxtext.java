...
public class RtfCtrlWordBase_dptxbxtext extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dptxbxtext(RtfParser rtfParser){
		super(rtfParser, "dptxbxtext", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
