...
public class RtfCtrlWordBase_aftnrstcont extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnrstcont(RtfParser rtfParser){
		super(rtfParser, "aftnrstcont", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
