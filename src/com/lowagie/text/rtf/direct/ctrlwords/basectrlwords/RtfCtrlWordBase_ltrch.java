...
public class RtfCtrlWordBase_ltrch extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ltrch(RtfParser rtfParser){
		super(rtfParser, "ltrch", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
