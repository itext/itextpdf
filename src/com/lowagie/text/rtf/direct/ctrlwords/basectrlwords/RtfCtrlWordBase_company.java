...
public class RtfCtrlWordBase_company extends RtfCtrlWordBase {

	public RtfCtrlWordBase_company(RtfParser rtfParser){
		super(rtfParser, "company", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
