...
public class RtfCtrlWordBase_ulthdashdd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ulthdashdd(RtfParser rtfParser){
		super(rtfParser, "ulthdashdd", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
