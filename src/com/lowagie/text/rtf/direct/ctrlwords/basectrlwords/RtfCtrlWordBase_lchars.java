...
public class RtfCtrlWordBase_lchars extends RtfCtrlWordBase {

	public RtfCtrlWordBase_lchars(RtfParser rtfParser){
		super(rtfParser, "lchars", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
