...
public class RtfCtrlWordBase_langfenp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_langfenp(RtfParser rtfParser){
		super(rtfParser, "langfenp", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
