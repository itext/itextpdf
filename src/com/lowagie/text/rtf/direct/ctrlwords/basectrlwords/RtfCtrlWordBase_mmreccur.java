...
public class RtfCtrlWordBase_mmreccur extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmreccur(RtfParser rtfParser){
		super(rtfParser, "mmreccur", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
