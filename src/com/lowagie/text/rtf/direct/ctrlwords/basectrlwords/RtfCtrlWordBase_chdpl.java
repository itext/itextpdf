...
public class RtfCtrlWordBase_chdpl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chdpl(RtfParser rtfParser){
		super(rtfParser, "chdpl", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
