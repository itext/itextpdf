...
public class RtfCtrlWordBase_saftnnalc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnnalc(RtfParser rtfParser){
		super(rtfParser, "saftnnalc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
