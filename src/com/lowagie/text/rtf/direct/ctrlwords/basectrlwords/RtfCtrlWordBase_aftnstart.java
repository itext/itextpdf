...
public class RtfCtrlWordBase_aftnstart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnstart(RtfParser rtfParser){
		super(rtfParser, "aftnstart", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
