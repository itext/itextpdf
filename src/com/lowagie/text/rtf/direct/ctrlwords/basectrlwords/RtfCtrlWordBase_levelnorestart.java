...
/**
 * Description:
 * 	1 if this level does not restart its count each time a super
 * 	ordinate level is incremented; 0 if this level does restart
 * 	its count each time a super ordinate level is incremented.
 * Group:
 * 	List Table
 * Type:
 * 	Value
...
public class RtfCtrlWordBase_levelnorestart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_levelnorestart(RtfParser rtfParser){
		super(rtfParser, "levelnorestart", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
