...
public class RtfCtrlWordBase_margr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_margr(RtfParser rtfParser){
		super(rtfParser, "margr", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
