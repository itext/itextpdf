...
public class RtfCtrlWordBase_sftnncnum extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnncnum(RtfParser rtfParser){
		super(rtfParser, "sftnncnum", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
