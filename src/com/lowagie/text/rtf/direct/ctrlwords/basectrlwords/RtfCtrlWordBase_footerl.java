...
public class RtfCtrlWordBase_footerl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_footerl(RtfParser rtfParser){
		super(rtfParser, "footerl", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
