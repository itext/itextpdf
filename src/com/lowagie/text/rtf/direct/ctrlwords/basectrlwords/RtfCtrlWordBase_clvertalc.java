...
public class RtfCtrlWordBase_clvertalc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clvertalc(RtfParser rtfParser){
		super(rtfParser, "clvertalc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
