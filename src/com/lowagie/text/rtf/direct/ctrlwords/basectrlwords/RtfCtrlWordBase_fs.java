...
public class RtfCtrlWordBase_fs extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fs(RtfParser rtfParser){
		super(rtfParser, "fs", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
