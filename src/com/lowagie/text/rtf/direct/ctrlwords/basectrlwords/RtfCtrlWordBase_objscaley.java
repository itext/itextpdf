...
public class RtfCtrlWordBase_objscaley extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objscaley(RtfParser rtfParser){
		super(rtfParser, "objscaley", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
