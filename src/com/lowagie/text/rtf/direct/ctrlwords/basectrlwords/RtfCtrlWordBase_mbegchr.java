...
public class RtfCtrlWordBase_mbegchr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mbegchr(RtfParser rtfParser){
		super(rtfParser, "mbegchr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
