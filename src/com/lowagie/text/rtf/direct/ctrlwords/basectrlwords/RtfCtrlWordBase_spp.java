...
public class RtfCtrlWordBase_spp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_spp(RtfParser rtfParser){
		super(rtfParser, "spp", 0, false, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
