...
public class RtfCtrlWordBase_trspdt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trspdt(RtfParser rtfParser){
		super(rtfParser, "trspdt", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
