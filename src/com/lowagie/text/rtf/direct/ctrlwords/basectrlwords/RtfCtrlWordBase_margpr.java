...
public class RtfCtrlWordBase_margpr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_margpr(RtfParser rtfParser){
		super(rtfParser, "margpr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
