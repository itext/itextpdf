...
public class RtfCtrlWordBase_gutterprl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_gutterprl(RtfParser rtfParser){
		super(rtfParser, "gutterprl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
