...
public class RtfCtrlWordBase_adjustright extends RtfCtrlWordBase {

	public RtfCtrlWordBase_adjustright(RtfParser rtfParser){
		super(rtfParser, "adjustright", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
