...
public class RtfCtrlWordBase_bghoriz extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bghoriz(RtfParser rtfParser){
		super(rtfParser, "bghoriz", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
