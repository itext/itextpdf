...
public class RtfCtrlWordBase_posyin extends RtfCtrlWordBase {

	public RtfCtrlWordBase_posyin(RtfParser rtfParser){
		super(rtfParser, "posyin", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
