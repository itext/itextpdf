...
public class RtfCtrlWordBase_dpshadow extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpshadow(RtfParser rtfParser){
		super(rtfParser, "dpshadow", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
