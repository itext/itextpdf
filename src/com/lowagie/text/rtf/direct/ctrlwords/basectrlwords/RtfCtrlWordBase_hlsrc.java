...
public class RtfCtrlWordBase_hlsrc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_hlsrc(RtfParser rtfParser){
		super(rtfParser, "hlsrc", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
