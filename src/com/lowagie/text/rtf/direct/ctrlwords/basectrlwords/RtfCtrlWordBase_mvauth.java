...
public class RtfCtrlWordBase_mvauth extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mvauth(RtfParser rtfParser){
		super(rtfParser, "mvauth", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
