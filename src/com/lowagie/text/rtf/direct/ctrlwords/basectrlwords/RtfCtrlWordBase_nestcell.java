...
public class RtfCtrlWordBase_nestcell extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nestcell(RtfParser rtfParser){
		super(rtfParser, "nestcell", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
