...
public class RtfCtrlWordBase_fswiss extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fswiss(RtfParser rtfParser){
		super(rtfParser, "fswiss", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
