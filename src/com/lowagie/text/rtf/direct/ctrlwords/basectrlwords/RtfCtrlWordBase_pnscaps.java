...
public class RtfCtrlWordBase_pnscaps extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnscaps(RtfParser rtfParser){
		super(rtfParser, "pnscaps", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
