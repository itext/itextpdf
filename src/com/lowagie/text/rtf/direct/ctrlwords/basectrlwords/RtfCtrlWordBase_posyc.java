...
public class RtfCtrlWordBase_posyc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_posyc(RtfParser rtfParser){
		super(rtfParser, "posyc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
