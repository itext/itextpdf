...
public class RtfCtrlWordBase_phpg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_phpg(RtfParser rtfParser){
		super(rtfParser, "phpg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
