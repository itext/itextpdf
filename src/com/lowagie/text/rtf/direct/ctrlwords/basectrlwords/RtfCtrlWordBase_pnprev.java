...
public class RtfCtrlWordBase_pnprev extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnprev(RtfParser rtfParser){
		super(rtfParser, "pnprev", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
