...
public class RtfCtrlWordBase_gridtbl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_gridtbl(RtfParser rtfParser){
		super(rtfParser, "gridtbl", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
