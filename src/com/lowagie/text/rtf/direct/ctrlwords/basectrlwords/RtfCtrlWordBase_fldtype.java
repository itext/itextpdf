...
public class RtfCtrlWordBase_fldtype extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fldtype(RtfParser rtfParser){
		super(rtfParser, "fldtype", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
