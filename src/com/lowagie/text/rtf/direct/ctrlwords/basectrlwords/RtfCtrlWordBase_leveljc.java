...
public class RtfCtrlWordBase_leveljc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_leveljc(RtfParser rtfParser){
		super(rtfParser, "leveljc", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
