...
public class RtfCtrlWordBase_oldlinewrap extends RtfCtrlWordBase {

	public RtfCtrlWordBase_oldlinewrap(RtfParser rtfParser){
		super(rtfParser, "oldlinewrap", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
