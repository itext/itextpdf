...
public class RtfCtrlWordBase_mhidebot extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mhidebot(RtfParser rtfParser){
		super(rtfParser, "mhidebot", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
