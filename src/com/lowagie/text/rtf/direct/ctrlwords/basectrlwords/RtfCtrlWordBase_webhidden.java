...
public class RtfCtrlWordBase_webhidden extends RtfCtrlWordBase {

	public RtfCtrlWordBase_webhidden(RtfParser rtfParser){
		super(rtfParser, "webhidden", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
