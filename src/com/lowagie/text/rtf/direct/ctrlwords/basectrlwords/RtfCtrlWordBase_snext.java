...
/**
 * Description:
 * 	,"Defines the style to be used in the next paragraph after
 * 	the paragraph marked by this style. If it is omitted, the
 * 	next style is the current style.
 * Group:
 * 	Style Sheet
 * Type:
 * 	Value
...
public class RtfCtrlWordBase_snext extends RtfCtrlWordBase {

	public RtfCtrlWordBase_snext(RtfParser rtfParser){
		super(rtfParser, "snext", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
