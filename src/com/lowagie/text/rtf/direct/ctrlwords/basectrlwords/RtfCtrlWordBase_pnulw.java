...
public class RtfCtrlWordBase_pnulw extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnulw(RtfParser rtfParser){
		super(rtfParser, "pnulw", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
