...
public class RtfCtrlWordBase_pgnhindid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnhindid(RtfParser rtfParser){
		super(rtfParser, "pgnhindid", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
