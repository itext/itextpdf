...
public class RtfCtrlWordBase_mmaxdist extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmaxdist(RtfParser rtfParser){
		super(rtfParser, "mmaxdist", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
