...
public class RtfCtrlWordBase_brdrhair extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrhair(RtfParser rtfParser){
		super(rtfParser, "brdrhair", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
