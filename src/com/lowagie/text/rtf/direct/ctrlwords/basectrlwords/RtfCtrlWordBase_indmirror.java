...
public class RtfCtrlWordBase_indmirror extends RtfCtrlWordBase {

	public RtfCtrlWordBase_indmirror(RtfParser rtfParser){
		super(rtfParser, "indmirror", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
