...
public class RtfCtrlWordBase_trbrdrv extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trbrdrv(RtfParser rtfParser){
		super(rtfParser, "trbrdrv", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
