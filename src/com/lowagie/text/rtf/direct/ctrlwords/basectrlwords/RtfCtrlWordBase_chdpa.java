...
public class RtfCtrlWordBase_chdpa extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chdpa(RtfParser rtfParser){
		super(rtfParser, "chdpa", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
