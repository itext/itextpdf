...
public class RtfCtrlWordBase_pgndbnum extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgndbnum(RtfParser rtfParser){
		super(rtfParser, "pgndbnum", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
