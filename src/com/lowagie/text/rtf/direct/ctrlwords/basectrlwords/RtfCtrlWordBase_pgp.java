...
public class RtfCtrlWordBase_pgp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgp(RtfParser rtfParser){
		super(rtfParser, "pgp", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
