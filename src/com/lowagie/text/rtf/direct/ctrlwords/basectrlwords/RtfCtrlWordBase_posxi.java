...
public class RtfCtrlWordBase_posxi extends RtfCtrlWordBase {

	public RtfCtrlWordBase_posxi(RtfParser rtfParser){
		super(rtfParser, "posxi", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
