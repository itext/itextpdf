...
public class RtfCtrlWordBase_sbkodd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sbkodd(RtfParser rtfParser){
		super(rtfParser, "sbkodd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
