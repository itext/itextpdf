...
public class RtfCtrlWordBase_sautoupd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sautoupd(RtfParser rtfParser){
		super(rtfParser, "sautoupd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
