...
public class RtfCtrlWordBase_mmdatatypefile extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmdatatypefile(RtfParser rtfParser){
		super(rtfParser, "mmdatatypefile", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
