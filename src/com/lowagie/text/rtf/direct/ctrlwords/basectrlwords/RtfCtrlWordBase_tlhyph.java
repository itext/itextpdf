...
public class RtfCtrlWordBase_tlhyph extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tlhyph(RtfParser rtfParser){
		super(rtfParser, "tlhyph", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
