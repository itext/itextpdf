...
public class RtfCtrlWordBase_titlepg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_titlepg(RtfParser rtfParser){
		super(rtfParser, "titlepg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
