...
public class RtfCtrlWordBase_up extends RtfCtrlWordBase {

	public RtfCtrlWordBase_up(RtfParser rtfParser){
		super(rtfParser, "up", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
