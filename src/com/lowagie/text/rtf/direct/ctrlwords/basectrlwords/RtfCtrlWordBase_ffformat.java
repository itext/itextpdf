...
public class RtfCtrlWordBase_ffformat extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ffformat(RtfParser rtfParser){
		super(rtfParser, "ffformat", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
