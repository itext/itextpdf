...
public class RtfCtrlWordBase_acccomma extends RtfCtrlWordBase {

	public RtfCtrlWordBase_acccomma(RtfParser rtfParser){
		super(rtfParser, "acccomma", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
