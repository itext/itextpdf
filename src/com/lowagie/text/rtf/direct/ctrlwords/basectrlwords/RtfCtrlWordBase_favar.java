...
public class RtfCtrlWordBase_favar extends RtfCtrlWordBase {

	public RtfCtrlWordBase_favar(RtfParser rtfParser){
		super(rtfParser, "favar", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
