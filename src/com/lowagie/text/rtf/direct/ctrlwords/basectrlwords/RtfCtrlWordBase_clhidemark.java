...
public class RtfCtrlWordBase_clhidemark extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clhidemark(RtfParser rtfParser){
		super(rtfParser, "clhidemark", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
