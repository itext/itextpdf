...
public class RtfCtrlWordBase_msup extends RtfCtrlWordBase {

	public RtfCtrlWordBase_msup(RtfParser rtfParser){
		super(rtfParser, "msup", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
