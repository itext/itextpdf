...
public class RtfCtrlWordBase_pindtabqr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pindtabqr(RtfParser rtfParser){
		super(rtfParser, "pindtabqr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
