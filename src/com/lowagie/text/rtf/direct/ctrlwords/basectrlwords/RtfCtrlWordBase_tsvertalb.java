...
public class RtfCtrlWordBase_tsvertalb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsvertalb(RtfParser rtfParser){
		super(rtfParser, "tsvertalb", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
