...
public class RtfCtrlWordBase_listtable extends RtfCtrlWordBase {

	public RtfCtrlWordBase_listtable(RtfParser rtfParser){
		super(rtfParser, "listtable", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
