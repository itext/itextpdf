...
public class RtfCtrlWordBase_xe extends RtfCtrlWordBase {

	public RtfCtrlWordBase_xe(RtfParser rtfParser){
		super(rtfParser, "xe", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
