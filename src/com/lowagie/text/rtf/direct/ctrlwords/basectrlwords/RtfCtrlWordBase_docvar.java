...
public class RtfCtrlWordBase_docvar extends RtfCtrlWordBase {

	public RtfCtrlWordBase_docvar(RtfParser rtfParser){
		super(rtfParser, "docvar", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
