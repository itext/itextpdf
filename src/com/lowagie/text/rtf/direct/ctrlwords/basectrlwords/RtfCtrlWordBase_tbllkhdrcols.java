...
public class RtfCtrlWordBase_tbllkhdrcols extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tbllkhdrcols(RtfParser rtfParser){
		super(rtfParser, "tbllkhdrcols", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
