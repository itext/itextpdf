...
public class RtfCtrlWordBase_posnegy extends RtfCtrlWordBase {

	public RtfCtrlWordBase_posnegy(RtfParser rtfParser){
		super(rtfParser, "posnegy", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
