...
public class RtfCtrlWordBase_pict extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pict(RtfParser rtfParser){
		super(rtfParser, "pict", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
