...
public class RtfCtrlWordBase_piccropr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_piccropr(RtfParser rtfParser){
		super(rtfParser, "piccropr", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
