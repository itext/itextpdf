...
public class RtfCtrlWordBase_blue extends RtfCtrlWordBase {

	public RtfCtrlWordBase_blue(RtfParser rtfParser){
		super(rtfParser, "blue", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
