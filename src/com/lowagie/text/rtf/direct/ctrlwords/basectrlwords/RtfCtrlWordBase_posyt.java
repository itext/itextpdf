...
public class RtfCtrlWordBase_posyt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_posyt(RtfParser rtfParser){
		super(rtfParser, "posyt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
