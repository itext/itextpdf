...
public class RtfCtrlWordBase_brdrnil extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrnil(RtfParser rtfParser){
		super(rtfParser, "brdrnil", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
