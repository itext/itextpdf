...
public class RtfCtrlWordBase_mstrikev extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mstrikev(RtfParser rtfParser){
		super(rtfParser, "mstrikev", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
