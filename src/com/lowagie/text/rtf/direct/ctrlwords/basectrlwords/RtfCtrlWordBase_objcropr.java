...
public class RtfCtrlWordBase_objcropr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objcropr(RtfParser rtfParser){
		super(rtfParser, "objcropr", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
