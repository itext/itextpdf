...
public class RtfCtrlWordBase_themedata extends RtfCtrlWordBase {

	public RtfCtrlWordBase_themedata(RtfParser rtfParser){
		super(rtfParser, "themedata", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
