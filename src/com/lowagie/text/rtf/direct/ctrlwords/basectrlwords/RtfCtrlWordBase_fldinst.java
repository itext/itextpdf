...
public class RtfCtrlWordBase_fldinst extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fldinst(RtfParser rtfParser){
		super(rtfParser, "fldinst", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
