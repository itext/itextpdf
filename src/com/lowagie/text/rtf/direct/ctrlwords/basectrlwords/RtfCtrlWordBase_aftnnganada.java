...
public class RtfCtrlWordBase_aftnnganada extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnnganada(RtfParser rtfParser){
		super(rtfParser, "aftnnganada", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
