...
public class RtfCtrlWordBase_cltxlrtbv extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cltxlrtbv(RtfParser rtfParser){
		super(rtfParser, "cltxlrtbv", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
