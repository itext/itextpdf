...
public class RtfCtrlWordBase_sftnngbnuml extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnngbnuml(RtfParser rtfParser){
		super(rtfParser, "sftnngbnuml", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
