...
public class RtfCtrlWordBase_tsbgfdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsbgfdiag(RtfParser rtfParser){
		super(rtfParser, "tsbgfdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
