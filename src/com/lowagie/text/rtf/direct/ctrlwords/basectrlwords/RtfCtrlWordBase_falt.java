...
/**
 * Description:
 * 	Indicates alternate font name to use if the specified font
 * 	in the font table is not available. '{' \falt <Alternate
 * 	Font Name>'}'
 * Group:
 * 	Font Table
 * Type:
...
public class RtfCtrlWordBase_falt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_falt(RtfParser rtfParser){
		super(rtfParser, "falt", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
