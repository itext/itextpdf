...
public class RtfCtrlWordBase_saftnnzodiacd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnnzodiacd(RtfParser rtfParser){
		super(rtfParser, "saftnnzodiacd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
