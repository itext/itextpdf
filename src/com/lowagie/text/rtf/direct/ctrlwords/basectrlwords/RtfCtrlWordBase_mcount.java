...
public class RtfCtrlWordBase_mcount extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mcount(RtfParser rtfParser){
		super(rtfParser, "mcount", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
