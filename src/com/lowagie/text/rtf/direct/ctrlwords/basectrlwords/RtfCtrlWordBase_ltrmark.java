...
public class RtfCtrlWordBase_ltrmark extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ltrmark(RtfParser rtfParser){
		super(rtfParser, "ltrmark", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
