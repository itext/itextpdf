...
public class RtfCtrlWordBase_dpendgroup extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpendgroup(RtfParser rtfParser){
		super(rtfParser, "dpendgroup", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
