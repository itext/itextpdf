...
public class RtfCtrlWordBase_pagebb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pagebb(RtfParser rtfParser){
		super(rtfParser, "pagebb", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
