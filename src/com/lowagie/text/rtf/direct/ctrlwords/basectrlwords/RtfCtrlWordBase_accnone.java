...
public class RtfCtrlWordBase_accnone extends RtfCtrlWordBase {

	public RtfCtrlWordBase_accnone(RtfParser rtfParser){
		super(rtfParser, "accnone", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
