...
public class RtfCtrlWordBase_htmlbase extends RtfCtrlWordBase {

	public RtfCtrlWordBase_htmlbase(RtfParser rtfParser){
		super(rtfParser, "htmlbase", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
