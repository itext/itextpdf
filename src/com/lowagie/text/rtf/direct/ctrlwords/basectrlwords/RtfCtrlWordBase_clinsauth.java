...
public class RtfCtrlWordBase_clinsauth extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clinsauth(RtfParser rtfParser){
		super(rtfParser, "clinsauth", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
