...
public class RtfCtrlWordBase_brdrwavydb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrwavydb(RtfParser rtfParser){
		super(rtfParser, "brdrwavydb", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
