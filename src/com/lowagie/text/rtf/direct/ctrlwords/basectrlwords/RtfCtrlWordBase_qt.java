...
public class RtfCtrlWordBase_qt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_qt(RtfParser rtfParser){
		super(rtfParser, "qt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
