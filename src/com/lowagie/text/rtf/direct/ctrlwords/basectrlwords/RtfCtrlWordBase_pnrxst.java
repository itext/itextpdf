...
public class RtfCtrlWordBase_pnrxst extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnrxst(RtfParser rtfParser){
		super(rtfParser, "pnrxst", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
