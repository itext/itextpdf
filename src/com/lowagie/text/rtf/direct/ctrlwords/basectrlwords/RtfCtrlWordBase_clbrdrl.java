...
public class RtfCtrlWordBase_clbrdrl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clbrdrl(RtfParser rtfParser){
		super(rtfParser, "clbrdrl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
