...
public class RtfCtrlWordBase_dpcodbottom extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpcodbottom(RtfParser rtfParser){
		super(rtfParser, "dpcodbottom", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
