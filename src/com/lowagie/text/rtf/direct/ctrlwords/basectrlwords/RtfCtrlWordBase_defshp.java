...
public class RtfCtrlWordBase_defshp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_defshp(RtfParser rtfParser){
		super(rtfParser, "defshp", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
