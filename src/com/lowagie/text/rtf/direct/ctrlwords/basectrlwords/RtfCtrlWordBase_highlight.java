...
public class RtfCtrlWordBase_highlight extends RtfCtrlWordBase {

	public RtfCtrlWordBase_highlight(RtfParser rtfParser){
		super(rtfParser, "highlight", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
