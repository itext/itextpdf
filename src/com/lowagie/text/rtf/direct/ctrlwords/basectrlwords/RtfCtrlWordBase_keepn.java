...
public class RtfCtrlWordBase_keepn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_keepn(RtfParser rtfParser){
		super(rtfParser, "keepn", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
