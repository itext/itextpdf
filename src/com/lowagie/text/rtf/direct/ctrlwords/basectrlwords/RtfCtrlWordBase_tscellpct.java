...
/**
 * Description:
 * 	Cell shading percentage ? N is the shading of a table cell
...
public class RtfCtrlWordBase_tscellpct extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscellpct(RtfParser rtfParser){
		super(rtfParser, "tscellpct", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
