...
public class RtfCtrlWordBase_mvdate extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mvdate(RtfParser rtfParser){
		super(rtfParser, "mvdate", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
