...
public class RtfCtrlWordBase_saftnnzodiac extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnnzodiac(RtfParser rtfParser){
		super(rtfParser, "saftnnzodiac", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
