...
public class RtfCtrlWordBase_formshade extends RtfCtrlWordBase {

	public RtfCtrlWordBase_formshade(RtfParser rtfParser){
		super(rtfParser, "formshade", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
