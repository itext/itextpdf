...
public class RtfCtrlWordBase_brdrengrave extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrengrave(RtfParser rtfParser){
		super(rtfParser, "brdrengrave", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
