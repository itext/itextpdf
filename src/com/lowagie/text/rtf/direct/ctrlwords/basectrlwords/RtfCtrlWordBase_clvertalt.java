...
public class RtfCtrlWordBase_clvertalt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clvertalt(RtfParser rtfParser){
		super(rtfParser, "clvertalt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
