...
public class RtfCtrlWordBase_pgbrdrr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgbrdrr(RtfParser rtfParser){
		super(rtfParser, "pgbrdrr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
