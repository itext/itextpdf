...
public class RtfCtrlWordBase_brdrtnthlg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrtnthlg(RtfParser rtfParser){
		super(rtfParser, "brdrtnthlg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
