...
public class RtfCtrlWordBase_pnzodiacl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnzodiacl(RtfParser rtfParser){
		super(rtfParser, "pnzodiacl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
