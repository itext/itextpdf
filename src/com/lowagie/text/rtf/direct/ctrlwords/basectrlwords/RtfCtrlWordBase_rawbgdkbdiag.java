...
public class RtfCtrlWordBase_rawbgdkbdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rawbgdkbdiag(RtfParser rtfParser){
		super(rtfParser, "rawbgdkbdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
