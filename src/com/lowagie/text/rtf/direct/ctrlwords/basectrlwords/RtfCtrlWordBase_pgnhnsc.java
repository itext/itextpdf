...
public class RtfCtrlWordBase_pgnhnsc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnhnsc(RtfParser rtfParser){
		super(rtfParser, "pgnhnsc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
