...
public class RtfCtrlWordBase_hich extends RtfCtrlWordBase {

	public RtfCtrlWordBase_hich(RtfParser rtfParser){
		super(rtfParser, "hich", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
