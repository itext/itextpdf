...
public class RtfCtrlWordBase_tscellpaddfb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscellpaddfb(RtfParser rtfParser){
		super(rtfParser, "tscellpaddfb", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
