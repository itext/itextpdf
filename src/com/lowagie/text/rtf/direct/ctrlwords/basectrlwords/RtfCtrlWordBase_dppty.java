...
public class RtfCtrlWordBase_dppty extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dppty(RtfParser rtfParser){
		super(rtfParser, "dppty", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
