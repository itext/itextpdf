...
public class RtfCtrlWordBase_tposyoutv extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tposyoutv(RtfParser rtfParser){
		super(rtfParser, "tposyoutv", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
