...
public class RtfCtrlWordBase_ulthldash extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ulthldash(RtfParser rtfParser){
		super(rtfParser, "ulthldash", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
