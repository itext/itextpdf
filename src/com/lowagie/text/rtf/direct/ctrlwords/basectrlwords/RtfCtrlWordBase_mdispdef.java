...
public class RtfCtrlWordBase_mdispdef extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mdispdef(RtfParser rtfParser){
		super(rtfParser, "mdispdef", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
