...
public class RtfCtrlWordBase_tscbandvertodd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscbandvertodd(RtfParser rtfParser){
		super(rtfParser, "tscbandvertodd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
