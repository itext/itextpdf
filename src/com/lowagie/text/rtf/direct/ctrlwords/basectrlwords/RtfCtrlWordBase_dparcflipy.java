...
public class RtfCtrlWordBase_dparcflipy extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dparcflipy(RtfParser rtfParser){
		super(rtfParser, "dparcflipy", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
