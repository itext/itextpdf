...
public class RtfCtrlWordBase_mhtmltag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mhtmltag(RtfParser rtfParser){
		super(rtfParser, "mhtmltag", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
