...
public class RtfCtrlWordBase_dfrstart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dfrstart(RtfParser rtfParser){
		super(rtfParser, "dfrstart", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
