...
public class RtfCtrlWordBase_dpcosmarta extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpcosmarta(RtfParser rtfParser){
		super(rtfParser, "dpcosmarta", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
