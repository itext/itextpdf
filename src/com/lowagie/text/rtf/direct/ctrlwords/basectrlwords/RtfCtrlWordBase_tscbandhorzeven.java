...
public class RtfCtrlWordBase_tscbandhorzeven extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscbandhorzeven(RtfParser rtfParser){
		super(rtfParser, "tscbandhorzeven", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
