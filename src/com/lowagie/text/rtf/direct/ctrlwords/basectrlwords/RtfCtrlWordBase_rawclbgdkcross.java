...
public class RtfCtrlWordBase_rawclbgdkcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rawclbgdkcross(RtfParser rtfParser){
		super(rtfParser, "rawclbgdkcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
