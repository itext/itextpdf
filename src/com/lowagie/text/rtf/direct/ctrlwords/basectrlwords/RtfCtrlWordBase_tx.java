...
public class RtfCtrlWordBase_tx extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tx(RtfParser rtfParser){
		super(rtfParser, "tx", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
