...
public class RtfCtrlWordBase_ftnrstpg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnrstpg(RtfParser rtfParser){
		super(rtfParser, "ftnrstpg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
