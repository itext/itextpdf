...
public class RtfCtrlWordBase_fromhtml extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fromhtml(RtfParser rtfParser){
		super(rtfParser, "fromhtml", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
