...
public class RtfCtrlWordBase_pngblip extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pngblip(RtfParser rtfParser){
		super(rtfParser, "pngblip", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
