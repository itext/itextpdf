...
public class RtfCtrlWordBase_rxe extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rxe(RtfParser rtfParser){
		super(rtfParser, "rxe", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
