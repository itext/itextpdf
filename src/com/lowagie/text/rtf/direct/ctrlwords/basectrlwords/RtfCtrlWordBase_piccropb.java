...
public class RtfCtrlWordBase_piccropb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_piccropb(RtfParser rtfParser){
		super(rtfParser, "piccropb", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
