...
public class RtfCtrlWordBase_mrad extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mrad(RtfParser rtfParser){
		super(rtfParser, "mrad", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
