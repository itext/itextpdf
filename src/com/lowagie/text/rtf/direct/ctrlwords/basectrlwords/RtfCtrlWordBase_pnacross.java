...
public class RtfCtrlWordBase_pnacross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnacross(RtfParser rtfParser){
		super(rtfParser, "pnacross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
