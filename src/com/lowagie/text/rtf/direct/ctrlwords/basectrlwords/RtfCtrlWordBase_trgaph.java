...
public class RtfCtrlWordBase_trgaph extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trgaph(RtfParser rtfParser){
		super(rtfParser, "trgaph", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
