...
public class RtfCtrlWordBase_chbgdcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chbgdcross(RtfParser rtfParser){
		super(rtfParser, "chbgdcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
