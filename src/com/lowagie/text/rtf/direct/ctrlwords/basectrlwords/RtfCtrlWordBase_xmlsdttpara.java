...
public class RtfCtrlWordBase_xmlsdttpara extends RtfCtrlWordBase {

	public RtfCtrlWordBase_xmlsdttpara(RtfParser rtfParser){
		super(rtfParser, "xmlsdttpara", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
