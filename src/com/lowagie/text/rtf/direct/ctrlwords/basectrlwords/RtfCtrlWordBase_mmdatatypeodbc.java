...
public class RtfCtrlWordBase_mmdatatypeodbc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmdatatypeodbc(RtfParser rtfParser){
		super(rtfParser, "mmdatatypeodbc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
