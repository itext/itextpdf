...
public class RtfCtrlWordBase_brdrdb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrdb(RtfParser rtfParser){
		super(rtfParser, "brdrdb", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
