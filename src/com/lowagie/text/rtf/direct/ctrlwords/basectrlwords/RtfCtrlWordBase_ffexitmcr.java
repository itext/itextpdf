...
public class RtfCtrlWordBase_ffexitmcr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ffexitmcr(RtfParser rtfParser){
		super(rtfParser, "ffexitmcr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
