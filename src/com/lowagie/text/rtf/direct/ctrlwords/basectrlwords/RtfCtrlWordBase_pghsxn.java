...
public class RtfCtrlWordBase_pghsxn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pghsxn(RtfParser rtfParser){
		super(rtfParser, "pghsxn", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
