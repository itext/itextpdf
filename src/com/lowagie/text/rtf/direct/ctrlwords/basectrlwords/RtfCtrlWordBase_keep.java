...
public class RtfCtrlWordBase_keep extends RtfCtrlWordBase {

	public RtfCtrlWordBase_keep(RtfParser rtfParser){
		super(rtfParser, "keep", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
