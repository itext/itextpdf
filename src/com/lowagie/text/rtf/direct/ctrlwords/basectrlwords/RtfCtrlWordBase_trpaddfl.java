...
public class RtfCtrlWordBase_trpaddfl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trpaddfl(RtfParser rtfParser){
		super(rtfParser, "trpaddfl", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
