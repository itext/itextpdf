...
public class RtfCtrlWordBase_aftnnauc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnnauc(RtfParser rtfParser){
		super(rtfParser, "aftnnauc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
