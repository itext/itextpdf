...
public class RtfCtrlWordBase_brdrbar extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrbar(RtfParser rtfParser){
		super(rtfParser, "brdrbar", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
