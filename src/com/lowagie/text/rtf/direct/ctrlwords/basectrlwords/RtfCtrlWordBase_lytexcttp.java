...
public class RtfCtrlWordBase_lytexcttp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_lytexcttp(RtfParser rtfParser){
		super(rtfParser, "lytexcttp", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
