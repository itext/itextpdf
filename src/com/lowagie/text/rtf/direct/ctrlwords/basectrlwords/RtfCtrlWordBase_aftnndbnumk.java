...
public class RtfCtrlWordBase_aftnndbnumk extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnndbnumk(RtfParser rtfParser){
		super(rtfParser, "aftnndbnumk", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
