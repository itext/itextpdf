...
public class RtfCtrlWordBase_ffhps extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ffhps(RtfParser rtfParser){
		super(rtfParser, "ffhps", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
