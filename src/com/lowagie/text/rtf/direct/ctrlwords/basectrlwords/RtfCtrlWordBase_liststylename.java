...
/**
 * Description:
 * 	,"Identifies this list as a list style definition. This
 * 	creates a new list style with the given name and the
 * 	properties of the current list.
 * 	::\liststyleid and
 * 	\liststylename are exclusive; either zero or one of each can
 * 	exist per \list definition, but never both.
 * Group:
 * 	List Table
 * Type:
 * 	Value
...
public class RtfCtrlWordBase_liststylename extends RtfCtrlWordBase {

	public RtfCtrlWordBase_liststylename(RtfParser rtfParser){
		super(rtfParser, "liststylename", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
