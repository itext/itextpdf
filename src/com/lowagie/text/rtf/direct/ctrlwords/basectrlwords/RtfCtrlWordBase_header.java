...
public class RtfCtrlWordBase_header extends RtfCtrlWordBase {

	public RtfCtrlWordBase_header(RtfParser rtfParser){
		super(rtfParser, "header", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
