...
public class RtfCtrlWordBase_landscape extends RtfCtrlWordBase {

	public RtfCtrlWordBase_landscape(RtfParser rtfParser){
		super(rtfParser, "landscape", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
