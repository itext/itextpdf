...
public class RtfCtrlWordBase_pgnzodiacl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnzodiacl(RtfParser rtfParser){
		super(rtfParser, "pgnzodiacl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
