...
public class RtfCtrlWordBase_sprstsp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sprstsp(RtfParser rtfParser){
		super(rtfParser, "sprstsp", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
