...
public class RtfCtrlWordBase_brdrw extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrw(RtfParser rtfParser){
		super(rtfParser, "brdrw", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
