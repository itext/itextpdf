...
public class RtfCtrlWordBase_pnuldb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnuldb(RtfParser rtfParser){
		super(rtfParser, "pnuldb", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
