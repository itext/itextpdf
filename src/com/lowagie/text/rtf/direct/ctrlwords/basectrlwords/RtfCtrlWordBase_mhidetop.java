...
public class RtfCtrlWordBase_mhidetop extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mhidetop(RtfParser rtfParser){
		super(rtfParser, "mhidetop", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
