...
public class RtfCtrlWordBase_dfrmtxtx extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dfrmtxtx(RtfParser rtfParser){
		super(rtfParser, "dfrmtxtx", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
