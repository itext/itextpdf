...
public class RtfCtrlWordBase_flddirty extends RtfCtrlWordBase {

	public RtfCtrlWordBase_flddirty(RtfParser rtfParser){
		super(rtfParser, "flddirty", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
