...
public class RtfCtrlWordBase_ixe extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ixe(RtfParser rtfParser){
		super(rtfParser, "ixe", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
