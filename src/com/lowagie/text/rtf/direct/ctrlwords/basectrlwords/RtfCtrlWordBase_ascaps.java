...
public class RtfCtrlWordBase_ascaps extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ascaps(RtfParser rtfParser){
		super(rtfParser, "ascaps", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
