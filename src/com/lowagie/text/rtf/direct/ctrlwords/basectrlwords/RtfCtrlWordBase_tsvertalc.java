...
public class RtfCtrlWordBase_tsvertalc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsvertalc(RtfParser rtfParser){
		super(rtfParser, "tsvertalc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
