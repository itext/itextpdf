...
public class RtfCtrlWordBase_rsltbmp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rsltbmp(RtfParser rtfParser){
		super(rtfParser, "rsltbmp", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
