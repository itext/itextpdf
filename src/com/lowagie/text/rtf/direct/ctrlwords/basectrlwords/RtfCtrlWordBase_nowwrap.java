...
public class RtfCtrlWordBase_nowwrap extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nowwrap(RtfParser rtfParser){
		super(rtfParser, "nowwrap", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
