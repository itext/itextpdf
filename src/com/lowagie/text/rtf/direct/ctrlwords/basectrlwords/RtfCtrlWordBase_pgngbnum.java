...
public class RtfCtrlWordBase_pgngbnum extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgngbnum(RtfParser rtfParser){
		super(rtfParser, "pgngbnum", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
