...
public class RtfCtrlWordBase_picscaled extends RtfCtrlWordBase {

	public RtfCtrlWordBase_picscaled(RtfParser rtfParser){
		super(rtfParser, "picscaled", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
