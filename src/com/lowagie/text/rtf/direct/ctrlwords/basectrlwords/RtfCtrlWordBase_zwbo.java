...
public class RtfCtrlWordBase_zwbo extends RtfCtrlWordBase {

	public RtfCtrlWordBase_zwbo(RtfParser rtfParser){
		super(rtfParser, "zwbo", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
