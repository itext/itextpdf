...
/**
 * Description:
 * 	,"Designates character style. If a character style is
 * 	specified, style properties must be specified with the
 * 	character run. N refers to an entry in the style table.
 * Group:
...
public class RtfCtrlWordBase_cs extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cs(RtfParser rtfParser){
		super(rtfParser, "cs", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
