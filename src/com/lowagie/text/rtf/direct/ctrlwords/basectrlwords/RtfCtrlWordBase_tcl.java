...
public class RtfCtrlWordBase_tcl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tcl(RtfParser rtfParser){
		super(rtfParser, "tcl", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
