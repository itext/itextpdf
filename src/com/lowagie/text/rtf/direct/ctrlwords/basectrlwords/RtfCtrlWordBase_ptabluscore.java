...
public class RtfCtrlWordBase_ptabluscore extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ptabluscore(RtfParser rtfParser){
		super(rtfParser, "ptabluscore", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
