...
public class RtfCtrlWordBase_msubhide extends RtfCtrlWordBase {

	public RtfCtrlWordBase_msubhide(RtfParser rtfParser){
		super(rtfParser, "msubhide", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
