...
public class RtfCtrlWordBase_qk extends RtfCtrlWordBase {

	public RtfCtrlWordBase_qk(RtfParser rtfParser){
		super(rtfParser, "qk", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
