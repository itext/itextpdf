...
public class RtfCtrlWordBase_viewscale extends RtfCtrlWordBase {

	public RtfCtrlWordBase_viewscale(RtfParser rtfParser){
		super(rtfParser, "viewscale", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
