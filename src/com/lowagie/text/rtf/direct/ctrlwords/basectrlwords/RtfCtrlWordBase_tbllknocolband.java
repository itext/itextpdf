...
public class RtfCtrlWordBase_tbllknocolband extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tbllknocolband(RtfParser rtfParser){
		super(rtfParser, "tbllknocolband", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
