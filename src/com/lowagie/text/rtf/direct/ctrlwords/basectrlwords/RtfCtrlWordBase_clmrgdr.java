...
public class RtfCtrlWordBase_clmrgdr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clmrgdr(RtfParser rtfParser){
		super(rtfParser, "clmrgdr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
