...
public class RtfCtrlWordBase_trpat extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trpat(RtfParser rtfParser){
		super(rtfParser, "trpat", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
