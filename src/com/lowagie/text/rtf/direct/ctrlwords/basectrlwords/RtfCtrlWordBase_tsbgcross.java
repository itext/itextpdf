...
public class RtfCtrlWordBase_tsbgcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsbgcross(RtfParser rtfParser){
		super(rtfParser, "tsbgcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
