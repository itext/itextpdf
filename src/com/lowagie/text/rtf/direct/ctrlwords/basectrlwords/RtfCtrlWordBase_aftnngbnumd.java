...
public class RtfCtrlWordBase_aftnngbnumd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnngbnumd(RtfParser rtfParser){
		super(rtfParser, "aftnngbnumd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
