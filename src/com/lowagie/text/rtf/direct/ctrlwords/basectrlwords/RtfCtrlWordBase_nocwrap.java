...
public class RtfCtrlWordBase_nocwrap extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nocwrap(RtfParser rtfParser){
		super(rtfParser, "nocwrap", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
