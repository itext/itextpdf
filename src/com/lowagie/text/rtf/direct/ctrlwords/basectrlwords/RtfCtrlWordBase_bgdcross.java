...
public class RtfCtrlWordBase_bgdcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bgdcross(RtfParser rtfParser){
		super(rtfParser, "bgdcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
