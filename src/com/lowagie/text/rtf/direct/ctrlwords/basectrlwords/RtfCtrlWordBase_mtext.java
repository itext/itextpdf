...
public class RtfCtrlWordBase_mtext extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mtext(RtfParser rtfParser){
		super(rtfParser, "mtext", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
