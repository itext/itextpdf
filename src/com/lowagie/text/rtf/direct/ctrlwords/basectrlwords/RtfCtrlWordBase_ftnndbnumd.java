...
public class RtfCtrlWordBase_ftnndbnumd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnndbnumd(RtfParser rtfParser){
		super(rtfParser, "ftnndbnumd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
