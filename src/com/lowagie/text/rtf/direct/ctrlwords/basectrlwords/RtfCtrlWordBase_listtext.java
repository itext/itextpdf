...
public class RtfCtrlWordBase_listtext extends RtfCtrlWordBase {

	public RtfCtrlWordBase_listtext(RtfParser rtfParser){
		super(rtfParser, "listtext", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
