...
public class RtfCtrlWordBase_pgbrdrb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgbrdrb(RtfParser rtfParser){
		super(rtfParser, "pgbrdrb", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
