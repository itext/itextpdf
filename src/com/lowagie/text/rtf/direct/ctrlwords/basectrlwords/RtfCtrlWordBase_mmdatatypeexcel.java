...
public class RtfCtrlWordBase_mmdatatypeexcel extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmdatatypeexcel(RtfParser rtfParser){
		super(rtfParser, "mmdatatypeexcel", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
