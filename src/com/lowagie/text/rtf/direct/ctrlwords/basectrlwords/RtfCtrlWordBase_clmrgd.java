...
public class RtfCtrlWordBase_clmrgd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clmrgd(RtfParser rtfParser){
		super(rtfParser, "clmrgd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
