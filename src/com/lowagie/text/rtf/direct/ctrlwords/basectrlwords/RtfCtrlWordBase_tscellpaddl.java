...
public class RtfCtrlWordBase_tscellpaddl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscellpaddl(RtfParser rtfParser){
		super(rtfParser, "tscellpaddl", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
