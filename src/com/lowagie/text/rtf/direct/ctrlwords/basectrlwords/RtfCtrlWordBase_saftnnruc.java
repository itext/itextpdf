...
public class RtfCtrlWordBase_saftnnruc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnnruc(RtfParser rtfParser){
		super(rtfParser, "saftnnruc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
