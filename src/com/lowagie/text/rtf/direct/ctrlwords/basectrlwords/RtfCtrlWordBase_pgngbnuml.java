...
public class RtfCtrlWordBase_pgngbnuml extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgngbnuml(RtfParser rtfParser){
		super(rtfParser, "pgngbnuml", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
