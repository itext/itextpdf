...
public class RtfCtrlWordBase_wbmwidthbytes extends RtfCtrlWordBase {

	public RtfCtrlWordBase_wbmwidthbytes(RtfParser rtfParser){
		super(rtfParser, "wbmwidthbytes", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
