...
public class RtfCtrlWordBase_bookfoldrev extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bookfoldrev(RtfParser rtfParser){
		super(rtfParser, "bookfoldrev", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
