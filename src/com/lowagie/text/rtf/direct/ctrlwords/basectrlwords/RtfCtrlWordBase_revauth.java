...
public class RtfCtrlWordBase_revauth extends RtfCtrlWordBase {

	public RtfCtrlWordBase_revauth(RtfParser rtfParser){
		super(rtfParser, "revauth", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
