...
public class RtfCtrlWordBase_nextfile extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nextfile(RtfParser rtfParser){
		super(rtfParser, "nextfile", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
