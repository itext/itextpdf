...
public class RtfCtrlWordBase_sftnstart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnstart(RtfParser rtfParser){
		super(rtfParser, "sftnstart", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
