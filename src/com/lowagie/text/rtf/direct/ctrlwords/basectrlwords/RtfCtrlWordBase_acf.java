...
public class RtfCtrlWordBase_acf extends RtfCtrlWordBase {

	public RtfCtrlWordBase_acf(RtfParser rtfParser){
		super(rtfParser, "acf", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
