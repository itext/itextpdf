...
public class RtfCtrlWordBase_sv extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sv(RtfParser rtfParser){
		super(rtfParser, "sv", 0, false, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
