...
public class RtfCtrlWordBase_rawclbgdkdcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rawclbgdkdcross(RtfParser rtfParser){
		super(rtfParser, "rawclbgdkdcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
