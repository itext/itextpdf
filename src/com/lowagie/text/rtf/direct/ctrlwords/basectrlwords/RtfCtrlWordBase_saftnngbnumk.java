...
public class RtfCtrlWordBase_saftnngbnumk extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnngbnumk(RtfParser rtfParser){
		super(rtfParser, "saftnngbnumk", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
