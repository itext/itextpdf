...
public class RtfCtrlWordBase_aspnum extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aspnum(RtfParser rtfParser){
		super(rtfParser, "aspnum", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
