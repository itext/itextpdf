...
public class RtfCtrlWordBase_paperh extends RtfCtrlWordBase {

	public RtfCtrlWordBase_paperh(RtfParser rtfParser){
		super(rtfParser, "paperh", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
