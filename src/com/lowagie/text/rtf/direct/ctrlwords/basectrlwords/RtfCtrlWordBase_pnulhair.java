...
public class RtfCtrlWordBase_pnulhair extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnulhair(RtfParser rtfParser){
		super(rtfParser, "pnulhair", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
