...
public class RtfCtrlWordBase_pnnumonce extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnnumonce(RtfParser rtfParser){
		super(rtfParser, "pnnumonce", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
