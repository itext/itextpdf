...
public class RtfCtrlWordBase_frmtxbtlr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_frmtxbtlr(RtfParser rtfParser){
		super(rtfParser, "frmtxbtlr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
