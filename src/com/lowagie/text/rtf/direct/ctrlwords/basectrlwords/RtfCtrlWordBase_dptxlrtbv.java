...
public class RtfCtrlWordBase_dptxlrtbv extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dptxlrtbv(RtfParser rtfParser){
		super(rtfParser, "dptxlrtbv", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
