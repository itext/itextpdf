...
public class RtfCtrlWordBase_ftnnzodiacl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnnzodiacl(RtfParser rtfParser){
		super(rtfParser, "ftnnzodiacl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
