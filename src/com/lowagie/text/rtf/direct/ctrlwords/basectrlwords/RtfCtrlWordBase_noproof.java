...
public class RtfCtrlWordBase_noproof extends RtfCtrlWordBase {

	public RtfCtrlWordBase_noproof(RtfParser rtfParser){
		super(rtfParser, "noproof", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
