...
public class RtfCtrlWordBase_ptabldot extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ptabldot(RtfParser rtfParser){
		super(rtfParser, "ptabldot", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
