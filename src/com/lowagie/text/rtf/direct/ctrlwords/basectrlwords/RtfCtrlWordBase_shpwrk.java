...
public class RtfCtrlWordBase_shpwrk extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shpwrk(RtfParser rtfParser){
		super(rtfParser, "shpwrk", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
