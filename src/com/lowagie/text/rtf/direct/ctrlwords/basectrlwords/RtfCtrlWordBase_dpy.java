...
public class RtfCtrlWordBase_dpy extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpy(RtfParser rtfParser){
		super(rtfParser, "dpy", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
