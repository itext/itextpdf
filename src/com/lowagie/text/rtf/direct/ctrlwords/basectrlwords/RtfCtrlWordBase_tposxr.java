...
public class RtfCtrlWordBase_tposxr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tposxr(RtfParser rtfParser){
		super(rtfParser, "tposxr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
