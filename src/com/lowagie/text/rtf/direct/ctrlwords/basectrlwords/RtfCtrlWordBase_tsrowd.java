...
public class RtfCtrlWordBase_tsrowd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsrowd(RtfParser rtfParser){
		super(rtfParser, "tsrowd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
