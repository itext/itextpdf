...
public class RtfCtrlWordBase_cltxtbrl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cltxtbrl(RtfParser rtfParser){
		super(rtfParser, "cltxtbrl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
