...
public class RtfCtrlWordBase_bkmkpub extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bkmkpub(RtfParser rtfParser){
		super(rtfParser, "bkmkpub", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
