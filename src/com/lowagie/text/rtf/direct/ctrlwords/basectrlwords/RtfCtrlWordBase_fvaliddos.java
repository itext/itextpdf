...
public class RtfCtrlWordBase_fvaliddos extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fvaliddos(RtfParser rtfParser){
		super(rtfParser, "fvaliddos", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
