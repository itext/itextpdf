...
public class RtfCtrlWordBase_dplinedado extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dplinedado(RtfParser rtfParser){
		super(rtfParser, "dplinedado", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
