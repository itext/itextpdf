...
public class RtfCtrlWordBase_rawclbgdkvert extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rawclbgdkvert(RtfParser rtfParser){
		super(rtfParser, "rawclbgdkvert", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
