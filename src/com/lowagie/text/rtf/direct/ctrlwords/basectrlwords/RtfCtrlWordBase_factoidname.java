...
public class RtfCtrlWordBase_factoidname extends RtfCtrlWordBase {

	public RtfCtrlWordBase_factoidname(RtfParser rtfParser){
		super(rtfParser, "factoidname", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
