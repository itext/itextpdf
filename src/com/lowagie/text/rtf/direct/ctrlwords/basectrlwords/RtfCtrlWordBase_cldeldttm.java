...
public class RtfCtrlWordBase_cldeldttm extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cldeldttm(RtfParser rtfParser){
		super(rtfParser, "cldeldttm", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
