...
public class RtfCtrlWordBase_edmins extends RtfCtrlWordBase {

	public RtfCtrlWordBase_edmins(RtfParser rtfParser){
		super(rtfParser, "edmins", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
