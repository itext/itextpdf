...
public class RtfCtrlWordBase_ffdefres extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ffdefres(RtfParser rtfParser){
		super(rtfParser, "ffdefres", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
