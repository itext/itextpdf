...
public class RtfCtrlWordBase_linkself extends RtfCtrlWordBase {

	public RtfCtrlWordBase_linkself(RtfParser rtfParser){
		super(rtfParser, "linkself", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
