...
public class RtfCtrlWordBase_posxc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_posxc(RtfParser rtfParser){
		super(rtfParser, "posxc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
