...
public class RtfCtrlWordBase_hyphconsec extends RtfCtrlWordBase {

	public RtfCtrlWordBase_hyphconsec(RtfParser rtfParser){
		super(rtfParser, "hyphconsec", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
