...
public class RtfCtrlWordBase_rawclbgdkhor extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rawclbgdkhor(RtfParser rtfParser){
		super(rtfParser, "rawclbgdkhor", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
