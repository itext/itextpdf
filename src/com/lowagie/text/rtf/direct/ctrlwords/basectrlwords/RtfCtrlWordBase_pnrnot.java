...
public class RtfCtrlWordBase_pnrnot extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnrnot(RtfParser rtfParser){
		super(rtfParser, "pnrnot", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
