...
public class RtfCtrlWordBase_pniroha extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pniroha(RtfParser rtfParser){
		super(rtfParser, "pniroha", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
