...
public class RtfCtrlWordBase_brdrl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrl(RtfParser rtfParser){
		super(rtfParser, "brdrl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
