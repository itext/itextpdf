...
public class RtfCtrlWordBase_intbl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_intbl(RtfParser rtfParser){
		super(rtfParser, "intbl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
