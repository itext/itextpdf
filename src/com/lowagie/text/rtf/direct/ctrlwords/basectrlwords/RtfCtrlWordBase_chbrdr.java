...
public class RtfCtrlWordBase_chbrdr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chbrdr(RtfParser rtfParser){
		super(rtfParser, "chbrdr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
