...
public class RtfCtrlWordBase_pnsp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnsp(RtfParser rtfParser){
		super(rtfParser, "pnsp", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
