...
public class RtfCtrlWordBase_irow extends RtfCtrlWordBase {

	public RtfCtrlWordBase_irow(RtfParser rtfParser){
		super(rtfParser, "irow", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
