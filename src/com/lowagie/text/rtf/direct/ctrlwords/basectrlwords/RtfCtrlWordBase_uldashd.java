...
public class RtfCtrlWordBase_uldashd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_uldashd(RtfParser rtfParser){
		super(rtfParser, "uldashd", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
