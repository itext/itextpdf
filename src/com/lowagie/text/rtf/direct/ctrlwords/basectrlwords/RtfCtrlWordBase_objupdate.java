...
public class RtfCtrlWordBase_objupdate extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objupdate(RtfParser rtfParser){
		super(rtfParser, "objupdate", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
