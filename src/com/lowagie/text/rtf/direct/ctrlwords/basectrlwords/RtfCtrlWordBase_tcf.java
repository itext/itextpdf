...
public class RtfCtrlWordBase_tcf extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tcf(RtfParser rtfParser){
		super(rtfParser, "tcf", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
