...
public class RtfCtrlWordBase_sftnnchi extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnnchi(RtfParser rtfParser){
		super(rtfParser, "sftnnchi", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
