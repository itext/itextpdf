...
/**
 * Description:
 * 	A list of documents referenced by the current document. The
 * 	file table has a structure analogous to the style or font
 * 	table. This is a destination control word that is output as
 * 	part of the document header.
 * Group:
 * 	File Table
 * Type:
 * 	Destination
...
public class RtfCtrlWordBase_filetbl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_filetbl(RtfParser rtfParser){
		super(rtfParser, "filetbl", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
