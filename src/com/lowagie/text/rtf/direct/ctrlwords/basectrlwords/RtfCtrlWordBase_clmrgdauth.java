...
public class RtfCtrlWordBase_clmrgdauth extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clmrgdauth(RtfParser rtfParser){
		super(rtfParser, "clmrgdauth", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
