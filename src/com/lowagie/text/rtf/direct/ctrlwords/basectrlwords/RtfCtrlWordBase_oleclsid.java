...
public class RtfCtrlWordBase_oleclsid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_oleclsid(RtfParser rtfParser){
		super(rtfParser, "oleclsid", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
