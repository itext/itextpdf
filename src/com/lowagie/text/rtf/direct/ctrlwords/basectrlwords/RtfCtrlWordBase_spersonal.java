...
public class RtfCtrlWordBase_spersonal extends RtfCtrlWordBase {

	public RtfCtrlWordBase_spersonal(RtfParser rtfParser){
		super(rtfParser, "spersonal", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
