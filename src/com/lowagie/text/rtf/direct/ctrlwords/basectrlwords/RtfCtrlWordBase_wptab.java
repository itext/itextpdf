...
public class RtfCtrlWordBase_wptab extends RtfCtrlWordBase {

	public RtfCtrlWordBase_wptab(RtfParser rtfParser){
		super(rtfParser, "wptab", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
