...
public class RtfCtrlWordBase_fscript extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fscript(RtfParser rtfParser){
		super(rtfParser, "fscript", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
