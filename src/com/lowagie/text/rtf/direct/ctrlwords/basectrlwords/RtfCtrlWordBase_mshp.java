...
public class RtfCtrlWordBase_mshp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mshp(RtfParser rtfParser){
		super(rtfParser, "mshp", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
