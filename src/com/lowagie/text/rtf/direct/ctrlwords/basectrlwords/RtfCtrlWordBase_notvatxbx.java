...
public class RtfCtrlWordBase_notvatxbx extends RtfCtrlWordBase {

	public RtfCtrlWordBase_notvatxbx(RtfParser rtfParser){
		super(rtfParser, "notvatxbx", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
