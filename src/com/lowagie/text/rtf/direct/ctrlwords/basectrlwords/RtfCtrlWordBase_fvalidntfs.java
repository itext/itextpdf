...
public class RtfCtrlWordBase_fvalidntfs extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fvalidntfs(RtfParser rtfParser){
		super(rtfParser, "fvalidntfs", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
