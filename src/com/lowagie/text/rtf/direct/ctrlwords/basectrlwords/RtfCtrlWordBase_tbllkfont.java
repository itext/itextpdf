...
public class RtfCtrlWordBase_tbllkfont extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tbllkfont(RtfParser rtfParser){
		super(rtfParser, "tbllkfont", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
