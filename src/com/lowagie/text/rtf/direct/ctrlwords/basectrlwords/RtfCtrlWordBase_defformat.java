...
public class RtfCtrlWordBase_defformat extends RtfCtrlWordBase {

	public RtfCtrlWordBase_defformat(RtfParser rtfParser){
		super(rtfParser, "defformat", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
