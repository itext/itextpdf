...
public class RtfCtrlWordBase_aftnnchi extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnnchi(RtfParser rtfParser){
		super(rtfParser, "aftnnchi", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
