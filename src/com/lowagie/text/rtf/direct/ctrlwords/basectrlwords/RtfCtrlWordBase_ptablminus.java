...
public class RtfCtrlWordBase_ptablminus extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ptablminus(RtfParser rtfParser){
		super(rtfParser, "ptablminus", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
