...
public class RtfCtrlWordBase_pnf extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnf(RtfParser rtfParser){
		super(rtfParser, "pnf", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
