...
public class RtfCtrlWordBase_propname extends RtfCtrlWordBase {

	public RtfCtrlWordBase_propname(RtfParser rtfParser){
		super(rtfParser, "propname", 0, false, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
