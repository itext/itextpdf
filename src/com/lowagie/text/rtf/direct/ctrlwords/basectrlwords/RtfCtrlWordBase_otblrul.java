...
public class RtfCtrlWordBase_otblrul extends RtfCtrlWordBase {

	public RtfCtrlWordBase_otblrul(RtfParser rtfParser){
		super(rtfParser, "otblrul", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
