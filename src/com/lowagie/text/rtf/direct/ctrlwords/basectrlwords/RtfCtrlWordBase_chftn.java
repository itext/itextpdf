...
public class RtfCtrlWordBase_chftn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chftn(RtfParser rtfParser){
		super(rtfParser, "chftn", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
