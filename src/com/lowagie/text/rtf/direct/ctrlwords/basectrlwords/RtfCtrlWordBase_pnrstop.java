...
public class RtfCtrlWordBase_pnrstop extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnrstop(RtfParser rtfParser){
		super(rtfParser, "pnrstop", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
