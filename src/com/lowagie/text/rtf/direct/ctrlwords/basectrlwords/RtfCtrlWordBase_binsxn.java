...
public class RtfCtrlWordBase_binsxn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_binsxn(RtfParser rtfParser){
		super(rtfParser, "binsxn", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
