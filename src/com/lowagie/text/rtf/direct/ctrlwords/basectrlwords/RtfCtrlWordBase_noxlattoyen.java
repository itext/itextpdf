...
public class RtfCtrlWordBase_noxlattoyen extends RtfCtrlWordBase {

	public RtfCtrlWordBase_noxlattoyen(RtfParser rtfParser){
		super(rtfParser, "noxlattoyen", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
