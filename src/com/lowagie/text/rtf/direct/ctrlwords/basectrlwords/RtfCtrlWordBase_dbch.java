...
public class RtfCtrlWordBase_dbch extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dbch(RtfParser rtfParser){
		super(rtfParser, "dbch", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
