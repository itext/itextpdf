...
public class RtfCtrlWordBase_pnulth extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnulth(RtfParser rtfParser){
		super(rtfParser, "pnulth", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
