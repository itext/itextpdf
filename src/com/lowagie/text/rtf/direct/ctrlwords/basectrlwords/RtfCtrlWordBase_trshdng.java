...
public class RtfCtrlWordBase_trshdng extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trshdng(RtfParser rtfParser){
		super(rtfParser, "trshdng", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
