...
public class RtfCtrlWordBase_ltrrow extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ltrrow(RtfParser rtfParser){
		super(rtfParser, "ltrrow", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
