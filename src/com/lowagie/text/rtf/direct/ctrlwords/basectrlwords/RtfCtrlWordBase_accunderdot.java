...
public class RtfCtrlWordBase_accunderdot extends RtfCtrlWordBase {

	public RtfCtrlWordBase_accunderdot(RtfParser rtfParser){
		super(rtfParser, "accunderdot", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
