...
public class RtfCtrlWordBase_sprslnsp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sprslnsp(RtfParser rtfParser){
		super(rtfParser, "sprslnsp", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
