...
public class RtfCtrlWordBase_dobymargin extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dobymargin(RtfParser rtfParser){
		super(rtfParser, "dobymargin", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
