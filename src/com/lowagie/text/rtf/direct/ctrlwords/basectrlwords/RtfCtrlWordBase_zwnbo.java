...
public class RtfCtrlWordBase_zwnbo extends RtfCtrlWordBase {

	public RtfCtrlWordBase_zwnbo(RtfParser rtfParser){
		super(rtfParser, "zwnbo", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
