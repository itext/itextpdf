...
public class RtfCtrlWordBase_mchr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mchr(RtfParser rtfParser){
		super(rtfParser, "mchr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
