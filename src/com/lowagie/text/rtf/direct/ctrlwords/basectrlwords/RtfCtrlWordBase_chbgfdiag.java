...
public class RtfCtrlWordBase_chbgfdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chbgfdiag(RtfParser rtfParser){
		super(rtfParser, "chbgfdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
