...
public class RtfCtrlWordBase_stshfloch extends RtfCtrlWordBase {

	public RtfCtrlWordBase_stshfloch(RtfParser rtfParser){
		super(rtfParser, "stshfloch", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
