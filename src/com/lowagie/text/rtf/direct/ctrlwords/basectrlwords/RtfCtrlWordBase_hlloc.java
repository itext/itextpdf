...
public class RtfCtrlWordBase_hlloc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_hlloc(RtfParser rtfParser){
		super(rtfParser, "hlloc", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
