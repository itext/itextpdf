...
public class RtfCtrlWordBase_astrike extends RtfCtrlWordBase {

	public RtfCtrlWordBase_astrike(RtfParser rtfParser){
		super(rtfParser, "astrike", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
