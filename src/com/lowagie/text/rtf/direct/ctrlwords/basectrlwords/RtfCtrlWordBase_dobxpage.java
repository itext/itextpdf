...
public class RtfCtrlWordBase_dobxpage extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dobxpage(RtfParser rtfParser){
		super(rtfParser, "dobxpage", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
