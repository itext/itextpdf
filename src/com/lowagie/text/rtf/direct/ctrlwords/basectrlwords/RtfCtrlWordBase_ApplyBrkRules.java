...
public class RtfCtrlWordBase_ApplyBrkRules extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ApplyBrkRules(RtfParser rtfParser){
		super(rtfParser, "ApplyBrkRules", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
