...
public class RtfCtrlWordBase_hyphhotz extends RtfCtrlWordBase {

	public RtfCtrlWordBase_hyphhotz(RtfParser rtfParser){
		super(rtfParser, "hyphhotz", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
