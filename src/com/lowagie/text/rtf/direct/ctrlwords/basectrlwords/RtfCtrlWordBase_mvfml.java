...
public class RtfCtrlWordBase_mvfml extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mvfml(RtfParser rtfParser){
		super(rtfParser, "mvfml", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
