...
public class RtfCtrlWordBase_ashad extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ashad(RtfParser rtfParser){
		super(rtfParser, "ashad", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
