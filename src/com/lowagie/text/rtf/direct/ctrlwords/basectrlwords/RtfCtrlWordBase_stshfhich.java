 ...
 * 	sheet for High-ANSI characters.
 * Group:
 * 	Default Fonts
 * Type:
 * 	Value
...
public class RtfCtrlWordBase_stshfhich extends RtfCtrlWordBase {

	public RtfCtrlWordBase_stshfhich(RtfParser rtfParser){
		super(rtfParser, "stshfhich", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
