...
public class RtfCtrlWordBase_wpeqn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_wpeqn(RtfParser rtfParser){
		super(rtfParser, "wpeqn", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
