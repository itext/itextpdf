...
public class RtfCtrlWordBase_mmathpara extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmathpara(RtfParser rtfParser){
		super(rtfParser, "mmathpara", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
