...
public class RtfCtrlWordBase_ftnstart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnstart(RtfParser rtfParser){
		super(rtfParser, "ftnstart", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
