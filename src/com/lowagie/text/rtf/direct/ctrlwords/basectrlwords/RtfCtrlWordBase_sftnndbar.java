...
public class RtfCtrlWordBase_sftnndbar extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnndbar(RtfParser rtfParser){
		super(rtfParser, "sftnndbar", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
