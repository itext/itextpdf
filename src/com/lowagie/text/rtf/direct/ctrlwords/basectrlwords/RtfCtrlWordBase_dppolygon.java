...
public class RtfCtrlWordBase_dppolygon extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dppolygon(RtfParser rtfParser){
		super(rtfParser, "dppolygon", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
