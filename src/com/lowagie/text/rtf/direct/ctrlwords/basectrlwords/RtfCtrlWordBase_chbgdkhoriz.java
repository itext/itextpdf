...
public class RtfCtrlWordBase_chbgdkhoriz extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chbgdkhoriz(RtfParser rtfParser){
		super(rtfParser, "chbgdkhoriz", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
