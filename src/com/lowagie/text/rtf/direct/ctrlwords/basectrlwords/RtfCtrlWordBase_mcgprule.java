...
public class RtfCtrlWordBase_mcgprule extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mcgprule(RtfParser rtfParser){
		super(rtfParser, "mcgprule", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
