...
public class RtfCtrlWordBase_chbghoriz extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chbghoriz(RtfParser rtfParser){
		super(rtfParser, "chbghoriz", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
