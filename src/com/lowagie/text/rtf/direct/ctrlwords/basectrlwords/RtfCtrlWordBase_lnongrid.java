...
public class RtfCtrlWordBase_lnongrid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_lnongrid(RtfParser rtfParser){
		super(rtfParser, "lnongrid", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
