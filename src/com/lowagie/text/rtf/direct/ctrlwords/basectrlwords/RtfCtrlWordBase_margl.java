...
public class RtfCtrlWordBase_margl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_margl(RtfParser rtfParser){
		super(rtfParser, "margl", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
