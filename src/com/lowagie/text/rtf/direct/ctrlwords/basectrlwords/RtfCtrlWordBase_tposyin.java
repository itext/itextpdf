...
public class RtfCtrlWordBase_tposyin extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tposyin(RtfParser rtfParser){
		super(rtfParser, "tposyin", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
