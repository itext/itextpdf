...
public class RtfCtrlWordBase_pnb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnb(RtfParser rtfParser){
		super(rtfParser, "pnb", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
