...
public class RtfCtrlWordBase_sftnnzodiacl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnnzodiacl(RtfParser rtfParser){
		super(rtfParser, "sftnnzodiacl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
