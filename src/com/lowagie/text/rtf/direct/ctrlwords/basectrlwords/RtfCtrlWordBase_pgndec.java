...
public class RtfCtrlWordBase_pgndec extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgndec(RtfParser rtfParser){
		super(rtfParser, "pgndec", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
