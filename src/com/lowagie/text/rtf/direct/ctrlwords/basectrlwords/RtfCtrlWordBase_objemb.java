...
public class RtfCtrlWordBase_objemb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objemb(RtfParser rtfParser){
		super(rtfParser, "objemb", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
