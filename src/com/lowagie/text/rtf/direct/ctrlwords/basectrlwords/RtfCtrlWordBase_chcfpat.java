...
public class RtfCtrlWordBase_chcfpat extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chcfpat(RtfParser rtfParser){
		super(rtfParser, "chcfpat", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
