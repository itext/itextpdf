...
public class RtfCtrlWordBase_wbitmap extends RtfCtrlWordBase {

	public RtfCtrlWordBase_wbitmap(RtfParser rtfParser){
		super(rtfParser, "wbitmap", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
