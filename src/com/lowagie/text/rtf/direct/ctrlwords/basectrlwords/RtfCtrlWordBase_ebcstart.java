...
public class RtfCtrlWordBase_ebcstart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ebcstart(RtfParser rtfParser){
		super(rtfParser, "ebcstart", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
