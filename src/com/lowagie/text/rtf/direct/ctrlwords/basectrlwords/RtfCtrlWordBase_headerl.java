...
public class RtfCtrlWordBase_headerl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_headerl(RtfParser rtfParser){
		super(rtfParser, "headerl", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
