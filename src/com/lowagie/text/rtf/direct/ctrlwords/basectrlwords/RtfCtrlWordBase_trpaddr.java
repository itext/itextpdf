...
public class RtfCtrlWordBase_trpaddr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trpaddr(RtfParser rtfParser){
		super(rtfParser, "trpaddr", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
