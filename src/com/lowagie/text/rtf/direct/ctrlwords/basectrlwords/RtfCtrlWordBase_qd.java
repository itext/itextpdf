...
public class RtfCtrlWordBase_qd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_qd(RtfParser rtfParser){
		super(rtfParser, "qd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
