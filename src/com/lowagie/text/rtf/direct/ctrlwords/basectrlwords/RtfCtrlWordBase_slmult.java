...
public class RtfCtrlWordBase_slmult extends RtfCtrlWordBase {

	public RtfCtrlWordBase_slmult(RtfParser rtfParser){
		super(rtfParser, "slmult", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
