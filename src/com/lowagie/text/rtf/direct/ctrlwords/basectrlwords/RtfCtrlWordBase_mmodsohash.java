...
public class RtfCtrlWordBase_mmodsohash extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmodsohash(RtfParser rtfParser){
		super(rtfParser, "mmodsohash", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
