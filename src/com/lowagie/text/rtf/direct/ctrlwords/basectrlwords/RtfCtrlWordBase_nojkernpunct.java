...
public class RtfCtrlWordBase_nojkernpunct extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nojkernpunct(RtfParser rtfParser){
		super(rtfParser, "nojkernpunct", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
