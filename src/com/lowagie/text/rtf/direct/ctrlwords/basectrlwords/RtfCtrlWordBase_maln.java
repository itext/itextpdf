...
public class RtfCtrlWordBase_maln extends RtfCtrlWordBase {

	public RtfCtrlWordBase_maln(RtfParser rtfParser){
		super(rtfParser, "maln", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
