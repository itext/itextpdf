...
public class RtfCtrlWordBase_pnbidia extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnbidia(RtfParser rtfParser){
		super(rtfParser, "pnbidia", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
