...
public class RtfCtrlWordBase_dpastartw extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpastartw(RtfParser rtfParser){
		super(rtfParser, "dpastartw", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
