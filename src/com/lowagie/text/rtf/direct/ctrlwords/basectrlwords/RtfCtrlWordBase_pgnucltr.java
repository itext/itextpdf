...
public class RtfCtrlWordBase_pgnucltr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnucltr(RtfParser rtfParser){
		super(rtfParser, "pgnucltr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
