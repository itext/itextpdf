...
public class RtfCtrlWordBase_pnlvlcont extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnlvlcont(RtfParser rtfParser){
		super(rtfParser, "pnlvlcont", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
