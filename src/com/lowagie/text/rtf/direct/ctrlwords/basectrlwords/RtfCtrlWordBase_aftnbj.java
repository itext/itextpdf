...
public class RtfCtrlWordBase_aftnbj extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnbj(RtfParser rtfParser){
		super(rtfParser, "aftnbj", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
