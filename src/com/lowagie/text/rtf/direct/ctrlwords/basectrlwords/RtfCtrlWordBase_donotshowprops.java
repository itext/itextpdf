...
public class RtfCtrlWordBase_donotshowprops extends RtfCtrlWordBase {

	public RtfCtrlWordBase_donotshowprops(RtfParser rtfParser){
		super(rtfParser, "donotshowprops", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
