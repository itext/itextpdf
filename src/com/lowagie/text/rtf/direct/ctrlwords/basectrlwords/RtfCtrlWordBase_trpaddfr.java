...
public class RtfCtrlWordBase_trpaddfr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trpaddfr(RtfParser rtfParser){
		super(rtfParser, "trpaddfr", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
