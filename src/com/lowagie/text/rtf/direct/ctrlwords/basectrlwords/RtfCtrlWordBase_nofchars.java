...
public class RtfCtrlWordBase_nofchars extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nofchars(RtfParser rtfParser){
		super(rtfParser, "nofchars", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
