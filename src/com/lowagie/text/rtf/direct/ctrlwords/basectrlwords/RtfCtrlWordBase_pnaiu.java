...
public class RtfCtrlWordBase_pnaiu extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnaiu(RtfParser rtfParser){
		super(rtfParser, "pnaiu", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
