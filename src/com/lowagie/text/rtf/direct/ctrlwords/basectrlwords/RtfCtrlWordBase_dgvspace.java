...
public class RtfCtrlWordBase_dgvspace extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dgvspace(RtfParser rtfParser){
		super(rtfParser, "dgvspace", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
