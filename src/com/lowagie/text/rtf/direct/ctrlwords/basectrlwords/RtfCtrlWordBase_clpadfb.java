...
public class RtfCtrlWordBase_clpadfb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clpadfb(RtfParser rtfParser){
		super(rtfParser, "clpadfb", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
