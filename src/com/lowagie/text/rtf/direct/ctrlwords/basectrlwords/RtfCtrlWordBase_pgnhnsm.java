...
public class RtfCtrlWordBase_pgnhnsm extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnhnsm(RtfParser rtfParser){
		super(rtfParser, "pgnhnsm", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
