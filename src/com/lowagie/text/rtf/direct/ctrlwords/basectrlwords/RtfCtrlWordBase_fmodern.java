...
public class RtfCtrlWordBase_fmodern extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fmodern(RtfParser rtfParser){
		super(rtfParser, "fmodern", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
