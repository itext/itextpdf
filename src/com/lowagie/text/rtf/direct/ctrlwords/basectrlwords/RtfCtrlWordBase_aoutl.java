...
public class RtfCtrlWordBase_aoutl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aoutl(RtfParser rtfParser){
		super(rtfParser, "aoutl", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
