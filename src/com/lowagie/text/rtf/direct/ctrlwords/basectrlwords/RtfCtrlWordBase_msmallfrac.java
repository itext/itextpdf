...
public class RtfCtrlWordBase_msmallfrac extends RtfCtrlWordBase {

	public RtfCtrlWordBase_msmallfrac(RtfParser rtfParser){
		super(rtfParser, "msmallfrac", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
