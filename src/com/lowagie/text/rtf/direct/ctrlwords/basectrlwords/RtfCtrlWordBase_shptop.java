...
public class RtfCtrlWordBase_shptop extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shptop(RtfParser rtfParser){
		super(rtfParser, "shptop", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
