...
public class RtfCtrlWordBase_pndbnuml extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pndbnuml(RtfParser rtfParser){
		super(rtfParser, "pndbnuml", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
