...
public class RtfCtrlWordBase_brdrdash extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrdash(RtfParser rtfParser){
		super(rtfParser, "brdrdash", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
