...
public class RtfCtrlWordBase_stextflow extends RtfCtrlWordBase {

	public RtfCtrlWordBase_stextflow(RtfParser rtfParser){
		super(rtfParser, "stextflow", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
