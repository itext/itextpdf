...
public class RtfCtrlWordBase_mssub extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mssub(RtfParser rtfParser){
		super(rtfParser, "mssub", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
