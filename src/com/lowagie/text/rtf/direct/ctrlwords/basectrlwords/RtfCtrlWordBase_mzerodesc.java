...
public class RtfCtrlWordBase_mzerodesc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mzerodesc(RtfParser rtfParser){
		super(rtfParser, "mzerodesc", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
