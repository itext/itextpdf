...
public class RtfCtrlWordBase_trspdfr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trspdfr(RtfParser rtfParser){
		super(rtfParser, "trspdfr", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
