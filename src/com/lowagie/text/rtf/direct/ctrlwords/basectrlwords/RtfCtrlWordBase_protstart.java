...
public class RtfCtrlWordBase_protstart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_protstart(RtfParser rtfParser){
		super(rtfParser, "protstart", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
