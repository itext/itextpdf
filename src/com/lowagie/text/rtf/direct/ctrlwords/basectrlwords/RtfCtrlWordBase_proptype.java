...
public class RtfCtrlWordBase_proptype extends RtfCtrlWordBase {

	public RtfCtrlWordBase_proptype(RtfParser rtfParser){
		super(rtfParser, "proptype", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
