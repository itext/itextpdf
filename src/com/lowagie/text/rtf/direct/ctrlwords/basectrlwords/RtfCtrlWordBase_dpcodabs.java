...
public class RtfCtrlWordBase_dpcodabs extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpcodabs(RtfParser rtfParser){
		super(rtfParser, "dpcodabs", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
