...
public class RtfCtrlWordBase_outlinelevel extends RtfCtrlWordBase {

	public RtfCtrlWordBase_outlinelevel(RtfParser rtfParser){
		super(rtfParser, "outlinelevel", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
