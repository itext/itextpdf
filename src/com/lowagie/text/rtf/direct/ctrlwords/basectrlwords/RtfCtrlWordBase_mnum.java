...
public class RtfCtrlWordBase_mnum extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mnum(RtfParser rtfParser){
		super(rtfParser, "mnum", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
