...
public class RtfCtrlWordBase_objlock extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objlock(RtfParser rtfParser){
		super(rtfParser, "objlock", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
