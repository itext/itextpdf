...
public class RtfCtrlWordBase_box extends RtfCtrlWordBase {

	public RtfCtrlWordBase_box(RtfParser rtfParser){
		super(rtfParser, "box", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
