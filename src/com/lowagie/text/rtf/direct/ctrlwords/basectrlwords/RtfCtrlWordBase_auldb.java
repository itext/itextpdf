...
public class RtfCtrlWordBase_auldb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_auldb(RtfParser rtfParser){
		super(rtfParser, "auldb", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
