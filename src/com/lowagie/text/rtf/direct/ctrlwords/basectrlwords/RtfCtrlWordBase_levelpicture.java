...
/**
 * Description:
 * 	Determines which picture bullet from the \listpicture
...
public class RtfCtrlWordBase_levelpicture extends RtfCtrlWordBase {

	public RtfCtrlWordBase_levelpicture(RtfParser rtfParser){
		super(rtfParser, "levelpicture", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
