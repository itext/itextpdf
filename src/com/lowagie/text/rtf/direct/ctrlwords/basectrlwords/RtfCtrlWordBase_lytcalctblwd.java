...
public class RtfCtrlWordBase_lytcalctblwd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_lytcalctblwd(RtfParser rtfParser){
		super(rtfParser, "lytcalctblwd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
