...
public class RtfCtrlWordBase_pnaiueo extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnaiueo(RtfParser rtfParser){
		super(rtfParser, "pnaiueo", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
