...
public class RtfCtrlWordBase_tsnowrap extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsnowrap(RtfParser rtfParser){
		super(rtfParser, "tsnowrap", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
