...
public class RtfCtrlWordBase_margb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_margb(RtfParser rtfParser){
		super(rtfParser, "margb", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
