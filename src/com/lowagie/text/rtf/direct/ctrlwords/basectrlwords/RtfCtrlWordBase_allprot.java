...
public class RtfCtrlWordBase_allprot extends RtfCtrlWordBase {

	public RtfCtrlWordBase_allprot(RtfParser rtfParser){
		super(rtfParser, "allprot", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
