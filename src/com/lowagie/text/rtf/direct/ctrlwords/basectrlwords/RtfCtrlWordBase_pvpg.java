...
public class RtfCtrlWordBase_pvpg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pvpg(RtfParser rtfParser){
		super(rtfParser, "pvpg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
