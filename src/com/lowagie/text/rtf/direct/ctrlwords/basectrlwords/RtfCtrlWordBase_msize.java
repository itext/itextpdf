...
public class RtfCtrlWordBase_msize extends RtfCtrlWordBase {

	public RtfCtrlWordBase_msize(RtfParser rtfParser){
		super(rtfParser, "msize", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
