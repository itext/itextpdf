...
/**
 * Description:
 * 	File ID number. Files are referenced later in the document
 * 	using this number.
 * Group:
 * 	File Table
 * Type:
...
public class RtfCtrlWordBase_fid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fid(RtfParser rtfParser){
		super(rtfParser, "fid", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
