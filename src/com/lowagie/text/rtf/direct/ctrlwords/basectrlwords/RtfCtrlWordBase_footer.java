...
public class RtfCtrlWordBase_footer extends RtfCtrlWordBase {

	public RtfCtrlWordBase_footer(RtfParser rtfParser){
		super(rtfParser, "footer", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
