...
public class RtfCtrlWordBase_adn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_adn(RtfParser rtfParser){
		super(rtfParser, "adn", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
