...
public class RtfCtrlWordBase_revprot extends RtfCtrlWordBase {

	public RtfCtrlWordBase_revprot(RtfParser rtfParser){
		super(rtfParser, "revprot", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
