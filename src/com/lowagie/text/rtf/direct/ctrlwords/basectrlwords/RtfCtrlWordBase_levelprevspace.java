...
/**
 * Description:
 * 	,"1 if this level includes the indentation from the previous
 * 	level (used for Word 7.0 compatibility only); otherwise, the
 * 	value is 0. This keyword will only be valid if the
...
public class RtfCtrlWordBase_levelprevspace extends RtfCtrlWordBase {

	public RtfCtrlWordBase_levelprevspace(RtfParser rtfParser){
		super(rtfParser, "levelprevspace", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
