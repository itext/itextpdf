...
public class RtfCtrlWordBase_uldashdd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_uldashdd(RtfParser rtfParser){
		super(rtfParser, "uldashdd", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
