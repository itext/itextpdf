...
public class RtfCtrlWordBase_clsplitr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clsplitr(RtfParser rtfParser){
		super(rtfParser, "clsplitr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
