...
public class RtfCtrlWordBase_revdttm extends RtfCtrlWordBase {

	public RtfCtrlWordBase_revdttm(RtfParser rtfParser){
		super(rtfParser, "revdttm", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
