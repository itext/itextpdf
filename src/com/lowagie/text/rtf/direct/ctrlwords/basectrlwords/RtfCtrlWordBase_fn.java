...
/**
 * Description:
 * 	Specifies a function key where N is the function key number.
 * 	Used to describe shortcut-key codes for styles.
 * Group:
 * 	Style Sheet
 * Type:
 * 	Value
...
public class RtfCtrlWordBase_fn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fn(RtfParser rtfParser){
		super(rtfParser, "fn", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
