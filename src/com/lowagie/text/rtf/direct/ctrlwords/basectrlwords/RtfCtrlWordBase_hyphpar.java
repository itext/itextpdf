...
public class RtfCtrlWordBase_hyphpar extends RtfCtrlWordBase {

	public RtfCtrlWordBase_hyphpar(RtfParser rtfParser){
		super(rtfParser, "hyphpar", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
