...
public class RtfCtrlWordBase_tposxl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tposxl(RtfParser rtfParser){
		super(rtfParser, "tposxl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
