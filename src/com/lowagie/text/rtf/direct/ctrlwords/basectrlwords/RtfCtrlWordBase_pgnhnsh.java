...
public class RtfCtrlWordBase_pgnhnsh extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnhnsh(RtfParser rtfParser){
		super(rtfParser, "pgnhnsh", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
