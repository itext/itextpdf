...
public class RtfCtrlWordBase_nooverflow extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nooverflow(RtfParser rtfParser){
		super(rtfParser, "nooverflow", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
