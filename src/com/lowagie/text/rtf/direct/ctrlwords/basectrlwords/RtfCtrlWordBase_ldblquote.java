...
public class RtfCtrlWordBase_ldblquote extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ldblquote(RtfParser rtfParser){
		super(rtfParser, "ldblquote", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
