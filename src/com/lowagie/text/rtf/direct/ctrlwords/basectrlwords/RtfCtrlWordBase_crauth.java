...
public class RtfCtrlWordBase_crauth extends RtfCtrlWordBase {

	public RtfCtrlWordBase_crauth(RtfParser rtfParser){
		super(rtfParser, "crauth", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
