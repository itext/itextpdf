...
public class RtfCtrlWordBase_objname extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objname(RtfParser rtfParser){
		super(rtfParser, "objname", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
