...
public class RtfCtrlWordBase_pgnchosung extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnchosung(RtfParser rtfParser){
		super(rtfParser, "pgnchosung", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
