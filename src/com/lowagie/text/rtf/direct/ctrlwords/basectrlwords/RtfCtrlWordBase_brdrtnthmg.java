...
public class RtfCtrlWordBase_brdrtnthmg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrtnthmg(RtfParser rtfParser){
		super(rtfParser, "brdrtnthmg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
