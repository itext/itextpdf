...
public class RtfCtrlWordBase_yxe extends RtfCtrlWordBase {

	public RtfCtrlWordBase_yxe(RtfParser rtfParser){
		super(rtfParser, "yxe", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
