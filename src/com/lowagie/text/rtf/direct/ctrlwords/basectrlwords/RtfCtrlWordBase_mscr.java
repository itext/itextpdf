...
public class RtfCtrlWordBase_mscr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mscr(RtfParser rtfParser){
		super(rtfParser, "mscr", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
