 ...
 * 	group is '{?\keycode <keys>'}' where <keys> are the
 * 	characters used in the key code. For example, a style,
 * 	Normal, may be defined {\s0 {\keycode \shift\ctrl n}Normal;}
 * 	within the RTF style sheet. See the Special Character
 * 	control words for the characters outside the alphanumeric
...
public class RtfCtrlWordBase_keycode extends RtfCtrlWordBase {

	public RtfCtrlWordBase_keycode(RtfParser rtfParser){
		super(rtfParser, "keycode", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
