...
public class RtfCtrlWordBase_do extends RtfCtrlWordBase {

	public RtfCtrlWordBase_do(RtfParser rtfParser){
		super(rtfParser, "do", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
