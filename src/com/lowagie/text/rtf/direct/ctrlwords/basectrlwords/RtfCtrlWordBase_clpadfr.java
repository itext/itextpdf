...
public class RtfCtrlWordBase_clpadfr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clpadfr(RtfParser rtfParser){
		super(rtfParser, "clpadfr", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
