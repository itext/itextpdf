...
public class RtfCtrlWordBase_bkmkcolf extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bkmkcolf(RtfParser rtfParser){
		super(rtfParser, "bkmkcolf", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
