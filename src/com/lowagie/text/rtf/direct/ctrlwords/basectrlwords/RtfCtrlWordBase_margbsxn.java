...
public class RtfCtrlWordBase_margbsxn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_margbsxn(RtfParser rtfParser){
		super(rtfParser, "margbsxn", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
