...
public class RtfCtrlWordBase_clsplit extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clsplit(RtfParser rtfParser){
		super(rtfParser, "clsplit", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
