...
public class RtfCtrlWordBase_tscellcfpat extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscellcfpat(RtfParser rtfParser){
		super(rtfParser, "tscellcfpat", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
