...
public class RtfCtrlWordBase_shpbxmargin extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shpbxmargin(RtfParser rtfParser){
		super(rtfParser, "shpbxmargin", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
