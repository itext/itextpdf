...
public class RtfCtrlWordBase_tlmdot extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tlmdot(RtfParser rtfParser){
		super(rtfParser, "tlmdot", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
