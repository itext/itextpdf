...
public class RtfCtrlWordBase_clinsdttm extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clinsdttm(RtfParser rtfParser){
		super(rtfParser, "clinsdttm", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
