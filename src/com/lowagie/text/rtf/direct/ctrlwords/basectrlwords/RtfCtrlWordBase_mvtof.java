...
public class RtfCtrlWordBase_mvtof extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mvtof(RtfParser rtfParser){
		super(rtfParser, "mvtof", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
