...
public class RtfCtrlWordBase_chbgdkcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chbgdkcross(RtfParser rtfParser){
		super(rtfParser, "chbgdkcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
