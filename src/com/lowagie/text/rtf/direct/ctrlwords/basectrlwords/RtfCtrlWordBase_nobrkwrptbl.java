...
public class RtfCtrlWordBase_nobrkwrptbl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nobrkwrptbl(RtfParser rtfParser){
		super(rtfParser, "nobrkwrptbl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
