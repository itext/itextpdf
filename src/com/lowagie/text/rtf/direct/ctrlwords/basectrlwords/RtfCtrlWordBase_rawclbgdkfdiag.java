...
public class RtfCtrlWordBase_rawclbgdkfdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rawclbgdkfdiag(RtfParser rtfParser){
		super(rtfParser, "rawclbgdkfdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
