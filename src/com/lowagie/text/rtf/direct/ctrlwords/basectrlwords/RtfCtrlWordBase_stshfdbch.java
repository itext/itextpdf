 ...
 * 	sheet for East Asian characters.
 * Group:
 * 	Default Fonts
 * Type:
 * 	Value
...
public class RtfCtrlWordBase_stshfdbch extends RtfCtrlWordBase {

	public RtfCtrlWordBase_stshfdbch(RtfParser rtfParser){
		super(rtfParser, "stshfdbch", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
