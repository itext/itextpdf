...
public class RtfCtrlWordBase_uldb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_uldb(RtfParser rtfParser){
		super(rtfParser, "uldb", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
