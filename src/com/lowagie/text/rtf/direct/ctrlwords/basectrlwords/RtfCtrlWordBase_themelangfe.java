...
public class RtfCtrlWordBase_themelangfe extends RtfCtrlWordBase {

	public RtfCtrlWordBase_themelangfe(RtfParser rtfParser){
		super(rtfParser, "themelangfe", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
