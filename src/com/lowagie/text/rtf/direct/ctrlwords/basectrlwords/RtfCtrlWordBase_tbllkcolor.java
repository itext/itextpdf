...
public class RtfCtrlWordBase_tbllkcolor extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tbllkcolor(RtfParser rtfParser){
		super(rtfParser, "tbllkcolor", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
