...
public class RtfCtrlWordBase_ilfomacatclnup extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ilfomacatclnup(RtfParser rtfParser){
		super(rtfParser, "ilfomacatclnup", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
