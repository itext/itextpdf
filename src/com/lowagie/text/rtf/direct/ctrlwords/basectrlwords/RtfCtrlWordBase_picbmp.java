...
public class RtfCtrlWordBase_picbmp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_picbmp(RtfParser rtfParser){
		super(rtfParser, "picbmp", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
