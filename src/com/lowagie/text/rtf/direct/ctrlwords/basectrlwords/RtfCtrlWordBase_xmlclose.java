...
public class RtfCtrlWordBase_xmlclose extends RtfCtrlWordBase {

	public RtfCtrlWordBase_xmlclose(RtfParser rtfParser){
		super(rtfParser, "xmlclose", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
