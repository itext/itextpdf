...
public class RtfCtrlWordBase_bliptag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bliptag(RtfParser rtfParser){
		super(rtfParser, "bliptag", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
