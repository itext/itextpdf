...
/**
 * Description:
 * 	Defines the default language used in the document used with
 * 	a \plain control word. See the section on Font/Character
 * 	Formatting Properties in this Specification for a list of
...
public class RtfCtrlWordBase_deflang extends RtfCtrlWordBase {

	public RtfCtrlWordBase_deflang(RtfParser rtfParser){
		super(rtfParser, "deflang", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
