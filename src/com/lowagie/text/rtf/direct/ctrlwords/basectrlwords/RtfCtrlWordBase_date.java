...
public class RtfCtrlWordBase_date extends RtfCtrlWordBase {

	public RtfCtrlWordBase_date(RtfParser rtfParser){
		super(rtfParser, "date", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
