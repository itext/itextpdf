...
public class RtfCtrlWordBase_ftnngbnumd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnngbnumd(RtfParser rtfParser){
		super(rtfParser, "ftnngbnumd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
