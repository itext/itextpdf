...
public class RtfCtrlWordBase_tsbrdrt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsbrdrt(RtfParser rtfParser){
		super(rtfParser, "tsbrdrt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
