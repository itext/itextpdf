...
public class RtfCtrlWordBase_objpub extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objpub(RtfParser rtfParser){
		super(rtfParser, "objpub", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
