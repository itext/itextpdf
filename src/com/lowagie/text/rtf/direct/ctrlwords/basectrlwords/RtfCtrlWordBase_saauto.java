...
public class RtfCtrlWordBase_saauto extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saauto(RtfParser rtfParser){
		super(rtfParser, "saauto", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
