...
public class RtfCtrlWordBase_sftnrestart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnrestart(RtfParser rtfParser){
		super(rtfParser, "sftnrestart", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
