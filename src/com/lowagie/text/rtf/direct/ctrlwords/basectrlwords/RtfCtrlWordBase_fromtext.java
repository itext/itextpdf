...
public class RtfCtrlWordBase_fromtext extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fromtext(RtfParser rtfParser){
		super(rtfParser, "fromtext", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
