...
public class RtfCtrlWordBase_phnthaia extends RtfCtrlWordBase {

	public RtfCtrlWordBase_phnthaia(RtfParser rtfParser){
		super(rtfParser, "phnthaia", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
