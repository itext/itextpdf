...
public class RtfCtrlWordBase_tposx extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tposx(RtfParser rtfParser){
		super(rtfParser, "tposx", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
