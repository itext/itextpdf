...
public class RtfCtrlWordBase_row extends RtfCtrlWordBase {

	public RtfCtrlWordBase_row(RtfParser rtfParser){
		super(rtfParser, "row", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
