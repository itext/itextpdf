...
public class RtfCtrlWordBase_pmartabql extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pmartabql(RtfParser rtfParser){
		super(rtfParser, "pmartabql", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
