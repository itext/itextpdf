...
public class RtfCtrlWordBase_nosupersub extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nosupersub(RtfParser rtfParser){
		super(rtfParser, "nosupersub", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
