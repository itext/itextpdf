...
public class RtfCtrlWordBase_shading extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shading(RtfParser rtfParser){
		super(rtfParser, "shading", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
