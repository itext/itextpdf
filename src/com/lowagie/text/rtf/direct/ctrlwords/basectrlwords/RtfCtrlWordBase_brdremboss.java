...
public class RtfCtrlWordBase_brdremboss extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdremboss(RtfParser rtfParser){
		super(rtfParser, "brdremboss", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
