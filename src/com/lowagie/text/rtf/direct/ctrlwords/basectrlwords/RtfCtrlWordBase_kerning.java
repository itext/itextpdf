...
public class RtfCtrlWordBase_kerning extends RtfCtrlWordBase {

	public RtfCtrlWordBase_kerning(RtfParser rtfParser){
		super(rtfParser, "kerning", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
