...
public class RtfCtrlWordBase_dpaendhol extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpaendhol(RtfParser rtfParser){
		super(rtfParser, "dpaendhol", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
