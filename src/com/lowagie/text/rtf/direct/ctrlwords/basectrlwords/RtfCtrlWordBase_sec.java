...
public class RtfCtrlWordBase_sec extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sec(RtfParser rtfParser){
		super(rtfParser, "sec", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
