...
public class RtfCtrlWordBase_trpaddft extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trpaddft(RtfParser rtfParser){
		super(rtfParser, "trpaddft", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
