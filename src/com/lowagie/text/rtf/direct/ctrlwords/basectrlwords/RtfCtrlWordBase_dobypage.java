...
public class RtfCtrlWordBase_dobypage extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dobypage(RtfParser rtfParser){
		super(rtfParser, "dobypage", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
