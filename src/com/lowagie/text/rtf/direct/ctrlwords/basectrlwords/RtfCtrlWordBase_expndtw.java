...
public class RtfCtrlWordBase_expndtw extends RtfCtrlWordBase {

	public RtfCtrlWordBase_expndtw(RtfParser rtfParser){
		super(rtfParser, "expndtw", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
