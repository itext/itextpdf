...
public class RtfCtrlWordBase_brdrsh extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrsh(RtfParser rtfParser){
		super(rtfParser, "brdrsh", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
