...
public class RtfCtrlWordBase_ftnndbnum extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnndbnum(RtfParser rtfParser){
		super(rtfParser, "ftnndbnum", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
