...
public class RtfCtrlWordBase_linkstyles extends RtfCtrlWordBase {

	public RtfCtrlWordBase_linkstyles(RtfParser rtfParser){
		super(rtfParser, "linkstyles", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
