...
public class RtfCtrlWordBase_tscbandsv extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscbandsv(RtfParser rtfParser){
		super(rtfParser, "tscbandsv", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
