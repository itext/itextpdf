...
public class RtfCtrlWordBase_dptxbxmar extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dptxbxmar(RtfParser rtfParser){
		super(rtfParser, "dptxbxmar", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
