...
public class RtfCtrlWordBase_dppolyline extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dppolyline(RtfParser rtfParser){
		super(rtfParser, "dppolyline", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
