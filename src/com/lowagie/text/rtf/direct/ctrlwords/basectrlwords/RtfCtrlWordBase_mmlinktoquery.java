...
public class RtfCtrlWordBase_mmlinktoquery extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmlinktoquery(RtfParser rtfParser){
		super(rtfParser, "mmlinktoquery", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
