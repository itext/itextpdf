...
public class RtfCtrlWordBase_mfname extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mfname(RtfParser rtfParser){
		super(rtfParser, "mfname", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
