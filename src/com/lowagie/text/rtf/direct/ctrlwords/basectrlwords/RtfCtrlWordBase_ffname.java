...
public class RtfCtrlWordBase_ffname extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ffname(RtfParser rtfParser){
		super(rtfParser, "ffname", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
