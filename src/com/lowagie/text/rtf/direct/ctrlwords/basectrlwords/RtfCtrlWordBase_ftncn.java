...
public class RtfCtrlWordBase_ftncn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftncn(RtfParser rtfParser){
		super(rtfParser, "ftncn", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
