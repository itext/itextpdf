...
public class RtfCtrlWordBase_pgnthaia extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnthaia(RtfParser rtfParser){
		super(rtfParser, "pgnthaia", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
