...
public class RtfCtrlWordBase_lineppage extends RtfCtrlWordBase {

	public RtfCtrlWordBase_lineppage(RtfParser rtfParser){
		super(rtfParser, "lineppage", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
