...
/**
 * Description:
 * 	,"Style does not appear in the Styles drop-down list in the
 * 	Style dialog box  (on the Format menu, click Styles).
 * Group:
 * 	Style Sheet
 * Type:
 * 	Flag
...
public class RtfCtrlWordBase_shidden extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shidden(RtfParser rtfParser){
		super(rtfParser, "shidden", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
