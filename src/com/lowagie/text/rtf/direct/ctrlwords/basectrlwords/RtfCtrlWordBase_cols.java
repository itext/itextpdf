...
public class RtfCtrlWordBase_cols extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cols(RtfParser rtfParser){
		super(rtfParser, "cols", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
