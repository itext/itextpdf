...
public class RtfCtrlWordBase_cldelauth extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cldelauth(RtfParser rtfParser){
		super(rtfParser, "cldelauth", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
