...
public class RtfCtrlWordBase_momathparapr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_momathparapr(RtfParser rtfParser){
		super(rtfParser, "momathparapr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
