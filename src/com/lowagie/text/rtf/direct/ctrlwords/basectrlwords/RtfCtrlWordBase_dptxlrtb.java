...
public class RtfCtrlWordBase_dptxlrtb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dptxlrtb(RtfParser rtfParser){
		super(rtfParser, "dptxlrtb", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
