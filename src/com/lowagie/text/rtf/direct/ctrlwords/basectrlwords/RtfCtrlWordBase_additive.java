...
/**
 * Description:
 * 	,"Used in a character style definition ('{'\cs?'}').
 * 	Indicates that character style attributes are to be added to
 * 	the current paragraph style attributes, rather than setting
 * 	the paragraph attributes to only those defined in the
...
public class RtfCtrlWordBase_additive extends RtfCtrlWordBase {

	public RtfCtrlWordBase_additive(RtfParser rtfParser){
		super(rtfParser, "additive", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
