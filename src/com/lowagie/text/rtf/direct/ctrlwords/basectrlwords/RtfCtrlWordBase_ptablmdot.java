...
public class RtfCtrlWordBase_ptablmdot extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ptablmdot(RtfParser rtfParser){
		super(rtfParser, "ptablmdot", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
