...
public class RtfCtrlWordBase_chbgdkfdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chbgdkfdiag(RtfParser rtfParser){
		super(rtfParser, "chbgdkfdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
