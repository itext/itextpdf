...
public class RtfCtrlWordBase_pnzodiac extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnzodiac(RtfParser rtfParser){
		super(rtfParser, "pnzodiac", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
