...
public class RtfCtrlWordBase_dpcominusy extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpcominusy(RtfParser rtfParser){
		super(rtfParser, "dpcominusy", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
