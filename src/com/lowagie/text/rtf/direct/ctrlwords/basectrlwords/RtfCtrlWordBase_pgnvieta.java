...
public class RtfCtrlWordBase_pgnvieta extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnvieta(RtfParser rtfParser){
		super(rtfParser, "pgnvieta", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
