...
public class RtfCtrlWordBase_wbmbitspixel extends RtfCtrlWordBase {

	public RtfCtrlWordBase_wbmbitspixel(RtfParser rtfParser){
		super(rtfParser, "wbmbitspixel", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
