...
public class RtfCtrlWordBase_rslthtml extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rslthtml(RtfParser rtfParser){
		super(rtfParser, "rslthtml", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
