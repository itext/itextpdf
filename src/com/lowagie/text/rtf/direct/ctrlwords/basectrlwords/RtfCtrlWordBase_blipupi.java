...
public class RtfCtrlWordBase_blipupi extends RtfCtrlWordBase {

	public RtfCtrlWordBase_blipupi(RtfParser rtfParser){
		super(rtfParser, "blipupi", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
