...
public class RtfCtrlWordBase_endash extends RtfCtrlWordBase {

	public RtfCtrlWordBase_endash(RtfParser rtfParser){
		super(rtfParser, "endash", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
