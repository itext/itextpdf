...
public class RtfCtrlWordBase_langfe extends RtfCtrlWordBase {

	public RtfCtrlWordBase_langfe(RtfParser rtfParser){
		super(rtfParser, "langfe", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
