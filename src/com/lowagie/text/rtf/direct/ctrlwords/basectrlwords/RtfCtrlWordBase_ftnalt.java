...
public class RtfCtrlWordBase_ftnalt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnalt(RtfParser rtfParser){
		super(rtfParser, "ftnalt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
