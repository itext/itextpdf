...
public class RtfCtrlWordBase_trhdr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trhdr(RtfParser rtfParser){
		super(rtfParser, "trhdr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
