...
public class RtfCtrlWordBase_saftnngbnumd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnngbnumd(RtfParser rtfParser){
		super(rtfParser, "saftnngbnumd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
