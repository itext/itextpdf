...
public class RtfCtrlWordBase_atnicn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_atnicn(RtfParser rtfParser){
		super(rtfParser, "atnicn", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
