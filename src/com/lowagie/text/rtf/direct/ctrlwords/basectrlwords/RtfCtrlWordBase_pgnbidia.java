...
public class RtfCtrlWordBase_pgnbidia extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnbidia(RtfParser rtfParser){
		super(rtfParser, "pgnbidia", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
