...
public class RtfCtrlWordBase_mac extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mac(RtfParser rtfParser){
		super(rtfParser, "mac", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
