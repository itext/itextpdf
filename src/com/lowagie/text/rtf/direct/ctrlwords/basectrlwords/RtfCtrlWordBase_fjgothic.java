...
public class RtfCtrlWordBase_fjgothic extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fjgothic(RtfParser rtfParser){
		super(rtfParser, "fjgothic", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
