...
public class RtfCtrlWordBase_pvmrg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pvmrg(RtfParser rtfParser){
		super(rtfParser, "pvmrg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
