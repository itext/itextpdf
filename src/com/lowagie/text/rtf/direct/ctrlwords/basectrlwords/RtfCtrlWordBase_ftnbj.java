...
public class RtfCtrlWordBase_ftnbj extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnbj(RtfParser rtfParser){
		super(rtfParser, "ftnbj", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
