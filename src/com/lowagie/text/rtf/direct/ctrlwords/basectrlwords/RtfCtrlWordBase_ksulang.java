...
public class RtfCtrlWordBase_ksulang extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ksulang(RtfParser rtfParser){
		super(rtfParser, "ksulang", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
