...
public class RtfCtrlWordBase_picbpp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_picbpp(RtfParser rtfParser){
		super(rtfParser, "picbpp", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
