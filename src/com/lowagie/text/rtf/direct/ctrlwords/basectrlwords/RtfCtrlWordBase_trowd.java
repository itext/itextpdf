...
public class RtfCtrlWordBase_trowd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trowd(RtfParser rtfParser){
		super(rtfParser, "trowd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
