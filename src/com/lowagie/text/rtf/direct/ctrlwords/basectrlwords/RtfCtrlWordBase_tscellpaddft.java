...
public class RtfCtrlWordBase_tscellpaddft extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscellpaddft(RtfParser rtfParser){
		super(rtfParser, "tscellpaddft", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
