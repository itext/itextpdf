...
public class RtfCtrlWordBase_dpline extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpline(RtfParser rtfParser){
		super(rtfParser, "dpline", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
