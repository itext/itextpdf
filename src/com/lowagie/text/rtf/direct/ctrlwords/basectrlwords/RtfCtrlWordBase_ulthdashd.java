...
public class RtfCtrlWordBase_ulthdashd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ulthdashd(RtfParser rtfParser){
		super(rtfParser, "ulthdashd", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
