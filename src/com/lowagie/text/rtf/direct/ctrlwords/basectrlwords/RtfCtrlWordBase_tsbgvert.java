...
public class RtfCtrlWordBase_tsbgvert extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsbgvert(RtfParser rtfParser){
		super(rtfParser, "tsbgvert", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
