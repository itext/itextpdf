...
public class RtfCtrlWordBase_ffownhelp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ffownhelp(RtfParser rtfParser){
		super(rtfParser, "ffownhelp", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
