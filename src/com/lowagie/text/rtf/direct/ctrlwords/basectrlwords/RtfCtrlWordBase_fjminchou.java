...
public class RtfCtrlWordBase_fjminchou extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fjminchou(RtfParser rtfParser){
		super(rtfParser, "fjminchou", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
