...
public class RtfCtrlWordBase_pgnucrm extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnucrm(RtfParser rtfParser){
		super(rtfParser, "pgnucrm", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
