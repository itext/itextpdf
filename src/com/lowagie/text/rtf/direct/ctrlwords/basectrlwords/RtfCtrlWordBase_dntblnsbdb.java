...
public class RtfCtrlWordBase_dntblnsbdb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dntblnsbdb(RtfParser rtfParser){
		super(rtfParser, "dntblnsbdb", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
