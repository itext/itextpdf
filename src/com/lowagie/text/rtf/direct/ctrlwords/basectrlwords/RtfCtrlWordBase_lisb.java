...
public class RtfCtrlWordBase_lisb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_lisb(RtfParser rtfParser){
		super(rtfParser, "lisb", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
