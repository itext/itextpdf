...
public class RtfCtrlWordBase_dpfillbggray extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpfillbggray(RtfParser rtfParser){
		super(rtfParser, "dpfillbggray", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
