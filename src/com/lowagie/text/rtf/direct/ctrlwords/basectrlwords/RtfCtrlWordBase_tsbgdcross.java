...
public class RtfCtrlWordBase_tsbgdcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsbgdcross(RtfParser rtfParser){
		super(rtfParser, "tsbgdcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
