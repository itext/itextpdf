...
public class RtfCtrlWordBase_tbllkborder extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tbllkborder(RtfParser rtfParser){
		super(rtfParser, "tbllkborder", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
