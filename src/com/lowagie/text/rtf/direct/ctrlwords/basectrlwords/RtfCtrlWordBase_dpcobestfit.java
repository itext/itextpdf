...
public class RtfCtrlWordBase_dpcobestfit extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpcobestfit(RtfParser rtfParser){
		super(rtfParser, "dpcobestfit", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
