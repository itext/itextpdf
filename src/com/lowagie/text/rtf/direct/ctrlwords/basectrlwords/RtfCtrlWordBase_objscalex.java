...
public class RtfCtrlWordBase_objscalex extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objscalex(RtfParser rtfParser){
		super(rtfParser, "objscalex", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
