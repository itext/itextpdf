...
/**
 * Description:
 * 	RSID value identifying when character formatting was
 * 	changed.
 * Group:
...
public class RtfCtrlWordBase_charrsid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_charrsid(RtfParser rtfParser){
		super(rtfParser, "charrsid", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
