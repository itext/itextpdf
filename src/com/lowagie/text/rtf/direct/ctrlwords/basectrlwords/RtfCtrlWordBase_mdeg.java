...
public class RtfCtrlWordBase_mdeg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mdeg(RtfParser rtfParser){
		super(rtfParser, "mdeg", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
