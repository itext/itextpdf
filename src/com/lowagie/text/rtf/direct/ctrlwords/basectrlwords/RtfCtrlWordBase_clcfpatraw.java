...
public class RtfCtrlWordBase_clcfpatraw extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clcfpatraw(RtfParser rtfParser){
		super(rtfParser, "clcfpatraw", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
