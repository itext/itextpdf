...
public class RtfCtrlWordBase_deflangfe extends RtfCtrlWordBase {

	public RtfCtrlWordBase_deflangfe(RtfParser rtfParser){
		super(rtfParser, "deflangfe", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
