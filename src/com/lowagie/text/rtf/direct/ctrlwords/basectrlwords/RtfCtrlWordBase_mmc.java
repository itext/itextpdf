...
public class RtfCtrlWordBase_mmc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmc(RtfParser rtfParser){
		super(rtfParser, "mmc", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
