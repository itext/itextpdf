...
public class RtfCtrlWordBase_phcol extends RtfCtrlWordBase {

	public RtfCtrlWordBase_phcol(RtfParser rtfParser){
		super(rtfParser, "phcol", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
