...
public class RtfCtrlWordBase_viewnobound extends RtfCtrlWordBase {

	public RtfCtrlWordBase_viewnobound(RtfParser rtfParser){
		super(rtfParser, "viewnobound", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
