...
public class RtfCtrlWordBase_dobxmargin extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dobxmargin(RtfParser rtfParser){
		super(rtfParser, "dobxmargin", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
