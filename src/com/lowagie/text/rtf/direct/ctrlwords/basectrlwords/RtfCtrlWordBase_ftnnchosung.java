...
public class RtfCtrlWordBase_ftnnchosung extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnnchosung(RtfParser rtfParser){
		super(rtfParser, "ftnnchosung", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
