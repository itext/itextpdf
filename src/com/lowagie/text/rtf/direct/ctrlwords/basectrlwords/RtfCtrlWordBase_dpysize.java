...
public class RtfCtrlWordBase_dpysize extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpysize(RtfParser rtfParser){
		super(rtfParser, "dpysize", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
