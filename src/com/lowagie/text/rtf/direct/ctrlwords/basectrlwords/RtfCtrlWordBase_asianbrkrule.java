...
public class RtfCtrlWordBase_asianbrkrule extends RtfCtrlWordBase {

	public RtfCtrlWordBase_asianbrkrule(RtfParser rtfParser){
		super(rtfParser, "asianbrkrule", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
