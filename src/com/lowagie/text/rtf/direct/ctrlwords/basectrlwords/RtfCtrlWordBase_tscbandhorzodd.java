...
public class RtfCtrlWordBase_tscbandhorzodd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscbandhorzodd(RtfParser rtfParser){
		super(rtfParser, "tscbandhorzodd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
