...
public class RtfCtrlWordBase_fnil extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fnil(RtfParser rtfParser){
		super(rtfParser, "fnil", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
