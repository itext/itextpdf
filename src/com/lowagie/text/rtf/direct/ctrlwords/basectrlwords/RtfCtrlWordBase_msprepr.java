...
public class RtfCtrlWordBase_msprepr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_msprepr(RtfParser rtfParser){
		super(rtfParser, "msprepr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
