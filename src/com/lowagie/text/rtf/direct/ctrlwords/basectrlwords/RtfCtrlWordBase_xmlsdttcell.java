...
public class RtfCtrlWordBase_xmlsdttcell extends RtfCtrlWordBase {

	public RtfCtrlWordBase_xmlsdttcell(RtfParser rtfParser){
		super(rtfParser, "xmlsdttcell", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
