...
public class RtfCtrlWordBase_wpjst extends RtfCtrlWordBase {

	public RtfCtrlWordBase_wpjst(RtfParser rtfParser){
		super(rtfParser, "wpjst", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
