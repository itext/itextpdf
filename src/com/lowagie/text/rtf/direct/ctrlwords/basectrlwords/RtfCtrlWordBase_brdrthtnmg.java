...
public class RtfCtrlWordBase_brdrthtnmg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrthtnmg(RtfParser rtfParser){
		super(rtfParser, "brdrthtnmg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
