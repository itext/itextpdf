...
public class RtfCtrlWordBase_cfpat extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cfpat(RtfParser rtfParser){
		super(rtfParser, "cfpat", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
