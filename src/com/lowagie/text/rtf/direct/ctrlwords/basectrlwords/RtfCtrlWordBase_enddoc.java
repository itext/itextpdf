...
public class RtfCtrlWordBase_enddoc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_enddoc(RtfParser rtfParser){
		super(rtfParser, "enddoc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
