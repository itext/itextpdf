...
public class RtfCtrlWordBase_dobxcolumn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dobxcolumn(RtfParser rtfParser){
		super(rtfParser, "dobxcolumn", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
