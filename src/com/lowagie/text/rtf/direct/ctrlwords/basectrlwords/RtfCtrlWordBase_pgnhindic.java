...
public class RtfCtrlWordBase_pgnhindic extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnhindic(RtfParser rtfParser){
		super(rtfParser, "pgnhindic", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
