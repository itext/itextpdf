...
public class RtfCtrlWordBase_mendchr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mendchr(RtfParser rtfParser){
		super(rtfParser, "mendchr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
