...
public class RtfCtrlWordBase_noextrasprl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_noextrasprl(RtfParser rtfParser){
		super(rtfParser, "noextrasprl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
