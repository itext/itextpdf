...
public class RtfCtrlWordBase_pnirohad extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnirohad(RtfParser rtfParser){
		super(rtfParser, "pnirohad", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
