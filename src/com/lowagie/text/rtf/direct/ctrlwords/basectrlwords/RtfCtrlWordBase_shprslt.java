...
public class RtfCtrlWordBase_shprslt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shprslt(RtfParser rtfParser){
		super(rtfParser, "shprslt", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
