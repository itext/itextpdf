...
public class RtfCtrlWordBase_irowband extends RtfCtrlWordBase {

	public RtfCtrlWordBase_irowband(RtfParser rtfParser){
		super(rtfParser, "irowband", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
