...
/**
 * Description:
 * 	,"Designates section style.::Designates section style. If a
 * 	section style is specified, style properties must be
...
public class RtfCtrlWordBase_ds extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ds(RtfParser rtfParser){
		super(rtfParser, "ds", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
