...
public class RtfCtrlWordBase_aftnndbnumt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnndbnumt(RtfParser rtfParser){
		super(rtfParser, "aftnndbnumt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
