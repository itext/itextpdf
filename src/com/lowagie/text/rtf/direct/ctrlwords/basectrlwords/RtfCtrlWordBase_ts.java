...
/**
 * Description:
 * 	,"Designates table style, in the same style as \cs for
...
public class RtfCtrlWordBase_ts extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ts(RtfParser rtfParser){
		super(rtfParser, "ts", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
