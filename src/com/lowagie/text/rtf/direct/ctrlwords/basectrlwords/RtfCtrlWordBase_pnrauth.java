...
public class RtfCtrlWordBase_pnrauth extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnrauth(RtfParser rtfParser){
		super(rtfParser, "pnrauth", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
