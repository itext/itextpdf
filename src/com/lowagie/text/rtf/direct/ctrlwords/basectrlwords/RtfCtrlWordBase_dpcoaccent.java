...
public class RtfCtrlWordBase_dpcoaccent extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpcoaccent(RtfParser rtfParser){
		super(rtfParser, "dpcoaccent", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
