...
public class RtfCtrlWordBase_pgny extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgny(RtfParser rtfParser){
		super(rtfParser, "pgny", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
