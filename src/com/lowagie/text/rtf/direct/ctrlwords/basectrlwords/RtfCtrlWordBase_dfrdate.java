...
public class RtfCtrlWordBase_dfrdate extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dfrdate(RtfParser rtfParser){
		super(rtfParser, "dfrdate", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
