...
public class RtfCtrlWordBase_tblrsid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tblrsid(RtfParser rtfParser){
		super(rtfParser, "tblrsid", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
