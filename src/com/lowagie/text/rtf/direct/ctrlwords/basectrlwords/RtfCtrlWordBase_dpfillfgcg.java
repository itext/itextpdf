...
public class RtfCtrlWordBase_dpfillfgcg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpfillfgcg(RtfParser rtfParser){
		super(rtfParser, "dpfillfgcg", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
