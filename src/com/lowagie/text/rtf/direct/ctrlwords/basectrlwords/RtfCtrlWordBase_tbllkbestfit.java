...
public class RtfCtrlWordBase_tbllkbestfit extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tbllkbestfit(RtfParser rtfParser){
		super(rtfParser, "tbllkbestfit", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
