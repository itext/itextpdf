...
public class RtfCtrlWordBase_mdefjc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mdefjc(RtfParser rtfParser){
		super(rtfParser, "mdefjc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
