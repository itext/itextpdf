...
public class RtfCtrlWordBase_objdata extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objdata(RtfParser rtfParser){
		super(rtfParser, "objdata", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
