...
public class RtfCtrlWordBase_saftnndbnumt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnndbnumt(RtfParser rtfParser){
		super(rtfParser, "saftnndbnumt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
