...
public class RtfCtrlWordBase_oldas extends RtfCtrlWordBase {

	public RtfCtrlWordBase_oldas(RtfParser rtfParser){
		super(rtfParser, "oldas", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
