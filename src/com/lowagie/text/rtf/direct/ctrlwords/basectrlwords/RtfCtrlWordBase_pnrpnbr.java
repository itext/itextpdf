...
public class RtfCtrlWordBase_pnrpnbr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnrpnbr(RtfParser rtfParser){
		super(rtfParser, "pnrpnbr", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
