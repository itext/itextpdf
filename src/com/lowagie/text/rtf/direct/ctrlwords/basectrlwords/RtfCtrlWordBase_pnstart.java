...
public class RtfCtrlWordBase_pnstart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnstart(RtfParser rtfParser){
		super(rtfParser, "pnstart", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
