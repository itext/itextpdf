...
public class RtfCtrlWordBase_clshdrawnil extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clshdrawnil(RtfParser rtfParser){
		super(rtfParser, "clshdrawnil", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
