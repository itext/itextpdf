...
public class RtfCtrlWordBase_lsdstimax extends RtfCtrlWordBase {

	public RtfCtrlWordBase_lsdstimax(RtfParser rtfParser){
		super(rtfParser, "lsdstimax", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
