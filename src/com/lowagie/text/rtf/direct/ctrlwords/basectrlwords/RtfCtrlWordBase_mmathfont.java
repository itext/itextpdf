...
public class RtfCtrlWordBase_mmathfont extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmathfont(RtfParser rtfParser){
		super(rtfParser, "mmathfont", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
