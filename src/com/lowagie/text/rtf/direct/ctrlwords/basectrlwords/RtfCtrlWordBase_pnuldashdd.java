...
public class RtfCtrlWordBase_pnuldashdd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnuldashdd(RtfParser rtfParser){
		super(rtfParser, "pnuldashdd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
