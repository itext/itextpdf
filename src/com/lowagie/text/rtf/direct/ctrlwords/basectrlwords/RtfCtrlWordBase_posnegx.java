...
public class RtfCtrlWordBase_posnegx extends RtfCtrlWordBase {

	public RtfCtrlWordBase_posnegx(RtfParser rtfParser){
		super(rtfParser, "posnegx", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
