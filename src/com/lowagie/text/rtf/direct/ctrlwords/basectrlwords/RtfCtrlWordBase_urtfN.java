...
public class RtfCtrlWordBase_urtfN extends RtfCtrlWordBase {

	public RtfCtrlWordBase_urtfN(RtfParser rtfParser){
		super(rtfParser, "urtfN", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
