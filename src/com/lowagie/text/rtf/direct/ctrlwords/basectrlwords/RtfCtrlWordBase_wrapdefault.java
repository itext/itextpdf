...
public class RtfCtrlWordBase_wrapdefault extends RtfCtrlWordBase {

	public RtfCtrlWordBase_wrapdefault(RtfParser rtfParser){
		super(rtfParser, "wrapdefault", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
