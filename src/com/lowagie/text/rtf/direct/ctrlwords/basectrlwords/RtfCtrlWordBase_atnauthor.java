...
public class RtfCtrlWordBase_atnauthor extends RtfCtrlWordBase {

	public RtfCtrlWordBase_atnauthor(RtfParser rtfParser){
		super(rtfParser, "atnauthor", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
