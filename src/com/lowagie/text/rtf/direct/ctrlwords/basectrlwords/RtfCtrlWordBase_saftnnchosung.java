...
public class RtfCtrlWordBase_saftnnchosung extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnnchosung(RtfParser rtfParser){
		super(rtfParser, "saftnnchosung", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
