...
public class RtfCtrlWordBase_fracwidth extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fracwidth(RtfParser rtfParser){
		super(rtfParser, "fracwidth", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
