...
/**
 * Description:
 * 	1 if this level was converted from Word 6.0 or Word 7.0; 0
 * 	if it is a native Word 97 through Word 2007 level.
 * Group:
 * 	List Table
 * Type:
 * 	Value
...
public class RtfCtrlWordBase_levelold extends RtfCtrlWordBase {

	public RtfCtrlWordBase_levelold(RtfParser rtfParser){
		super(rtfParser, "levelold", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
