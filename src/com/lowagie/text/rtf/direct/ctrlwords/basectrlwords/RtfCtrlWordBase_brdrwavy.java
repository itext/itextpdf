...
public class RtfCtrlWordBase_brdrwavy extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrwavy(RtfParser rtfParser){
		super(rtfParser, "brdrwavy", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
