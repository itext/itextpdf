...
public class RtfCtrlWordBase_pni extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pni(RtfParser rtfParser){
		super(rtfParser, "pni", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
