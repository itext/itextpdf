...
public class RtfCtrlWordBase_htmltag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_htmltag(RtfParser rtfParser){
		super(rtfParser, "htmltag", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
