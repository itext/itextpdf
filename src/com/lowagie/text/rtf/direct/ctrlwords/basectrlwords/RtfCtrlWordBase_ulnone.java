...
public class RtfCtrlWordBase_ulnone extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ulnone(RtfParser rtfParser){
		super(rtfParser, "ulnone", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
