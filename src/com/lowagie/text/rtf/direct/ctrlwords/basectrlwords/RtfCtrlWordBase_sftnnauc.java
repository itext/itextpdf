...
public class RtfCtrlWordBase_sftnnauc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnnauc(RtfParser rtfParser){
		super(rtfParser, "sftnnauc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
