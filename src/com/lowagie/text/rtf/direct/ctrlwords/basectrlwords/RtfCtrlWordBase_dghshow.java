...
public class RtfCtrlWordBase_dghshow extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dghshow(RtfParser rtfParser){
		super(rtfParser, "dghshow", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
