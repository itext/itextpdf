...
public class RtfCtrlWordBase_yr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_yr(RtfParser rtfParser){
		super(rtfParser, "yr", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
