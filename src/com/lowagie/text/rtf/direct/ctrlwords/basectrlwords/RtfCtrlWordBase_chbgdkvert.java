...
public class RtfCtrlWordBase_chbgdkvert extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chbgdkvert(RtfParser rtfParser){
		super(rtfParser, "chbgdkvert", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
