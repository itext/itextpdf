...
public class RtfCtrlWordBase_mssubsuppr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mssubsuppr(RtfParser rtfParser){
		super(rtfParser, "mssubsuppr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
