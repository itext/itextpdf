...
public class RtfCtrlWordBase_userprops extends RtfCtrlWordBase {

	public RtfCtrlWordBase_userprops(RtfParser rtfParser){
		super(rtfParser, "userprops", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
