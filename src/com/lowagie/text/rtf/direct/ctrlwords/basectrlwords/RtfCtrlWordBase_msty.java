...
public class RtfCtrlWordBase_msty extends RtfCtrlWordBase {

	public RtfCtrlWordBase_msty(RtfParser rtfParser){
		super(rtfParser, "msty", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
