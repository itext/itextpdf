...
public class RtfCtrlWordBase_tsclastrow extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsclastrow(RtfParser rtfParser){
		super(rtfParser, "tsclastrow", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
