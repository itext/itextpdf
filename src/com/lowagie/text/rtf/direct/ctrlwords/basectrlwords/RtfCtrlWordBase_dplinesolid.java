...
public class RtfCtrlWordBase_dplinesolid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dplinesolid(RtfParser rtfParser){
		super(rtfParser, "dplinesolid", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
