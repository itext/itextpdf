...
public class RtfCtrlWordBase_ai extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ai(RtfParser rtfParser){
		super(rtfParser, "ai", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
