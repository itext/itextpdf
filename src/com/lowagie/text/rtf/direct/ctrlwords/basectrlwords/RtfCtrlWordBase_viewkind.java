...
public class RtfCtrlWordBase_viewkind extends RtfCtrlWordBase {

	public RtfCtrlWordBase_viewkind(RtfParser rtfParser){
		super(rtfParser, "viewkind", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
