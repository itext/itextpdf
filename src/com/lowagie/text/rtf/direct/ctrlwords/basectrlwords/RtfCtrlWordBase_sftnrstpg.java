...
public class RtfCtrlWordBase_sftnrstpg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnrstpg(RtfParser rtfParser){
		super(rtfParser, "sftnrstpg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
