...
/**
 * Description:
 * 	Defines what font should be used by default in the style
 * 	sheet for Complex Scripts (BiDi) characters.
 * Group:
 * 	Default Fonts
 * Type:
 * 	Value
...
public class RtfCtrlWordBase_stshfbi extends RtfCtrlWordBase {

	public RtfCtrlWordBase_stshfbi(RtfParser rtfParser){
		super(rtfParser, "stshfbi", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
