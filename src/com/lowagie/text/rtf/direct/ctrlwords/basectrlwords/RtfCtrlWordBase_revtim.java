...
public class RtfCtrlWordBase_revtim extends RtfCtrlWordBase {

	public RtfCtrlWordBase_revtim(RtfParser rtfParser){
		super(rtfParser, "revtim", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
