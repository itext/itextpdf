...
public class RtfCtrlWordBase_pard extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pard(RtfParser rtfParser){
		super(rtfParser, "pard", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
