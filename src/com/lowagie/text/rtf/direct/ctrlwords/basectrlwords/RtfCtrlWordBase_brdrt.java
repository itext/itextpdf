...
public class RtfCtrlWordBase_brdrt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrt(RtfParser rtfParser){
		super(rtfParser, "brdrt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
