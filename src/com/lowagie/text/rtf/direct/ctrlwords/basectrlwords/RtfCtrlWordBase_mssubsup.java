...
public class RtfCtrlWordBase_mssubsup extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mssubsup(RtfParser rtfParser){
		super(rtfParser, "mssubsup", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
