...
public class RtfCtrlWordBase_cf extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cf(RtfParser rtfParser){
		super(rtfParser, "cf", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
