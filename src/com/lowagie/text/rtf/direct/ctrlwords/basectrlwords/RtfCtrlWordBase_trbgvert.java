...
public class RtfCtrlWordBase_trbgvert extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trbgvert(RtfParser rtfParser){
		super(rtfParser, "trbgvert", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
