...
public class RtfCtrlWordBase_saftnnganada extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnnganada(RtfParser rtfParser){
		super(rtfParser, "saftnnganada", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
