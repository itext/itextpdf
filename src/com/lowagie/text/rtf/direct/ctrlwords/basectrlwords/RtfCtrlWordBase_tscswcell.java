...
public class RtfCtrlWordBase_tscswcell extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscswcell(RtfParser rtfParser){
		super(rtfParser, "tscswcell", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
