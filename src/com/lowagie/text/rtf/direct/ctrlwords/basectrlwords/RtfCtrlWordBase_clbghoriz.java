...
public class RtfCtrlWordBase_clbghoriz extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clbghoriz(RtfParser rtfParser){
		super(rtfParser, "clbghoriz", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
