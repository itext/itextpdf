...
public class RtfCtrlWordBase_mmathpr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmathpr(RtfParser rtfParser){
		super(rtfParser, "mmathpr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
