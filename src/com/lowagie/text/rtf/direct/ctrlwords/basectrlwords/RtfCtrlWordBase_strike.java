...
public class RtfCtrlWordBase_strike extends RtfCtrlWordBase {

	public RtfCtrlWordBase_strike(RtfParser rtfParser){
		super(rtfParser, "strike", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
