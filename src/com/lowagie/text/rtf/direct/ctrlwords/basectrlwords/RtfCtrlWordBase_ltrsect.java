...
public class RtfCtrlWordBase_ltrsect extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ltrsect(RtfParser rtfParser){
		super(rtfParser, "ltrsect", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
