...
public class RtfCtrlWordBase_min extends RtfCtrlWordBase {

	public RtfCtrlWordBase_min(RtfParser rtfParser){
		super(rtfParser, "min", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
