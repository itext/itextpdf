...
public class RtfCtrlWordBase_sftnndbnumt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnndbnumt(RtfParser rtfParser){
		super(rtfParser, "sftnndbnumt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
