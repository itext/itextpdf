...
public class RtfCtrlWordBase_vertalt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_vertalt(RtfParser rtfParser){
		super(rtfParser, "vertalt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
