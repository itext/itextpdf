...
public class RtfCtrlWordBase_bgcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bgcross(RtfParser rtfParser){
		super(rtfParser, "bgcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
