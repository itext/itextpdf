...
public class RtfCtrlWordBase_level extends RtfCtrlWordBase {

	public RtfCtrlWordBase_level(RtfParser rtfParser){
		super(rtfParser, "level", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
