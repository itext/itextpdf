...
public class RtfCtrlWordBase_pnlcltr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnlcltr(RtfParser rtfParser){
		super(rtfParser, "pnlcltr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
