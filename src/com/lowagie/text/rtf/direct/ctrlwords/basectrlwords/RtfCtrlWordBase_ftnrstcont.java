...
public class RtfCtrlWordBase_ftnrstcont extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnrstcont(RtfParser rtfParser){
		super(rtfParser, "ftnrstcont", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
