...
public class RtfCtrlWordBase_shplockanchor extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shplockanchor(RtfParser rtfParser){
		super(rtfParser, "shplockanchor", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
