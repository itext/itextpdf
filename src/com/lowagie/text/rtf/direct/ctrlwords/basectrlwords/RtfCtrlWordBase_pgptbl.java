...
public class RtfCtrlWordBase_pgptbl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgptbl(RtfParser rtfParser){
		super(rtfParser, "pgptbl", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
