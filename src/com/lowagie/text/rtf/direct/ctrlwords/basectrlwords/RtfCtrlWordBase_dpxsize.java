...
public class RtfCtrlWordBase_dpxsize extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpxsize(RtfParser rtfParser){
		super(rtfParser, "dpxsize", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
