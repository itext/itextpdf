...
public class RtfCtrlWordBase_linebetcol extends RtfCtrlWordBase {

	public RtfCtrlWordBase_linebetcol(RtfParser rtfParser){
		super(rtfParser, "linebetcol", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
