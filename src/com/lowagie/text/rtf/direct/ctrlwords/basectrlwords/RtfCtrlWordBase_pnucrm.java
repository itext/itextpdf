...
public class RtfCtrlWordBase_pnucrm extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnucrm(RtfParser rtfParser){
		super(rtfParser, "pnucrm", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
