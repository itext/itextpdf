...
public class RtfCtrlWordBase_ftnnrlc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnnrlc(RtfParser rtfParser){
		super(rtfParser, "ftnnrlc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
