...
public class RtfCtrlWordBase_overlay extends RtfCtrlWordBase {

	public RtfCtrlWordBase_overlay(RtfParser rtfParser){
		super(rtfParser, "overlay", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
