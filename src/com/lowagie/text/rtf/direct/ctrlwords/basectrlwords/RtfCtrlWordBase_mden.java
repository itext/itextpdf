...
public class RtfCtrlWordBase_mden extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mden(RtfParser rtfParser){
		super(rtfParser, "mden", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
