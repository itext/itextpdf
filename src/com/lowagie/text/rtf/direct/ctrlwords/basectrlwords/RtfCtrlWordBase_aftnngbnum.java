...
public class RtfCtrlWordBase_aftnngbnum extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnngbnum(RtfParser rtfParser){
		super(rtfParser, "aftnngbnum", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
