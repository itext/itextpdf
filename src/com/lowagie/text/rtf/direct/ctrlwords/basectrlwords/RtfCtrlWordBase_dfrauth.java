...
public class RtfCtrlWordBase_dfrauth extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dfrauth(RtfParser rtfParser){
		super(rtfParser, "dfrauth", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
