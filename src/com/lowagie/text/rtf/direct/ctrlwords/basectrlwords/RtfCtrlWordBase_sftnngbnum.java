...
public class RtfCtrlWordBase_sftnngbnum extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnngbnum(RtfParser rtfParser){
		super(rtfParser, "sftnngbnum", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
