...
public class RtfCtrlWordBase_footerr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_footerr(RtfParser rtfParser){
		super(rtfParser, "footerr", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
