...
public class RtfCtrlWordBase_sftntj extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftntj(RtfParser rtfParser){
		super(rtfParser, "sftntj", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
