...
public class RtfCtrlWordBase_pgbrdrhead extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgbrdrhead(RtfParser rtfParser){
		super(rtfParser, "pgbrdrhead", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
