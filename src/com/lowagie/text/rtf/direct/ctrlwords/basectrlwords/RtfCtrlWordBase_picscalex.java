...
public class RtfCtrlWordBase_picscalex extends RtfCtrlWordBase {

	public RtfCtrlWordBase_picscalex(RtfParser rtfParser){
		super(rtfParser, "picscalex", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
