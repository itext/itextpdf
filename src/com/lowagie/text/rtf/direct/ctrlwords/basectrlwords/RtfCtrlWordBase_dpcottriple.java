...
public class RtfCtrlWordBase_dpcottriple extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpcottriple(RtfParser rtfParser){
		super(rtfParser, "dpcottriple", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
