...
public class RtfCtrlWordBase_shplid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shplid(RtfParser rtfParser){
		super(rtfParser, "shplid", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
