...
public class RtfCtrlWordBase_dghspace extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dghspace(RtfParser rtfParser){
		super(rtfParser, "dghspace", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
