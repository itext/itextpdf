...
/**
 * Description:
 * 	The ALT modifier key. Used to describe shortcut key codes
 * 	for styles.
 * Group:
 * 	Style Sheet
 * Type:
...
public class RtfCtrlWordBase_alt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_alt(RtfParser rtfParser){
		super(rtfParser, "alt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
