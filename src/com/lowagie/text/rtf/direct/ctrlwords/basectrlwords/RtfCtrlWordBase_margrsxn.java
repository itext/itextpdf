...
public class RtfCtrlWordBase_margrsxn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_margrsxn(RtfParser rtfParser){
		super(rtfParser, "margrsxn", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
