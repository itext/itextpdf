...
public class RtfCtrlWordBase_subdocument extends RtfCtrlWordBase {

	public RtfCtrlWordBase_subdocument(RtfParser rtfParser){
		super(rtfParser, "subdocument", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
