...
public class RtfCtrlWordBase_vertalb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_vertalb(RtfParser rtfParser){
		super(rtfParser, "vertalb", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
