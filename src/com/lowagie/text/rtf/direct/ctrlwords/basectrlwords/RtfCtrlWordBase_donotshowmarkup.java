...
public class RtfCtrlWordBase_donotshowmarkup extends RtfCtrlWordBase {

	public RtfCtrlWordBase_donotshowmarkup(RtfParser rtfParser){
		super(rtfParser, "donotshowmarkup", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
