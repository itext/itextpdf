...
public class RtfCtrlWordBase_cltxlrtb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cltxlrtb(RtfParser rtfParser){
		super(rtfParser, "cltxlrtb", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
