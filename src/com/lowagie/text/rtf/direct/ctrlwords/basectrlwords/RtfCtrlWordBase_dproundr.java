...
public class RtfCtrlWordBase_dproundr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dproundr(RtfParser rtfParser){
		super(rtfParser, "dproundr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
