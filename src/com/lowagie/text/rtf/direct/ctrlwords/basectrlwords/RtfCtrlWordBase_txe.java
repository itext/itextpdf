...
public class RtfCtrlWordBase_txe extends RtfCtrlWordBase {

	public RtfCtrlWordBase_txe(RtfParser rtfParser){
		super(rtfParser, "txe", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
