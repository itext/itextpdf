...
public class RtfCtrlWordBase_wrppunct extends RtfCtrlWordBase {

	public RtfCtrlWordBase_wrppunct(RtfParser rtfParser){
		super(rtfParser, "wrppunct", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
