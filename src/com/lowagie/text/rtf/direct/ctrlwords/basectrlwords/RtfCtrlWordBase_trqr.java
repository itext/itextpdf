...
public class RtfCtrlWordBase_trqr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trqr(RtfParser rtfParser){
		super(rtfParser, "trqr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
