...
public class RtfCtrlWordBase_revdttmdel extends RtfCtrlWordBase {

	public RtfCtrlWordBase_revdttmdel(RtfParser rtfParser){
		super(rtfParser, "revdttmdel", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
