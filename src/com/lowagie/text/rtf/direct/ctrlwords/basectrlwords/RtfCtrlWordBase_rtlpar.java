...
public class RtfCtrlWordBase_rtlpar extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rtlpar(RtfParser rtfParser){
		super(rtfParser, "rtlpar", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
