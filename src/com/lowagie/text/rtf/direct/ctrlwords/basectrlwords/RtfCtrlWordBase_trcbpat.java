...
public class RtfCtrlWordBase_trcbpat extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trcbpat(RtfParser rtfParser){
		super(rtfParser, "trcbpat", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
