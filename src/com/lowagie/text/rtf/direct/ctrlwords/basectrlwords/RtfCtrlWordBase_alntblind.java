...
public class RtfCtrlWordBase_alntblind extends RtfCtrlWordBase {

	public RtfCtrlWordBase_alntblind(RtfParser rtfParser){
		super(rtfParser, "alntblind", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
