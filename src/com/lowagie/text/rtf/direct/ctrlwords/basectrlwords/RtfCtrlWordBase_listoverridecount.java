...
/**
 * Description:
 * 	Number of list override levels within this list override (1
 * 	or 9).
 * Group:
 * 	List Table
 * Type:
...
public class RtfCtrlWordBase_listoverridecount extends RtfCtrlWordBase {

	public RtfCtrlWordBase_listoverridecount(RtfParser rtfParser){
		super(rtfParser, "listoverridecount", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
