...
public class RtfCtrlWordBase_shppict extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shppict(RtfParser rtfParser){
		super(rtfParser, "shppict", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
