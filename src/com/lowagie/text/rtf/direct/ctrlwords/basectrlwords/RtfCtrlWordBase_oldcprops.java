...
public class RtfCtrlWordBase_oldcprops extends RtfCtrlWordBase {

	public RtfCtrlWordBase_oldcprops(RtfParser rtfParser){
		super(rtfParser, "oldcprops", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
