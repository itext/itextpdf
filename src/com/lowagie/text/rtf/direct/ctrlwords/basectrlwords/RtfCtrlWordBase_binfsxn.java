...
public class RtfCtrlWordBase_binfsxn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_binfsxn(RtfParser rtfParser){
		super(rtfParser, "binfsxn", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
