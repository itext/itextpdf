...
public class RtfCtrlWordBase_tscellpaddr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscellpaddr(RtfParser rtfParser){
		super(rtfParser, "tscellpaddr", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
