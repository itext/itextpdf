...
public class RtfCtrlWordBase_clcbpat extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clcbpat(RtfParser rtfParser){
		super(rtfParser, "clcbpat", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
