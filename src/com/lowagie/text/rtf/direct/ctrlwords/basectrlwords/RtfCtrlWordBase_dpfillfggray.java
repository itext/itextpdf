...
public class RtfCtrlWordBase_dpfillfggray extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpfillfggray(RtfParser rtfParser){
		super(rtfParser, "dpfillfggray", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
