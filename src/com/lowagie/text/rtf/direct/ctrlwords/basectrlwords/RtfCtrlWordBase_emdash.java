...
public class RtfCtrlWordBase_emdash extends RtfCtrlWordBase {

	public RtfCtrlWordBase_emdash(RtfParser rtfParser){
		super(rtfParser, "emdash", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
