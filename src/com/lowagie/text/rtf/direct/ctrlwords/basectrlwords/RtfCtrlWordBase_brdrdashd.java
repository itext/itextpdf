...
public class RtfCtrlWordBase_brdrdashd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrdashd(RtfParser rtfParser){
		super(rtfParser, "brdrdashd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
