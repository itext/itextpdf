...
public class RtfCtrlWordBase_doctype extends RtfCtrlWordBase {

	public RtfCtrlWordBase_doctype(RtfParser rtfParser){
		super(rtfParser, "doctype", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
