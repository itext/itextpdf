...
public class RtfCtrlWordBase_pnqr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnqr(RtfParser rtfParser){
		super(rtfParser, "pnqr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
