...
public class RtfCtrlWordBase_dgvorigin extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dgvorigin(RtfParser rtfParser){
		super(rtfParser, "dgvorigin", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
