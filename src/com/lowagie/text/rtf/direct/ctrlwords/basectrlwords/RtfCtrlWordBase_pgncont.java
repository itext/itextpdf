...
public class RtfCtrlWordBase_pgncont extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgncont(RtfParser rtfParser){
		super(rtfParser, "pgncont", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
