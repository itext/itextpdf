...
public class RtfCtrlWordBase_brdrs extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrs(RtfParser rtfParser){
		super(rtfParser, "brdrs", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
