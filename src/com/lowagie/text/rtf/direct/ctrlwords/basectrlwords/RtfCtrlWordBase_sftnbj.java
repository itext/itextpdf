...
public class RtfCtrlWordBase_sftnbj extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnbj(RtfParser rtfParser){
		super(rtfParser, "sftnbj", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
