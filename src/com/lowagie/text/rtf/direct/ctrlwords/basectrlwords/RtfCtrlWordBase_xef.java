...
public class RtfCtrlWordBase_xef extends RtfCtrlWordBase {

	public RtfCtrlWordBase_xef(RtfParser rtfParser){
		super(rtfParser, "xef", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
