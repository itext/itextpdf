...
public class RtfCtrlWordBase_posxo extends RtfCtrlWordBase {

	public RtfCtrlWordBase_posxo(RtfParser rtfParser){
		super(rtfParser, "posxo", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
