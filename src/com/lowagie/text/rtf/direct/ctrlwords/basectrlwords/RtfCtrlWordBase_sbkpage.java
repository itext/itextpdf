...
public class RtfCtrlWordBase_sbkpage extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sbkpage(RtfParser rtfParser){
		super(rtfParser, "sbkpage", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
