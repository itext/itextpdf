...
public class RtfCtrlWordBase_saftnndbar extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnndbar(RtfParser rtfParser){
		super(rtfParser, "saftnndbar", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
