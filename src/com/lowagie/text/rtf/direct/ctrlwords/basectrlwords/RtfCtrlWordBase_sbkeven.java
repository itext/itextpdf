...
public class RtfCtrlWordBase_sbkeven extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sbkeven(RtfParser rtfParser){
		super(rtfParser, "sbkeven", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
