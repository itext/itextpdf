...
public class RtfCtrlWordBase_tphpg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tphpg(RtfParser rtfParser){
		super(rtfParser, "tphpg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
