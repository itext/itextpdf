...
public class RtfCtrlWordBase_oldsprops extends RtfCtrlWordBase {

	public RtfCtrlWordBase_oldsprops(RtfParser rtfParser){
		super(rtfParser, "oldsprops", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
