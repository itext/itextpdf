...
public class RtfCtrlWordBase_trdate extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trdate(RtfParser rtfParser){
		super(rtfParser, "trdate", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
