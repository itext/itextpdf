...
public class RtfCtrlWordBase_saftnstart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnstart(RtfParser rtfParser){
		super(rtfParser, "saftnstart", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
