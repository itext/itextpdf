...
public class RtfCtrlWordBase_clcfpat extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clcfpat(RtfParser rtfParser){
		super(rtfParser, "clcfpat", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
