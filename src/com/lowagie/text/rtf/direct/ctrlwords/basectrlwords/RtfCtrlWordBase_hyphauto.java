...
public class RtfCtrlWordBase_hyphauto extends RtfCtrlWordBase {

	public RtfCtrlWordBase_hyphauto(RtfParser rtfParser){
		super(rtfParser, "hyphauto", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
