...
public class RtfCtrlWordBase_aftnncnum extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnncnum(RtfParser rtfParser){
		super(rtfParser, "aftnncnum", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
