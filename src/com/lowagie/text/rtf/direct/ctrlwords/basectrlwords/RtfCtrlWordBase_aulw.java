...
public class RtfCtrlWordBase_aulw extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aulw(RtfParser rtfParser){
		super(rtfParser, "aulw", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
