...
public class RtfCtrlWordBase_nosnaplinegrid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nosnaplinegrid(RtfParser rtfParser){
		super(rtfParser, "nosnaplinegrid", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
