...
public class RtfCtrlWordBase_mo extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mo(RtfParser rtfParser){
		super(rtfParser, "mo", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
