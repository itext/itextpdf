...
public class RtfCtrlWordBase_tscfirstcol extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscfirstcol(RtfParser rtfParser){
		super(rtfParser, "tscfirstcol", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
