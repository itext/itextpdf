...
public class RtfCtrlWordBase_ftnnchi extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnnchi(RtfParser rtfParser){
		super(rtfParser, "ftnnchi", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
