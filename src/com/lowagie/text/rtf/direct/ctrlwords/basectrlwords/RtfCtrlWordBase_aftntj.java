...
public class RtfCtrlWordBase_aftntj extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftntj(RtfParser rtfParser){
		super(rtfParser, "aftntj", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
