...
public class RtfCtrlWordBase_pnlvl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnlvl(RtfParser rtfParser){
		super(rtfParser, "pnlvl", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
