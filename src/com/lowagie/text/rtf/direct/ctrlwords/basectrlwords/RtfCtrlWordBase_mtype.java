...
public class RtfCtrlWordBase_mtype extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mtype(RtfParser rtfParser){
		super(rtfParser, "mtype", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
