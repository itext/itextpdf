...
public class RtfCtrlWordBase_objtime extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objtime(RtfParser rtfParser){
		super(rtfParser, "objtime", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
