...
public class RtfCtrlWordBase_mintrasp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mintrasp(RtfParser rtfParser){
		super(rtfParser, "mintrasp", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
