...
public class RtfCtrlWordBase_mnary extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mnary(RtfParser rtfParser){
		super(rtfParser, "mnary", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
