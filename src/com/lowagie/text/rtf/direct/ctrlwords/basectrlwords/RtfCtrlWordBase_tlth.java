...
public class RtfCtrlWordBase_tlth extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tlth(RtfParser rtfParser){
		super(rtfParser, "tlth", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
