...
public class RtfCtrlWordBase_hlfr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_hlfr(RtfParser rtfParser){
		super(rtfParser, "hlfr", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
