...
public class RtfCtrlWordBase_cufi extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cufi(RtfParser rtfParser){
		super(rtfParser, "cufi", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
