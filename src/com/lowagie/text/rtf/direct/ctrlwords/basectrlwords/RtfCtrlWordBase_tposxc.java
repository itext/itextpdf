...
public class RtfCtrlWordBase_tposxc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tposxc(RtfParser rtfParser){
		super(rtfParser, "tposxc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
