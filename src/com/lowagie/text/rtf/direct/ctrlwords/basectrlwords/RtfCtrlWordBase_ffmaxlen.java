...
public class RtfCtrlWordBase_ffmaxlen extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ffmaxlen(RtfParser rtfParser){
		super(rtfParser, "ffmaxlen", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
