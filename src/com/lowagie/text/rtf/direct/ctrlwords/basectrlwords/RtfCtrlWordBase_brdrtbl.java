...
public class RtfCtrlWordBase_brdrtbl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrtbl(RtfParser rtfParser){
		super(rtfParser, "brdrtbl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
