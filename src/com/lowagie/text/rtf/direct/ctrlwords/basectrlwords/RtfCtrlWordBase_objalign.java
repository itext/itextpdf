...
public class RtfCtrlWordBase_objalign extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objalign(RtfParser rtfParser){
		super(rtfParser, "objalign", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
