...
public class RtfCtrlWordBase_mrpr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mrpr(RtfParser rtfParser){
		super(rtfParser, "mrpr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
