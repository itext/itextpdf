...
public class RtfCtrlWordBase_ulhair extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ulhair(RtfParser rtfParser){
		super(rtfParser, "ulhair", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
