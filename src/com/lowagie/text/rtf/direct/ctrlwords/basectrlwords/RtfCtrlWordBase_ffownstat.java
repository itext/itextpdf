...
public class RtfCtrlWordBase_ffownstat extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ffownstat(RtfParser rtfParser){
		super(rtfParser, "ffownstat", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
