...
public class RtfCtrlWordBase_title extends RtfCtrlWordBase {

	public RtfCtrlWordBase_title(RtfParser rtfParser){
		super(rtfParser, "title", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
