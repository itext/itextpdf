...
public class RtfCtrlWordBase_outl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_outl(RtfParser rtfParser){
		super(rtfParser, "outl", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
