...
public class RtfCtrlWordBase_brdrthtnsg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrthtnsg(RtfParser rtfParser){
		super(rtfParser, "brdrthtnsg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
