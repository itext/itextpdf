...
public class RtfCtrlWordBase_vertalc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_vertalc(RtfParser rtfParser){
		super(rtfParser, "vertalc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
