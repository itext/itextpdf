...
public class RtfCtrlWordBase_nowidctlpar extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nowidctlpar(RtfParser rtfParser){
		super(rtfParser, "nowidctlpar", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
