...
public class RtfCtrlWordBase_frmtxlrtbv extends RtfCtrlWordBase {

	public RtfCtrlWordBase_frmtxlrtbv(RtfParser rtfParser){
		super(rtfParser, "frmtxlrtbv", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
