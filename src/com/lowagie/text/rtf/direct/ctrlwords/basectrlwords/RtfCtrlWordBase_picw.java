...
public class RtfCtrlWordBase_picw extends RtfCtrlWordBase {

	public RtfCtrlWordBase_picw(RtfParser rtfParser){
		super(rtfParser, "picw", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
