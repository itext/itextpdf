...
public class RtfCtrlWordBase_pnulwave extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnulwave(RtfParser rtfParser){
		super(rtfParser, "pnulwave", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
