...
/**
 * Description:
 * 	XML namespace table entry::Specifies the namespace of the
 * 	given XML Tag.::Specifies the namespace of the given
 * 	SmartTag.
 * Group:
...
public class RtfCtrlWordBase_xmlns extends RtfCtrlWordBase {

	public RtfCtrlWordBase_xmlns(RtfParser rtfParser){
		super(rtfParser, "xmlns", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
