...
public class RtfCtrlWordBase_i extends RtfCtrlWordBase {

	public RtfCtrlWordBase_i(RtfParser rtfParser){
		super(rtfParser, "i", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
