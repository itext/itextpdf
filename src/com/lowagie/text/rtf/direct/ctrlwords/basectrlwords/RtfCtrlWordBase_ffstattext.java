...
public class RtfCtrlWordBase_ffstattext extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ffstattext(RtfParser rtfParser){
		super(rtfParser, "ffstattext", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
