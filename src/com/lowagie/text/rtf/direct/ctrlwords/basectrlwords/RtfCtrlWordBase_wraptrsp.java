...
public class RtfCtrlWordBase_wraptrsp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_wraptrsp(RtfParser rtfParser){
		super(rtfParser, "wraptrsp", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
