...
public class RtfCtrlWordBase_sa extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sa(RtfParser rtfParser){
		super(rtfParser, "sa", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
