...
public class RtfCtrlWordBase_fldedit extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fldedit(RtfParser rtfParser){
		super(rtfParser, "fldedit", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
