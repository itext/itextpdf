...
public class RtfCtrlWordBase_dpcotdouble extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpcotdouble(RtfParser rtfParser){
		super(rtfParser, "dpcotdouble", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
