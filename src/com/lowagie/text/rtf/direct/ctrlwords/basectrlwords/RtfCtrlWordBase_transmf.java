...
public class RtfCtrlWordBase_transmf extends RtfCtrlWordBase {

	public RtfCtrlWordBase_transmf(RtfParser rtfParser){
		super(rtfParser, "transmf", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
