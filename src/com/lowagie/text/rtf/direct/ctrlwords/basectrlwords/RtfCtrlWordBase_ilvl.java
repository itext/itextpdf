...
public class RtfCtrlWordBase_ilvl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ilvl(RtfParser rtfParser){
		super(rtfParser, "ilvl", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
