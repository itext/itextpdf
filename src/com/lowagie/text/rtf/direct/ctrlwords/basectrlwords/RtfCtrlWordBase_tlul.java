...
public class RtfCtrlWordBase_tlul extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tlul(RtfParser rtfParser){
		super(rtfParser, "tlul", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
