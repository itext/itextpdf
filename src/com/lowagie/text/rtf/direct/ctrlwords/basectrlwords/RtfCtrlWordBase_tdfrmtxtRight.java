...
public class RtfCtrlWordBase_tdfrmtxtRight extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tdfrmtxtRight(RtfParser rtfParser){
		super(rtfParser, "tdfrmtxtRight", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
