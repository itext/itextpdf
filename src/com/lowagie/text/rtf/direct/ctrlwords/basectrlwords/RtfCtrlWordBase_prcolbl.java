...
public class RtfCtrlWordBase_prcolbl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_prcolbl(RtfParser rtfParser){
		super(rtfParser, "prcolbl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
