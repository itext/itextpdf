...
public class RtfCtrlWordBase_chtime extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chtime(RtfParser rtfParser){
		super(rtfParser, "chtime", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
