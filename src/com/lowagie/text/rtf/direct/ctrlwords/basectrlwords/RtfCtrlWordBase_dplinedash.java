...
public class RtfCtrlWordBase_dplinedash extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dplinedash(RtfParser rtfParser){
		super(rtfParser, "dplinedash", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
