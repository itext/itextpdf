...
public class RtfCtrlWordBase_mlmargin extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mlmargin(RtfParser rtfParser){
		super(rtfParser, "mlmargin", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
