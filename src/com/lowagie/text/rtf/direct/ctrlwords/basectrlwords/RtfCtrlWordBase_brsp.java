...
public class RtfCtrlWordBase_brsp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brsp(RtfParser rtfParser){
		super(rtfParser, "brsp", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
