...
public class RtfCtrlWordBase_mzeroasc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mzeroasc(RtfParser rtfParser){
		super(rtfParser, "mzeroasc", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
