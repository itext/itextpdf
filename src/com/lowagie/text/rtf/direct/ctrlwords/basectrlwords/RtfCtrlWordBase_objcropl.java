...
public class RtfCtrlWordBase_objcropl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objcropl(RtfParser rtfParser){
		super(rtfParser, "objcropl", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
