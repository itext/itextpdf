...
public class RtfCtrlWordBase_lang extends RtfCtrlWordBase {

	public RtfCtrlWordBase_lang(RtfParser rtfParser){
		super(rtfParser, "lang", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
