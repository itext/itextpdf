...
public class RtfCtrlWordBase_dgvshow extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dgvshow(RtfParser rtfParser){
		super(rtfParser, "dgvshow", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
