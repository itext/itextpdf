...
public class RtfCtrlWordBase_pnzodiacd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnzodiacd(RtfParser rtfParser){
		super(rtfParser, "pnzodiacd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
