...
public class RtfCtrlWordBase_tc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tc(RtfParser rtfParser){
		super(rtfParser, "tc", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
