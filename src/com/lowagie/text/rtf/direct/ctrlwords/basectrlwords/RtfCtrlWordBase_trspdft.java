...
public class RtfCtrlWordBase_trspdft extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trspdft(RtfParser rtfParser){
		super(rtfParser, "trspdft", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
