...
public class RtfCtrlWordBase_pgndbnumd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgndbnumd(RtfParser rtfParser){
		super(rtfParser, "pgndbnumd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
