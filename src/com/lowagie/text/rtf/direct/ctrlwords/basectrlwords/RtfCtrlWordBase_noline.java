...
public class RtfCtrlWordBase_noline extends RtfCtrlWordBase {

	public RtfCtrlWordBase_noline(RtfParser rtfParser){
		super(rtfParser, "noline", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
