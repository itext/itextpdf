...
public class RtfCtrlWordBase_dolock extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dolock(RtfParser rtfParser){
		super(rtfParser, "dolock", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
