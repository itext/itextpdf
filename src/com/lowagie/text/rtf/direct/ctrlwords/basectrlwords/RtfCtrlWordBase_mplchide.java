...
public class RtfCtrlWordBase_mplchide extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mplchide(RtfParser rtfParser){
		super(rtfParser, "mplchide", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
