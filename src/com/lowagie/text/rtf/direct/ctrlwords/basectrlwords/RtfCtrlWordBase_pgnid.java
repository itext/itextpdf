...
public class RtfCtrlWordBase_pgnid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnid(RtfParser rtfParser){
		super(rtfParser, "pgnid", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
