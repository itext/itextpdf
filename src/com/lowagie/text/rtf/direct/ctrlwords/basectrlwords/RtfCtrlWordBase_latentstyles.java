...
public class RtfCtrlWordBase_latentstyles extends RtfCtrlWordBase {

	public RtfCtrlWordBase_latentstyles(RtfParser rtfParser){
		super(rtfParser, "latentstyles", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
