...
public class RtfCtrlWordBase_mssuppr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mssuppr(RtfParser rtfParser){
		super(rtfParser, "mssuppr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
