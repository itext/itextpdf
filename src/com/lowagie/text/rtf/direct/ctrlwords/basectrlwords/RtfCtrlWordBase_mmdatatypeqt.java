...
public class RtfCtrlWordBase_mmdatatypeqt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmdatatypeqt(RtfParser rtfParser){
		super(rtfParser, "mmdatatypeqt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
