...
public class RtfCtrlWordBase_dptxbx extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dptxbx(RtfParser rtfParser){
		super(rtfParser, "dptxbx", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
