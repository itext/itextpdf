...
public class RtfCtrlWordBase_ulc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ulc(RtfParser rtfParser){
		super(rtfParser, "ulc", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
