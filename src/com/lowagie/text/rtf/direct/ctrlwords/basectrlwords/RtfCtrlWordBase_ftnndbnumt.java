...
public class RtfCtrlWordBase_ftnndbnumt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnndbnumt(RtfParser rtfParser){
		super(rtfParser, "ftnndbnumt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
