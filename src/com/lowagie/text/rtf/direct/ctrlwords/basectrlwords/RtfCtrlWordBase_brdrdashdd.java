...
public class RtfCtrlWordBase_brdrdashdd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrdashdd(RtfParser rtfParser){
		super(rtfParser, "brdrdashdd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
