...
public class RtfCtrlWordBase_levelstartat extends RtfCtrlWordBase {

	public RtfCtrlWordBase_levelstartat(RtfParser rtfParser){
		super(rtfParser, "levelstartat", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
