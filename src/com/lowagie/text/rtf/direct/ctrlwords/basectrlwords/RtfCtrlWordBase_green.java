...
public class RtfCtrlWordBase_green extends RtfCtrlWordBase {

	public RtfCtrlWordBase_green(RtfParser rtfParser){
		super(rtfParser, "green", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
