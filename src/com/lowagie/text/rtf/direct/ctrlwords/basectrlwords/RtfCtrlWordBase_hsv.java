...
public class RtfCtrlWordBase_hsv extends RtfCtrlWordBase {

	public RtfCtrlWordBase_hsv(RtfParser rtfParser){
		super(rtfParser, "hsv", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
