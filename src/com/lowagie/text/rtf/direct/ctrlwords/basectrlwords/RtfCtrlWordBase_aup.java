...
public class RtfCtrlWordBase_aup extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aup(RtfParser rtfParser){
		super(rtfParser, "aup", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
