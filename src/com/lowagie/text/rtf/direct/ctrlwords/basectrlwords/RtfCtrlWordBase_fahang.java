...
public class RtfCtrlWordBase_fahang extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fahang(RtfParser rtfParser){
		super(rtfParser, "fahang", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
