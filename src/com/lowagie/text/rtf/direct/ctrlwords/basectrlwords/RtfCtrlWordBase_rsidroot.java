...
/**
 * Description:
 * 	Designates the start of the document?s history (first
 * 	save).
 * Group:
...
public class RtfCtrlWordBase_rsidroot extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rsidroot(RtfParser rtfParser){
		super(rtfParser, "rsidroot", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
