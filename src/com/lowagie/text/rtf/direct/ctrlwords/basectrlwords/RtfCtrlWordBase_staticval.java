...
public class RtfCtrlWordBase_staticval extends RtfCtrlWordBase {

	public RtfCtrlWordBase_staticval(RtfParser rtfParser){
		super(rtfParser, "staticval", 0, false, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
