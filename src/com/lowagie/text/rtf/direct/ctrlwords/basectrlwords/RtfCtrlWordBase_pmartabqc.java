...
public class RtfCtrlWordBase_pmartabqc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pmartabqc(RtfParser rtfParser){
		super(rtfParser, "pmartabqc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
