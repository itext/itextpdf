...
public class RtfCtrlWordBase_cltxbtlr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cltxbtlr(RtfParser rtfParser){
		super(rtfParser, "cltxbtlr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
