...
public class RtfCtrlWordBase_sp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sp(RtfParser rtfParser){
		super(rtfParser, "sp", 0, false, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
