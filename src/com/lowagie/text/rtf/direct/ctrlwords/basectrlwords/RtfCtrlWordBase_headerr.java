...
public class RtfCtrlWordBase_headerr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_headerr(RtfParser rtfParser){
		super(rtfParser, "headerr", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
