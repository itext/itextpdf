...
public class RtfCtrlWordBase_pnbidib extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnbidib(RtfParser rtfParser){
		super(rtfParser, "pnbidib", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
