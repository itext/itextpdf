...
public class RtfCtrlWordBase_pich extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pich(RtfParser rtfParser){
		super(rtfParser, "pich", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
