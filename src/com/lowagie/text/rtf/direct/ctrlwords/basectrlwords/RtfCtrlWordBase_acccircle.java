...
public class RtfCtrlWordBase_acccircle extends RtfCtrlWordBase {

	public RtfCtrlWordBase_acccircle(RtfParser rtfParser){
		super(rtfParser, "acccircle", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
