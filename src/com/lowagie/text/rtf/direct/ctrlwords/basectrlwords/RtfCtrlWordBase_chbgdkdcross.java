...
public class RtfCtrlWordBase_chbgdkdcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chbgdkdcross(RtfParser rtfParser){
		super(rtfParser, "chbgdkdcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
