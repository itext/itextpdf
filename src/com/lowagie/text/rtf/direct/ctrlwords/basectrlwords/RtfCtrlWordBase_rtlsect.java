...
public class RtfCtrlWordBase_rtlsect extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rtlsect(RtfParser rtfParser){
		super(rtfParser, "rtlsect", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
