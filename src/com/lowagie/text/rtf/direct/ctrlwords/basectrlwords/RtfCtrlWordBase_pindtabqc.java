...
public class RtfCtrlWordBase_pindtabqc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pindtabqc(RtfParser rtfParser){
		super(rtfParser, "pindtabqc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
