...
public class RtfCtrlWordBase_notabind extends RtfCtrlWordBase {

	public RtfCtrlWordBase_notabind(RtfParser rtfParser){
		super(rtfParser, "notabind", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
