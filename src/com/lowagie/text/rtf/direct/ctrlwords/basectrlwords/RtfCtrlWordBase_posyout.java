...
public class RtfCtrlWordBase_posyout extends RtfCtrlWordBase {

	public RtfCtrlWordBase_posyout(RtfParser rtfParser){
		super(rtfParser, "posyout", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
