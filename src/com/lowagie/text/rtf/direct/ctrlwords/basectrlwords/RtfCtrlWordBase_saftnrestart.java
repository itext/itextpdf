...
public class RtfCtrlWordBase_saftnrestart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnrestart(RtfParser rtfParser){
		super(rtfParser, "saftnrestart", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
