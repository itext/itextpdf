...
public class RtfCtrlWordBase_rsidtbl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rsidtbl(RtfParser rtfParser){
		super(rtfParser, "rsidtbl", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
