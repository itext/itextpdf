...
public class RtfCtrlWordBase_ulldash extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ulldash(RtfParser rtfParser){
		super(rtfParser, "ulldash", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
