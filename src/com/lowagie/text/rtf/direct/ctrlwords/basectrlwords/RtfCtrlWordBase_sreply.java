...
public class RtfCtrlWordBase_sreply extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sreply(RtfParser rtfParser){
		super(rtfParser, "sreply", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
