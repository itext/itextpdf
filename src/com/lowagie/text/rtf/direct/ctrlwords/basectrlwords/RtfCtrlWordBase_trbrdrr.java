...
public class RtfCtrlWordBase_trbrdrr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trbrdrr(RtfParser rtfParser){
		super(rtfParser, "trbrdrr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
