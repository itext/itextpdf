...
public class RtfCtrlWordBase_revauthdel extends RtfCtrlWordBase {

	public RtfCtrlWordBase_revauthdel(RtfParser rtfParser){
		super(rtfParser, "revauthdel", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
