...
/**
 * Description:
 * 	,"1 if this level includes the text from the previous level
 * 	(used for Word 7.0 compatibility only); otherwise, the value
 * 	is 0. This keyword will only be valid if the \leveloldN
 * 	keyword is emitted.
 * Group:
 * 	List Table
 * Type:
...
public class RtfCtrlWordBase_levelprev extends RtfCtrlWordBase {

	public RtfCtrlWordBase_levelprev(RtfParser rtfParser){
		super(rtfParser, "levelprev", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
