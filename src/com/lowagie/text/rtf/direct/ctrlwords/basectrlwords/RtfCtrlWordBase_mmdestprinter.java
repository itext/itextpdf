...
public class RtfCtrlWordBase_mmdestprinter extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmdestprinter(RtfParser rtfParser){
		super(rtfParser, "mmdestprinter", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
