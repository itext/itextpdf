...
public class RtfCtrlWordBase_shpright extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shpright(RtfParser rtfParser){
		super(rtfParser, "shpright", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
