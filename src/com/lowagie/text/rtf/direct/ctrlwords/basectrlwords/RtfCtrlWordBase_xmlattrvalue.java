...
public class RtfCtrlWordBase_xmlattrvalue extends RtfCtrlWordBase {

	public RtfCtrlWordBase_xmlattrvalue(RtfParser rtfParser){
		super(rtfParser, "xmlattrvalue", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
