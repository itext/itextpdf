...
public class RtfCtrlWordBase_objhtml extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objhtml(RtfParser rtfParser){
		super(rtfParser, "objhtml", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
