...
public class RtfCtrlWordBase_themelang extends RtfCtrlWordBase {

	public RtfCtrlWordBase_themelang(RtfParser rtfParser){
		super(rtfParser, "themelang", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
