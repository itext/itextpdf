...
public class RtfCtrlWordBase_protend extends RtfCtrlWordBase {

	public RtfCtrlWordBase_protend(RtfParser rtfParser){
		super(rtfParser, "protend", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
