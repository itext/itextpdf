...
public class RtfCtrlWordBase_dropcapt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dropcapt(RtfParser rtfParser){
		super(rtfParser, "dropcapt", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
