...
public class RtfCtrlWordBase_ffres extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ffres(RtfParser rtfParser){
		super(rtfParser, "ffres", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
