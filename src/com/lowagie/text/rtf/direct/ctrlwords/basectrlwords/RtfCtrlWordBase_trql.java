...
public class RtfCtrlWordBase_trql extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trql(RtfParser rtfParser){
		super(rtfParser, "trql", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
