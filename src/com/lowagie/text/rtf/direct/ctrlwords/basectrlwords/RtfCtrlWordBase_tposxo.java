...
public class RtfCtrlWordBase_tposxo extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tposxo(RtfParser rtfParser){
		super(rtfParser, "tposxo", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
