...
public class RtfCtrlWordBase_mstrikeh extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mstrikeh(RtfParser rtfParser){
		super(rtfParser, "mstrikeh", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
