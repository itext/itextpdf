...
public class RtfCtrlWordBase_tleq extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tleq(RtfParser rtfParser){
		super(rtfParser, "tleq", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
