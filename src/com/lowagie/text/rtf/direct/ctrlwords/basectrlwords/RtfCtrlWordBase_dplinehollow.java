...
public class RtfCtrlWordBase_dplinehollow extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dplinehollow(RtfParser rtfParser){
		super(rtfParser, "dplinehollow", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
