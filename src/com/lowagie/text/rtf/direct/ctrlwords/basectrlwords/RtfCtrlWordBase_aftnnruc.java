...
public class RtfCtrlWordBase_aftnnruc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnnruc(RtfParser rtfParser){
		super(rtfParser, "aftnnruc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
