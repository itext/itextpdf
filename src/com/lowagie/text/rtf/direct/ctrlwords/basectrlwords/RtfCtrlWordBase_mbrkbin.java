...
public class RtfCtrlWordBase_mbrkbin extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mbrkbin(RtfParser rtfParser){
		super(rtfParser, "mbrkbin", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
