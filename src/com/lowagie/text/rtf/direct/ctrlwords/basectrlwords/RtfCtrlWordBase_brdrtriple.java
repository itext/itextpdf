...
public class RtfCtrlWordBase_brdrtriple extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrtriple(RtfParser rtfParser){
		super(rtfParser, "brdrtriple", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
