...
public class RtfCtrlWordBase_tscellpaddfl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscellpaddfl(RtfParser rtfParser){
		super(rtfParser, "tscellpaddfl", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
