...
public class RtfCtrlWordBase_trftsWidth extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trftsWidth(RtfParser rtfParser){
		super(rtfParser, "trftsWidth", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
