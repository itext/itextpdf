...
public class RtfCtrlWordBase_rslttxt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rslttxt(RtfParser rtfParser){
		super(rtfParser, "rslttxt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
