...
public class RtfCtrlWordBase_qj extends RtfCtrlWordBase {

	public RtfCtrlWordBase_qj(RtfParser rtfParser){
		super(rtfParser, "qj", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
