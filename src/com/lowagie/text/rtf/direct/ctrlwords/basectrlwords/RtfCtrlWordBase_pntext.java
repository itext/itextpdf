...
public class RtfCtrlWordBase_pntext extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pntext(RtfParser rtfParser){
		super(rtfParser, "pntext", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
