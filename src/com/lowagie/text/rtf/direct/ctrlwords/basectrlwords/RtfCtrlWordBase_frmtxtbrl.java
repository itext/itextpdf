...
public class RtfCtrlWordBase_frmtxtbrl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_frmtxtbrl(RtfParser rtfParser){
		super(rtfParser, "frmtxtbrl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
