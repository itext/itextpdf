...
/**
 * Description:
 * 	,"Tied to the rsid table, N is the rsid of the author who
 * 	implemented the style.
 * Group:
...
public class RtfCtrlWordBase_styrsid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_styrsid(RtfParser rtfParser){
		super(rtfParser, "styrsid", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
