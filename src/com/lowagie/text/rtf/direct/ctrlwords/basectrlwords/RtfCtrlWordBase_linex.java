...
public class RtfCtrlWordBase_linex extends RtfCtrlWordBase {

	public RtfCtrlWordBase_linex(RtfParser rtfParser){
		super(rtfParser, "linex", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
