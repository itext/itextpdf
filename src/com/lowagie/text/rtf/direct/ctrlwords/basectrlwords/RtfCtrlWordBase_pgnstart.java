...
public class RtfCtrlWordBase_pgnstart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnstart(RtfParser rtfParser){
		super(rtfParser, "pgnstart", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
