...
public class RtfCtrlWordBase_tsbrdrv extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsbrdrv(RtfParser rtfParser){
		super(rtfParser, "tsbrdrv", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
