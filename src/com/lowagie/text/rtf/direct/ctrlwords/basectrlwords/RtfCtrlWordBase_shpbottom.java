...
public class RtfCtrlWordBase_shpbottom extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shpbottom(RtfParser rtfParser){
		super(rtfParser, "shpbottom", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
