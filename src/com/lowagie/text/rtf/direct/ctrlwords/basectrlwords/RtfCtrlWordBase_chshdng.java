...
public class RtfCtrlWordBase_chshdng extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chshdng(RtfParser rtfParser){
		super(rtfParser, "chshdng", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
