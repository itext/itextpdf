...
public class RtfCtrlWordBase_ulhwave extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ulhwave(RtfParser rtfParser){
		super(rtfParser, "ulhwave", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
