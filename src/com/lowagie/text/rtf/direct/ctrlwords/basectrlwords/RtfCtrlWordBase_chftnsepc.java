...
public class RtfCtrlWordBase_chftnsepc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chftnsepc(RtfParser rtfParser){
		super(rtfParser, "chftnsepc", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
