...
public class RtfCtrlWordBase_readprot extends RtfCtrlWordBase {

	public RtfCtrlWordBase_readprot(RtfParser rtfParser){
		super(rtfParser, "readprot", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
