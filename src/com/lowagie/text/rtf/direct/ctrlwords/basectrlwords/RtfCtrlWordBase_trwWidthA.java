...
public class RtfCtrlWordBase_trwWidthA extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trwWidthA(RtfParser rtfParser){
		super(rtfParser, "trwWidthA", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
