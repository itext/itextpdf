...
public class RtfCtrlWordBase_tscbandsh extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscbandsh(RtfParser rtfParser){
		super(rtfParser, "tscbandsh", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
