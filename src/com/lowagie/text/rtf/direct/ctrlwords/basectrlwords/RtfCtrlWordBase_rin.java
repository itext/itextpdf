...
public class RtfCtrlWordBase_rin extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rin(RtfParser rtfParser){
		super(rtfParser, "rin", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
