...
public class RtfCtrlWordBase_rtlmark extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rtlmark(RtfParser rtfParser){
		super(rtfParser, "rtlmark", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
