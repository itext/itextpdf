...
public class RtfCtrlWordBase_jcompress extends RtfCtrlWordBase {

	public RtfCtrlWordBase_jcompress(RtfParser rtfParser){
		super(rtfParser, "jcompress", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
