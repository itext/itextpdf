...
public class RtfCtrlWordBase_bookfoldsheets extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bookfoldsheets(RtfParser rtfParser){
		super(rtfParser, "bookfoldsheets", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
