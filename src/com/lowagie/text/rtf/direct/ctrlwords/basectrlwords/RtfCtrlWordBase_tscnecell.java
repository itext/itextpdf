...
public class RtfCtrlWordBase_tscnecell extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscnecell(RtfParser rtfParser){
		super(rtfParser, "tscnecell", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
