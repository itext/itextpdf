...
public class RtfCtrlWordBase_mmdestfax extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmdestfax(RtfParser rtfParser){
		super(rtfParser, "mmdestfax", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
