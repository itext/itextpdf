...
public class RtfCtrlWordBase_sectd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sectd(RtfParser rtfParser){
		super(rtfParser, "sectd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
