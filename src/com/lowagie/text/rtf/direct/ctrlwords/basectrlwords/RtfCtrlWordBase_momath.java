...
public class RtfCtrlWordBase_momath extends RtfCtrlWordBase {

	public RtfCtrlWordBase_momath(RtfParser rtfParser){
		super(rtfParser, "momath", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
