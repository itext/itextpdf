...
public class RtfCtrlWordBase_bdbfhdr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bdbfhdr(RtfParser rtfParser){
		super(rtfParser, "bdbfhdr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
