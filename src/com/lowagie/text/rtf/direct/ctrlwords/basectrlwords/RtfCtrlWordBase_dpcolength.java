...
public class RtfCtrlWordBase_dpcolength extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpcolength(RtfParser rtfParser){
		super(rtfParser, "dpcolength", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
