...
public class RtfCtrlWordBase_endnhere extends RtfCtrlWordBase {

	public RtfCtrlWordBase_endnhere(RtfParser rtfParser){
		super(rtfParser, "endnhere", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
