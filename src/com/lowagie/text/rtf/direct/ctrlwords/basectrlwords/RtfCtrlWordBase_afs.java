...
public class RtfCtrlWordBase_afs extends RtfCtrlWordBase {

	public RtfCtrlWordBase_afs(RtfParser rtfParser){
		super(rtfParser, "afs", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
