...
public class RtfCtrlWordBase_chatn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chatn(RtfParser rtfParser){
		super(rtfParser, "chatn", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
