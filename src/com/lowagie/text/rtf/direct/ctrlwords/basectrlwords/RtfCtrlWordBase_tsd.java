...
public class RtfCtrlWordBase_tsd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsd(RtfParser rtfParser){
		super(rtfParser, "tsd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
