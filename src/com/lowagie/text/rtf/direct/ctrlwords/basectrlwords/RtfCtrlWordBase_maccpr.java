...
public class RtfCtrlWordBase_maccpr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_maccpr(RtfParser rtfParser){
		super(rtfParser, "maccpr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
