...
public class RtfCtrlWordBase_tpvmrg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tpvmrg(RtfParser rtfParser){
		super(rtfParser, "tpvmrg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
