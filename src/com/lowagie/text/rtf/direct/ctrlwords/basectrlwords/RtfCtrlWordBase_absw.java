...
public class RtfCtrlWordBase_absw extends RtfCtrlWordBase {

	public RtfCtrlWordBase_absw(RtfParser rtfParser){
		super(rtfParser, "absw", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
