...
public class RtfCtrlWordBase_xmlattrns extends RtfCtrlWordBase {

	public RtfCtrlWordBase_xmlattrns(RtfParser rtfParser){
		super(rtfParser, "xmlattrns", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
