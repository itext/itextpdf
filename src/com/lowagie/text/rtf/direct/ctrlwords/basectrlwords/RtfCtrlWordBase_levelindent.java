...
/**
 * Description:
 * 	Minimum distance from the left indent to the start of the
 * 	paragraph text (used for Word 7.0 compatibility only). This
 * 	keyword will only be valid if the \leveloldN keyword is
 * 	emitted.
 * Group:
 * 	List Table
 * Type:
...
public class RtfCtrlWordBase_levelindent extends RtfCtrlWordBase {

	public RtfCtrlWordBase_levelindent(RtfParser rtfParser){
		super(rtfParser, "levelindent", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
