...
public class RtfCtrlWordBase_pngbnuml extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pngbnuml(RtfParser rtfParser){
		super(rtfParser, "pngbnuml", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
