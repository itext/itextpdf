...
public class RtfCtrlWordBase_rawclbgfdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rawclbgfdiag(RtfParser rtfParser){
		super(rtfParser, "rawclbgfdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
