...
public class RtfCtrlWordBase_clshdng extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clshdng(RtfParser rtfParser){
		super(rtfParser, "clshdng", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
