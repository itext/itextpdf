...
public class RtfCtrlWordBase_ffsize extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ffsize(RtfParser rtfParser){
		super(rtfParser, "ffsize", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
