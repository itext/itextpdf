...
public class RtfCtrlWordBase_enforceprot extends RtfCtrlWordBase {

	public RtfCtrlWordBase_enforceprot(RtfParser rtfParser){
		super(rtfParser, "enforceprot", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
