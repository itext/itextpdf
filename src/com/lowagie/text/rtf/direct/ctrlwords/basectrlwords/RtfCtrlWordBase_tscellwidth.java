...
public class RtfCtrlWordBase_tscellwidth extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscellwidth(RtfParser rtfParser){
		super(rtfParser, "tscellwidth", 0, true, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
