...
public class RtfCtrlWordBase_dpcodescent extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpcodescent(RtfParser rtfParser){
		super(rtfParser, "dpcodescent", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
