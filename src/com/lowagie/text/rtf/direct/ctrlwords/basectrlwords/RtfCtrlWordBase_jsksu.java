...
public class RtfCtrlWordBase_jsksu extends RtfCtrlWordBase {

	public RtfCtrlWordBase_jsksu(RtfParser rtfParser){
		super(rtfParser, "jsksu", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
