...
public class RtfCtrlWordBase_trwWidth extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trwWidth(RtfParser rtfParser){
		super(rtfParser, "trwWidth", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
