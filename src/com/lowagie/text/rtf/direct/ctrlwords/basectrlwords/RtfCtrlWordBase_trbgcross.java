...
public class RtfCtrlWordBase_trbgcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trbgcross(RtfParser rtfParser){
		super(rtfParser, "trbgcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
