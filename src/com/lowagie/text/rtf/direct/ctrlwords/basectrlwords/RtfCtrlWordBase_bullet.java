...
public class RtfCtrlWordBase_bullet extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bullet(RtfParser rtfParser){
		super(rtfParser, "bullet", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
