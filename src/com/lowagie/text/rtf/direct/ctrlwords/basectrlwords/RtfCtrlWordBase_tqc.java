...
public class RtfCtrlWordBase_tqc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tqc(RtfParser rtfParser){
		super(rtfParser, "tqc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
