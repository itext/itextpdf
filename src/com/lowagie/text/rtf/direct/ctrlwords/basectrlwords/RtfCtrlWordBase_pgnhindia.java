...
public class RtfCtrlWordBase_pgnhindia extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnhindia(RtfParser rtfParser){
		super(rtfParser, "pgnhindia", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
