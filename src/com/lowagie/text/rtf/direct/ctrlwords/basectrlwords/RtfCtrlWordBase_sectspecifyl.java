...
public class RtfCtrlWordBase_sectspecifyl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sectspecifyl(RtfParser rtfParser){
		super(rtfParser, "sectspecifyl", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
