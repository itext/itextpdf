...
public class RtfCtrlWordBase_clbgdkfdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clbgdkfdiag(RtfParser rtfParser){
		super(rtfParser, "clbgdkfdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
