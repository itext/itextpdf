...
public class RtfCtrlWordBase_ftntj extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftntj(RtfParser rtfParser){
		super(rtfParser, "ftntj", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
