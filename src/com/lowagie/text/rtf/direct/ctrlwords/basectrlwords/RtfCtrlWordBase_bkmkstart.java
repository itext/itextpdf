...
public class RtfCtrlWordBase_bkmkstart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bkmkstart(RtfParser rtfParser){
		super(rtfParser, "bkmkstart", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
