...
public class RtfCtrlWordBase_defchp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_defchp(RtfParser rtfParser){
		super(rtfParser, "defchp", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
