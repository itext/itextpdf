...
public class RtfCtrlWordBase_datafield extends RtfCtrlWordBase {

	public RtfCtrlWordBase_datafield(RtfParser rtfParser){
		super(rtfParser, "datafield", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
