...
public class RtfCtrlWordBase_tposnegx extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tposnegx(RtfParser rtfParser){
		super(rtfParser, "tposnegx", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
