...
public class RtfCtrlWordBase_tsbrdrh extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsbrdrh(RtfParser rtfParser){
		super(rtfParser, "tsbrdrh", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
