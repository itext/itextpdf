...
public class RtfCtrlWordBase_ltrpar extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ltrpar(RtfParser rtfParser){
		super(rtfParser, "ltrpar", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
