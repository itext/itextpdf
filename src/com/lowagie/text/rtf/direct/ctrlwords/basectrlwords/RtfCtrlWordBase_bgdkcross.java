...
public class RtfCtrlWordBase_bgdkcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bgdkcross(RtfParser rtfParser){
		super(rtfParser, "bgdkcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
