...
public class RtfCtrlWordBase_rtlrow extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rtlrow(RtfParser rtfParser){
		super(rtfParser, "rtlrow", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
