...
public class RtfCtrlWordBase_protlevel extends RtfCtrlWordBase {

	public RtfCtrlWordBase_protlevel(RtfParser rtfParser){
		super(rtfParser, "protlevel", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
