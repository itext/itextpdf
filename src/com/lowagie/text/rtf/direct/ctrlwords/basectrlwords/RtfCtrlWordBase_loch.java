...
public class RtfCtrlWordBase_loch extends RtfCtrlWordBase {

	public RtfCtrlWordBase_loch(RtfParser rtfParser){
		super(rtfParser, "loch", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
