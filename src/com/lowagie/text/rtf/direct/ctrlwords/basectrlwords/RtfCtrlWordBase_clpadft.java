...
public class RtfCtrlWordBase_clpadft extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clpadft(RtfParser rtfParser){
		super(rtfParser, "clpadft", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
