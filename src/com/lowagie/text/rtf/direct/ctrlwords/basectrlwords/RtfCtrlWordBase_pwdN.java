...
public class RtfCtrlWordBase_pwdN extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pwdN(RtfParser rtfParser){
		super(rtfParser, "pwdN", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
