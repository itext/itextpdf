...
public class RtfCtrlWordBase_posxr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_posxr(RtfParser rtfParser){
		super(rtfParser, "posxr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
