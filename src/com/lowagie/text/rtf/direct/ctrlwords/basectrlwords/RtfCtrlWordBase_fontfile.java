...
public class RtfCtrlWordBase_fontfile extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fontfile(RtfParser rtfParser){
		super(rtfParser, "fontfile", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
