...
public class RtfCtrlWordBase_wmetafile extends RtfCtrlWordBase {

	public RtfCtrlWordBase_wmetafile(RtfParser rtfParser){
		super(rtfParser, "wmetafile", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
