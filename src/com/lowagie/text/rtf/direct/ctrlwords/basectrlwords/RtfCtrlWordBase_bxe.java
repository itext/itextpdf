...
public class RtfCtrlWordBase_bxe extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bxe(RtfParser rtfParser){
		super(rtfParser, "bxe", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
