...
public class RtfCtrlWordBase_sftnrstcont extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnrstcont(RtfParser rtfParser){
		super(rtfParser, "sftnrstcont", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
