...
public class RtfCtrlWordBase_dy extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dy(RtfParser rtfParser){
		super(rtfParser, "dy", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
