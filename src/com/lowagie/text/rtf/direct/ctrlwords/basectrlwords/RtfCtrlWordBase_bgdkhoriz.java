...
public class RtfCtrlWordBase_bgdkhoriz extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bgdkhoriz(RtfParser rtfParser){
		super(rtfParser, "bgdkhoriz", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
