...
public class RtfCtrlWordBase_tqdec extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tqdec(RtfParser rtfParser){
		super(rtfParser, "tqdec", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
