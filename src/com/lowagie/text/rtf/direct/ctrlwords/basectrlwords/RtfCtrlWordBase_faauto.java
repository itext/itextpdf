...
public class RtfCtrlWordBase_faauto extends RtfCtrlWordBase {

	public RtfCtrlWordBase_faauto(RtfParser rtfParser){
		super(rtfParser, "faauto", 0, false, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
