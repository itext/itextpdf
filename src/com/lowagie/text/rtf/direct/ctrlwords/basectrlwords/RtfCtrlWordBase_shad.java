...
public class RtfCtrlWordBase_shad extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shad(RtfParser rtfParser){
		super(rtfParser, "shad", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
