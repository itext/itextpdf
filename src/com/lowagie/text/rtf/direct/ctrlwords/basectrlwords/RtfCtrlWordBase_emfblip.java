...
public class RtfCtrlWordBase_emfblip extends RtfCtrlWordBase {

	public RtfCtrlWordBase_emfblip(RtfParser rtfParser){
		super(rtfParser, "emfblip", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
