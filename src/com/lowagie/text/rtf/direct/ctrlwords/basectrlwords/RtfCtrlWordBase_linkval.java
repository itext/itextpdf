...
/**
 * Description:
 * 	The name of a bookmark that contains the text to display as
...
public class RtfCtrlWordBase_linkval extends RtfCtrlWordBase {

	public RtfCtrlWordBase_linkval(RtfParser rtfParser){
		super(rtfParser, "linkval", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
