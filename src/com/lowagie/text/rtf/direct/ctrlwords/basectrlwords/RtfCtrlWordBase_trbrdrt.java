...
public class RtfCtrlWordBase_trbrdrt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trbrdrt(RtfParser rtfParser){
		super(rtfParser, "trbrdrt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
