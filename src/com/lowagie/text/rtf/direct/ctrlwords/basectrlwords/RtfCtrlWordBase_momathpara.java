...
public class RtfCtrlWordBase_momathpara extends RtfCtrlWordBase {

	public RtfCtrlWordBase_momathpara(RtfParser rtfParser){
		super(rtfParser, "momathpara", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
