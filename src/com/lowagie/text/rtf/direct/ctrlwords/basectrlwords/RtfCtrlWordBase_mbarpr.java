...
public class RtfCtrlWordBase_mbarpr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mbarpr(RtfParser rtfParser){
		super(rtfParser, "mbarpr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
