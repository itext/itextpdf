...
public class RtfCtrlWordBase_tbllkhdrrows extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tbllkhdrrows(RtfParser rtfParser){
		super(rtfParser, "tbllkhdrrows", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
