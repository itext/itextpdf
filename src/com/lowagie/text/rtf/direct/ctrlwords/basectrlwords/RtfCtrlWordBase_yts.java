...
public class RtfCtrlWordBase_yts extends RtfCtrlWordBase {

	public RtfCtrlWordBase_yts(RtfParser rtfParser){
		super(rtfParser, "yts", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
