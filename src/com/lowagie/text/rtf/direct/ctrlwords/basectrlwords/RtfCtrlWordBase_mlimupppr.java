...
public class RtfCtrlWordBase_mlimupppr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mlimupppr(RtfParser rtfParser){
		super(rtfParser, "mlimupppr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
