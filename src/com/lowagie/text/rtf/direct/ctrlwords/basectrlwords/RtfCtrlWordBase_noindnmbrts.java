 ...
 * 	the custom tab stop generated by the hanging indent (if any)
 * 	when advancing the text after the numbering for a numbered
 * 	paragraph.
 * Group:
...
public class RtfCtrlWordBase_noindnmbrts extends RtfCtrlWordBase {

	public RtfCtrlWordBase_noindnmbrts(RtfParser rtfParser){
		super(rtfParser, "noindnmbrts", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
