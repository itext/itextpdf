...
public class RtfCtrlWordBase_aulnone extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aulnone(RtfParser rtfParser){
		super(rtfParser, "aulnone", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
