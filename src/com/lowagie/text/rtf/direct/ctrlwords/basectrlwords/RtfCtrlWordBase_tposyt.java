...
public class RtfCtrlWordBase_tposyt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tposyt(RtfParser rtfParser){
		super(rtfParser, "tposyt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
