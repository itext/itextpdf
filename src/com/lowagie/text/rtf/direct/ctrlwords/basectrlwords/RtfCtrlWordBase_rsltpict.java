...
public class RtfCtrlWordBase_rsltpict extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rsltpict(RtfParser rtfParser){
		super(rtfParser, "rsltpict", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
