...
public class RtfCtrlWordBase_trspdfl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trspdfl(RtfParser rtfParser){
		super(rtfParser, "trspdfl", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
