...
public class RtfCtrlWordBase_mbar extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mbar(RtfParser rtfParser){
		super(rtfParser, "mbar", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
