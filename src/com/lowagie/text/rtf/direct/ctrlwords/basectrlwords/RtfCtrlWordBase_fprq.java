...
public class RtfCtrlWordBase_fprq extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fprq(RtfParser rtfParser){
		super(rtfParser, "fprq", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
