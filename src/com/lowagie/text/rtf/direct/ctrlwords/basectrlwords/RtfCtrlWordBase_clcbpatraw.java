...
public class RtfCtrlWordBase_clcbpatraw extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clcbpatraw(RtfParser rtfParser){
		super(rtfParser, "clcbpatraw", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
