...
public class RtfCtrlWordBase_ftnnruc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnnruc(RtfParser rtfParser){
		super(rtfParser, "ftnnruc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
