...
public class RtfCtrlWordBase_pvpara extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pvpara(RtfParser rtfParser){
		super(rtfParser, "pvpara", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
