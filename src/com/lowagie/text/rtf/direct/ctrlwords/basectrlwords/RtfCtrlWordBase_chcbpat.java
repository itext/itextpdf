...
public class RtfCtrlWordBase_chcbpat extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chcbpat(RtfParser rtfParser){
		super(rtfParser, "chcbpat", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
