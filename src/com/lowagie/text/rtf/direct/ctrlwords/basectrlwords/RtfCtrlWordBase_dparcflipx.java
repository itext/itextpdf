...
public class RtfCtrlWordBase_dparcflipx extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dparcflipx(RtfParser rtfParser){
		super(rtfParser, "dparcflipx", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
