...
public class RtfCtrlWordBase_pnql extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnql(RtfParser rtfParser){
		super(rtfParser, "pnql", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
