...
public class RtfCtrlWordBase_trbgdkfdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trbgdkfdiag(RtfParser rtfParser){
		super(rtfParser, "trbgdkfdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
