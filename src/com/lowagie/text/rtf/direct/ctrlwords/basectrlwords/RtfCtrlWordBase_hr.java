...
public class RtfCtrlWordBase_hr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_hr(RtfParser rtfParser){
		super(rtfParser, "hr", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
