...
public class RtfCtrlWordBase_objlink extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objlink(RtfParser rtfParser){
		super(rtfParser, "objlink", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
