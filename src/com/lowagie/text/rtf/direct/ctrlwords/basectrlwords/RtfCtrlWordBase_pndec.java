...
public class RtfCtrlWordBase_pndec extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pndec(RtfParser rtfParser){
		super(rtfParser, "pndec", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
