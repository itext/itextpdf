...
public class RtfCtrlWordBase_pndbnumt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pndbnumt(RtfParser rtfParser){
		super(rtfParser, "pndbnumt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
