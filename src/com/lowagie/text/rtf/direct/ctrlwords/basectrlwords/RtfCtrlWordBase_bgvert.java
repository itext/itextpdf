...
public class RtfCtrlWordBase_bgvert extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bgvert(RtfParser rtfParser){
		super(rtfParser, "bgvert", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
