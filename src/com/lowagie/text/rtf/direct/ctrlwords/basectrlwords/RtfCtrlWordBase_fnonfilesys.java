...
public class RtfCtrlWordBase_fnonfilesys extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fnonfilesys(RtfParser rtfParser){
		super(rtfParser, "fnonfilesys", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
