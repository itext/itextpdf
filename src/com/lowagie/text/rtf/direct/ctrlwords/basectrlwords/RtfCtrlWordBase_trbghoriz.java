...
public class RtfCtrlWordBase_trbghoriz extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trbghoriz(RtfParser rtfParser){
		super(rtfParser, "trbghoriz", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
