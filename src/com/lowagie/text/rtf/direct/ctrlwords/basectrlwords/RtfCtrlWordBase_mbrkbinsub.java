...
public class RtfCtrlWordBase_mbrkbinsub extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mbrkbinsub(RtfParser rtfParser){
		super(rtfParser, "mbrkbinsub", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
