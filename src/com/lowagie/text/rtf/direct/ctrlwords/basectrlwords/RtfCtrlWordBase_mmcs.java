...
public class RtfCtrlWordBase_mmcs extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmcs(RtfParser rtfParser){
		super(rtfParser, "mmcs", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
