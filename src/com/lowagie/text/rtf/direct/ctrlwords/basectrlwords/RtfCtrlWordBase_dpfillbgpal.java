...
public class RtfCtrlWordBase_dpfillbgpal extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpfillbgpal(RtfParser rtfParser){
		super(rtfParser, "dpfillbgpal", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
