...
public class RtfCtrlWordBase_jclisttab extends RtfCtrlWordBase {

	public RtfCtrlWordBase_jclisttab(RtfParser rtfParser){
		super(rtfParser, "jclisttab", 0, false, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
