...
public class RtfCtrlWordBase_saftnnar extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnnar(RtfParser rtfParser){
		super(rtfParser, "saftnnar", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
