...
public class RtfCtrlWordBase_horzvert extends RtfCtrlWordBase {

	public RtfCtrlWordBase_horzvert(RtfParser rtfParser){
		super(rtfParser, "horzvert", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
