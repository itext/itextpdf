...
public class RtfCtrlWordBase_ul extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ul(RtfParser rtfParser){
		super(rtfParser, "ul", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
