...
public class RtfCtrlWordBase_background extends RtfCtrlWordBase {

	public RtfCtrlWordBase_background(RtfParser rtfParser){
		super(rtfParser, "background", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
