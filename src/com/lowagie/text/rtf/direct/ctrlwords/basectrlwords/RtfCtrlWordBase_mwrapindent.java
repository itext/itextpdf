...
public class RtfCtrlWordBase_mwrapindent extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mwrapindent(RtfParser rtfParser){
		super(rtfParser, "mwrapindent", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
