...
public class RtfCtrlWordBase_faroman extends RtfCtrlWordBase {

	public RtfCtrlWordBase_faroman(RtfParser rtfParser){
		super(rtfParser, "faroman", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
