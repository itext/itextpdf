...
public class RtfCtrlWordBase_tsvertalt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsvertalt(RtfParser rtfParser){
		super(rtfParser, "tsvertalt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
