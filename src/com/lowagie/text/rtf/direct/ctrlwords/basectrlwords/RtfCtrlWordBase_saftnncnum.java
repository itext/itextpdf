...
public class RtfCtrlWordBase_saftnncnum extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnncnum(RtfParser rtfParser){
		super(rtfParser, "saftnncnum", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
