...
public class RtfCtrlWordBase_sbauto extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sbauto(RtfParser rtfParser){
		super(rtfParser, "sbauto", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
