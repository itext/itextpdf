...
public class RtfCtrlWordBase_pndbnum extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pndbnum(RtfParser rtfParser){
		super(rtfParser, "pndbnum", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
