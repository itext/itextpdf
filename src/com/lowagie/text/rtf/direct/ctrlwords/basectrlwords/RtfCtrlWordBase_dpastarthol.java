...
public class RtfCtrlWordBase_dpastarthol extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpastarthol(RtfParser rtfParser){
		super(rtfParser, "dpastarthol", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
