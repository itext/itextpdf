...
public class RtfCtrlWordBase_aftncn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftncn(RtfParser rtfParser){
		super(rtfParser, "aftncn", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
