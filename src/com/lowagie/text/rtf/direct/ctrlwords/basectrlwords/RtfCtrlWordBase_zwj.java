...
public class RtfCtrlWordBase_zwj extends RtfCtrlWordBase {

	public RtfCtrlWordBase_zwj(RtfParser rtfParser){
		super(rtfParser, "zwj", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
