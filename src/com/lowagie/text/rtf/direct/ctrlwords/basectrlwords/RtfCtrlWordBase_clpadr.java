...
public class RtfCtrlWordBase_clpadr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clpadr(RtfParser rtfParser){
		super(rtfParser, "clpadr", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
