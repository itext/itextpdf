...
public class RtfCtrlWordBase_listoverridestart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_listoverridestart(RtfParser rtfParser){
		super(rtfParser, "listoverridestart", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
