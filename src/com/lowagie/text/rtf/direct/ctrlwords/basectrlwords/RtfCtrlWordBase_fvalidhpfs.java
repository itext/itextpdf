...
public class RtfCtrlWordBase_fvalidhpfs extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fvalidhpfs(RtfParser rtfParser){
		super(rtfParser, "fvalidhpfs", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
