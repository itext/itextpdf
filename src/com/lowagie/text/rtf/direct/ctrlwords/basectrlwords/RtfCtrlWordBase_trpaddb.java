...
public class RtfCtrlWordBase_trpaddb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trpaddb(RtfParser rtfParser){
		super(rtfParser, "trpaddb", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
