...
public class RtfCtrlWordBase_pgnbidib extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgnbidib(RtfParser rtfParser){
		super(rtfParser, "pgnbidib", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
