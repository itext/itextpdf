...
public class RtfCtrlWordBase_dobypara extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dobypara(RtfParser rtfParser){
		super(rtfParser, "dobypara", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
