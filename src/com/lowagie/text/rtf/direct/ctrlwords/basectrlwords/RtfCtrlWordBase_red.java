...
public class RtfCtrlWordBase_red extends RtfCtrlWordBase {

	public RtfCtrlWordBase_red(RtfParser rtfParser){
		super(rtfParser, "red", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
