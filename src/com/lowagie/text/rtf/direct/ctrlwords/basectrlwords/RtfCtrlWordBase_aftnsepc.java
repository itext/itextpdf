...
public class RtfCtrlWordBase_aftnsepc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnsepc(RtfParser rtfParser){
		super(rtfParser, "aftnsepc", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
