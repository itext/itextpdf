...
public class RtfCtrlWordBase_tphmrg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tphmrg(RtfParser rtfParser){
		super(rtfParser, "tphmrg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
