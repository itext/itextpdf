...
public class RtfCtrlWordBase_aftnnalc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnnalc(RtfParser rtfParser){
		super(rtfParser, "aftnnalc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
