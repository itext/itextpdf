...
public class RtfCtrlWordBase_rawclbgdcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rawclbgdcross(RtfParser rtfParser){
		super(rtfParser, "rawclbgdcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
