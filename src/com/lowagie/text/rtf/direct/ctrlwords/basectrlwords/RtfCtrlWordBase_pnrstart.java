...
public class RtfCtrlWordBase_pnrstart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnrstart(RtfParser rtfParser){
		super(rtfParser, "pnrstart", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
