...
/**
 * Description:
 * 	,"Each list should have a unique template ID as well, which
 * 	also should be randomly generated. The template ID cannot be
...
public class RtfCtrlWordBase_listtemplateid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_listtemplateid(RtfParser rtfParser){
		super(rtfParser, "listtemplateid", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
