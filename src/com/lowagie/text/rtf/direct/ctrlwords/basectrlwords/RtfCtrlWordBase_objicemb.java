...
public class RtfCtrlWordBase_objicemb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objicemb(RtfParser rtfParser){
		super(rtfParser, "objicemb", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
