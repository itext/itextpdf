...
public class RtfCtrlWordBase_fftypetxt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fftypetxt(RtfParser rtfParser){
		super(rtfParser, "fftypetxt", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
