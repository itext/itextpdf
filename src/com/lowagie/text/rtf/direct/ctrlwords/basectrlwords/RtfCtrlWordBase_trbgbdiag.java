...
public class RtfCtrlWordBase_trbgbdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trbgbdiag(RtfParser rtfParser){
		super(rtfParser, "trbgbdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
