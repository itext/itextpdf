...
public class RtfCtrlWordBase_scompose extends RtfCtrlWordBase {

	public RtfCtrlWordBase_scompose(RtfParser rtfParser){
		super(rtfParser, "scompose", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
