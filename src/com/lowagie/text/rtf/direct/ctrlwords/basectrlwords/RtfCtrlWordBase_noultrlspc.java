...
public class RtfCtrlWordBase_noultrlspc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_noultrlspc(RtfParser rtfParser){
		super(rtfParser, "noultrlspc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
