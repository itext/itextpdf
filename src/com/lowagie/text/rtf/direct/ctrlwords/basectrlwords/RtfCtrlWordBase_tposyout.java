...
public class RtfCtrlWordBase_tposyout extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tposyout(RtfParser rtfParser){
		super(rtfParser, "tposyout", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
