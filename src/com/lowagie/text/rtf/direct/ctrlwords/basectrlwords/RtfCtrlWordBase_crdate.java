...
public class RtfCtrlWordBase_crdate extends RtfCtrlWordBase {

	public RtfCtrlWordBase_crdate(RtfParser rtfParser){
		super(rtfParser, "crdate", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
