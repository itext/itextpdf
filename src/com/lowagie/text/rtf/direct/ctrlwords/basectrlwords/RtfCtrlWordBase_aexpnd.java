...
public class RtfCtrlWordBase_aexpnd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aexpnd(RtfParser rtfParser){
		super(rtfParser, "aexpnd", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
