...
public class RtfCtrlWordBase_lsdqformat extends RtfCtrlWordBase {

	public RtfCtrlWordBase_lsdqformat(RtfParser rtfParser){
		super(rtfParser, "lsdqformat", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
