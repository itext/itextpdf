...
public class RtfCtrlWordBase_brdroutset extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdroutset(RtfParser rtfParser){
		super(rtfParser, "brdroutset", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
