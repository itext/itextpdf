...
public class RtfCtrlWordBase_tsbrdrdgr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsbrdrdgr(RtfParser rtfParser){
		super(rtfParser, "tsbrdrdgr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
