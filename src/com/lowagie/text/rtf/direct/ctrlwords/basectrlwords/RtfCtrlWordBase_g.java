...
public class RtfCtrlWordBase_g extends RtfCtrlWordBase {

	public RtfCtrlWordBase_g(RtfParser rtfParser){
		super(rtfParser, "g", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
