...
public class RtfCtrlWordBase_pnaiud extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnaiud(RtfParser rtfParser){
		super(rtfParser, "pnaiud", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
