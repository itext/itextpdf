...
/**
 * Description:
 * 	1 if any list numbers from previous levels should be
 * 	converted to Arabic numbers;
 * 	0 if they should be left
...
public class RtfCtrlWordBase_levellegal extends RtfCtrlWordBase {

	public RtfCtrlWordBase_levellegal(RtfParser rtfParser){
		super(rtfParser, "levellegal", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
