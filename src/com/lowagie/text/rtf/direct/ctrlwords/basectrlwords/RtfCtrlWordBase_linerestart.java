...
public class RtfCtrlWordBase_linerestart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_linerestart(RtfParser rtfParser){
		super(rtfParser, "linerestart", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
