...
public class RtfCtrlWordBase_doctemp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_doctemp(RtfParser rtfParser){
		super(rtfParser, "doctemp", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
