...
public class RtfCtrlWordBase_tsbgdkcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsbgdkcross(RtfParser rtfParser){
		super(rtfParser, "tsbgdkcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
