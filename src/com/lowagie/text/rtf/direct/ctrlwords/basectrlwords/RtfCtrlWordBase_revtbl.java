...
public class RtfCtrlWordBase_revtbl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_revtbl(RtfParser rtfParser){
		super(rtfParser, "revtbl", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
