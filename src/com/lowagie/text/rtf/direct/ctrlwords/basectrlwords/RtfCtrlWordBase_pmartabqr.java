...
public class RtfCtrlWordBase_pmartabqr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pmartabqr(RtfParser rtfParser){
		super(rtfParser, "pmartabqr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
