...
public class RtfCtrlWordBase_fldlock extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fldlock(RtfParser rtfParser){
		super(rtfParser, "fldlock", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
