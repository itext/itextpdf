...
public class RtfCtrlWordBase_objautlink extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objautlink(RtfParser rtfParser){
		super(rtfParser, "objautlink", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
