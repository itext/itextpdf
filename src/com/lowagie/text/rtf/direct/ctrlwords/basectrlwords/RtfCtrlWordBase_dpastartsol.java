...
public class RtfCtrlWordBase_dpastartsol extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpastartsol(RtfParser rtfParser){
		super(rtfParser, "dpastartsol", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
