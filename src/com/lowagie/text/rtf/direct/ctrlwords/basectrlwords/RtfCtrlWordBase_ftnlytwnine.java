...
public class RtfCtrlWordBase_ftnlytwnine extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnlytwnine(RtfParser rtfParser){
		super(rtfParser, "ftnlytwnine", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
