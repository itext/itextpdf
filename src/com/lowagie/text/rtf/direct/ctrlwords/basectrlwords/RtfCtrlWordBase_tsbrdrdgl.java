...
public class RtfCtrlWordBase_tsbrdrdgl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsbrdrdgl(RtfParser rtfParser){
		super(rtfParser, "tsbrdrdgl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
