...
public class RtfCtrlWordBase_pnqc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnqc(RtfParser rtfParser){
		super(rtfParser, "pnqc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
