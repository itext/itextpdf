...
public class RtfCtrlWordBase_dpfillbgcg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpfillbgcg(RtfParser rtfParser){
		super(rtfParser, "dpfillbgcg", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
