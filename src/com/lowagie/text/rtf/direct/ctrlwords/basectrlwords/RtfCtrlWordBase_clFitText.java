...
public class RtfCtrlWordBase_clFitText extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clFitText(RtfParser rtfParser){
		super(rtfParser, "clFitText", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
