...
public class RtfCtrlWordBase_xmlattr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_xmlattr(RtfParser rtfParser){
		super(rtfParser, "xmlattr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
