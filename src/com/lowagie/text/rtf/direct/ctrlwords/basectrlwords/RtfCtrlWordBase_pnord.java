...
public class RtfCtrlWordBase_pnord extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnord(RtfParser rtfParser){
		super(rtfParser, "pnord", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
