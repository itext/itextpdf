...
public class RtfCtrlWordBase_clmrgddttm extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clmrgddttm(RtfParser rtfParser){
		super(rtfParser, "clmrgddttm", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
