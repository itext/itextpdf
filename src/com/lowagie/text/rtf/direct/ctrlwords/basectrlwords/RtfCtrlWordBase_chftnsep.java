...
public class RtfCtrlWordBase_chftnsep extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chftnsep(RtfParser rtfParser){
		super(rtfParser, "chftnsep", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
