...
public class RtfCtrlWordBase_shpinst extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shpinst(RtfParser rtfParser){
		super(rtfParser, "shpinst", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
