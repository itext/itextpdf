...
public class RtfCtrlWordBase_facenter extends RtfCtrlWordBase {

	public RtfCtrlWordBase_facenter(RtfParser rtfParser){
		super(rtfParser, "facenter", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
