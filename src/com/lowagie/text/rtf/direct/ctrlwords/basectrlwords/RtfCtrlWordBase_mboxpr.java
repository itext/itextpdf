...
public class RtfCtrlWordBase_mboxpr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mboxpr(RtfParser rtfParser){
		super(rtfParser, "mboxpr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
