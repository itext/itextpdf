...
/**
 * Description:
 * 	The SHIFT modifier key. Used to describe shortcut key codes
 * 	for styles.
 * Group:
 * 	Style Sheet
 * Type:
...
public class RtfCtrlWordBase_shift extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shift(RtfParser rtfParser){
		super(rtfParser, "shift", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
