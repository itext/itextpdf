...
public class RtfCtrlWordBase_jexpand extends RtfCtrlWordBase {

	public RtfCtrlWordBase_jexpand(RtfParser rtfParser){
		super(rtfParser, "jexpand", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
