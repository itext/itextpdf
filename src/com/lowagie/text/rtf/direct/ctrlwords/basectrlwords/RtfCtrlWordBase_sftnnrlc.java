...
public class RtfCtrlWordBase_sftnnrlc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnnrlc(RtfParser rtfParser){
		super(rtfParser, "sftnnrlc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
