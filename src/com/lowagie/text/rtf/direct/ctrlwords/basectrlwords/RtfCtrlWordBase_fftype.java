...
public class RtfCtrlWordBase_fftype extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fftype(RtfParser rtfParser){
		super(rtfParser, "fftype", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
