...
public class RtfCtrlWordBase_column extends RtfCtrlWordBase {

	public RtfCtrlWordBase_column(RtfParser rtfParser){
		super(rtfParser, "column", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
