...
public class RtfCtrlWordBase_dptxtbrlv extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dptxtbrlv(RtfParser rtfParser){
		super(rtfParser, "dptxtbrlv", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
