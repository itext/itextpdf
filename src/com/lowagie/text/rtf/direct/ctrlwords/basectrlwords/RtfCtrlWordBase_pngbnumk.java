...
public class RtfCtrlWordBase_pngbnumk extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pngbnumk(RtfParser rtfParser){
		super(rtfParser, "pngbnumk", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
