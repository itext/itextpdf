...
public class RtfCtrlWordBase_bgdkvert extends RtfCtrlWordBase {

	public RtfCtrlWordBase_bgdkvert(RtfParser rtfParser){
		super(rtfParser, "bgdkvert", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
