...
public class RtfCtrlWordBase_dpfillfgcr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpfillfgcr(RtfParser rtfParser){
		super(rtfParser, "dpfillfgcr", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
