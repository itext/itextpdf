...
public class RtfCtrlWordBase_aenddoc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aenddoc(RtfParser rtfParser){
		super(rtfParser, "aenddoc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
