...
public class RtfCtrlWordBase_pgndbnumt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgndbnumt(RtfParser rtfParser){
		super(rtfParser, "pgndbnumt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
