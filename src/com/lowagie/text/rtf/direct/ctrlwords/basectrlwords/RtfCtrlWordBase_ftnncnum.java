...
public class RtfCtrlWordBase_ftnncnum extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnncnum(RtfParser rtfParser){
		super(rtfParser, "ftnncnum", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
