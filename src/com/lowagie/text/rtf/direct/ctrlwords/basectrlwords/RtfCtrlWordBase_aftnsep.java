...
public class RtfCtrlWordBase_aftnsep extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnsep(RtfParser rtfParser){
		super(rtfParser, "aftnsep", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
