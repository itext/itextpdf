...
public class RtfCtrlWordBase_brdrtnthtnsg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrtnthtnsg(RtfParser rtfParser){
		super(rtfParser, "brdrtnthtnsg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
