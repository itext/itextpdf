...
public class RtfCtrlWordBase_tbllknorowband extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tbllknorowband(RtfParser rtfParser){
		super(rtfParser, "tbllknorowband", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
