...
public class RtfCtrlWordBase_tposyc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tposyc(RtfParser rtfParser){
		super(rtfParser, "tposyc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
