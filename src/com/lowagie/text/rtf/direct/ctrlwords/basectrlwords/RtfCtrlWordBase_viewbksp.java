...
public class RtfCtrlWordBase_viewbksp extends RtfCtrlWordBase {

	public RtfCtrlWordBase_viewbksp(RtfParser rtfParser){
		super(rtfParser, "viewbksp", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
