...
public class RtfCtrlWordBase_impr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_impr(RtfParser rtfParser){
		super(rtfParser, "impr", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
