...
public class RtfCtrlWordBase_ftnngbnumk extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnngbnumk(RtfParser rtfParser){
		super(rtfParser, "ftnngbnumk", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
