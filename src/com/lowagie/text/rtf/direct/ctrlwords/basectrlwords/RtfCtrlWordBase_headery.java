...
public class RtfCtrlWordBase_headery extends RtfCtrlWordBase {

	public RtfCtrlWordBase_headery(RtfParser rtfParser){
		super(rtfParser, "headery", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
