...
public class RtfCtrlWordBase_ptablnone extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ptablnone(RtfParser rtfParser){
		super(rtfParser, "ptablnone", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
