...
public class RtfCtrlWordBase_tscellpaddfr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscellpaddfr(RtfParser rtfParser){
		super(rtfParser, "tscellpaddfr", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
