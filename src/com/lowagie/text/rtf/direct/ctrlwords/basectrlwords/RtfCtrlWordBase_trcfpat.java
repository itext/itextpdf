...
public class RtfCtrlWordBase_trcfpat extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trcfpat(RtfParser rtfParser){
		super(rtfParser, "trcfpat", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
