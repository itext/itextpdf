...
public class RtfCtrlWordBase_dxfrtext extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dxfrtext(RtfParser rtfParser){
		super(rtfParser, "dxfrtext", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
