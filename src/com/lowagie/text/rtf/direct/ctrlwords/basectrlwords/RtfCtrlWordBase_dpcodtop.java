...
public class RtfCtrlWordBase_dpcodtop extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpcodtop(RtfParser rtfParser){
		super(rtfParser, "dpcodtop", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
