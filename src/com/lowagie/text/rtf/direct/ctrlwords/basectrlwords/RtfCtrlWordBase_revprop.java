...
public class RtfCtrlWordBase_revprop extends RtfCtrlWordBase {

	public RtfCtrlWordBase_revprop(RtfParser rtfParser){
		super(rtfParser, "revprop", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
