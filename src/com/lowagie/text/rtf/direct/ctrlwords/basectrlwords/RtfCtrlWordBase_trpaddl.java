...
public class RtfCtrlWordBase_trpaddl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trpaddl(RtfParser rtfParser){
		super(rtfParser, "trpaddl", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
