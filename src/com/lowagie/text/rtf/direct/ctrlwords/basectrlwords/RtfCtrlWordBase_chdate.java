...
public class RtfCtrlWordBase_chdate extends RtfCtrlWordBase {

	public RtfCtrlWordBase_chdate(RtfParser rtfParser){
		super(rtfParser, "chdate", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
