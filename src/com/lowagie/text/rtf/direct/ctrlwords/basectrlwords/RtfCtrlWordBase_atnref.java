...
public class RtfCtrlWordBase_atnref extends RtfCtrlWordBase {

	public RtfCtrlWordBase_atnref(RtfParser rtfParser){
		super(rtfParser, "atnref", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
