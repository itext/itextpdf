...
public class RtfCtrlWordBase_pxe extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pxe(RtfParser rtfParser){
		super(rtfParser, "pxe", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
