...
public class RtfCtrlWordBase_wgrffmtfilter extends RtfCtrlWordBase {

	public RtfCtrlWordBase_wgrffmtfilter(RtfParser rtfParser){
		super(rtfParser, "wgrffmtfilter", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
