...
public class RtfCtrlWordBase_aul extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aul(RtfParser rtfParser){
		super(rtfParser, "aul", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
