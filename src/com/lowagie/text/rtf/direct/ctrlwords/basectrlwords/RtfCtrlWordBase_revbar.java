...
public class RtfCtrlWordBase_revbar extends RtfCtrlWordBase {

	public RtfCtrlWordBase_revbar(RtfParser rtfParser){
		super(rtfParser, "revbar", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
