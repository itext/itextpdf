...
public class RtfCtrlWordBase_shpbypage extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shpbypage(RtfParser rtfParser){
		super(rtfParser, "shpbypage", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
