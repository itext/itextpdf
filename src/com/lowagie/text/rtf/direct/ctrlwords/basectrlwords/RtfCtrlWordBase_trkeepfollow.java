...
public class RtfCtrlWordBase_trkeepfollow extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trkeepfollow(RtfParser rtfParser){
		super(rtfParser, "trkeepfollow", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
