...
public class RtfCtrlWordBase_tqr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tqr(RtfParser rtfParser){
		super(rtfParser, "tqr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
