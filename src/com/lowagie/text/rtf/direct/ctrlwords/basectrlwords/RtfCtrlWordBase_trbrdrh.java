...
public class RtfCtrlWordBase_trbrdrh extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trbrdrh(RtfParser rtfParser){
		super(rtfParser, "trbrdrh", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
