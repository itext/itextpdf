...
public class RtfCtrlWordBase_clvmgf extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clvmgf(RtfParser rtfParser){
		super(rtfParser, "clvmgf", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
