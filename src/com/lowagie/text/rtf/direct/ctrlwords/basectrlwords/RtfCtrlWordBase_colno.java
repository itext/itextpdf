...
public class RtfCtrlWordBase_colno extends RtfCtrlWordBase {

	public RtfCtrlWordBase_colno(RtfParser rtfParser){
		super(rtfParser, "colno", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
