...
public class RtfCtrlWordBase_msmcap extends RtfCtrlWordBase {

	public RtfCtrlWordBase_msmcap(RtfParser rtfParser){
		super(rtfParser, "msmcap", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
