...
public class RtfCtrlWordBase_objsub extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objsub(RtfParser rtfParser){
		super(rtfParser, "objsub", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
