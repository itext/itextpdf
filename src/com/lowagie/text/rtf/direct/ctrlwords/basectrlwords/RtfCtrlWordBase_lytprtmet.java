...
public class RtfCtrlWordBase_lytprtmet extends RtfCtrlWordBase {

	public RtfCtrlWordBase_lytprtmet(RtfParser rtfParser){
		super(rtfParser, "lytprtmet", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
