...
public class RtfCtrlWordBase_endnotes extends RtfCtrlWordBase {

	public RtfCtrlWordBase_endnotes(RtfParser rtfParser){
		super(rtfParser, "endnotes", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
