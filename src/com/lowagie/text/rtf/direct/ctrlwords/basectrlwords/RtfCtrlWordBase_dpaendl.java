...
public class RtfCtrlWordBase_dpaendl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpaendl(RtfParser rtfParser){
		super(rtfParser, "dpaendl", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
