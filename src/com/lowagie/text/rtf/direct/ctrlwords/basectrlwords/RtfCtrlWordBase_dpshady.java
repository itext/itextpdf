...
public class RtfCtrlWordBase_dpshady extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpshady(RtfParser rtfParser){
		super(rtfParser, "dpshady", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
