...
public class RtfCtrlWordBase_dpfillfgcb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpfillfgcb(RtfParser rtfParser){
		super(rtfParser, "dpfillfgcb", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
