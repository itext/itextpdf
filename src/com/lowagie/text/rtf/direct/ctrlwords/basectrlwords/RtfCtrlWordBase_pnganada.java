...
public class RtfCtrlWordBase_pnganada extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnganada(RtfParser rtfParser){
		super(rtfParser, "pnganada", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
