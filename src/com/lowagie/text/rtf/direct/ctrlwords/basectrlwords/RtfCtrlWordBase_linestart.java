...
public class RtfCtrlWordBase_linestart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_linestart(RtfParser rtfParser){
		super(rtfParser, "linestart", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
