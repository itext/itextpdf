...
public class RtfCtrlWordBase_dplinecob extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dplinecob(RtfParser rtfParser){
		super(rtfParser, "dplinecob", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
