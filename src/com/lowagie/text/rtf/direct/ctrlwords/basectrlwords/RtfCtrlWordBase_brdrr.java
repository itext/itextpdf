...
public class RtfCtrlWordBase_brdrr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrr(RtfParser rtfParser){
		super(rtfParser, "brdrr", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
