...
public class RtfCtrlWordBase_tscellcbpat extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscellcbpat(RtfParser rtfParser){
		super(rtfParser, "tscellcbpat", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
