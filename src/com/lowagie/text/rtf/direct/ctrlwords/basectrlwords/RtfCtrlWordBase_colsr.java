...
public class RtfCtrlWordBase_colsr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_colsr(RtfParser rtfParser){
		super(rtfParser, "colsr", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
