...
public class RtfCtrlWordBase_ftnnzodiac extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnnzodiac(RtfParser rtfParser){
		super(rtfParser, "ftnnzodiac", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
