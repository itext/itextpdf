...
public class RtfCtrlWordBase_clbrdrt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clbrdrt(RtfParser rtfParser){
		super(rtfParser, "clbrdrt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
