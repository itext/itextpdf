...
public class RtfCtrlWordBase_aftnnar extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnnar(RtfParser rtfParser){
		super(rtfParser, "aftnnar", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
