...
public class RtfCtrlWordBase_fbidi extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fbidi(RtfParser rtfParser){
		super(rtfParser, "fbidi", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
