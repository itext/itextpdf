...
public class RtfCtrlWordBase_clbgcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clbgcross(RtfParser rtfParser){
		super(rtfParser, "clbgcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
