...
public class RtfCtrlWordBase_acaps extends RtfCtrlWordBase {

	public RtfCtrlWordBase_acaps(RtfParser rtfParser){
		super(rtfParser, "acaps", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
