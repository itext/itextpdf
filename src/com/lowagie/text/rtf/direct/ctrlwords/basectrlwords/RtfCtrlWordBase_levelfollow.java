...
public class RtfCtrlWordBase_levelfollow extends RtfCtrlWordBase {

	public RtfCtrlWordBase_levelfollow(RtfParser rtfParser){
		super(rtfParser, "levelfollow", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
