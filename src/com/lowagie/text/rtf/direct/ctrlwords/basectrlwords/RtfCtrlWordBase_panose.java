...
/**
 * Description:
 * 	Destination keyword. This destination contains a 10-byte
 * 	Panose 1 number. Each byte represents a single font property
 * 	as described by the Panose 1 standard specification.
 * Group:
 * 	
 * Type:
 * 	
...
public class RtfCtrlWordBase_panose extends RtfCtrlWordBase {

	public RtfCtrlWordBase_panose(RtfParser rtfParser){
		super(rtfParser, "panose", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
