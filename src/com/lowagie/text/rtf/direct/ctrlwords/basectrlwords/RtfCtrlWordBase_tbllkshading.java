...
public class RtfCtrlWordBase_tbllkshading extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tbllkshading(RtfParser rtfParser){
		super(rtfParser, "tbllkshading", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
