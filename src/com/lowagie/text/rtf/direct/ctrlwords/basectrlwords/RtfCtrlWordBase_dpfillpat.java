...
public class RtfCtrlWordBase_dpfillpat extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpfillpat(RtfParser rtfParser){
		super(rtfParser, "dpfillpat", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
