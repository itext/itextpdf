...
public class RtfCtrlWordBase_sectspecifycl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sectspecifycl(RtfParser rtfParser){
		super(rtfParser, "sectspecifycl", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
