...
public class RtfCtrlWordBase_trftsWidthB extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trftsWidthB(RtfParser rtfParser){
		super(rtfParser, "trftsWidthB", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
