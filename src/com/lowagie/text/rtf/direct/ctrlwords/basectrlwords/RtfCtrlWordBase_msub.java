...
public class RtfCtrlWordBase_msub extends RtfCtrlWordBase {

	public RtfCtrlWordBase_msub(RtfParser rtfParser){
		super(rtfParser, "msub", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
