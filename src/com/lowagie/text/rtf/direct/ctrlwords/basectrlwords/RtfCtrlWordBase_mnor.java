...
public class RtfCtrlWordBase_mnor extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mnor(RtfParser rtfParser){
		super(rtfParser, "mnor", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
