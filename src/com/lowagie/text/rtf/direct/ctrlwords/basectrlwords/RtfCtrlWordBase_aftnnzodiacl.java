...
public class RtfCtrlWordBase_aftnnzodiacl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnnzodiacl(RtfParser rtfParser){
		super(rtfParser, "aftnnzodiacl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
