...
public class RtfCtrlWordBase_ffhaslistbox extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ffhaslistbox(RtfParser rtfParser){
		super(rtfParser, "ffhaslistbox", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
