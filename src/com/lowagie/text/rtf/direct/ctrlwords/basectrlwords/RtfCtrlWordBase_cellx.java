...
public class RtfCtrlWordBase_cellx extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cellx(RtfParser rtfParser){
		super(rtfParser, "cellx", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
