...
public class RtfCtrlWordBase_mborderboxpr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mborderboxpr(RtfParser rtfParser){
		super(rtfParser, "mborderboxpr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
