...
public class RtfCtrlWordBase_ffl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ffl(RtfParser rtfParser){
		super(rtfParser, "ffl", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
