...
public class RtfCtrlWordBase_dpfillbgcb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpfillbgcb(RtfParser rtfParser){
		super(rtfParser, "dpfillbgcb", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
