...
public class RtfCtrlWordBase_horzsect extends RtfCtrlWordBase {

	public RtfCtrlWordBase_horzsect(RtfParser rtfParser){
		super(rtfParser, "horzsect", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
