...
public class RtfCtrlWordBase_sectlinegrid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sectlinegrid(RtfParser rtfParser){
		super(rtfParser, "sectlinegrid", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
