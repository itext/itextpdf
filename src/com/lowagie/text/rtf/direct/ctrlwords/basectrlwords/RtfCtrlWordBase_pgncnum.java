...
public class RtfCtrlWordBase_pgncnum extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgncnum(RtfParser rtfParser){
		super(rtfParser, "pgncnum", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
