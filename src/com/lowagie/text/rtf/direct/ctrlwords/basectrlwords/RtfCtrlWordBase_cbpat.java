...
public class RtfCtrlWordBase_cbpat extends RtfCtrlWordBase {

	public RtfCtrlWordBase_cbpat(RtfParser rtfParser){
		super(rtfParser, "cbpat", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
