...
public class RtfCtrlWordBase_sftnnzodiac extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnnzodiac(RtfParser rtfParser){
		super(rtfParser, "sftnnzodiac", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
