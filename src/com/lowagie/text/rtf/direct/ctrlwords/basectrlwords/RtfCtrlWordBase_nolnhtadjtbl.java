...
public class RtfCtrlWordBase_nolnhtadjtbl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nolnhtadjtbl(RtfParser rtfParser){
		super(rtfParser, "nolnhtadjtbl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
