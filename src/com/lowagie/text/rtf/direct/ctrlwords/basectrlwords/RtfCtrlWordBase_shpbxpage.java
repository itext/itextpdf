...
public class RtfCtrlWordBase_shpbxpage extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shpbxpage(RtfParser rtfParser){
		super(rtfParser, "shpbxpage", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
