...
public class RtfCtrlWordBase_tsbrdrb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsbrdrb(RtfParser rtfParser){
		super(rtfParser, "tsbrdrb", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
