...
public class RtfCtrlWordBase_dpaendsol extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpaendsol(RtfParser rtfParser){
		super(rtfParser, "dpaendsol", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
