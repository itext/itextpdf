...
public class RtfCtrlWordBase_printdata extends RtfCtrlWordBase {

	public RtfCtrlWordBase_printdata(RtfParser rtfParser){
		super(rtfParser, "printdata", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
