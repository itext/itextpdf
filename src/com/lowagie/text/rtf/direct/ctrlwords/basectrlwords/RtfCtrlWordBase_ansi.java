...
public class RtfCtrlWordBase_ansi extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ansi(RtfParser rtfParser){
		super(rtfParser, "ansi", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
