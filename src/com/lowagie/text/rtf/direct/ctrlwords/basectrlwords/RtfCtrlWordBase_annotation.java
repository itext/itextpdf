...
public class RtfCtrlWordBase_annotation extends RtfCtrlWordBase {

	public RtfCtrlWordBase_annotation(RtfParser rtfParser){
		super(rtfParser, "annotation", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
