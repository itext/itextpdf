...
public class RtfCtrlWordBase_tposyb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tposyb(RtfParser rtfParser){
		super(rtfParser, "tposyb", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
