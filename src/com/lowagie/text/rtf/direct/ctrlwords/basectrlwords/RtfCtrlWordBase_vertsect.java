...
public class RtfCtrlWordBase_vertsect extends RtfCtrlWordBase {

	public RtfCtrlWordBase_vertsect(RtfParser rtfParser){
		super(rtfParser, "vertsect", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
