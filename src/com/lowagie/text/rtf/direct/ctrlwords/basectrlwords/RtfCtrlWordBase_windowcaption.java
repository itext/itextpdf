...
public class RtfCtrlWordBase_windowcaption extends RtfCtrlWordBase {

	public RtfCtrlWordBase_windowcaption(RtfParser rtfParser){
		super(rtfParser, "windowcaption", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
