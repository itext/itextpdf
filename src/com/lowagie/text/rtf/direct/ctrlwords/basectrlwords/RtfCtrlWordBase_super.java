...
public class RtfCtrlWordBase_super extends RtfCtrlWordBase {

	public RtfCtrlWordBase_super(RtfParser rtfParser){
		super(rtfParser, "super", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
