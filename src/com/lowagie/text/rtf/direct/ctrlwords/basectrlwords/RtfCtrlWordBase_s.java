...
/**
 * Description:
 * 	,"Designates paragraph style.::Designates paragraph style.
 * 	If a paragraph style is specified, style properties must be
 * 	specified with the paragraph. N references an entry in the
 * 	style sheet.
 * Group:
...
public class RtfCtrlWordBase_s extends RtfCtrlWordBase {

	public RtfCtrlWordBase_s(RtfParser rtfParser){
		super(rtfParser, "s", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
