...
public class RtfCtrlWordBase_shpwr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shpwr(RtfParser rtfParser){
		super(rtfParser, "shpwr", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
