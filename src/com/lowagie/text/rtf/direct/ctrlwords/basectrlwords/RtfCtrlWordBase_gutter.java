...
public class RtfCtrlWordBase_gutter extends RtfCtrlWordBase {

	public RtfCtrlWordBase_gutter(RtfParser rtfParser){
		super(rtfParser, "gutter", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
