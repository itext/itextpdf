...
public class RtfCtrlWordBase_mmfttypemapped extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmfttypemapped(RtfParser rtfParser){
		super(rtfParser, "mmfttypemapped", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
