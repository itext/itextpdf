...
public class RtfCtrlWordBase_brdrtnthtnmg extends RtfCtrlWordBase {

	public RtfCtrlWordBase_brdrtnthtnmg(RtfParser rtfParser){
		super(rtfParser, "brdrtnthtnmg", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
