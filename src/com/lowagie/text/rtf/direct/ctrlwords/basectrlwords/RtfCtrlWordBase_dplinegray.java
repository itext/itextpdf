...
public class RtfCtrlWordBase_dplinegray extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dplinegray(RtfParser rtfParser){
		super(rtfParser, "dplinegray", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
