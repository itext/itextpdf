...
public class RtfCtrlWordBase_tb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tb(RtfParser rtfParser){
		super(rtfParser, "tb", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
