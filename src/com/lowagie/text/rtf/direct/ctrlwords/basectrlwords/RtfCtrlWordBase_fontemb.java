...
public class RtfCtrlWordBase_fontemb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fontemb(RtfParser rtfParser){
		super(rtfParser, "fontemb", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
