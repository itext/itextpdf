...
public class RtfCtrlWordBase_tphcol extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tphcol(RtfParser rtfParser){
		super(rtfParser, "tphcol", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
