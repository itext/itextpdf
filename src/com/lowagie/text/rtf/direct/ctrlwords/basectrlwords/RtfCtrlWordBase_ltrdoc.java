...
public class RtfCtrlWordBase_ltrdoc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ltrdoc(RtfParser rtfParser){
		super(rtfParser, "ltrdoc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
