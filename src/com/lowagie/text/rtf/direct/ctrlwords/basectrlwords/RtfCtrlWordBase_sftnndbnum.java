...
public class RtfCtrlWordBase_sftnndbnum extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnndbnum(RtfParser rtfParser){
		super(rtfParser, "sftnndbnum", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
