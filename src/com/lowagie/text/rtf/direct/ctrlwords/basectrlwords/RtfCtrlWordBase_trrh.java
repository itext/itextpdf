...
public class RtfCtrlWordBase_trrh extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trrh(RtfParser rtfParser){
		super(rtfParser, "trrh", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
