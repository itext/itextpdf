...
public class RtfCtrlWordBase_objclass extends RtfCtrlWordBase {

	public RtfCtrlWordBase_objclass(RtfParser rtfParser){
		super(rtfParser, "objclass", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
