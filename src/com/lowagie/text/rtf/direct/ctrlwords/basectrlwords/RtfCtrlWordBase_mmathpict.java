...
public class RtfCtrlWordBase_mmathpict extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmathpict(RtfParser rtfParser){
		super(rtfParser, "mmathpict", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
