...
public class RtfCtrlWordBase_shpbypara extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shpbypara(RtfParser rtfParser){
		super(rtfParser, "shpbypara", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
