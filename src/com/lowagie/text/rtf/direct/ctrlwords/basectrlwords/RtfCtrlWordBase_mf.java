...
public class RtfCtrlWordBase_mf extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mf(RtfParser rtfParser){
		super(rtfParser, "mf", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
