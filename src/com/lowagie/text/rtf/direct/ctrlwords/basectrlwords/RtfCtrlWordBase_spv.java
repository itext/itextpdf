...
public class RtfCtrlWordBase_spv extends RtfCtrlWordBase {

	public RtfCtrlWordBase_spv(RtfParser rtfParser){
		super(rtfParser, "spv", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
