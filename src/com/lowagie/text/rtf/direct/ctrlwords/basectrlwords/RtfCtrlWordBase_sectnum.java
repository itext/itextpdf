...
public class RtfCtrlWordBase_sectnum extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sectnum(RtfParser rtfParser){
		super(rtfParser, "sectnum", 0, false, RtfCtrlWordType.SYMBOL, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
