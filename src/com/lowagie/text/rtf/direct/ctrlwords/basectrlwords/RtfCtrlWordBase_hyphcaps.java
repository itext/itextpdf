...
public class RtfCtrlWordBase_hyphcaps extends RtfCtrlWordBase {

	public RtfCtrlWordBase_hyphcaps(RtfParser rtfParser){
		super(rtfParser, "hyphcaps", 0, false, RtfCtrlWordType.TOGGLE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
