...
public class RtfCtrlWordBase_tpvpara extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tpvpara(RtfParser rtfParser){
		super(rtfParser, "tpvpara", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
