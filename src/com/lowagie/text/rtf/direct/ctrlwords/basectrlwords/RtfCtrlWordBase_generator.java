...
public class RtfCtrlWordBase_generator extends RtfCtrlWordBase {

	public RtfCtrlWordBase_generator(RtfParser rtfParser){
		super(rtfParser, "generator", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
