...
public class RtfCtrlWordBase_pnlcrm extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnlcrm(RtfParser rtfParser){
		super(rtfParser, "pnlcrm", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
