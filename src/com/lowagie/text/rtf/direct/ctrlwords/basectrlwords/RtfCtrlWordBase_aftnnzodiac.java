...
public class RtfCtrlWordBase_aftnnzodiac extends RtfCtrlWordBase {

	public RtfCtrlWordBase_aftnnzodiac(RtfParser rtfParser){
		super(rtfParser, "aftnnzodiac", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
