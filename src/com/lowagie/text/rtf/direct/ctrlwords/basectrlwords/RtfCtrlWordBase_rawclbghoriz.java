...
public class RtfCtrlWordBase_rawclbghoriz extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rawclbghoriz(RtfParser rtfParser){
		super(rtfParser, "rawclbghoriz", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
