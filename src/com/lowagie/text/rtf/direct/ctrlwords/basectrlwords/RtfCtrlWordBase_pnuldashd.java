...
public class RtfCtrlWordBase_pnuldashd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnuldashd(RtfParser rtfParser){
		super(rtfParser, "pnuldashd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
