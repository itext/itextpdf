...
public class RtfCtrlWordBase_pgbrdrl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgbrdrl(RtfParser rtfParser){
		super(rtfParser, "pgbrdrl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
