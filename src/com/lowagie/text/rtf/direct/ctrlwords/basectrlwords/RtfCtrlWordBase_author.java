...
public class RtfCtrlWordBase_author extends RtfCtrlWordBase {

	public RtfCtrlWordBase_author(RtfParser rtfParser){
		super(rtfParser, "author", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
