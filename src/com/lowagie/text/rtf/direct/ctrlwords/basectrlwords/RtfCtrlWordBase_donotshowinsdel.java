...
public class RtfCtrlWordBase_donotshowinsdel extends RtfCtrlWordBase {

	public RtfCtrlWordBase_donotshowinsdel(RtfParser rtfParser){
		super(rtfParser, "donotshowinsdel", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
