...
public class RtfCtrlWordBase_colsx extends RtfCtrlWordBase {

	public RtfCtrlWordBase_colsx(RtfParser rtfParser){
		super(rtfParser, "colsx", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
