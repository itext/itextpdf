...
public class RtfCtrlWordBase_xmlname extends RtfCtrlWordBase {

	public RtfCtrlWordBase_xmlname(RtfParser rtfParser){
		super(rtfParser, "xmlname", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
