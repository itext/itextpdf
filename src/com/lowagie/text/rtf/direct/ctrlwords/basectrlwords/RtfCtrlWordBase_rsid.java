...
/**
 * Description:
 * 	,"Each time a document is saved a new entry is added to this
 * 	table, with N being the random number assigned to represent
 * 	the unique session.
 * Group:
...
public class RtfCtrlWordBase_rsid extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rsid(RtfParser rtfParser){
		super(rtfParser, "rsid", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
