...
public class RtfCtrlWordBase_zwnj extends RtfCtrlWordBase {

	public RtfCtrlWordBase_zwnj(RtfParser rtfParser){
		super(rtfParser, "zwnj", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
