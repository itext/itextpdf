...
public class RtfCtrlWordBase_footnote extends RtfCtrlWordBase {

	public RtfCtrlWordBase_footnote(RtfParser rtfParser){
		super(rtfParser, "footnote", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
