...
public class RtfCtrlWordBase_linecont extends RtfCtrlWordBase {

	public RtfCtrlWordBase_linecont(RtfParser rtfParser){
		super(rtfParser, "linecont", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
