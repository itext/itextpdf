...
public class RtfCtrlWordBase_pc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pc(RtfParser rtfParser){
		super(rtfParser, "pc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
