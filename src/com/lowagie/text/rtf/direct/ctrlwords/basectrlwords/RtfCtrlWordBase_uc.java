...
public class RtfCtrlWordBase_uc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_uc(RtfParser rtfParser){
		super(rtfParser, "uc", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
