...
public class RtfCtrlWordBase_ftnil extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnil(RtfParser rtfParser){
		super(rtfParser, "ftnil", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
