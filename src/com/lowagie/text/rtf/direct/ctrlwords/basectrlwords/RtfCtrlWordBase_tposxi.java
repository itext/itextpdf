...
public class RtfCtrlWordBase_tposxi extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tposxi(RtfParser rtfParser){
		super(rtfParser, "tposxi", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
