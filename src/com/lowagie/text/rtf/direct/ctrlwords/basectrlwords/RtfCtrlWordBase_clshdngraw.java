...
public class RtfCtrlWordBase_clshdngraw extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clshdngraw(RtfParser rtfParser){
		super(rtfParser, "clshdngraw", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
