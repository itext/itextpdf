...
public class RtfCtrlWordBase_trpaddfb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trpaddfb(RtfParser rtfParser){
		super(rtfParser, "trpaddfb", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
