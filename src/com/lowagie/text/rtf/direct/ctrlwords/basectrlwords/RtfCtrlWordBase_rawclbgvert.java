...
public class RtfCtrlWordBase_rawclbgvert extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rawclbgvert(RtfParser rtfParser){
		super(rtfParser, "rawclbgvert", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
