...
public class RtfCtrlWordBase_animtext extends RtfCtrlWordBase {

	public RtfCtrlWordBase_animtext(RtfParser rtfParser){
		super(rtfParser, "animtext", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
