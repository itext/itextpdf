...
public class RtfCtrlWordBase_atrfend extends RtfCtrlWordBase {

	public RtfCtrlWordBase_atrfend(RtfParser rtfParser){
		super(rtfParser, "atrfend", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
