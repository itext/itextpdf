...
public class RtfCtrlWordBase_rtldoc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rtldoc(RtfParser rtfParser){
		super(rtfParser, "rtldoc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
