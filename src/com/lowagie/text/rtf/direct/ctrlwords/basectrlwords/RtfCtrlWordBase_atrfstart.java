...
public class RtfCtrlWordBase_atrfstart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_atrfstart(RtfParser rtfParser){
		super(rtfParser, "atrfstart", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
