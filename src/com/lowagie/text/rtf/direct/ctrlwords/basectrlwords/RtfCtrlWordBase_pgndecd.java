...
public class RtfCtrlWordBase_pgndecd extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgndecd(RtfParser rtfParser){
		super(rtfParser, "pgndecd", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
