...
/**
 * Description:
 * 	Minimum distance from the right edge of the number to the
 * 	start of the paragraph text (used for Word 7.0 compatibility
 * 	only). This keyword will only be valid if the \leveloldN
 * 	keyword is emitted.
 * Group:
 * 	List Table
 * Type:
...
public class RtfCtrlWordBase_levelspace extends RtfCtrlWordBase {

	public RtfCtrlWordBase_levelspace(RtfParser rtfParser){
		super(rtfParser, "levelspace", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
