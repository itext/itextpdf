...
public class RtfCtrlWordBase_tscsecell extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tscsecell(RtfParser rtfParser){
		super(rtfParser, "tscsecell", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
