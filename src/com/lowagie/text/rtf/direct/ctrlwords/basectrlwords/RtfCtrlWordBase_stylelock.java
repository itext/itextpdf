...
public class RtfCtrlWordBase_stylelock extends RtfCtrlWordBase {

	public RtfCtrlWordBase_stylelock(RtfParser rtfParser){
		super(rtfParser, "stylelock", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
