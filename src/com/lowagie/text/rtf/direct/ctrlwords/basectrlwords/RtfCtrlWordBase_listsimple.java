...
/**
 * Description:
 * 	1 if the list has one level; 0 (default) if the list has
 * 	nine levels.
 * Group:
 * 	List Table
 * Type:
...
public class RtfCtrlWordBase_listsimple extends RtfCtrlWordBase {

	public RtfCtrlWordBase_listsimple(RtfParser rtfParser){
		super(rtfParser, "listsimple", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
