...
public class RtfCtrlWordBase_nofcharsws extends RtfCtrlWordBase {

	public RtfCtrlWordBase_nofcharsws(RtfParser rtfParser){
		super(rtfParser, "nofcharsws", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
