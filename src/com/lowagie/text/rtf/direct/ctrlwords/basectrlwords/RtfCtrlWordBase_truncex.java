...
public class RtfCtrlWordBase_truncex extends RtfCtrlWordBase {

	public RtfCtrlWordBase_truncex(RtfParser rtfParser){
		super(rtfParser, "truncex", 0, false, RtfCtrlWordType.UNIDENTIFIED, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
