...
public class RtfCtrlWordBase_dpcotright extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpcotright(RtfParser rtfParser){
		super(rtfParser, "dpcotright", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
