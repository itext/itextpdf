...
public class RtfCtrlWordBase_mgroupchr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mgroupchr(RtfParser rtfParser){
		super(rtfParser, "mgroupchr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
