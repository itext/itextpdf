...
public class RtfCtrlWordBase_trkeep extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trkeep(RtfParser rtfParser){
		super(rtfParser, "trkeep", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
