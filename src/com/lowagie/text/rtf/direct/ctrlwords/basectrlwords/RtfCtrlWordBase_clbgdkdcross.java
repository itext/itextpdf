...
public class RtfCtrlWordBase_clbgdkdcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clbgdkdcross(RtfParser rtfParser){
		super(rtfParser, "clbgdkdcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
