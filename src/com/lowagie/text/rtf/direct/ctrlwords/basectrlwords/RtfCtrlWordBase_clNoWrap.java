...
public class RtfCtrlWordBase_clNoWrap extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clNoWrap(RtfParser rtfParser){
		super(rtfParser, "clNoWrap", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
