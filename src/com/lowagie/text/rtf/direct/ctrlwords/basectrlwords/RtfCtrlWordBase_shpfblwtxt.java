...
public class RtfCtrlWordBase_shpfblwtxt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shpfblwtxt(RtfParser rtfParser){
		super(rtfParser, "shpfblwtxt", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
