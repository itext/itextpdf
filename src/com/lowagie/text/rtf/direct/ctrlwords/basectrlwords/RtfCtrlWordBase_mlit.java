...
public class RtfCtrlWordBase_mlit extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mlit(RtfParser rtfParser){
		super(rtfParser, "mlit", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
