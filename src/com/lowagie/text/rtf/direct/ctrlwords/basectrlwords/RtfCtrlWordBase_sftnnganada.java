...
public class RtfCtrlWordBase_sftnnganada extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnnganada(RtfParser rtfParser){
		super(rtfParser, "sftnnganada", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
