...
public class RtfCtrlWordBase_pn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pn(RtfParser rtfParser){
		super(rtfParser, "pn", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
