...
public class RtfCtrlWordBase_subfontbysize extends RtfCtrlWordBase {

	public RtfCtrlWordBase_subfontbysize(RtfParser rtfParser){
		super(rtfParser, "subfontbysize", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
