...
public class RtfCtrlWordBase_dgmargin extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dgmargin(RtfParser rtfParser){
		super(rtfParser, "dgmargin", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
