...
public class RtfCtrlWordBase_saftnnrlc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnnrlc(RtfParser rtfParser){
		super(rtfParser, "saftnnrlc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
