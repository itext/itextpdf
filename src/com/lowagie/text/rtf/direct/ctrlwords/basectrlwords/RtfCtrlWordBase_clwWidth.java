...
public class RtfCtrlWordBase_clwWidth extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clwWidth(RtfParser rtfParser){
		super(rtfParser, "clwWidth", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
