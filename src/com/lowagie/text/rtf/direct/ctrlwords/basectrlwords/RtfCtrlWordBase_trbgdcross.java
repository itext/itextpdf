...
public class RtfCtrlWordBase_trbgdcross extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trbgdcross(RtfParser rtfParser){
		super(rtfParser, "trbgdcross", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
