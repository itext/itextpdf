...
public class RtfCtrlWordBase_sbknone extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sbknone(RtfParser rtfParser){
		super(rtfParser, "sbknone", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
