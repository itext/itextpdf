...
public class RtfCtrlWordBase_sprsspbf extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sprsspbf(RtfParser rtfParser){
		super(rtfParser, "sprsspbf", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
