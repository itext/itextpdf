...
public class RtfCtrlWordBase_deff extends RtfCtrlWordBase {

	public RtfCtrlWordBase_deff(RtfParser rtfParser){
		super(rtfParser, "deff", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
