...
public class RtfCtrlWordBase_mlimloc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mlimloc(RtfParser rtfParser){
		super(rtfParser, "mlimloc", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
