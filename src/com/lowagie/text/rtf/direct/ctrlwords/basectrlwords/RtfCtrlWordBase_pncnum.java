...
public class RtfCtrlWordBase_pncnum extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pncnum(RtfParser rtfParser){
		super(rtfParser, "pncnum", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
