...
public class RtfCtrlWordBase_version extends RtfCtrlWordBase {

	public RtfCtrlWordBase_version(RtfParser rtfParser){
		super(rtfParser, "version", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
