...
public class RtfCtrlWordBase_rsltmerge extends RtfCtrlWordBase {

	public RtfCtrlWordBase_rsltmerge(RtfParser rtfParser){
		super(rtfParser, "rsltmerge", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
