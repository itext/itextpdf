...
public class RtfCtrlWordBase_fdecor extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fdecor(RtfParser rtfParser){
		super(rtfParser, "fdecor", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
