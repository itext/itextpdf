...
public class RtfCtrlWordBase_clins extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clins(RtfParser rtfParser){
		super(rtfParser, "clins", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
