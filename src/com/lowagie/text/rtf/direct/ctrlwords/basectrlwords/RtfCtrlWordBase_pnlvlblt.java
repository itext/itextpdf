...
public class RtfCtrlWordBase_pnlvlblt extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnlvlblt(RtfParser rtfParser){
		super(rtfParser, "pnlvlblt", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
