...
public class RtfCtrlWordBase_mfuncpr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mfuncpr(RtfParser rtfParser){
		super(rtfParser, "mfuncpr", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
