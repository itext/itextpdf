...
public class RtfCtrlWordBase_msuphide extends RtfCtrlWordBase {

	public RtfCtrlWordBase_msuphide(RtfParser rtfParser){
		super(rtfParser, "msuphide", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
