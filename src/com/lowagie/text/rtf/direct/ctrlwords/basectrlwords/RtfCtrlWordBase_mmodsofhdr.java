...
public class RtfCtrlWordBase_mmodsofhdr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmodsofhdr(RtfParser rtfParser){
		super(rtfParser, "mmodsofhdr", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
