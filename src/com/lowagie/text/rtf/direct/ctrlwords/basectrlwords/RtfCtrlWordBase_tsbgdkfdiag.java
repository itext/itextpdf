...
/**
 * Description:
 * 	Cell shading pattern ? dark forward diagonal (\\\\)
 * Group:
 * 	Table Styles
 * Type:
 * 	Flag
...
public class RtfCtrlWordBase_tsbgdkfdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsbgdkfdiag(RtfParser rtfParser){
		super(rtfParser, "tsbgdkfdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
