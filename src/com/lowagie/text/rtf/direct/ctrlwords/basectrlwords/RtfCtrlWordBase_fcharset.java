 ...
 * 	Values for N are defined by Windows header files:
 * 	0
 * 	ANSI
 * 	1 Default
 * 	2 Symbol
...
public class RtfCtrlWordBase_fcharset extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fcharset(RtfParser rtfParser){
		super(rtfParser, "fcharset", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
