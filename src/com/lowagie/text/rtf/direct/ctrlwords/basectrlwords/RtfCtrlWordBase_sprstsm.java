...
public class RtfCtrlWordBase_sprstsm extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sprstsm(RtfParser rtfParser){
		super(rtfParser, "sprstsm", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
