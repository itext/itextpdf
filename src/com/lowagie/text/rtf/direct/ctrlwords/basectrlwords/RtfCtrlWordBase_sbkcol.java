...
public class RtfCtrlWordBase_sbkcol extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sbkcol(RtfParser rtfParser){
		super(rtfParser, "sbkcol", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
