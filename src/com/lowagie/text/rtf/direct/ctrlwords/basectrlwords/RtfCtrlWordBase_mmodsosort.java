...
public class RtfCtrlWordBase_mmodsosort extends RtfCtrlWordBase {

	public RtfCtrlWordBase_mmodsosort(RtfParser rtfParser){
		super(rtfParser, "mmodsosort", 0, false, RtfCtrlWordType.DESTINATION, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
