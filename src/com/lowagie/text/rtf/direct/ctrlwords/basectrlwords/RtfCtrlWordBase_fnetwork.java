...
/**
 * Description:
 * 	Network file system. This control word may be used in
 * 	conjunction with any of the previous file source control
 * 	words.
 * Group:
 * 	File Table
 * Type:
...
public class RtfCtrlWordBase_fnetwork extends RtfCtrlWordBase {

	public RtfCtrlWordBase_fnetwork(RtfParser rtfParser){
		super(rtfParser, "fnetwork", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
