...
public class RtfCtrlWordBase_pnrdate extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnrdate(RtfParser rtfParser){
		super(rtfParser, "pnrdate", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
