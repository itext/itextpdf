...
public class RtfCtrlWordBase_dghorigin extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dghorigin(RtfParser rtfParser){
		super(rtfParser, "dghorigin", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
