...
public class RtfCtrlWordBase_dpfillbgcr extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dpfillbgcr(RtfParser rtfParser){
		super(rtfParser, "dpfillbgcr", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
