...
public class RtfCtrlWordBase_dppolycount extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dppolycount(RtfParser rtfParser){
		super(rtfParser, "dppolycount", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
