...
public class RtfCtrlWordBase_lisa extends RtfCtrlWordBase {

	public RtfCtrlWordBase_lisa(RtfParser rtfParser){
		super(rtfParser, "lisa", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
