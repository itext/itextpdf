...
public class RtfCtrlWordBase_clbgdkhor extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clbgdkhor(RtfParser rtfParser){
		super(rtfParser, "clbgdkhor", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
