...
public class RtfCtrlWordBase_trbrdrl extends RtfCtrlWordBase {

	public RtfCtrlWordBase_trbrdrl(RtfParser rtfParser){
		super(rtfParser, "trbrdrl", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
