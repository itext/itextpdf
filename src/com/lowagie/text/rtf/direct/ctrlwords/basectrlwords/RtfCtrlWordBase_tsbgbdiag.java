...
public class RtfCtrlWordBase_tsbgbdiag extends RtfCtrlWordBase {

	public RtfCtrlWordBase_tsbgbdiag(RtfParser rtfParser){
		super(rtfParser, "tsbgbdiag", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
