...
public class RtfCtrlWordBase_clpadb extends RtfCtrlWordBase {

	public RtfCtrlWordBase_clpadb(RtfParser rtfParser){
		super(rtfParser, "clpadb", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
