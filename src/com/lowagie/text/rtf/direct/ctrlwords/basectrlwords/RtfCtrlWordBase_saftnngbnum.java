...
public class RtfCtrlWordBase_saftnngbnum extends RtfCtrlWordBase {

	public RtfCtrlWordBase_saftnngbnum(RtfParser rtfParser){
		super(rtfParser, "saftnngbnum", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
