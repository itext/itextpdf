...
public class RtfCtrlWordBase_shpbxcolumn extends RtfCtrlWordBase {

	public RtfCtrlWordBase_shpbxcolumn(RtfParser rtfParser){
		super(rtfParser, "shpbxcolumn", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
