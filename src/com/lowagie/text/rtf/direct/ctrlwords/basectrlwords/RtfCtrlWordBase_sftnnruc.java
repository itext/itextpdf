...
public class RtfCtrlWordBase_sftnnruc extends RtfCtrlWordBase {

	public RtfCtrlWordBase_sftnnruc(RtfParser rtfParser){
		super(rtfParser, "sftnnruc", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
