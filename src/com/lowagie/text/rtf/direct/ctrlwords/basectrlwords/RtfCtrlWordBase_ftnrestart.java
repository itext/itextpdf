...
public class RtfCtrlWordBase_ftnrestart extends RtfCtrlWordBase {

	public RtfCtrlWordBase_ftnrestart(RtfParser rtfParser){
		super(rtfParser, "ftnrestart", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
