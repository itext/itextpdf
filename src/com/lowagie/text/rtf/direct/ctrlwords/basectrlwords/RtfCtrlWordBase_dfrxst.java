...
public class RtfCtrlWordBase_dfrxst extends RtfCtrlWordBase {

	public RtfCtrlWordBase_dfrxst(RtfParser rtfParser){
		super(rtfParser, "dfrxst", 0, true, RtfCtrlWordType.VALUE, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
