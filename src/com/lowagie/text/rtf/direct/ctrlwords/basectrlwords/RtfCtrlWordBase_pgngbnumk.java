...
public class RtfCtrlWordBase_pgngbnumk extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pgngbnumk(RtfParser rtfParser){
		super(rtfParser, "pgngbnumk", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
