...
public class RtfCtrlWordBase_pnulnone extends RtfCtrlWordBase {

	public RtfCtrlWordBase_pnulnone(RtfParser rtfParser){
		super(rtfParser, "pnulnone", 0, false, RtfCtrlWordType.FLAG, RtfCtrlWordPropertyType.UNIDENTIFIED);
	}
}
