...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_afs;
...
public class RtfCtrlWord_afs extends RtfCtrlWordBase_afs {

	public RtfCtrlWord_afs(RtfParser rtfParser){
		super(rtfParser);
	}
