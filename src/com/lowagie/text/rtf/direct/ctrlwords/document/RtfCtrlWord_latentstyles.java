...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_latentstyles;

/**
 * Description:
 * 	Indicates that there are style and formatting usage
...
public class RtfCtrlWord_latentstyles extends RtfCtrlWordBase_latentstyles {

	public RtfCtrlWord_latentstyles(RtfParser rtfParser){
		super(rtfParser);
	}
	/* (non-Javadoc)
	...
	protected boolean handleControlWord() {
		setParserState(RtfParser.PARSER_IN_LATENTSTYLES);
