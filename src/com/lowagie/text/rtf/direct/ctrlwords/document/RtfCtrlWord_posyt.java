...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_posyt;
...
public class RtfCtrlWord_posyt extends RtfCtrlWordBase_posyt {

	public RtfCtrlWord_posyt(RtfParser rtfParser){
		super(rtfParser);
	}
