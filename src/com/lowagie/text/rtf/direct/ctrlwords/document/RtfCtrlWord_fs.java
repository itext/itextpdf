...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_fs;
...
public class RtfCtrlWord_fs extends RtfCtrlWordBase_fs {

	public RtfCtrlWord_fs(RtfParser rtfParser){
		super(rtfParser);
	}
