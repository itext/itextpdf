...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_BackSlash;
...
public class RtfCtrlWord_BackSlash extends RtfCtrlWordBase_BackSlash {

	public RtfCtrlWord_BackSlash(RtfParser rtfParser){
		super(rtfParser);
	}
