...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_g;
...
public class RtfCtrlWord_g extends RtfCtrlWordBase_g {

	public RtfCtrlWord_g(RtfParser rtfParser){
		super(rtfParser);
	}
