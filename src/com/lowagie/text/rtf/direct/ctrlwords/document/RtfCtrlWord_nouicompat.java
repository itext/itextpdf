...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_nouicompat;
 ...
 *
 * 		ofeaturethrottle are present, the last control word in the
 * 	given RTF file shall be the control word carried out.
 * Group:
...
public class RtfCtrlWord_nouicompat extends RtfCtrlWordBase_nouicompat {

	public RtfCtrlWord_nouicompat(RtfParser rtfParser){
		super(rtfParser);
	}
