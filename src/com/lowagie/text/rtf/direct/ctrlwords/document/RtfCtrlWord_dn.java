...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_dn;
...
public class RtfCtrlWord_dn extends RtfCtrlWordBase_dn {

	public RtfCtrlWord_dn(RtfParser rtfParser){
		super(rtfParser);
	}
