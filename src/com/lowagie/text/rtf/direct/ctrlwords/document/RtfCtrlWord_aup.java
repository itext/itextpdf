...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_aup;
...
public class RtfCtrlWord_aup extends RtfCtrlWordBase_aup {

	public RtfCtrlWord_aup(RtfParser rtfParser){
		super(rtfParser);
	}
