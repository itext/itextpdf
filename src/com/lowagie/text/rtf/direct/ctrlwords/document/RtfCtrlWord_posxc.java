...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_posxc;
...
public class RtfCtrlWord_posxc extends RtfCtrlWordBase_posxc {

	public RtfCtrlWord_posxc(RtfParser rtfParser){
		super(rtfParser);
	}
