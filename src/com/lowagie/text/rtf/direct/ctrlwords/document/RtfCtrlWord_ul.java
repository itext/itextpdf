...
import com.lowagie.text.rtf.direct.ctrlwords.basectrlwords.RtfCtrlWordBase_ul;
...
public class RtfCtrlWord_ul extends RtfCtrlWordBase_ul {

	public RtfCtrlWord_ul(RtfParser rtfParser){
		super(rtfParser);
	}
