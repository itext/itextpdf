...
/**
 * This class contains the metrics of the font <VAR>Courier</VAR>.
 * <P>
 * You can find these metrics in the following file:
 * ftp://ftp.adobe.com/pub/adobe/type/win/all/afmfiles/base17/0.1/com_____.afm
 *
...
public class Courier extends PdfFontMetrics {

// static membervariables
	
	/** Contains the widths of the Courier characters. */
...
// constructor
	...
	public Courier(int encoding, int fontsize) {
...
// implementing the abstract methods of the superclass.
	...
	public final PdfName name() {
		return PdfName.COURIER;
	}

	/**
	 * Gets the kerning of a certain pair of characters.
	 * <P>
	 * In the case of <CODE>Courier</CODE>, the kerning is always <VAR>0</VAR>.
	 * 
