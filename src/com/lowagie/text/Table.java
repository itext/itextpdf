...
public class Table extends Rectangle implements Element {
    ...
    public final void setWidths(float[] widths) throws DocumentException {
        if (widths.length != columns) throw new DocumentException("Wrong number of columns.");
    ...
    public String toString() {
        ...
        /*
         *	Will integrate all added tables
    ...
    private void mergeInsertedTables() throws DocumentException {
        ...
        /*
         *	add new<CODE>Cell</CODE>'s to empty/null spaces
         * @author  Geert Poels
         **/
    ...
    private boolean isValidLocation(Cell aCell, Point aLocation) {
        ...
        /*
         *	used to insert Cell in cell-array and reserve cells defined by row-/colspan
         * @author  Geert Poels
         **/
     ...
     *	      (because the rows to be spanned actually don't exist)
     *
     *	Lowagie's library, like HTML, requires an element at the lowest point or below
     *	the lowest row, targetted by the rowspan.
     *
