...
public class PRTokeniser {
    ...
    public void throwError(String error) throws IOException {
        throw new InvalidPdfException(MessageLocalization.getComposedMessage(this.getClass(), "PRTokeniser.throw.error", error, String.valueOf(file.getFilePointer())));
    }
    ...
    public char checkPdfHeader() throws IOException {
        ...
        if (idx < 0)
            throw new InvalidPdfException(MessageLocalization.getComposedMessage(this.getClass(), "PRTokeniser.pdf.header.not.found"));
    ...
    public void checkFdfHeader() throws IOException {
        ...
        if (idx < 0)
            throw new InvalidPdfException(MessageLocalization.getComposedMessage(this.getClass(), "PRTokeniser.fdf.header.not.found"));
        file.setStartOffset(idx);
    }
    ...
    public int getStartxref() throws IOException {
        ...
        if (idx < 0)
            throw new InvalidPdfException(MessageLocalization.getComposedMessage(this.getClass(), "PRTokeniser.pdf.startxref.not.found"));
        return pos + idx;
    }
    ...
    public boolean nextToken() throws IOException {
        ...
        switch (ch) {
            ...
            case '>':
                ch = file.read();
                if (ch != '>')
                    throwError(MessageLocalization.getComposedMessage(this.getClass(), "PRTokeniser.greaterthan.not.expected"));
                type = TK_END_DIC;
                break;
            case '<':
            {
                ...
                if (v1 < 0 || v2 < 0)
                    throwError(MessageLocalization.getComposedMessage(this.getClass(), "PRTokeniser.error.reading.string"));
                break;
            }
            case '%':
                type = TK_COMMENT;
