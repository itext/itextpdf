    ...
    public static PdfArray getMKColor(Color color) {
        ...
        switch (type) {
            ...
            case ExtendedColor.TYPE_SHADING:
                throw new RuntimeException(MessageLocalization.getComposedMessage(PdfAnnotation.class, "separations.patterns.and.shadings.are.not.allowed.in.mk.dictionary"));
            default:
    ...
    public static class PdfImportedLink {
    	...
    	PdfImportedLink(PdfDictionary annotation) {
    		...
    		try {
    			...
    			throw new IllegalArgumentException(MessageLocalization.getComposedMessage(this.getClass(), "you.have.to.consolidate.the.named.destinations.of.your.reader"));
    		}
    		if (destination != null) {
    	...
    	public int getDestinationPage() {
    		...
    		throw new IllegalArgumentException(MessageLocalization.getComposedMessage(this.getClass(), "page.not.found"));
    	}

    	public void setDestinationPage(int newPage) {
    		if (!isInternal()) throw new IllegalArgumentException(MessageLocalization.getComposedMessage(this.getClass(), "cannot.change.destination.of.external.link"));
