...
public class PdfContentByte {
    ...
    public void add(PdfContentByte other) {
        if (other.writer != null && writer != other.writer)
            throw new RuntimeException(MessageLocalization.getComposedMessage(this.getClass(), "inconsistent.writers.are.you.mixing.two.documents"));
    ...
    public void addImage(Image image, boolean inlineImage) throws DocumentException {
        if (!image.hasAbsoluteY())
            throw new DocumentException(MessageLocalization.getComposedMessage(this.getClass(), "the.image.must.have.absolute.positioning"));
    ...
    public void beginText() {
    	if (inText) {
    		throw new IllegalPdfSyntaxException(MessageLocalization.getComposedMessage(this.getClass(), "unbalanced.begin.end.text.operators"));
    	}
    	inText = true;
        state.xTLM = 0;
        state.yTLM = 0;
    ...
    public void restoreState() {
        ...
        if (idx < 0)
            throw new IllegalPdfSyntaxException(MessageLocalization.getComposedMessage(this.getClass(), "unbalanced.save.restore.state.operators"));
    ...
    public void setFontAndSize(BaseFont bf, float size) {
        ...
        if (size < 0.0001f && size > -0.0001f)
            throw new IllegalArgumentException(MessageLocalization.getComposedMessage(this.getClass(), "font.size.too.small.1", String.valueOf(size)));
        state.size = size;
    ...
    private void showText2(String text) {
        if (state.fontDetails == null)
            throw new NullPointerException(MessageLocalization.getComposedMessage(this.getClass(), "font.and.size.must.be.set.before.writing.any.text"));
    ...
    public PdfPatternPainter createPattern(float width, float height, float xstep, float ystep) {
        ...
        if ( xstep == 0.0f || ystep == 0.0f )
            throw new RuntimeException(MessageLocalization.getComposedMessage(this.getClass(), "xstep.or.ystep.can.not.be.zero"));
    ...
    void outputColorNumbers(Color color, float tint) {
        ...
        switch (type) {
            ...
            case ExtendedColor.TYPE_SEPARATION:
                ...
                break;
            default:
                throw new RuntimeException(MessageLocalization.getComposedMessage(this.getClass(), "invalid.color.type"));
        }
    }
    ...
    public void setPatternFill(PdfPatternPainter p, Color color, float tint) {
        checkWriter();
        if (!p.isStencil())
            throw new RuntimeException(MessageLocalization.getComposedMessage(this.getClass(), "an.uncolored.pattern.was.expected"));
        PageResources prs = getPageResources();
        PdfName name = writer.addSimplePattern(p);
        name = prs.addPattern(name, p.getIndirectReference());
    ...
    protected void checkWriter() {
        if (writer == null)
            throw new NullPointerException(MessageLocalization.getComposedMessage(this.getClass(), "the.writer.in.pdfcontentbyte.is.null"));
    }
    ...
    void checkNoPattern(PdfTemplate t) {
        if (t.getType() == PdfTemplate.TYPE_PATTERN)
            throw new RuntimeException(MessageLocalization.getComposedMessage(this.getClass(), "invalid.use.of.a.pattern.a.template.was.expected"));
    }
    ...
    public void beginLayer(PdfOCG layer) {
        if ((layer instanceof PdfLayer) && ((PdfLayer)layer).getTitle() != null)
            throw new IllegalArgumentException(MessageLocalization.getComposedMessage(this.getClass(), "a.title.is.not.a.layer"));
        if (layerDepth == null)
    ...
    public void endLayer() {
        ...
        if (layerDepth != null && !layerDepth.isEmpty()) {
        	...
        	throw new IllegalPdfSyntaxException(MessageLocalization.getComposedMessage(this.getClass(), "unbalanced.layer.operators"));
        }
        while (n-- > 0)
        ...
        if (obj != null) {
            ...
            if (obj.isNumber()) {
                ...
                if (!(ar.getPdfObject(0)).isNumber())
                    throw new IllegalArgumentException(MessageLocalization.getComposedMessage(this.getClass(), "the.structure.has.kids"));
            }
            else
                throw new IllegalArgumentException(MessageLocalization.getComposedMessage(this.getClass(), "unknown.object.at.k.1", obj.getClass().toString()));
    ...
    public void endMarkedContentSequence() {
    	if (mcDepth == 0) {
    		throw new IllegalPdfSyntaxException(MessageLocalization.getComposedMessage(this.getClass(), "unbalanced.begin.end.marked.content.operators"));
    	}
    	--mcDepth;
        content.append("EMC").append_i(separator);
    }
    ...
    public void sanityCheck() {
    	if (mcDepth != 0) {
    		throw new IllegalPdfSyntaxException(MessageLocalization.getComposedMessage(this.getClass(), "unbalanced.marked.content.operators"));
    	}
    	if (inText) {
    		throw new IllegalPdfSyntaxException(MessageLocalization.getComposedMessage(this.getClass(), "unbalanced.begin.end.text.operators"));
    	}
