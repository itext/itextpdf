...
public class PdfSignatureAppearance {
    ...
    */    
    ...
    public void setVisibleSignature(Rectangle pageRect, int page, String fieldName) {
        if (fieldName != null) {
            if (fieldName.indexOf('.') >= 0)
                throw new IllegalArgumentException(MessageLocalization.getComposedMessage(this.getClass(), "field.names.cannot.contain.a.dot"));
            AcroFields af = writer.getAcroFields();
            AcroFields.Item item = af.getFieldItem(fieldName);
            if (item != null)
                throw new IllegalArgumentException(MessageLocalization.getComposedMessage(this.getClass(), "the.field.1.already.exists", fieldName));
    ...
    public void setVisibleSignature(String fieldName) {
        ...
        AcroFields.Item item = af.getFieldItem(fieldName);
        if (item == null)
            throw new IllegalArgumentException(MessageLocalization.getComposedMessage(this.getClass(), "the.field.1.does.not.exist", fieldName));
        PdfDictionary merged = item.getMerged(0);
        if (!PdfName.SIG.equals(PdfReader.getPdfObject(merged.get(PdfName.FT))))
            throw new IllegalArgumentException(MessageLocalization.getComposedMessage(this.getClass(), "the.field.1.is.not.a.signature.field", fieldName));
        this.fieldName = fieldName;
    ...
    public void preClose(HashMap exclusionSizes) throws IOException, DocumentException {
        if (preClosed)
            throw new DocumentException(MessageLocalization.getComposedMessage(this.getClass(), "document.already.pre.closed"));
        preClosed = true;
        AcroFields af = writer.getAcroFields();
        ...
        if (cryptoDictionary == null) {
            if (PdfName.ADOBE_PPKLITE.equals(getFilter()))
                ...
                throw new IllegalArgumentException(MessageLocalization.getComposedMessage(this.getClass(), "unknown.filter.1", getFilter()));
    ...
    public void close(PdfDictionary update) throws IOException, DocumentException {
        try {
            if (!preClosed)
                throw new DocumentException(MessageLocalization.getComposedMessage(this.getClass(), "preclose.must.be.called.first"));
            ByteBuffer bf = new ByteBuffer();
            for (Iterator it = update.getKeys().iterator(); it.hasNext();) {
                ...
                if (lit == null)
                    throw new IllegalArgumentException(MessageLocalization.getComposedMessage(this.getClass(), "the.key.1.didn.t.reserve.space.in.preclose", key.toString()));
                bf.reset();
                obj.toPdf(null, bf);
                if (bf.size() > lit.getPosLength())
                    throw new IllegalArgumentException(MessageLocalization.getComposedMessage(this.getClass(), "the.key.1.is.too.big.is.2.reserved.3", key.toString(), String.valueOf(bf.size()), String.valueOf(lit.getPosLength())));
                if (tempFile == null)
            ...
            if (update.size() != exclusionLocations.size())
                throw new IllegalArgumentException(MessageLocalization.getComposedMessage(this.getClass(), "the.update.dictionary.has.less.keys.than.required"));
            if (tempFile == null) {
                ...
                if (originalout != null) {
                    ...
                    while (length > 0) {
                        ...
                        if (r < 0)
                            throw new EOFException(MessageLocalization.getComposedMessage(this.getClass(), "unexpected.eof"));
