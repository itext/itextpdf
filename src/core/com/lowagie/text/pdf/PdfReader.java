...
public class PdfReader implements PdfViewerPreferences {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    throw new InvalidPdfException(MessageLocalization.getComposedMessage(this.getClass(), "rebuild.failed.1.original.message.2", ne.getMessage(), e.getMessage()));
                }
            }
            try {
                readDocObj();
    ...
    private void readDecryptedDocObj() throws IOException {
        ...
        if (filter.equals(PdfName.STANDARD)) {
            ...
            o = enc.get(PdfName.P);
            if (!o.isNumber())
            	throw new InvalidPdfException(MessageLocalization.getComposedMessage(this.getClass(), "illegal.p.value"));
            pValue = ((PdfNumber)o).intValue();

            o = enc.get(PdfName.R);
            if (!o.isNumber())
            	throw new InvalidPdfException(MessageLocalization.getComposedMessage(this.getClass(), "illegal.r.value"));
            ...
            case 3:
                ...
                if (!o.isNumber())
                    throw new InvalidPdfException(MessageLocalization.getComposedMessage(this.getClass(), "illegal.length.value"));
            ...
            case 4:
                ...
                if (dic == null)
                    throw new InvalidPdfException(MessageLocalization.getComposedMessage(this.getClass(), "cf.not.found.encryption"));
                dic = (PdfDictionary)dic.get(PdfName.STDCF);
                if (dic == null)
                    throw new InvalidPdfException(MessageLocalization.getComposedMessage(this.getClass(), "stdcf.not.found.encryption"));
                if (PdfName.V2.equals(dic.get(PdfName.CFM)))
                    cryptoMode = PdfWriter.STANDARD_ENCRYPTION_128;
                else if (PdfName.AESV2.equals(dic.get(PdfName.CFM)))
                    cryptoMode = PdfWriter.ENCRYPTION_AES_128;
                else
                    throw new UnsupportedPdfException(MessageLocalization.getComposedMessage(this.getClass(), "no.compatible.encryption.found"));
                PdfObject em = enc.get(PdfName.ENCRYPTMETADATA);
                if (em != null && em.toString().equals("false"))
                    cryptoMode |= PdfWriter.DO_NOT_ENCRYPT_METADATA;
                break;
            default:
            	throw new UnsupportedPdfException(MessageLocalization.getComposedMessage(this.getClass(), "unknown.encryption.type.r.eq.1", rValue));
            }
        }
            ...
            o = enc.get(PdfName.V);
            if (!o.isNumber())
            	throw new InvalidPdfException(MessageLocalization.getComposedMessage(this.getClass(), "illegal.v.value"));
            ...
            case 4:
                ...
                if (dic == null)
                    throw new InvalidPdfException(MessageLocalization.getComposedMessage(this.getClass(), "defaultcryptfilter.not.found.encryption"));
                if (PdfName.V2.equals(dic.get(PdfName.CFM))) {
                    cryptoMode = PdfWriter.STANDARD_ENCRYPTION_128;
                    lengthValue = 128;
                }
                ...
                break;
            default:
            	throw new UnsupportedPdfException(MessageLocalization.getComposedMessage(this.getClass(), "unknown.encryption.type.v.eq.1", rValue));
            }
            ...
            if(!foundRecipient || envelopedData == null) {
                throw new UnsupportedPdfException(MessageLocalization.getComposedMessage(this.getClass(), "bad.certificate.and.key"));
            }
        ...
        if (filter.equals(PdfName.STANDARD)) {
            ...
            if (!equalsArray(uValue, decrypt.userKey, (rValue == 3 || rValue == 4) ? 16 : 32)) {
                ...
                if (!equalsArray(uValue, decrypt.userKey, (rValue == 3 || rValue == 4) ? 16 : 32)) {
                    throw new BadPasswordException(MessageLocalization.getComposedMessage(this.getClass(), "bad.user.password"));
                }
            }
            else
    ...
    protected PdfObject readSingleObject(int k) throws IOException {
        ...
        if (tokens.getTokenType() != PRTokeniser.TK_NUMBER)
            tokens.throwError(MessageLocalization.getComposedMessage(this.getClass(), "invalid.object.number"));
        objNum = tokens.intValue();
        tokens.nextValidToken();
        if (tokens.getTokenType() != PRTokeniser.TK_NUMBER)
            tokens.throwError(MessageLocalization.getComposedMessage(this.getClass(), "invalid.generation.number"));
        objGen = tokens.intValue();
        tokens.nextValidToken();
        if (!tokens.getStringValue().equals("obj"))
            tokens.throwError(MessageLocalization.getComposedMessage(this.getClass(), "token.obj.expected"));
        PdfObject obj;
        try {
            obj = readPRObject();
    ...
    protected PdfObject readOneObjStm(PRStream stream, int idx) throws IOException {
        ...
        try {
            ...
            if (!ok)
                throw new InvalidPdfException(MessageLocalization.getComposedMessage(this.getClass(), "error.reading.objstm"));
            tokens.seek(address);
            return readPRObject();
        }
        finally {
    ...
    protected void readXref() throws IOException {
        ...
        if (!tokens.getStringValue().equals("startxref"))
            throw new InvalidPdfException(MessageLocalization.getComposedMessage(this.getClass(), "startxref.not.found"));
        tokens.nextToken();
        if (tokens.getTokenType() != PRTokeniser.TK_NUMBER)
            throw new InvalidPdfException(MessageLocalization.getComposedMessage(this.getClass(), "startxref.is.not.followed.by.a.number"));
    ...
    protected PdfDictionary readXrefSection() throws IOException {
        ...
        if (!tokens.getStringValue().equals("xref"))
            tokens.throwError(MessageLocalization.getComposedMessage(this.getClass(), "xref.subsection.not.found"));
        int start = 0;
        int end = 0;
        int pos = 0;
        int gen = 0;
        while (true) {
            ...
            if (tokens.getStringValue().equals("trailer"))
                break;
            if (tokens.getTokenType() != PRTokeniser.TK_NUMBER)
                tokens.throwError(MessageLocalization.getComposedMessage(this.getClass(), "object.number.of.the.first.object.in.this.xref.subsection.not.found"));
            start = tokens.intValue();
            tokens.nextValidToken();
            if (tokens.getTokenType() != PRTokeniser.TK_NUMBER)
                tokens.throwError(MessageLocalization.getComposedMessage(this.getClass(), "number.of.entries.in.this.xref.subsection.not.found"));
...
//                            tokens.throwError(MessageLocalization.getComposedMessage("file.position.0.cross.reference.entry.in.this.xref.subsection"));
                    ...
                    tokens.throwError(MessageLocalization.getComposedMessage(this.getClass(), "invalid.cross.reference.entry.in.this.xref.subsection"));
            }
        }
    ...
    protected void rebuildXref() throws IOException {
        ...
        if (trailer == null)
            throw new InvalidPdfException(MessageLocalization.getComposedMessage(this.getClass(), "trailer.not.found"));
        xref = new int[top * 2];
        for (int k = 0; k < top; ++k) {
            int obj[] = xr[k];
            if (obj != null)
    ...
    protected PdfDictionary readDictionary() throws IOException {
        ...
        while (true) {
            ...
            if (tokens.getTokenType() != PRTokeniser.TK_NAME)
                tokens.throwError(MessageLocalization.getComposedMessage(this.getClass(), "dictionary.key.is.not.a.name"));
            PdfName name = new PdfName(tokens.getStringValue(), false);
            PdfObject obj = readPRObject();
            int type = obj.type();
            if (-type == PRTokeniser.TK_END_DIC)
                tokens.throwError(MessageLocalization.getComposedMessage(this.getClass(), "unexpected.gt.gt"));
            if (-type == PRTokeniser.TK_END_ARRAY)
                tokens.throwError(MessageLocalization.getComposedMessage(this.getClass(), "unexpected"));
            dic.put(name, obj);
        }
        return dic;
    }
        ...
        while (true) {
            ...
            switch (filter) {
                ...
                default:
                    ...
                    throw new RuntimeException(MessageLocalization.getComposedMessage(PdfReader.class, "png.filter.unknown"));
            }
            try {
                fout.write(curr);
            }
    ...
    public static byte[] ASCIIHexDecode(byte in[]) {
        ...
        for (int k = 0; k < in.length; ++k) {
            ...
            if (n == -1)
                throw new RuntimeException(MessageLocalization.getComposedMessage(PdfReader.class, "illegal.character.in.asciihexdecode"));
            if (first)
                n1 = n;
            else
    ...
    public static byte[] ASCII85Decode(byte in[]) {
        ...
        for (int k = 0; k < in.length; ++k) {
            ...
            if (ch < '!' || ch > 'u')
                throw new RuntimeException(MessageLocalization.getComposedMessage(PdfReader.class, "illegal.character.in.ascii85decode"));
            chn[state] = ch - '!';
            ++state;
            if (state == 5) {
                state = 0;
    ...
    public static byte[] getStreamBytes(PRStream stream, RandomAccessFileOrArray file) throws IOException {
        ...
        for (int j = 0; j < filters.size(); ++j) {
            ...
            if (name.equals("/FlateDecode") || name.equals("/Fl")) {
                ...
                throw new UnsupportedPdfException(MessageLocalization.getComposedMessage(PdfReader.class, "the.filter.1.is.not.supported", name));
        }
        return b;
    }
