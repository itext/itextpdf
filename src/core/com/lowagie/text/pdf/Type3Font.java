...
public class Type3Font extends BaseFont {
    ...
    public PdfContentByte defineGlyph(char c, float wx, float llx, float lly, float urx, float ury) {
        if (c == 0 || c > 255)
            throw new IllegalArgumentException(MessageLocalization.getComposedMessage(this.getClass(), "the.char.1.doesn.t.belong.in.this.type3.font", (int)c));
        usedSlot[c] = true;
    ...
    void writeFont(PdfWriter writer, PdfIndirectReference ref, Object[] params) throws com.lowagie.text.DocumentException, java.io.IOException {
        if (this.writer != writer)
            throw new IllegalArgumentException(MessageLocalization.getComposedMessage(this.getClass(), "type3.font.used.with.the.wrong.pdfwriter"));
        ...
        if ( firstChar == usedSlot.length ) {
        	throw new DocumentException(MessageLocalization.getComposedMessage(this.getClass(), "no.glyphs.defined.for.type3.font"));
        }
    ...
    public int getWidth(int char1) {
        if (!widths3.containsKey(char1))
            throw new IllegalArgumentException(MessageLocalization.getComposedMessage(this.getClass(), "the.char.1.is.not.defined.in.a.type3.font", char1));
