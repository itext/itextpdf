...
/**
 * Interface for an Element that allows you to put a mark at the current
 * vertical position. One of the trivial implementations is class LineSeparator
 * that can be used to draw a line at the current vertical position.
 * @since 2.1.2
 */
public interface VerticalPositionMark {
	/**
	 * Implement this method if you want the separator to draw something
	 * (for instance a line).
