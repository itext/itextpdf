...
public class FontAndColorTest {
    ...
    public void resolveColor() throws IOException {
        ...
        assertEquals(255, elementList.get(3).getChunks().get(1).getFont().getColor().getGreen());
        assertEquals(255, elementList.get(3).getChunks().get(5).getFont().getColor().getRed());
    }
}
