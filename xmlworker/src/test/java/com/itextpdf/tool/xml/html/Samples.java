...
public class Samples {
	public static final String RESOURCE_TEST_PATH = "./target/test-classes/snippets";
	...
	public void createAllSamples() throws IOException {
		for (String str : list) {
			...
			doc.open();
			BufferedInputStream bis = new BufferedInputStream(Samples.class.getResourceAsStream("/snippets/" + str
					+ "snippet.html"));
